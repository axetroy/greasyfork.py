...
window.onload = function() {
    ...
    $( "#nick" ).after("<div><select id='nick' class='form-control' onchange='location = this.options[this.selectedIndex].value;' style='float: left; width: 146,5px; color: black; background-color: white;'><option disabled selected>-- Server --</option><option value='//agar.io/?ip=mastclanserv.servegame.com:59856'>MaSt Clan</option></select></div>");
