...
window.onload = function() {                                      //fonction au démarrage
    ...
    $( "#nick" ).after("<div><select id='nick' class='form-control' onchange='location = this.options[this.selectedIndex].value;' style='float: right; width: 146,5px; color: black; background-color: white;'><option>Server !</option><option value='//agar.io/?ip=mastclan.servehttp.com:444'>MaSt Clan</option><option value='//agar.io/?ip=bubble-wars.tk:443'>Bubble Wars</option></select></div>");
