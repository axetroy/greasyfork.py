...
(function() {
    ...
    sclink.innerHTML = '🤜Clique aqui e crie sua skin!🤛';
    ...
    scheader.innerHTML = '<span style="color:black">Youtube e mod Ghost:</span><br/><span style="color:black"><a href="https://www.youtube.com/channel/UCDmF7VKehVa2mbn9-8xAbUg?view_as=subscriber" target="_blank">Ghost sinister youtube😍';
    scheader.style.margin = 0;
    schelp.appendChild(scheader);
    scp3 = document.createElement('h4');
    scp3.innerHTML = '<a href="https://greasyfork.org/pt-BR/scripts/370483-ghost-sinister" target="_blank"><font color="darkorange">Baixe o mod Ghost😝</font></a>';
...
var userInterface = window.userInterface = (function (window, document) {
    ...
    return {
        ...
        initServerIp: function () {
            ...
            serverIn.placeholder = '👉Digite manualmente o ip👈';
        ...
        onPrefChange: function () {
            ...
            oContent.push('🔥[Bolinha do mouse] zoom');
        ...
        handleTextColor: function (enabled) {
            return '<span style=\"color:' +
                (enabled ? 'lime;\">Ativado👍' : 'magenta;\">Desativado👎') + '</span>';
        }
    };
})(window, document);
...
(function(w) {
    ...
    function setMenu() {
        ...
        if (login) {
            ...
            sltMenu.innerHTML = "🍂Ghost Sinister🍂</strong>";
    ...
    function setLeaderboard() {
        if (w.lbh) {
            w.lbh.textContent = "▶Ghost Sinister◀";
