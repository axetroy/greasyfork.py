// ==UserScript==
// @name         JuniorBots Script for Youtubers
// @namespace    By Boujee
// @version      v1.0 Youtuber/Admin
// @description  JuniorBots.ga Script
// @match       *.5bz.esy.es/*
// @match       http://ugar.pw/
