// ==UserScript==
// @name          Youtube Dark Red Tsuki Theme
// @namespace     http://userstyles.org
// @description	  A dark and reddish youtube theme with tsuki flavor
// @author        Rai
// @run-at        document-start
// @version       0.20150210164947
// @include       https://www.youtube.com/*
// @require       http://code.jquery.com/jquery-latest.js
// @grant         GM_addStyle
// ==/UserScript==
$("body").append (
    '<div id="overlay2">','<div id="overlay1">'
);


(function() {var css = [
		"/* Youtube - Lights Out! */",
		"/* A Dark Youtube Theme */",
		"",
        "",
        "@font-face {",
        "font-family: Paragraph;",
        "src: url(https://systemspace.link/paragraph.ttf);",
        "}",
		"",
        "@font-face {",
        "font-family: Synapsian;",
        "src: url(https://systemspace.link/dataverses/SynapsianFont/Synapsian.ttf);",
        "}",
		"",
        "@font-face {",
        "font-family: Heading;",
        "src: url(https://systemspace.link/heading.woff);",
        "}",
		"",
        "@font-face {",
        "font-family: Tiny;",
        "src: url(https://systemspace.link/tiny.woff);",
        "}",
		"",
        "@font-face {",
        "font-family: Normal;",
        "font-size: 16px !important;",
        "src: url(https://systemspace.link/PixelOperator.ttf);",
        "}",
		"/* Background - Body */",
		"html body{",
		"background-color: rgb(10,10,10) !important;",
		"background-image: url(http://i.imgur.com/3yTpS3i.png) !important;",
        "color:#f44848;",
        "@namespace url(https://systemspace.link/paragraph.ttf);",
        "src: url(https://systemspace.link/paragraph.ttf);",
        ...
        "-webkit-animation: typing 4s steps(50, end), blink-caret 1s step-end forwards;",
        "-moz-animation: typing 4s steps(50, end), blink-caret 1s step-end forwards;",
        "}",
		"",
		".yt-ui-ellipsis {",
        ...
        "pointer-events: none;",
        "z-index: 900;",
        "background-image: url(https://systemspace.link/overlay2.png);",
        ...
        "height: 100%;",
        "pointer-events: none;",
        "background-image: url(https://systemspace.link/overlay.png);",
        "background-repeat: all;",
        "background-position: 0px 0px;",
        "animation-name: Static;",
        ...
        "}",
        "",
        "p { font-family: Paragraph !important;}",
        "",
        "#p, .yt-uix-button-icon-material-upload { background-color: #f44848 !important;}",
        "",
        "#P-settings, #P-container, #P-sidebar, #P-sidebar-list, #P-content {",
        "background-color: #1b1b1b !important;",
        "color: #f44848 !important;",
        "}",
        "",
        "a:hover{ color:#f44848 !important;}",
        "",
		...
		"}",
		"",
        "button.yt-uix-button.yt-uix-button-size-default.yt-uix-button-expander.yt-uix-expander-head.yt-uix-expander-collapsed-body.yt-uix-gen204, button.yt-uix-button.yt-uix-button-size-default.yt-uix-button-expander.yt-uix-expander-head.yt-uix-expander-body, button.yt-uix-button.yt-uix-button-size-default.yt-uix-button-expander, button.yt-uix-expander-head.guide-view-more.yt-valign{",
		"color: #6ed841 !important;",
        "}",
        "",
		...
		"}",
		"    ",
		".yt-uix-button-arrow { border-top-color: #f44848 !important; }",
		"",
		...
		"background: no-repeat url(data:image/png;base64,) !important;",
		...
		"background: #1b1b1b !important;",
		"border-bottom-color: #f44848 !important;",
		"}",
		"",
		"#yt-masthead #logo {",
		...
		"border-right-color: #f44848 !important;",
		"}",
		"",
		".guide-item {",
		"color: #bbb !important;",
        ...
        "}",
        "",
        "#watch-related { overflow-y: scroll !important;",
		...
		"",
		"#watch7-headline.yt-uix-expander-collapsed h1, .yt-uix-expander-head, #watch-description, #watch-headline-title h1, .yt-card .yt-uix-button-expander:hover { color: #aaa !important;",
        "@namespace url(https://boards.systemspace.link/heading.woff);",
        "font-family: heading !important;",
        "}",
		"",
		"#watch7-user-header .yt-user-info a { color: #167ac6 !important; }",
		"",
		...
		"border-color: transparent #f44848 !important;",
		"}",
		"",
		...
		"border-top-color: #f44848 !important;",
		"}",
		"",
		...
		"#watch7-sidebar .watch-sidebar-section { background: #1b1b1b !important; }",
		"#watch7-sidebar .watch-sidebar-separation-line { border-bottom-color: #f44848 !important; }",
		"",
		"/* Sidebar Link Colors */",
		"",
		"#watch7-sidebar .video-list .video-list-item .title { color: #999 !important; }",
		"#watch7-sidebar .video-list .video-list-item .title:hover { color: #167ac6 !important; }",
		"#watch7-sidebar .video-list-item a:visited .title { color: #555 !important; }",
		"#watch7-sidebar .video-list-item a:hover:visited .title { color: #0059B3 !important; }",
		"",
		...
		"}",
		"",
		"#watch-like span, #watch-dislike span { color:#fff }",
		...
		"/* Channel Page */",
		"",
		".channel-header .branded-page-header-title .branded-page-header-title-link, .branded-page-module-title { color: #aaa !important; }",
		"",
		".branded-page-v2-top-row { background: #1b1b1b !important; }",
		"",
		".branded-page-box.yt-card { background: #1b1b1b !important; }",
		"",
		"#c4-header-bg-container, .branded-page-v2-subnav-container { border-bottom-color: #f44848 !important; }",
		"",
		".branded-page-v2-secondary-col .branded-page-related-channels-see-more a { color: #167ac6 !important; }",
		"",
		...
		"}",
		"",
		".secondary-header-contents .nav-text { color: #fff !important; }",
		"",
		...
		"/* Search Page */",
		"",
		".search-header { border-bottom-color: #f44848 !important; }",
		".search-header .num-results, .search-header .num-results strong, .search-header .yt-uix-button-content, .filter-col-title, .filter { color: #aaa !important; }",
		"",
		".yt-badge {",
		"border-color: #f44848 !important;",
		"color: #aaa !important;",
		...
		"/* All Comments Page */",
		"",
		"#watch-response { background: #1b1b1b !important; }",
		"",
		...
		"}",
		"",
		"#watch-response-content { border-top-color: #f44848 !important; }",
		"",
		"#watch-response-header-content p a { color: #167ac6 !important; }",
        "",
        "#comment-renderer-text-content { color: #aaa !important; } ",
        "",
		"#yt-comments-sb-standin .box {",
		"background-color:#111!important;",
		"border-top:1px solid #f44848!important;",
		"border-color:#f44848!important;",
		"}",
		"",
		...
		"}",
		"",
		".callout-outer { border-color: #f44848!important; }",
		".callout-inner { border-color: #f44848!important; }",
		"",
		".comments .comment-text .comment-text-content .comment-renderer-text-content { color: #800000 !important; }",
		"",
		"/*---*/",
		"",
		"/* Playlist Page */",
		"",
		"#pl-header .pl-header-title { color: #bbb !important; }",
		"",
		".pl-video-title-link { color: #aaa !important; }",
		".pl-video:hover .pl-video-title-link, .pl-video:hover .pl-video-owner a { color: #167ac6 !important; }",
		"",
		".pl-video { border-bottom-color: #f44848 !important; }",
		"",
		"	/* Playlist Page - Icons */",
		"",
		...
		"",
		".create-playlist-widget-form .create-playlist-bottom-section { background-color: #222 !important; }",
		"",
		...
		"	/* yt-uix-form */",
		"",
		".yt-uix-form-legend, .yt-uix-form-label { color: #bbb !important; }",
		"",
		...
		"}",
		"",
		".yt-ui-menu-item:focus { background: #242424 !important; }",
		"",
		...
		".yt-dialog-fg-content, .yt-uix-overlay-fg-content { color: #aaa !important; }",
		"",
		".yt-uix-overlay-actions { background: #1b1b1b !important; }",
		"  ",
		"	/* Account switcher */",
		"",
		".yt-masthead-account-picker.yt-uix-clickcard-card-content, #masthead-expanded .masthead-expanded-menu-header { color: #aaa !important; }",
		"",
		...
		"}",
		"",
		".yt-masthead-picker-header { border-bottom-color: #f44848 !important; }",
		"  ",
		".yt-masthead-account-picker-option, .yt-masthead-picker-footer { background: #222 !important; }",
		".yt-masthead-account-picker-option .yt-masthead-picker-name { color: #aaa !important; }",
		".yt-uix-button-icon-icon-account-settings { background: no-repeat url(http://i.imgur.com/7fc8SwR.png) -49px -507px !important; }",
		"  ",
		".yt-uix-clickcard-card-reverse .yt-uix-card-body-arrow-vertical, .yt-uix-hovercard-card-reverse .yt-uix-card-body-arrow-vertical { border-bottom-color: #f44848 !important; }    ",
		".yt-uix-clickcard-card-reverse .yt-uix-card-border-arrow-vertical, .yt-uix-hovercard-card-reverse .yt-uix-card-border-arrow-vertical { border-bottom-color: #f44848 !important; }",
		"",
		"/*---*/",
		"",
		...
		"/* Blanket Fonts */",
		"",
		".yt-card .yt-card-title, a.yt-uix-button-epic-nav-item.selected, a.yt-uix-button-epic-nav-item.yt-uix-button-toggled, button.yt-uix-button-epic-nav-item.selected, button.yt-uix-button-epic-nav-item.yt-uix-button-toggled, .epic-nav-item.selected, .epic-nav-item.yt-uix-button-toggled, .epic-nav-item-heading { color: #bbb !important; }",
		"",
		"/*---*/"
	].join("\n");
if (false || (new RegExp("^https://plus.googleapis.com/(.*)/widget/render/comments\\?usegapi=1&first_party_property=YOUTUBE&href=(.*)$")).test(document.location.href) || (new RegExp("^https://apis.google.com/u/[0-9]/(.*)/_/widget/render/comments\\?usegapi=1&first_party_property=YOUTUBE&href=(.*)$")).test(document.location.href))
	css += [
		...
		"",
		".yDa{background-color:#222!important;}",
		"",
		".DJa{background-color:transparent!important;color:#999!important;}",
		"",
		".E5,.e4{background-color:#111!important;border-top:1px solid #f44848!important;border-color:#f44848!important;}",
		"",
		...
		".bmd{color:#590;}",
		"",
		".r3 .r0{background:#242323!important;color:#aaa!important;border-color:#f44848!important;}",
		"",
		".d-y-r-c{background-color:#2b2b2b!important;background-image:linear-gradient(to bottom,#222 0,#2c2c2c 100%)!important;color:#bbb!important;border-color:#444!important;}",
		"",
		".d-k-l.d-y-r-c-Qa,.ena{background:no-repeat url(http://i.imgur.com/ho8PnMO.png) -131px -17px!important;}",
		"",
		".d-r{background:#222!important;border:1px solid #444!important;}",
		"",
		".d-A-yb,.d-A-u{background-color:#333!important;border-color:#333!important;border-style:solid!important;}",
		"",
		".Hma .Pga.d-A-yb{border:none!important;}",
		"",
		".ot-anchor{color:#6f6f6f!important;}",
		"",
		".dga{background-color:#151515!important;border-color:#f44848!important;}",
		"",
		".mj .tm{background:no-repeat url(http://i.imgur.com/VpPZ6yW.png) -13px -719px!important;}",
		"",
		".g-h-f-V-nb{background:#222!important;}",
		"",
		".d-cm{border-top-color:#f44848!important;}",
		"",
		...
		"",
		".FnlLyd:hover{background-color:#222!important;border-color:#f44848!important;}",
		"",
		".FnlLyd:active{background-color:#2a2a2a!important;border-color:#f44848!important;}",
		"",
		...
		"",
		".sk{background:#222!important;outline:none!important;border-color:#f44848!important;}",
		"",
		".Jea,.mj .g-h-f-vc-B,.g-h-f-k .g-h-f-V-nb{border-color:#f44848!important;}",
		"",
		".Jea,.Mga{border-bottom-color:transparent!important;border-left-color:transparent!important;}",
		"",
		".dn,.ve.oba,.Aq,.OF,.e4,.cp,.jbgcdb,.M7Fqc{color:#aaa!important;}",
		"",
		".ot-hashtag,.proflink,.zDa,.proflinkPrefix,.xN .d-y-r-c-ha,.Pga.d-A .d-A-B{color:#bbb!important;}"
	].join("\n");
