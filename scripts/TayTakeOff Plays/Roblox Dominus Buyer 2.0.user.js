// ==UserScript==
// @name         Roblox Dominus Buyer 2.0
// @namespace    http://tampermonkey.net/
// @version      0.2
// @description  make it appear as if you bought a Dominus Aureus from the catalog.
// @author       TayTakeOff
...
function start() {
    ...
    moremessage.innerHTML = "Would you like to buy the Hat: <span class='font-bold'>Dominus Aureus</span> from ROBLOX for <span class='icon-robux-16x16'></span><span class='text-robux'>660,000</span>?";
