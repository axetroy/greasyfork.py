...
(function() {
    ...
    var coubFullWidthScript = (function CoubFullWidthScript () {
        ...
        var calcScaledWidth = function( height, width, maxHeight ) {
            var ratio = Math.min(width / width, maxHeight / height);
            width = ratio * width;
            height = ratio * height;
        ...
        return {
            ...
            attachMaxWidthToViewer: function( viewer ) {
                ...
                var availableHeight = viewHeight - header.offsetHeight - menu.offsetHeight - 119 - 80; // 119 = description of coubs, 80 = better scrolling
