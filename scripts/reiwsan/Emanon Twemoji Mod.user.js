...
// @grant        GM_addStyle
// @require      https://cdn.staticfile.org/twemoji/12.0.1/2/twemoji.min.js
// @icon         https://cdn.staticfile.org/twemoji/12.0.1/2/72x72/1f47a.png
...
(function() {
    ...
    const twemojiPath = function(icon) {
        ...
        return `https://cdn.staticfile.org/twemoji/12.0.1/2/${folder}/${icon}.${type}`;
    };
