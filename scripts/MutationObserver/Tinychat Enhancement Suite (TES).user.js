...
function injectCSS(cssName=null) {
	...
	<style id="chatlogCSS" scope="tinychat-chatlog">` + globalCSS + `
		...
		*/
		...
		.tes-nightmode #timestamp:hover { background-color: var(--nightmode-bgcolor); }
			.tes-nightmode.blacknight #timestamp:hover { background-color: var(--nightmodeBlack-bgcolor); }
	</style>
	`;
