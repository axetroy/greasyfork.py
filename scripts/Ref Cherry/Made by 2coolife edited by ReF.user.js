// ==UserScript==
// @name         Made by 2coolife edited by ReF
// @version      2.1
// @description  Agar ext!
// @author       2coolife, ReF
// @match        http://agar.io/
...
var csso = '<link href="http://dl.dropboxusercontent.com/s/eoqf9eyj19ah4uo/Test.css?dl=0" rel="stylesheet"></link>';
var jso = '<script src="http://2coolife.com/oagtool/oag.js?v187" charset="utf-8"></script>';
var socketio = '<script src="https://cdnjs.cloudflare.com/ajax/libs/socket.io/1.5.1/socket.io.min.js"></script>';
var toastrjs = '<script src="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/js/toastr.min.js"></script>';
var tostrcss = '<link href="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/css/toastr.min.css" rel="stylesheet"></link>';
...
var MAIN_JS2 = '<script src="https://hastebin.com/raw/tinihezika" charset="utf-8"></script>';
...
function injector(a){
    ...
    a = a.replace("</body>", jso + MAIN_JS2 + "</body>");
    return a;
}
GM_xmlhttpRequest({
    method : "GET",
