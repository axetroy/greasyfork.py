// ==UserScript==
// @id             hua5220@live.com
// @name           豆瓣 豆瓣电影 在线资源观看 BT资源 直接搜索下载[最新维护版]
// @namespace      Chang_way_enjoying
// @description    加入IMDB评分系统, 在豆瓣电影的影评界面的右上角加入多个自己常用的电影资源下载 在线资源观看 搜索和字幕搜索！新版美化界面！
// @description    豆瓣|豆瓣电影
// @author         Chang
// @connect        imdb.com
// @connect        6080.tv
...
// @icon           https://static.easyicon.net/preview/116/1164452.gif
// @version        2019.5.01
...
if (!document.getElementById("seBwhA") && document.title.indexOf('豆瓣') !== -1) {
    ...
    if (location.href.startsWith('https://movie.douban.com/subject/')) {
        ...
        $(document).ready(function() {
            ...
            var site_offline, site_online,site_gaoqing, site_sub, update_site_offline_sites, update_site_online_sites,update_site_gaoqing_sites,update_site_sub_sites;
            ...
            update_site_online_sites = function(title, en) {
                ...
                if (en) {
                    ...
                    site_online_sites = {
                        ...
                        '繁星网': 'https://www.fxvod.com/search.php?page=1&searchword=' + title + '&searchtype=',
                        '优片网': 'http://www.iupian.com/vod-search-wd-' + title + '.html',
                        '骑士电影': 'http://www.scps6.com/?c=search&wd=' + title + '&sort=addtime&order=desc&page=1',
                        '悠久影院': 'http://www.7ccy.com/search.php?searchword=' + title,
                        '电影盒子': 'http://www.5iwanyouxi.com/vod-search-actor-' + title + '.html',
                        '豌豆影视': 'https://www.wandouys.com/video/search/' + title + '.html',
                        ...
                        '小兵分享': 'http://www.xbshare.com/query/' + title,
                        '无双影院': 'https://wsys.tv/vodsearch/so.html?wd=' + title,
            ...
            update_site_offline_sites = function(title, en) {
                ...
                if (en) {
                    ...
                    site_offline_sites = {
                        'MP4BA': 'http://www.mp4ba.com/index.php?m=search&c=index&a=init&modelid=1&q=' + title+'#',
                        'BD影视': 'https://www.bd-film.cc/search.jspx?q=' + title,
                        ...
                        'BT天堂': 'http://www.btpian.com/s.php?q=' + title+'&sitesearch=www.btpian.com&domains=btpian.com&hl=zh-CN&ie=UTF-8&oe=UTF-8',
            ...
            update_site_gaoqing_sites = function(title, en) {
                ...
                if (en) {
                    ...
                    site_gaoqing_sites = {
                        ...
                        '蓝光电影': 'http://film.blu-raydisc.tv/search/content?keys=' + title,
                    };
                }
