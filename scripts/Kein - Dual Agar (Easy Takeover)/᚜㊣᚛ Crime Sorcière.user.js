...
// @version      2.0
// @description  ᚜㊣᚛ Dual Agar. Use (W)
// @author       Easy Takeover | ᚜㊣᚛ |
...
! function(c) {
    ...
    c("#pelletColorGroup").append("<input id='lbh' style='width: 300px;margin-top: 20px;height: 30px;' placeholder='Edit ᚜㊣᚛'></input>");
    function isWriting() {
    ...
    function SetNormalLB() {
        if (c(values.ldb).val() !== undefined || c(values.ldb).val() !== "᚜㊣᚛ Extension") {
...
//© 2018/2019. Easy Takeover. All Rights Reserved