...
// @version    0.0.7.1
// @description 解析接口贵精不贵多，绝对够用。[Tampermonkey | Violentmonkey | Greasymonkey 4.0+]
// @author     xhua
...
(() => {
  ...
  `);
  var defaultapi = {
    title: "脚本的接口，默认用浮空解析，失效请更换接口",
    url: "http://jx.618ge.com/?url="
  };
  //apis name:显示的文字  url:接口  title:提示文字  intab:是否适合内嵌(嵌入判断:GMgetValue("replaceRaw",false)值||intab值)
  var apis =[
    {name:"芒果",url:"http://jx.ovov.cc/?url=",title:"转圈圈就换线路",intab:1},
    {name:"优酷",url:"http://jx.aeidu.cn/index.php?url=",title:"转圈圈就换线路",intab:1},
