...
// @include     http://www.skyscrapercity.com/showthread.php*
// @include     http://www.skyscrapercity.com/showpost.php*
// @version     1.4 (K423)
// @grant       GM.getValue
// @grant       GM.setValue
// @grant       GM_getValue
...
function createSettingsMenu() {
  var topMenu = document.querySelector("td#threadtools").parentNode;
  ...
  if ((presentationMode & PM_DATAFMT_MASK) == PM_DATAFMT_1_0) {
    ...
    switch (presentationMode) {
      ...
      case 5:  newPresentationMode = PM_POST_SHOW_THUMB_R;                                      /* Bez podglądu, miniatura */
               break;
      default: alert("Cannot migrate from presentationMode=" + presentationMode);
    }
