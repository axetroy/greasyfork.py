// ==UserScript==
// @name         VIP视频在线解析-全网视频解析
// @namespace    http://www.renrenfabu.com/
// @version      1.0.2
// @description  在各大视频网站标题旁上显示“vip解析”按钮和“搜索电影”按钮，在线播放vip视频；支持优酷vip，腾讯vip，爱奇艺vip，芒果vip，乐视vip等常用视频...方便直接解析，无需复制粘贴
// @author       花呆子
...
(function() {
    ...
    var mSearchBtn = '<a id="ifkdySearchBtn" target="_blank" style="cursor:pointer;text-decoration:none;color:red;padding:0 5px;border:1px solid red;">外站搜索</a>';
    ...
    if(reYk.test(videoSite)){
        ...
        if(youkuTitle.length !== 0){
	        ...
	        $('#ifkdySearchBtn').attr('href','http://www.renrenfabu.com/index.php?s=/vod-search-name-' + curWords + '.html');
        }else{
    ...
    $('#ifkdyVipBtn').on('click',function(){
        ...
        window.location.href = 'http://v.renrenfabu.com/jiexi.php?url=' + curPlaySite;
    });
})();