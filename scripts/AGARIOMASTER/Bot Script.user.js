...
setTimeout(function() {
    ...
    window.addEventListener("load",function(){
        ...
        //console.log("Ð¿ÐµÑ€ÐµÑ…Ð²Ð°Ñ‚Ð¸Ð»Ð¸ Ð¿ÐµÑ€ÐµÐ´Ð°Ñ‡Ñƒ! " + arguments[0]);
        ...
        //console.log("Ð¿ÐµÑ€ÐµÑ…Ð²Ð°Ñ‚Ð¸Ð»Ð¸ Ð¿Ñ€Ð¸ÐµÐ¼! " + arguments[0].data);
        ...
        //console.log("Ð¿ÐµÑ€ÐµÑ…Ð²Ð°Ñ‚Ð¸Ð»Ð¸ Ð¿Ð¾Ð´ÐºÐ»ÑŽÑ‡ÐµÐ½Ð¸Ðµ!");
        fakeWS.readyState = 1;
   ...
   $( "#canvas" ).after( "<div style='position: absolute; top: 20px; left: 5px; color: #000; font-family: Ubuntu; width: 240px; height: 140px; background-image: radial-gradient(ellipse at center, rgba(255,255,255,1) 0%, rgba(184,184,184,0.4) 100%); padding: 20px; '><center> <span style='border-radius: 25px; background-color: #f1c40f; padding: 5px 70px; color: #fff; top 20px; font-size: 17px; width: 200px; -webkit-box-shadow: 0px 0px 28px -5px rgba(0,0,0,1); -moz-box-shadow: 0px 0px 28px -5px rgba(0,0,0,1); box-shadow: 0px 0px 28px -5px rgba(0,0,0,1);'>Bots</span><br><br> <span style='padding: 5px; color: #2c3e50;'>Bots: </span><span id='minionCount' style='border-radius: 25px; background-color: #f1c40f; padding: 5px 12px; color: #fff; top 20px; font-size: 17px; width: 200px; -webkit-box-shadow: 0px 0px 28px -5px rgba(0,0,0,1); -moz-box-shadow: 0px 0px 28px -5px rgba(0,0,0,1); box-shadow: 0px 0px 28px -5px rgba(0,0,0,1);'>0</span><br><br> <span style='padding: 5px; color: #2c3e50;'>Position: </span><span id='gh45nmvsy' style='border-radius: 25px; background-color: #f1c40f; padding: 5px 12px; color: #fff; top 20px; font-size: 17px; width: 200px; -webkit-box-shadow: 0px 0px 28px -5px rgba(0,0,0,1); -moz-box-shadow: 0px 0px 28px -5px rgba(0,0,0,1); box-shadow: 0px 0px 28px -5px rgba(0,0,0,1);'>0,0</span></center> <div id='dfdghehfj' style='display: none;'> </div> <div id='ismoveToMouse' style='display: none;'> </div><br><br> </div>" );
