// ==UserScript==
// @name TW Gold Finder Jobs [PT-BR]
// @namespace Elly Síranno 
// @author Elly Síranno 
// @description Script busca e faz uma lista atualizada dos Trabalhos ouro e Prata
...
(function (fn) {
  ...
  GoldJobs = {
    version: '3.0',
    name: 'Jobs Ouro/Prata',
    author: 'Elly Síranno',
    minGame: '2.25',
    maxGame: Game.version.toString(),
    website: 'https://www.facebook.com/profile.php?id=100004733507165',
  ...
  langs = {
    pt_BR: {
      ...
      feedbackWindowTitle: 'Suporte Gold Job 2015',
  ...
  GoldJobsApi.setGui('<br><i>Idioma : </i>' + GJlang.language + '<br><br>' + GJlang.ApiGui + '<br><br><i>' + GoldJobs.name + ' v' + GoldJobs.version + '</i>');
  ...
  GoldJobs.openFeedbackWindow = function () {
    ...
    ':</b><ul style="margin-left:15px;"><li>Enviar mensagem para <a target=\'_blanck\' href="http://om.the-west.com.br/west/br/player/?ref=west_invite_linkrl&player_id=1956087&world_id=1&hash=7337">Steeve Jobs - Mundo 1 </a></li>' +
    '<li>Hospedado em <a target=\'_blanck\' href="https://greasyfork.org/forum/messages/add/Tom Robert">Greasy Fork</a></li>' +
    '<br>Facebook: Elly Síranno / Twitter: Elly__Siranno <img src="../images/chat/emoticons/smile.png"></li></ul>');
    win.appendToContentPane(content);
  };
