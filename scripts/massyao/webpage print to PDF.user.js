...
function(e) {
	...
	return (function e(t, n, r) {
		...
		4: [function(_dereq_, module, exports) {
			...
			var html2canvasExport = (typeof(document) === "undefined" || typeof(Object.create) !== "function" || typeof(document.createElement("canvas").getContext) !== "function") ?
			function() {
	...
	html2canvas(document.body, {
		onrendered: function(canvas) {
			...
			if (leftHeight < pageHeight) {
				...
				while (leftHeight > 0) {
					pdf.addImage(pageData, 'JPEG', 10, position, imgWidth, imgHeight) leftHeight -= pageHeight;
					position -= 841.89;
					if (leftHeight > 0) {
						pdf.addPage()
					}
