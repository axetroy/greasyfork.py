...
(function (factory) {
   ...
   $.ajax({
            ...
            success:function(response){
                ...
                bans += '</div>'
                bangumi.after(`<div class="zone-wrap-module report-wrap-module report-scroll-module clearfix"><a class="name" style="font-size:24px">订阅番剧</a>${bans}</div>`);
                }
            },
         );
