// ==UserScript==
// @name         SlitherPlus veteran
// @namespace    slitherplus.io
// @version      1
// @description  slither.io veteran skins pack, subscribe to mkdspro64 on youtube. i dont own the slitherplus script, i just like to mess with the code.
...
s.onload = function() {
	...
	var s = document.createElement('script');
	s.src = 'http://puu.sh/pKw50/a556db6a18.js';
	s.onload = function() {
