...
function load() {
	...
	try {
		...
		for (i = 0; i < tournaments.length; i++) {
			...
			clonedTime.add(1, 'minute').startOf('minute');
            ...
            if (timeFormat === '12-hour') {
                tournaments[i].children[3].innerHTML = moment(startTime).format("dddd<br>D MMM YYYY<br>h:00 A");
                tournaments[i].children[4].innerHTML = moment(endTime).format("dddd<br>D MMM YYYY<br>h:00 A");
            } else {
                tournaments[i].children[3].innerHTML = moment(startTime).format("dddd<br>D MMM YYYY<br>HH:00").concat(" hrs");
                tournaments[i].children[4].innerHTML = moment(endTime).format("dddd<br>D MMM YYYY<br>HH:00").concat(" hrs");
            }
