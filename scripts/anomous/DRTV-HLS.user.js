...
// @name           DRTV-HLS
// @namespace      anomous
// @description    Dette script gør det muligt at downloade playlist-filer til udsendelser fra DR TV HLS
// @version        1.1
...
$("<img id='dllogo' title='Klik for at åbne programscanneren' src='http://i62.tinypic.com/8vr8tx.jpg' style='display:none;top:0;position:fixed;left:0;z-index:99999;margin:4px;cursor:pointer'>").prependTo("body").click(function(){
...
$progDiv = $("<div id='showList'><a id='showclose' title='Luk'>[X]</a>\
             <div id='makelist' title='Scan programmer som kan streammapes'><a>Start programscanning</a></div>\
             ...
             <div class='bigbutton' id='browserdownload' title='Download master playlist'><a>Hent master playlist via browser</a></div>\
             <div class='bigbutton' id='makecmdline' title='Generér kommandolinjer i højeste kvalitet til at copy-paste ind i terminalen'><a>Generér kommandolinje</a></div>\
             ...
             <b>ffmpeg</b> som er standard i Linux, men fås også <a href='http://www.ffmpeg.org/download.html'>til Windows</a>. ffmpeg kræves for at kunne streammappe og merge alle videosektioner.<br><br>\
             ...
             3) Vælg tilsidst de programmer der skal optages og tryk på 'Generér kommandolinje' eller 'Hent master playlist via browser'<br><br>\
...
$('#makecmdline, #browserdownload, #showlinks').click(function(){
    ...
    $("#showList input.showcb:checked").parent().each(function(){
       ...
       switch(buttonId) {
        case "showlinks":
            cmdline = cmdline + filename.replace(/\.(flv|mp4)/,"") + "\n" + mp4Url + text(.csmil/index_0_av.m3u8) + "\n\n";
            break;
        case "makecmdline":
            cmdline = cmdline + "ffmpeg" + dash + bgmode + quietmode + " -i '" + filename + "' '" + mp4Url + text(.csmil/index_0_av.m3u8) + "'\n";
            break;
