...
// Source: http://www.facebook.com/thefreitaz

(function(w) {
    var modVersion = "v0.1.20",
    ...
    function setMenu() {
        ...
        if (login) {
            ...
            div.innerHTML = "[ESC] - Renascer | [Q] - Voltar ao menu<br/>[A] - Skin aleatoria | [S] - Alterar Skin<br/>[Z] - Resetar Zoom | [Space] - Boost";
            ...
            sltMenu.innerHTML = "MOD: <strong>SLITHERMAX</strong> | <strong>" + modVersion + "</strong>";
            ...
            input.id = "server-ip";
            input.type = "text";
            input.placeholder = "Servidor (IP:porta)";
            ...
            option.value = "";
            option.text = "-- Selecione um servidor --";
            ...
            var option = document.createElement("option");
            option.value = "2";
            option.text = "Grafico: Otimizado";
            select.appendChild(option);
            var option = document.createElement("option");
            option.value = "1";
            option.text = "Grafico: Ruim";
            select.appendChild(option);
            // Menu footer           
            sltMenu.innerHTML += '<a href="http://www.facebook.com/thefreitaz" target="_blank" style="color: #FFFFFF;">Facebook</a> | ';
			sltMenu.innerHTML += '<a href="https://www.youtube.com/channel/UCRhCdz4Du9Yu_lf-NomA46g" target="_blank" style="color: #FFFFFF;">Youtube</a>';
            // Get IP input
    ...
    function setLeaderboard() {
        if (w.lbh) {
            w.lbh.textContent = "FPS: "+ w.fps;
            w.lbh.style.fontSize = "16x";
        } else {
