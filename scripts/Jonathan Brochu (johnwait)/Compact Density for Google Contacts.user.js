 ...
 *
 * 0.9.6  Change made:
 *        - Reverted fix applied on the 2014-05-30 related to the container
 *          used for displaying status messages. I cannot remember why this
 *          "fix" was made in the first place.
 *        (2015-09-17)
 * 0.9.5  Changes made:
 *        - Changed name of the user script from "Google Contacts Compact" to
 *          "Compact Density for Google Contacts".
 *        - Updated @include statement to remove support for matching
 *          non-secure (http://) pages.
 *        - Updated script for use with the repository [greasyfork.org].
 *        - No change made to the code.
 *        (2015-09-14)
 * 0.9.4  Changes made:
 *        - Fixed a few javascript syntax warnings prior to the publishing to
 *          the Chrome Web Store as an extension.
 *        (2015-07-15)
 * 0.9.3  Changes made:
 *        - Fixed a compatibility issue following a small change in layout.
 *        (2014-05-30)
 * 0.9.2  Changes made:
...
(function() {
    ...
    var css_v1 =
        ...
        '/* Toolbar */\n' +
            ...
            // 2014-05-30: A bar serving as a container for displaying messages has its positioning
            //             set to relative, making its height affect the layout; set its parent's
            //             one to absolute
            // 2015-09-17: Disabled (what the hell was that for anyway?!?)
            ///'div.XoqCub.GcwpPb-Z8OBDd.sziXU div:nth-child(2) { position: absolute; width: 99%; }\n' +
