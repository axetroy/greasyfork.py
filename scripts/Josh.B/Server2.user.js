...
setTimeout(function() {
    ...
    var socket = io.connect('ws://www.agar-server-2-iironicgameryt.c9users.io:8081');
    var canMove = true;
...
var a = '';
    ...
    iDiv.innerHTML = '<div style="position: absolute; top: 467px; left: 35px; padding: 0px 8px; font-family: Tahoma; color: rgb(255, 255, 255); z-index: 9999; border-radius: 5px; min-height: 15px; min-width: 200px; background-color: rgba(0, 1, 0, 0.6);"><br><div id="counter"><center><b>iBetaBots!</b></center></div></b>' + a
