...
addLb(lbWarez, 'alllossless.pw', 'http://www.alllossless.pw/?s=' + name); /*very good,42750*/
...
addLb(lbWarez, 'freealbums.org', 'http://freealbums.org/?do=search&subaction=search&titleonly=3&story=' + name);	/*good, 3509*/
...
addLb(lbWarez, 'losslessalbums.net', 'https://losslessalbums.net/?do=search&subaction=search&story=' + name);
