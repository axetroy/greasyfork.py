...
stopPercentage = 0.000002,
maxWait = 200,
stopped = false, // debugging
stopBefore = 55; // In minutes for timer before stopping redirect on webpage
var $loButton = $('#double_your_btc_bet_hi_button'),
$hiButton = $('#double_your_btc_bet_lo_button');
function multiply(){
