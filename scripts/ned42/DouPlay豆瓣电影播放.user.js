...
// @version      0.2.1
// @description  豆瓣电影条目页面内直接添加播放窗口，欢迎试用反馈
// @author       You
    ...
    if(Y != null){
        ...
        for (var i = 0; i < obj.length; i++){
            ...
            if(url.href != "javascript: void 0;"){
                url.href = url.href.replace("https://www.douban.com/link2/?url=","https://jx.618g.com/?url=");
        ...
        document.addEventListener('DOMNodeInserted', function() {
            ...
            if(li != null){
                ...
                for (i = 0; i < eps.length-1; i++){
                    ...
                    eps[i].href = eps[i].href.replace("www.douban.com/link2/?url=","jx.618g.com/?url=");
