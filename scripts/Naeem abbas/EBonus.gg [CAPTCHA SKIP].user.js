...
(function() {
    ...
    $( document ).ready(function() {
        ...
        if($("#btnPrevious").height() === null && $("#btnNext").height() !== null){
            $("#btnNext").parent().before('<a href="#!"><img id="btnPrevious" src="http://ebonus.ggborder="0"></a>&nbsp;&nbsp;');
            $("#btnPrevious").parent().css("display","none");
        }

        if($("#btnNext").height() === null && $("#btnPrevious").height() !== null){
            $("#btnPrevious").parent().after('&nbsp;&nbsp;<a href="#!"><img id="btnNext" src="http://ebonus.gg/Content/images/next.png" title="Next episode" border="0"></a>');
            $("#btnNext").parent().css("display","none");
        }
        ...
        function postdata(answer){
            ...
            var msg = $.ajax({type: "POST", url: "http://ebonus.gg/Special/AreYouHuman2",data: data ,async: false}).responseText;
            //console.log(msg);
            //alert();
        ...
        function loadImage(items, i, onComplete) {
            ...
            img.src = "http://ebonus.gg/Special/"+items[i];
        }
