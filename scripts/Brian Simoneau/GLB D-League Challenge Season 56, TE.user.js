// ==UserScript==
// @name           GLB D-League Challenge Season 56, TE
// @namespace      briansimoneau
// @description    Collect the stats for the GLB D-League Challenge.
...
var playerList = [4664893,4666781,4664360,4667067,4667294,4666957,4664841,4665687,4664312,4667307,4666896,4665957,4664884,4664525,4664404,4664285,4666761,4665635,4665347];
...
//var statTypes = ["Rushing"];
//var statTypes = ["Receiving", "Rushing", "Kick/Punt Return", "Offensive Line"]; // WR
//var statTypes = ["Defense"]; // SS
//var statTypes = ["Passing"]; // PQB
//var statTypes = ["Defense"]; // DE
var statTypes = ["Receiving","Offensive Line"]; // TE
//var statTypes = ["Defense"]; // LB
//var statTypes = ["Rushing", "Receiving"]; // HB
//var statTypes = ["Defense"]; // FS
//var statTypes = ["Defense"]; // CB
//var statTypes = ["Defense"]; // DT
...
//headings["Passing"] = ["Plays","Comp","Yds","Sack","BadTh","Int","TD"]; // PQB
//headings["Receiving"] = ["Plays","Targ","Rec","Yds","Avg","YAC","TD","Drop","TargRZ","Targ3d","Fum","FumL"];
//headings["Receiving"] = ["Plays","Rec","Yds","YAC","TD","Drop","Fum"]; // WR
headings["Receiving"] = ["Plays","Rec","Yds","YAC","TD","Drop"]; // TE
//headings["Receiving"] = ["Plays","Rec","Yds","TD","Drop","Fum"]; // HB
//headings["Rushing"] = ["Plays","Rush","Yds","Avg","TD","BrTk","TFL","Fum","FumL"];
//headings["Rushing"] = ["Plays","Yds","TD","BrTk","TFL","Fum"]; // HB
//headings["Rushing"] = ["BrTk"]; // WR
...
//headings["Kick/Punt Return"] = ["KTD","PTD"]; // WR
...
//headings["Offensive Line"] = ["Pancakes"]; // WR
headings["Offensive Line"] = ["Pancakes"]; // TE
//headings["Defense"] = ["Ply","Tk","MsTk","Sack","Hry","TFL","FFum","FumR","KL","PD","Int","DefTD","Pnkd","RevPnk"];
...
//headings["Defense"] = ["Ply","Tk","MsTk","Sack","Hry","TFL","FFum","FumR","RecAlw","KL","PD","Int","DefTD"]; // SS
//headings["Defense"] = ["Ply","Tk","MsTk","Sack","Hry","TFL","FFum","FumR","KL","PD","Int","DefTD","Pnkd","RevPnk"]; // DE
//headings["Defense"] = ["Ply","Tk","MsTk","Sack","Hry","TFL","FFum","FumR","KL","PD","Int","DefTD","Pnkd","RevPnk"]; // LB
//headings["Defense"] = ["Ply","Tk","MsTk","Sack","Hry","TFL","FFum","FumR","RecAlw","KL","PD","Int","DefTD"]; // FS
//headings["Defense"] = ["Ply","Tk","MsTk","Sack","Hry","TFL","FFum","FumR","KL","PD","Int","DefTD","Pnkd","RevPnk"]; // DT
...
var points = [];
//points["Passing"] = [0,0.25,0.04,-0.5,-0.25,-5,6]; // PQB
//points["Defense"] = [0,1,-2,2,1,3,4,3,5,6,1,-1,1];
//points["Defense"] = [0,1,-2,1,1,3,6,1,6,10,2,2,-0.1,.1];
//points["Defense"] = [0,1,-2,3,0,2,2,3,2,0,0,1,1,3,0,6,-0.5,0.2];
//points["Defense"] = [0,1,-1,3,1,1,4,3,-.5,1,1,5,6]; // SS
//points["Defense"] = [0,1,-1,2,1,1,4,2,1,1,4,6,-0.25,0.25]; // DE
//points["Receiving"] = ["0","1","0.125","0.05","6","-1","-4"]; // WR
points["Receiving"] = ["0","1","0.1","0.1","6","-2"]; // TE
//points["Receiving"] = [0,0.5,0.1,6,-0.5,-5]; // HB
//points["Rushing"] = ["1"]; // WR
//points["Rushing"] = [0,0,0.2,0,6,0.25,0,-10,0];
//points["Rushing"] = [0,0.1,6,0.5,-0.5,-5]; // HB
//points["Offensive Line"] = ["1.25","-1.25","-0.5","-4"]
//points["Offensive Line"] = ["0.2"] // WR
points["Offensive Line"] = ["5"] // TE
//points["Kick/Punt Return"] = ["4","4"]; // WR
//safety = 4
//points["Defense"] = [0,1,-2,3,1,1,6,1,2,2,6,10,-0.1,0.1]; // LB
//points["Defense"] = [0,1,-2,3,1,1,4,3,-1,1,1,5,6]; // FS
//points["Defense"] = [0,1,-1,3,2,2,3,2,1,1,3,6,-0.2,0.2]; // DT

var agents = [];
agents["4664893"]="briansimoneau";
//agents[""]="AC";
//agents[""]="Ahrens858";
//agents[""]="AlBarsch";
//agents[""]="bluto";
//agents[""]="Boozer";
//agents[""]="ChildishGambino";
//agents[""]="chopper409";
//agents[""]="ClutchDreams";
//agents[""]="Crash.0";
//agents[""]="crazy224";
agents["4666781"]="Dave Mr Majors";
//agents[""]="Dr. Brawler";
//agents[""]="eglefan72";
agents["4664360"]="F8n4tune";
//agents[""]="Farlig";
//agents[""]="FatLoad";
//agents[""]="fogie55";
agents["4667067"]="Gambler75";
agents["4667294"]="Guppy, Inc";
//agents[""]="Jayadamo";
agents["4666957"]="Jay Gold";
//agents[""]="joe";
//agents[""]="jpjn94";
agents["4664841"]="lexden11";
agents["4665687"]="mikl972";
agents["4664312"]="ninja turtles";
//agents[""]="no14mike";
//agents[""]="o The Boss x";
agents["4667307"]="Pena_FIN";
//agents[""]="ProfessionalKop";
agents["4666896"]="Redass Ranch";
//agents[""]="Redster";
agents["4665957"]="rlawrence";
agents["4664884"]="Robbnva";
//agents[""]="Sabataged";
//agents[""]="SciFi not Syfy";
agents["4664525"]="sewinston";
agents["4664404"]="spindoctor02";
agents["4664285"]="stat2883";
//agents[""]="Steelernutt68";
//agents[""]="Stoned Beaver";
agents["4666761"]="TJ Spikes";
agents["4665635"]="Union Jack Jensen";
agents["4665347"]="ZoSo1";
