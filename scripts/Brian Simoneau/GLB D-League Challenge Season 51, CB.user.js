// ==UserScript==
// @name           GLB D-League Challenge Season 51, CB
...
var playerList = [4639114,4641673,4639884,4639862,4640227,4639610,4640874,4639542,4640157,4639571,4640191,4640300,4640051,4640552,4639799,4639603,4639562,4640485,4639701];
...
//headings["Receiving"] = ["Plays","Rec","Yds","YAC","TD","Drop","Fum"];
...
//headings["Kick/Punt Return"] = ["KTD","PTD"];
...
//adings["Offensive Line"] = ["Pancakes"]; // TE
...
//points["Receiving"] = ["0","1","0.125","0.05","6","-1","-4"];
...
//points["Offensive Line"] = ["0.2"]
//points["Offensive Line"] = ["5"] // TE
//points["Kick/Punt Return"] = ["4","4"];
//safety = 4
//points["Defense"] = [0,1,-2,3,1,1,6,1,2,2,6,10,-0.1,0.1]; // LB
points["Defense"] = [0,1,-2,3,1,1,4,3,-1,1,1,5,6]; // FS

var agents = [];
agents["4639114"]="briansimoneau";
//agents[""]="AC";
agents["4641673"]="Ahrens858";
//agents[""]="AlBarsch";
//agents[""]="Boozer";
//agents[""]="chopper409";
//agents[""]="ClutchDreams";
agents["4639884"]="Crash.0";
agents["4639862"]="Dave Mr Majors";
//agents[""]="Dr. Brawler";
//agents[""]="eglefan72";
agents["4640227"]="F8n4tune";
agents["4639610"]="Farlig";
//agents[""]="fogie55";
agents["4640874"]="Gambler75";
agents["4639542"]="Guppy, Inc";
//agents[""]="Jayadamo";
agents["4640157"]="Jay Gold";
//agents[""]="joe";
agents["4639571"]="lexden11";
//agents[""]="mikl972";
agents["4640191"]="ninja turtles";
//agents[""]="no14mike";
agents["4640300"]="Pena_FIN";
agents["4640051"]="ProfessionalKop";
agents["4640552"]="Redass Ranch";
//agents[""]="Redster";
agents["4639799"]="rlawrence";
agents["4639603"]="Robbnva";
//agents[""]="Sabataged";
agents["4639562"]="spindoctor02";
//agents[""]="Steelernutt68";
agents["4640485"]="TJ Spikes";
agents["4639701"]="Union Jack Jensen";
