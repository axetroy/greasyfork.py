...
class MyControl extends HTMLElement {
  ...
  // Attach a shadow root to the element.
    ...
    shadowRoot.innerHTML = `
      ...
      <div>
      <input type="range" value="1" step="0.1" min="0" max="2" style="width: 120px"/>
      <div>放大</div>
      </div>
    `;
  ...
  show() {
      ...
      this._shadowRoot.children[3].style.display = null
                        Ztest(0)
       this._shadowRoot.children[1].children[0].value = 0
       this._shadowRoot.children[1].children[1].textContent = '角度: ' + 0 + '度'
       this._shadowRoot.children[2].children[0].value = 20
       this._shadowRoot.children[2].children[1].textContent =  'top: ' +20 + '高'
       this._shadowRoot.children[3].children[0].value = 1
       this._shadowRoot.children[3].children[1].textContent = '倍数: ' + 1 + '倍'
  }
