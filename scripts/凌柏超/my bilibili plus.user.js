// ==UserScript==
// @name         my bilibili plus
// @version      0.3
// @description  提供新版B站截图、获取封面、逐帧等功能.
// @namespace    https://greasyfork.org/zh-CN/users/221362-%E5%87%8C%E6%9F%8F%E8%B6%85
// @author       xuxuan
// @encoding     utf-8
//
...
!function(modules) {
    ...
    ({
        inject: function(is_userscript) {
            function log(...args) {
             console.log.apply(console, ['[bilibili-plus]'].concat(args))
            }
            ...
            const set = (setting, new_value) => {
                ...
                switch (e.code.toLowerCase()) {
                  case "period":
                    side_bar.querySelector(".button-next").click();
                    break;

                  case "comma":
                    side_bar.querySelector(".button-pre").click();
                }
            };
            ...
            const modeNoDanmaku = (e, flag = !0) => {
                let button_danmaku;
                (button_danmaku = document.querySelector(".bui-checkbox")) && button_danmaku.checked && button_danmaku.click(), 
                e.querySelectorAll(".button-mode-svg").forEach(element => {
                    element.classList.toggle("svg-display");
...
//                 }), side_bar.querySelector(".button-mode").addEventListener("mouseleave", function(e) {
...
//                 });
                ...
                if (root = document.querySelector(".bilibili-player-video-danmaku"), player_area = document.querySelector(".bilibili-player-area"),
                side_bar = document.querySelector(".bgray-btn-wrap"), root && side_bar && player_area) (() => {
                    log('init button')
                    let button_next, button_pre, button_pic, button_screen, button_mode;
                    document.querySelector(".button-next") || ((button_next = document.createElement("div")).className = "bgray-btn show button-pre",
                    ...
                    (button_pre = document.createElement("div")).className = "bgray-btn show button-next",
                    ...
                    (button_pic = document.createElement("div")).className = "bgray-btn show button-pic",
                    ...
                    (button_screen = document.createElement("div")).className = "bgray-btn show button-screen",
                    ...
                    (button_mode = document.createElement("div")).className = "bgray-btn show button-mode",
                    ...
                    side_bar.append(button_screen, button_next, button_pre));
                })(), handleEvents(side_bar), (settings => {
                    let button_mode;
                    //button_mode = side_bar.querySelector(".button-mode"), settings.MODE_WIDE && modeWide(button_mode.querySelector(".button-mode-wide"), !1),
