...
// @include     https://steamdb.steamcn.com/sync
...
if (document.URL == 'https://steamdb.steamcn.com/sync' || document.URL == 'http://steamdb.sinaapp.com/sync') {
    ...
    script.setAttribute("src", "https://steamdb.steamcn.com/steam_info.js");
...
function load(url, id) {
    ...
    GM_xmlhttpRequest({
        ...
        location.href = 'https://steamcn.com/t329493-1-1';
    }
}
