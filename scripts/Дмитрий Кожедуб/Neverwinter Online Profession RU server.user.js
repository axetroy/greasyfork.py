// ==UserScript==
// @name           Neverwinter Online Profession RU server
// @namespace      local
...
// @description Profession Neverwinter script
// ==/UserScript==
...
(function() {
    ...
    var defaultTasklist = [
        {
            ...
            level: {
                ...
                14:["Leadership_Tier3_14_Assemble","Leadership_Tier2_9_Chart","Leadership_Tier1_4_Protect","Leadership_Tier1_5_Explore","Leadership_Tier2_10_Battle"],
                15:["Leadership_Tier3_14_Assemble","Leadership_Tier2_9_Chart","Leadership_Tier1_4_Protect","Leadership_Tier1_5_Explore","Leadership_Tier2_10_Battle"],
                16:["Leadership_Tier3_14_Assemble","Leadership_Tier2_9_Chart","Leadership_Tier3_16_Fight","Leadership_Tier1_5_Explore","Leadership_Tier2_10_Battle"],
                17:["Leadership_Tier3_14_Assemble","Leadership_Tier2_9_Chart","Leadership_Tier3_17_Deliver","Leadership_Tier3_16_Fight","Leadership_Tier1_5_Explore","Leadership_Tier2_12_Taxes","Leadership_Tier2_10_Battle"],
                18:["Leadership_Tier3_18_Resell","Leadership_Tier3_16_Fight","Leadership_Tier1_Feedtheneedy"],
                19:["Leadership_Tier3_19r_Siegekeep","Leadership_Tier3_18_Resell","Leadership_Tier3_16_Fight","Leadership_Tier1_Feedtheneedy"],
                20:["Leadership_Tier3_20r_Master3","Leadership_Tier3_20r_Master1","Leadership_Tier3_20r_Master2","Leadership_Tier3_18r_Followmap","Leadership_Tier3_19r_Siegekeep","Leadership_Tier3_15r_Raidtreasury","Leadership_Tier3_20_Destroy","Leadership_Tier3_18_Resell","Leadership_Tier3_19_Acquire"],
            },
        },
        {
            // Mailsmithing
    ...
    function searchForTask(taskname, profname) {
        ...
        var taskList = unsafeWindow.client.dataModel.model.craftinglist['craft_' + profname].entries.filter(function(entry) {
            ...
            if (entry.def.displayname.match(/^(Batch|Mass|mass|Deep|Intensive)/)) { return false; }
        ...
        if (searchItem == "Crafting_Resource_Leather_T1" && taskList.length > 1) { taskList.shift(); }

        if (searchItem == "Crafting_Resource_Vitriol_Emerald" && taskList.length > 1) { taskList.shift(); }

        if (searchItem == "Crafting_Resource_Vitriol_Red" && taskList.length > 1) { taskList.shift(); }
    ...
    function process() {
        ...
        if (window.location.href.indexOf("gatewaysitedown") > -1) {
            ...
            window.setTimeout(function() {unsafeWindow.location.href = "http://gateway.nw.ru.perfectworld.eu";}, delay.MINS);
            return;
        }
