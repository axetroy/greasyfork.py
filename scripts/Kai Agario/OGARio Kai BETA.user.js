...
function inicio() {
    ...
    modificarCanalYoutube("Suscríbete a mi canal", "UCbmERyEunp6-OOlMn4hm2VQ");
    ...
    colorPanelCentral("#09F1E3");
    colorPanelDerecho("#09F1E3");
    colorTextoPestaña("#FFFFFF");
    colorPestañaActiva("black");
    
    colorBotonPlay("black", "black");
    bordeBotonPlay("black", "black");
 
    colorBotonLoginAndPlay("black", "black");
    bordeBotonLoginAndPlay("black", "black");
 
    colorBotonLogout("black", "black");
    bordeBotonLogout("black", "black");
 
    colorBotonFacebook("black", "black");
    bordeBotonFacebook("black", "black");
 
    colorBotonGoogle("black", "black");
    bordeBotonGoogle("black", "black");
 
    colorBotonSpectate("black", "black");
    bordeBotonSpectate("black", "black");
 
    colorBotonCopy("black", "black");
    bordeBotonCopy("black", "black");
 
    colorBotonCreate("black", "black");
    bordeBotonCreate("black", "black");
 
    colorBotonJoin("black", "black");
    bordeBotonJoin("black", "black");
