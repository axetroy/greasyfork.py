...
// @name:zh-CN  Snap Links Mod 批量操作链接、选项
// @description:zh-CN 从网页中批量复制、打开链接，选择复选框 // @description:en snap Links(open, copy), radios, chenkboxs, images from website
// @description:en  snap muti-links 
