...
(function() {
    ...
    var bilibili_wrapper = document.querySelector('div.nav-con.fr');//document.querySelector('div.bili-wrapper.clearfix').addedNodes[0].querySelector('ul.fr');
    var sdf = new MutationObserver(function (mutations, observer) {
		console.log("进入观察者");
