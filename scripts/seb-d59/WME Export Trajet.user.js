...
function updateTrajetsList()
{
  ...
  var selectTrajet = getId('selectTrajet');
    ...
    trajetDetail.Time = trajetDetail.Time.substr(trajetDetail.Time.indexOf(":")-2).trim().replace(/\:/g,'h');
    trajetDetail.dst = available_Trajets[i].childNodes[3].childNodes[1].textContent;
    trajetDetail.tps = available_Trajets[i].childNodes[3].childNodes[3].textContent;
    ...
    log('startTime d',d);
    WMEExpT.Trajets.list[trajetID].startDate = d.getFullYear() + "-" + (d.getMonth() > 9 ? d.getMonth() : "0"+d.getMonth())  + "-" + (d.getDate()>9 ? d.getDate() : "0"+d.getDate());
    ...
    d = new Date(W.model.archives.objects[trajetID].endTime);
    log('endTime d',d);
    WMEExpT.Trajets.list[trajetID].endDate = d.getFullYear() + "-" + (d.getMonth() > 9 ? d.getMonth() : "0"+d.getMonth())  + "-" + (d.getDate()>9 ? d.getDate() : "0"+d.getDate());
    WMEExpT.Trajets.list[trajetID].endTime = (d.getHours() > 9 ? d.getHours() : "0" + d.getHours()) + ":" + (d.getMinutes()>9 ? d.getMinutes() : "0"+d.getMinutes()) + ":" + (d.getSeconds()>9 ? d.getSeconds() : "0"+d.getSeconds());
    ...
    log("WMEExpT.Trajets.list[trajetID].text",WMEExpT.Trajets.list[trajetID].text);
  ...
  if (!WMEExpT.Trajets.objects.hasOwnProperty(id)){
    ...
    RequestObject.onreadystatechange = function(){
        ...
        resultRequest = JSON.parse(RequestObject.responseText);
    		...
    		if (WMEExpT.typeExport == "gpx") generateGpxFile();
    		if (WMEExpT.typeExport == "kml") generateKmlFile();
...
function generateGpxFile(){
  ...
  */
  ...
  temp = String(WMEExpT.Trajets.objects[id].fromLocation.street)+', '+String(WMEExpT.Trajets.objects[id].fromLocation.city)+', '+String(WMEExpT.Trajets.objects[id].fromLocation.country);
  roadName.push(temp);
  temp = String(WMEExpT.Trajets.objects[id].toLocation.street)+', '+String(WMEExpT.Trajets.objects[id].toLocation.city)+', '+String(WMEExpT.Trajets.objects[id].toLocation.country);
  roadName.push(temp);
