// ==UserScript==
// @name         Working YouTube MP3 Button
// @namespace    https://recordmp3.co
// @version      1.0.3
...
function polymerInject(){
    ...
    addButton.onclick = function () {
        ...
        addIframe.src = '//www.recordmp3.co/#/watch?v=' + window.location.href +'&layout=button';
...
function finalButton(){
    ...
    buttonIframeDownload.src = '//www.recordmp3.co/#/watch?v=' + window.location.href +'&layout=button';
