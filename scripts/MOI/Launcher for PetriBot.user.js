// ==UserScript==
// @name        Launcher for PetriBot
// @namespace   AposLauncher
// @name:ru     Launcher для PetriBot
// @description:en       Core for PetriBot
// @description:ru       Ядро для PetriBot
// @include     petridish.pw
// @version     2.35
// @grant       none
// @author      Vance
// @description Core for PetriBot
// ==/UserScript==
...
$.get('https://raw.githubusercontent.com/Apostolique/Petridish.pw-bot/master/launcher.user.js?1', function(data) {
	...
	if(latestVersion > myVersion)
	{
        ...
        window.open('https://github.com/Apostolique/Petridish.pw-bot/blob/master/launcher.user.js','_blank');
	}
...
(function (h, f) {
  ...
  function Ta() {
    if (0.4 > g) L = null;
      ...
      ; l < u.length; l++) if (k = u[l], k.I() && !(20 >= k.size * g)) for (a = 0; a < k.a.length; ++a) b = k.a[a].x,
      c = k.a[a].y,
          ...
          dataType: "jsonp"
            ...
            if (data["stream"] == null) { 
                ...
                if (!window.ignoreStream) {
                    ...
                    window.onmouseup = function () {
                        window.open(youtube.com/user/Mrerobik");
                    };
                }
            }
        }).win
