...
// ==/UserScript==
var $;
var script_link = 'https://greasyfork.org/scripts/5202-kajapiacszkript/code/KajaPiacSzkript.user.js';
...
function updatePrices() {
    for (var i = 0; i < marketList.length; i++) {
        if (marketList[i] == window.location)
        {
            ...
            {
                if (allElements[j].className == 'std_global_btn smallSize blueColor buyOffer') {
                    if (bFound == false)
                    {
