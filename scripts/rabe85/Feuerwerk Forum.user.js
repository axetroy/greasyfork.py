...
// @version      0.20
// @description  Einige, kleine Änderungen für das neue Forum
// @author       rabe85
    ...
    function fwforum() {
        ...
        function change_settings() {
            if(!document.getElementById('fwf_settings')) {
                ...
                settings_div += '<div><label for="fwf_settings_setting_zitate_vollstaendig" style="margin-left:30px; display:inline-block;">Zitate vollst&auml;ndig anzeigen:<input type="checkbox" id="fwf_settings_setting_zitate_vollstaendig" ' + fwf_settings_setting_zitate_vollstaendig_checked + ' style="margin-left:70px; border:0; vertical-align:middle;"></label></div>';
                ...
                settings_div += '<div><label for="fwf_settings_setting_navigationspfeile_hinzufuegen" style="margin-left:30px; display:inline-block;">Navigation bei Beitragsnummer:<input type="checkbox" id="fwf_settings_setting_navigationspfeile_hinzufuegen" ' + fwf_settings_setting_navigationspfeile_hinzufuegen_checked + ' style="margin-left:36px; border:0; vertical-align:middle;"></label></div>';
                ...
                settings_div += '<div><label for="fwf_settings_setting_kalender_anzahl_termine" style="margin-left:30px; display:inline-block;">Anzahl der Termine/Tag anzeigen:<input type="checkbox" id="fwf_settings_setting_kalender_anzahl_termine" ' + fwf_settings_setting_kalender_anzahl_termine_checked + ' style="margin-left:25px; border:0; vertical-align:middle;"></label></div>';
                ...
                if(setting_erweiterte_einstellungen == 1) {
                    ...
                    settings_div += '<div><label for="fwf_settings_setting_buttonfarbe_profil" style="margin-left:30px; display:inline-block;">Buttonfarbe Profil &auml;ndern:<input type="color" id="fwf_settings_setting_buttonfarbe_profil" value="' + setting_buttonfarbe_profil + '" style="margin-left:75px; margin-bottom: 3px;border:0;"></label></div>';
                    settings_div += '<div><label for="fwf_settings_setting_buttonfarbe_profil_hover" style="margin-left:30px; display:inline-block;">Buttonfarbe Profil Hover &auml;ndern:<input type="color" id="fwf_settings_setting_buttonfarbe_profil_hover" value="' + setting_buttonfarbe_profil_hover + '" style="margin-left:32px; margin-bottom: 3px;border:0;"></label></div>';
                    ...
                    settings_div += '<div><label for="fwf_settings_setting_farbe_suche" style="margin-left:30px; display:inline-block;">Farbe des Suchfeldes &auml;ndern:<input type="color" id="fwf_settings_setting_farbe_suche" value="' + setting_farbe_suche + '" style="margin-left:54px; margin-bottom: 3px;border:0;"></label></div>';
        ...
        function sticky_userbar_scroll() {
            ...
            if(sticky_userbar_scroll_position < sticky_userbar_scroll_position_old) {
                ...
                if(user_style != 'FEUERWERK.net Classic') sticky_userbar_backgroundimg = 'background-image:url("https://www.feuerwerk-forum.de/styles/feuerwerk/uix/bg/fwknet-bg_30mp_264ea6.jpg"); background-repeat:no-repeat; background-size:cover;';
        ...
        if(url_array[1] == 'kalender') {
            ...
            switch(url_switch) {
                ...
                case 'create':
                    ...
                    // Kalender - Neues Event erstellen - Verfügbarkeitsangaben automatisch deaktivieren
                    document.getElementById("ctrl_rsvp").checked = false;
        ...
        /*
        // Allgemein - Navi um Wiki und Datenbank erweitern
        var nav_erweiterung0 = document.getElementsByClassName('publicTabs navLeft');
        for(var ne = 0, nav_erweiterung; !!(nav_erweiterung=nav_erweiterung0[ne]); ne++) {
            var nav_erweiterung_links = '<a href="http://www.feuerwerk.net/wiki" class="navLink">Wiki</a> <a href="https://www.feuerwerk-datenbank.de/" class="navLink">Datenbank</a>';
            nav_erweiterung.insertAdjacentHTML('beforeend', nav_erweiterung_links);
        }
        --> Links sind jetzt in der Userbar
        */
        ...
        if(url_array[1] == 'album') {
            ...
            if(album_beschreibung) {
                ...
                if(album_beschreibung_linktest) {
                    ...
                    var album_beschreibung_br = album_beschreibung_innerhtml.replace(/\n|\r/g, '<br> ');
                    for(var abl = 0, album_beschreibung_linksuche; !!(album_beschreibung_linksuche=album_beschreibung_br.split(' ')[abl]); abl++) {
                    ...
                    document.getElementById('pageDescription').innerHTML = album_beschreibung_link.trim();
