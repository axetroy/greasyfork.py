        ...
        if(url_array[3] == 'badges') {
            ...
            for(var mb = 0, missing_badges; !!(missing_badges=missing_badges0[mb]); mb++) {
                ...
                if(badge_category == 'Capture Badges') {
                    ...
                    var badge_myth_mermaid1000 = insert_badge('Kingdom Mermaid Commander', 'Capture 1000 unique Mermaid Munzees', 'merm5', 'merm5_null');
                    ...
                    // Banshee
                    var badge_myth_banshee500 = insert_badge('Polis Banshee General', 'Capture 500 unique Banshee Munzees', 'ban4', 'ban3_null');
                    var badge_myth_banshee1000 = insert_badge('Kingdom Banshee Commander', 'Capture 1000 unique Banshee Munzees', 'ban5', 'ban3_null');
                    var badge_myth_banshee1500 = insert_badge('Imperial Banshee Master', 'Capture 1500 unique Banshee Munzees', 'ban6', 'ban3_null');
                    ...
                    for(var bm = 0, badge_myth; !!(badge_myth=badge_myth0[bm]); bm++) {
                        ...
                        if(badge_myth_text_now == 'Frolicking Fairy Finder') {
                            if(badge_myth_text_before == 'Kingdom Mermaid Commander') {
                        ...
                        if(badge_myth_text_now == '??? Banshee Finder') {
                        ...
                        if(badge_myth_text_now == '??? Finder') {
                            if(badge_myth_text_before == 'Kingdom Banshee Commander') {
                                ...
                                if(badge_myth_text_before == 'Polis Banshee General') {
                                    badge_myth.insertAdjacentHTML('beforebegin', badge_myth_banshee1000 + badge_myth_banshee1500);
                                } else {
                                    if(badge_myth_text_before == 'Fantastic Banshee Trainer') {
                    ...
                    // Myth nach letztem Badge ausgeben - aktuell Fairy
                    var badge_myth_exist_array_last = badge_myth_exist_array[badge_myth_exist_array.length - 1];
                    if(badge_myth_exist_array_last == 'Fantastic Fairy Trainer') {
                        badge_myth_innerHTML.getElementsByClassName('badge-helper')[badge_myth0.length - 1].insertAdjacentHTML('afterend', badge_myth_fairy500 + badge_myth_fairy1000 + badge_myth_fairy1500);
                    } else {
                        if(badge_myth_exist_array_last == 'Faithful Fairy General') {
                            badge_myth_innerHTML.getElementsByClassName('badge-helper')[badge_myth0.length - 1].insertAdjacentHTML('afterend', badge_myth_fairy1000 + badge_myth_fairy1500);
                        } else {
                            if(badge_myth_exist_array_last == 'Kingdom Fairy Commander') {
                                badge_myth_innerHTML.getElementsByClassName('badge-helper')[badge_myth0.length - 1].insertAdjacentHTML('afterend', badge_myth_fairy1500);
                            }
                        }
                    }
/*
                    // Myth nach letztem Badge ausgeben - aktuell Banshee
                    var badge_myth_exist_array_last = badge_myth_exist_array[badge_myth_exist_array.length - 1];
                    if(badge_myth_exist_array_last == 'Fantastic Banshee Trainer') {
                        badge_myth_innerHTML.getElementsByClassName('badge-helper')[badge_myth0.length - 1].insertAdjacentHTML('afterend', badge_myth_banshee500 + badge_myth_banshee1000 + badge_myth_banshee1500);
                    } else {
                        if(badge_myth_exist_array_last == 'Polis Banshee General') {
                            badge_myth_innerHTML.getElementsByClassName('badge-helper')[badge_myth0.length - 1].insertAdjacentHTML('afterend', badge_myth_banshee1000 + badge_myth_banshee1500);
                        } else {
                            if(badge_myth_exist_array_last == 'Kingdom Banshee Commander') {
                                badge_myth_innerHTML.getElementsByClassName('badge-helper')[badge_myth0.length - 1].insertAdjacentHTML('afterend', badge_myth_banshee1500);
                            }
                        }
                    }
*/
                    ...
                    // Pouch nach letztem Badge ausgeben - aktuell Pimedus
                    var badge_pouch_exist_array_last = badge_pouch_exist_array[badge_pouch_exist_array.length - 1];
                    if(badge_pouch_exist_array_last == 'Bronze Pimedus Scout') {
                        badge_pouch_innerHTML.getElementsByClassName('badge-helper')[badge_pouch0.length - 1].insertAdjacentHTML('afterend', badge_pouch_pimedus50 + badge_pouch_pimedus100);
                    } else {
                        if(badge_pouch_exist_array_last == 'Silver Pimedus Searcher') {
                            badge_pouch_innerHTML.getElementsByClassName('badge-helper')[badge_pouch0.length - 1].insertAdjacentHTML('afterend', badge_pouch_pimedus100);
                        }
                    }
