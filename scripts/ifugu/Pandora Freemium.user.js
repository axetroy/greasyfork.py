...
function addDownloadLink() {
    $('#trackInfoButtons .buttons').append(
        $('<a href="#" id="freemium_download_button" class="button btn_bg" style="width: 75px; padding: 5px 7px 6px 6px;"><img style="height: 13px; margin-right: 4px; float: left; margin-top: 2px; width: 20px;" title="Download" alt="cloud arrow download icon" src="data:image/png;base64,"><div class="text" style="font-size: 11px; padding-top: 2px;">Download</div></a>')
