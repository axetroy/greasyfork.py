            ...
            if($(element).is("div[class*='fortbattle-']")) {
                ...
                setTimeout(function(){
                    ...
                    switch (datafort[NSfortID]) {
                        case 0: //PICCOLO
                            if(NSlang=='it') NSurl='https://media.innogamescdn.com/com_WEST_IT/ImmaginiScriptEsterni/piccolo.png';
                            else NSurl='https://media.innogamescdn.com/com_WEST_IT/ImmaginiScriptEsterni/small.png';
                            break;
                        case 2: //GRANDE
                            if(NSlang=='it') NSurl='https://media.innogamescdn.com/com_WEST_IT/ImmaginiScriptEsterni/medio.png';
                            else NSurl='https://media.innogamescdn.com/com_WEST_IT/ImmaginiScriptEsterni/big.png';
                            break;
                        default: //MEDIO
                            if(NSlang=='it') NSurl='https://media.innogamescdn.com/com_WEST_IT/ImmaginiScriptEsterni/grande.png';
