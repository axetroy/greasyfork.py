...
function update_dl_links(update_html_only){
    ...
    $("#to-watch .secondary-link").each(function(){
        ...
        if (episode.match(/^(a-Z)*S[0-9]+E[0-9]+/)){
            ...
            dl_div += " <a class='dl_button' href='" + base_url + url + " 480p" + sufix + "' style='margin-top: 0px; " + style + "' target='_blank'>480p</a>";
            dl_div += " <a class='dl_button' href='" + base_url + url + " 720p" + sufix + "' style='margin-top: 12px; " + style + "' target='_blank'>720p</a>";
            dl_div += "</div>";
