...
(function() {
    ...
    $().ready(function(){
        ...
        function show_Medal(data){
            ...
            $("body").append("<style>.helper_not_use .fans-medal-item,.helper_not_use .fans-medal-item span{border-color:rgb(87, 87, 87)}.helper_not_use .label{background-color:rgb(87, 87, 87)}.helper_not_use .level{color:rgb(87, 87, 87)}.bilibili-like-box{border:1px solid #e9eaec;border-radius:12px;font-size:12px;padding:16px 12px 24px 12px;margin:0;margin-bottom:24px;background-color:#fff}.bilibili-like-box p{margin-top:0 ;font-size:20px;color:#333}.helper-myMedal{cursor:pointer;margin:2px 4px;}</style>");
        ...
        function hightLight(id){
            ...
            helper.find(".helper-myMedal").each(function(){
                if($(this).attr("helper-medal-id")!=id){
                    $(this).addClass("helper_not_use");}else{
                    $(this).removeClass("helper_not_use");
                    }
            });
