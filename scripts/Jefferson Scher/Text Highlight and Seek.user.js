...
// @version       2.3.0
// @description   Automatically highlight user-defined text with Seek function (2017-12-15)
...
// @copyright     Copyright 2017 Jefferson Scher. Portions created by erosman.
// @license       BSD-3-clause
// @resource      mycon http://www.jeffersonscher.com/gm/src/gfrk-THS-ver230.png
// ==/UserScript==
...
async function THS_init(){
  ...
  kwhied.innerHTML = "<form onsubmit=\"return false;\"><p style=\"margin-top:0\"><b>Edit/Add Keywords/Highlighting</b>" +
    ...
    "<td style=\"width:416px\" id=\"stylecontrols\"><p><span>Text color:</span> R:<input id=\"txtr\" type=\"number\" min=\"0\" max=\"255\" step=\"1\" " +
    ...
    "#kwhiedit td p{margin-top:12px;} #stylecontrols>p>span{display:inline-block;width:6.5em;}</style><style type=\"text/css\" id=\"kwhiedittemp\"></style></div>";
