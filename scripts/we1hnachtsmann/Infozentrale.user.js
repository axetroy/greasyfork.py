...
// @version        $Id: infozentrale.user.js 197 2018-04-10 12:45:48Z mkl $
...
// Eigene Icons
var imgPrefix = new Array('http://s14.directupload.net/images/user/141020/');
...
function getIconAddr(img){
    ...
    if (imgs.length > 1)
        if (NrOfCalls % 100 == 0)
            if (imgPrefix.length > 1)
                indx = 1;
    if (imgs[indx].indexOf("://") != -1)
        return imgs[indx];
...
function CheckFightValues(content) {
    ...
    if (ATTBoost > 0) {
        ...
        ShowImg ('ADBACK', FIGHT_URL, ICON_GRNBG, titletext, 39, 40, 0, 12, 1, 'attboost');
    ...
    if (DEFBoost > 0) {
        ...
        ShowImg ('ADBACK', FIGHT_URL, ICON_GRNBG, titletext, 39, 40, 42, 12, 1, 'defboost');
    ...
    if (injury < 0) {
        ...
        if (ATTBoost > 0) {
            ...
            var height = 40;
        ShowImg ('ADBACK', FIGHT_URL, ICON_REDBG, titletext, 39, height, 0, (height==40?12:32), 1, 'injboost');
    ...
    if (injury > 0) {
        ...
        if (DEFBoost > 0) {
            ...
            var height = 40;
        ShowImg ('ADBACK', FIGHT_URL, ICON_REDBG, titletext, 39, height, 42, (height==40?12:32), 1, 'injdboost');
...
function AddPlunderIcon(content, plunder, imgtitle, usemode, slotnr) {
    ...
    if (slotnr > 1 && slotnr % MAXNROFSLOTS == 0 && !document.getElementById('PDBACK'+row)) {
        ShowImg('PDBACK', '', ICON_PLUNDERDIRECTBACK[bgrndInd], '', '', '', 0, row*41, -2*row, 'PDBACK'+row);
    }
    row--;
...
function FeedbackHandler(bgrnd) {
    ...
    if (bgrnd == 'PW' && EatDrinkFeedBack == 0 || bgrnd == 'SC' && CollEndAlert == 0 || bgrnd == 'PB' && FightWeakAlert == 0 || bgrnd == "MI" && MissionAlert == 0 || bgrnd == "AD" && JobEndAlert == 0 || bgrnd == "PD" && NewPlunderAlert == 0)
        var curElem = ShowImg(bgrnd + 'BACK', '', ICON_NOINFO, getLangTxt(TxtNoInfo), 10, 10, (bgrnd == "MI"?31:(bgrnd == 'PD'?241:(bgrnd == 'PW'?102:112))), 13, 8, bgrnd + 'Info');
    else
