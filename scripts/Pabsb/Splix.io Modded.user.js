// ==UserScript==
// @name         Splix.io Modded
// @description  Splix.io Extension Included: no ads,zoom, play with friends, stop player movement
// @version      3.0
// @author       Pabs_b
// @match        http://splix.io
...
// @connect      splix.io
// @website      N/A
// @namespace    https://greasyfork.org/en/users/212779-pabsb
// ==/UserScript==
...
(function() {
    ...
    nameForm.insertAdjacentHTML("beforeEnd", "<br><select style='float:left; margin-top: 20px; background:#bdf7c4' id='_servers' class='fancyBox'><option selected value='#'>Loading...</option></select>");
    ...
    window.searchServersRecursive = function(obj, ping){
        ...
        for(var i=0; i<obj.length; i++){
          searchServersRecursive(obj[i], ping);
        }
      }
			else {
    ...
    interval = setInterval(function(){
          ...
          searchServersRecursive(servers[i], servers[i].avgPing);
        }
      ...
      ga("create", "UA-78233995-1", "auto", "ter");
