...
<div class="modal fade" id="pathSetting" tabindex="-1" role="dialog" style="top: 100px;"></div>`;
    ...
    $('#path-creator-bar').on('click', '.fa-save', function () {
        ...
        txt += '\t\t{map = "191104002", door = "261"}, --Devant banque Astrub--\r\n' +
            ...
            '\t\t{map = "147254", door = "283"}, --Devant banque Bonta--\r\n' +
            '\t\t{map = "2885641", changeMap = "424", npcBank = true}, --Banque Bonta--\r\n' +
            '\t\t{map = "88081177", door = "203"}, --Devant banque Amakna--\r\n' +
            ...
            '\t\t{map = "155157", door = "242"}, --Devant banque Ottomaï--\r\n' +
            '\t\t{map = "86511105", door = "452", npcBank = true}, --Banque Ottomaï--\r\n' +
            '\t\t{map = "12580", door = "242"}, --Devant banque Pandala--\r\n' +
