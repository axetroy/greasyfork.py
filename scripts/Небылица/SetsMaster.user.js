...
// @homepage       https://greasyfork.org/en/scripts/40636
// @icon           http://i.imgur.com/LZJFLgt.png
// @version        3.13
// @encoding 	   utf-8
// @include        /^https{0,1}:\/\/((www|qrator)\.(heroeswm|lordswm)\.(ru|com)|178\.248\.235\.15)\/.+/
// @exclude        /^https{0,1}:\/\/((www|qrator)\.(heroeswm|lordswm)\.(ru|com)|178\.248\.235\.15)\/(login|war|cgame|frames|chat|chatonline|ch_box|chat_line|ticker|chatpost|rightcol|brd|frames)\.php.*/
