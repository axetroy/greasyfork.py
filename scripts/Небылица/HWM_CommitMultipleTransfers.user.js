    ...
    function getSign(plId){ // Определение sign текущего персонажа
        ...
        sendGETRequest("shop.php?cat=potions", "text/html; charset=windows-1251", function(){
            ...
            var parser = new DOMParser(),
                ...
                signLink = responseHTML.querySelector("a[href^='/shop.php?b=reset_tube&reset=1&cat=potions&sign=']"),
                sign = "";
            ...
            if (signLink){
                ...
                sendGETRequest("home.php", "text/html; charset=windows-1251", function(){
                    ...
                    if (signLink){
                        ...
                        alert("Не удалось записать sign, убедитесь, что на счету персонажа есть деньги, а на домашней странице нет непрочитанных новостей");
                    }
                });
            }
        });
