...
// @namespace https://greasyfork.org/users/3268
// ==/UserScript==
...
GoldJobs = {
    ...
    SCRIPT_SITE: "https://greasyfork.org/pl/scripts/3082-tw-gold-jobs-finder-pl",
	...
	GAME_VERSION_SUPPORTED_MAX: 2.95,
	bestJobTime: 0
};
...
GoldJobs.languages = {
	"en_US": {
		...
		generatedByBb: "[i][url="+GoldJobs.SCRIPT_SITE+"]Wygenerowano przez TW Gold Jobs Finder[/url][/i]",
...
GoldJobs.getJobIcon = function(jobId, x, y, shortname, gold) {
	...
	return '<div class="job" style="left: 0; top: 0; position: relative;"><div  onclick="javascript:Map.JobHandler.openJob('+jobId+',{x:'+x+',y:'+y+'})" class="featured '+t+'"></div>'+this.getGotoIcon(x, y)+'<img src="https://westpls.innogamescdn.com/images/jobs/'+ shortname +'.png" class="job_icon"></div>'
};
...
GoldJobs.makeJobsTable = function(chosenJobName, showSilver, showGold, sortByName, sortByDistance) {
	...
	var arrow_desc = '&nbsp;<img src="http://westpls.innogamescdn.com/images/window/jobs/sortarrow_desc.png"/>';
	var arrow_asc = '&nbsp;<img src="http://westpls.innogamescdn.com/images/window/jobs/sortarrow_asc.png"/>';
...
GoldJobs.init = function() {
	...
	var link = $('<div class="menulink" style="background: url(https://www.the-west.pl/images/map/icons/jobicon.png);background-position: -4px -3px;"></div>');
	link.click(function() {
...
GoldJobs.addNotification = function (title, jobId, jobX, jobY) {
    ...
    $(n.getMainDiv()).find(".image").css({
        "background-image": "url(http://westpl.innogamescdn.com/images/jobs/" + icon + ".png)",
