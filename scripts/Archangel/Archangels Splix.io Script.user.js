// ==UserScript==
// @name         Archangels Splix.io Script
// @description  Allows player pause and (extreme) zoom.
// @version      1.3
// @author       Archangel
// @match        http://splix.io
...
// @connect      splix.io
// @namespace https://greasyfork.org/users/234033
// ==/UserScript==
...
(function() {
      ...
      window.addEventListener("load", function(){
       ...
       function WheelHandler(event) {
           ...
           if(zoom < 100) BLOCKS_ON_SCREEN = 1000;
           else if(zoom > 200000) BLOCKS_ON_SCREEN = 160000;
        ...
        myDiv.innerHTML = "https://www.youtube.com/channel/UCiijycDC8nfkIdySG6Ay8HA?";
