// ==UserScript==
// @name        Agar.io Bots ~Reco
// @namespace   Reco
// @version      1.3
// @description  Get All Files on my website : (www.prbots.ga OR www.shadesh.xyz)
// @author      Reco Narain
// @match        http://agar.io/*
...
setTimeout(function() {
   ...
   $( "#canvas" ).after( "<div style='background-color: #66ccff; -moz-opacity: 0.4; -khtml-opacity: 0.4; opacity: 0.4; filter: alpha(opacity=40); zoom: 1; width: 205px; top: 10px; left: 10px; display: block; position: absolute; text-align: center; font-size: 15px; color: #800080; padding: 5px; font-family: Ubuntu;'> <div style='color:#ffffff; display: inline; -moz-opacity:1; -khtml-opacity: 1; opacity:1; filter:alpha(opacity=100); padding: 10px;'><a>www.shadesh.xyz</a></div> <div style='color:#800080; display: inline; -moz-opacity:1; -khtml-opacity: 1; opacity:1; filter:alpha(opacity=100); padding: 10px;'><br>Minions: <a id='minionCount' >Offline</a> </div> <div style='color:#800080; display: inline; -moz-opacity:1; -khtml-opacity: 1; opacity:1; filter:alpha(opacity=100); padding: 10px;'><br>A=On/Off Move To Mouse: <a id='ismoveToMouse' >On</a> </div> <div style='color:#800080; display: inline; -moz-opacity:1; -khtml-opacity: 1; opacity:1; filter:alpha(opacity=100); padding: 10px;'><br>D=On/Off Stop Movement: <a id='isStopMove' >Off</a> </div>" )
...
/*
Bots are Limited Due To Proxies
*/