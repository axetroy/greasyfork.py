...
// @include     /^https{0,1}:\/\/((www|qrator)\.heroeswm\.ru|178\.248\.235\.15)\/sklad_info\.php\?id=\d+&cat=[0-36]$/
// @version     1.2.14
// ==/UserScript==
...
function draw_header(parent){
  ...
  sign.title       = 'UIN игрока - уникальный номер вашего персонажа, состоит из 32 символов.\n' +
                     ...
                     'Например: http://www.heroeswm.ru/shop.php?b=wood_sword&cat=weapon&sign=<...>, где оставшиеся символы - это нужный UIN';
