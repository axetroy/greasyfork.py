// ==UserScript==
// @name           BOOT GERADOR LISTA DE ALDEIAS 
// @author         Marcos V.S. Marques Boot
// @autorScript    Dalesmckay 
...
// @grant          Publico
// @description    BOOT GERADOR LISTA DE ALDEIAS (linguagem: javascript-ECMAscript5;)
// @Realiza        Geração de coordenadas de aldeias de acordo com a Classificação de Aldeias e requisitos marcados no no display
// @Opções         Marcadores para gerar lista de aldeias de tribos, de players, de aldeias barbaras etc. (necessario dar atualizar para carregar informações atualizadas)
// @Utilização     Preferencialmente no Mapa (Boot abre em qualquer pagina do jogo, Mas local correto de uso e no mapa) 
// @Agradecimentos Dalesmckay por essa excelente criação e por criar um script de alta qualidade, todos meritos dessa criação são totalmente dele.
