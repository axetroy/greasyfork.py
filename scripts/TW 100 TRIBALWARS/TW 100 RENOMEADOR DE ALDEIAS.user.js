// ==UserScript==
// @name           TW 100 RENOMEADOR DE ALDEIAS
...
// @grant          Publico
// @description    Script HACK TW 100 RENOMEADOR DE ALDEIAS  (linguagem: javascript-ECMAscript5;)
// @Realiza        Renomeação de aldeias em Massa
// @Opções         Renomeação Por Continente, Por Distancia, Por Ordem Numerica, Por Texto, Etc.
// @Utilização     Visualizações Gerais
// @Necessario:    Ter Mais de 1 Aldeias Para Poder Renomear
...
// @icon           https://www.tribalwars.com.br/graphic/buildings/main.png
// ==/UserScript==
