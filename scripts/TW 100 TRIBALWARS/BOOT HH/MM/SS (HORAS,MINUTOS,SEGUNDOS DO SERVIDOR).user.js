// ==UserScript==
// @name           BOOT HH/MM/SS (HORAS,MINUTOS,SEGUNDOS DO SERVIDOR)
...
// @grant          Publico
// @description    BOOT HH/MM/SS (HORAS,MINUTOS,SEGUNDOS DO SERVIDOR) (linguagem: javascript-ECMAscript5;)
// @Realiza        AUMENTO FONTE DO HORARIO DO SERVIDOR, COM ADIÇÃO DOS SEGUNDOS.
// @Uso            IDEAL PARA REALIZAR ATAQUES SNIPES OU BACK TIMES PELO FATO DE SER MOSTRADO SEGUNDOS PELO BOOT.
// @Utilização     QUALQUER PAGINA DO JOGO
...
// @icon           https://media.innogamescdn.com/com_DS_FR/Quickbar/pclock.png
// ==/UserScript==
