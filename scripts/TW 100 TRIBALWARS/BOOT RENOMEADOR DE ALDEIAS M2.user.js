// ==UserScript==
// @name           BOOT RENOMEADOR DE ALDEIAS M2
...
// @grant          Publico
// @description    BOOT RENOMEADOR DE ALDEIAS M2 (linguagem: javascript-ECMAscript5;)
// @Realiza        Renomeação de aldeias em Massa
// @Opções         Renome por numeração, por letras, opção de classificação. etc.
