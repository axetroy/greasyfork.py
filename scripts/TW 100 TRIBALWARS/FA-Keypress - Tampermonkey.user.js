// ==UserScript==
// @name           FA-Keypress - Tampermonkey
// @authorBoot     Marcos V.S. Marques
// @AutorKeyPress  Crimsoni
...
// @grant          Publico
// @description    BOOT Saques no Teclado 'FA KeyPress' (linguagem: javascript-ECMAscript5;)
// @Realiza        Aprimoramento do processo de saques de recursos no assistente de saque com a utilização das teclas do teclado.
// @Opções         Troca de Aldeias Apertando Tecla Esquerda ← ou → Direita ou teclado numero Esquerda 4 ou 6 Direita.
// @include        https://*screen=am_farm*
// @icon           https://media.innogamescdn.com/com_DS_FR/Quickbar/pblueflag.png
// ==/UserScript==
