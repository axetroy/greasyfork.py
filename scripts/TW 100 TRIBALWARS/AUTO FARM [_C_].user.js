...
// @grant          Publico
// @description    Script Facilitador de Saques Game tribalwars(linguagem: javascript-ECMAscript5;)
// @Realiza        Saques Automatizados Opções (A B C;) Deis Que Sejam Configurados para Tal Função
// @Realiza        Avanço Para Proxima Aldeia (necessario conta premium para tal função;)
// @Opções         Configuravel Tempo Velocidade de Saque e Avanço de Aldeias(somente no setup do codigo-fonte;) 
// @Utilização     Utilizar no assistente de saque
// @include       https://*screen=am_farm*
// @icon           https://media.innogamescdn.com/com_DS_FR/Quickbar/lc.png
// ==/UserScript==
