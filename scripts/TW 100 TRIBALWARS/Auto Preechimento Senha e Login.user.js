// ==UserScript==
// @name           Auto Preechimento Senha e Login
...
// @grant          Publico
// @description    Auto preechedor de senha e login para todos serivdores de tribalwars em todos idiomas  (linguagem: javascript-ECMAscript5;)
// @Realiza        Auto Preechimento Login e Senha
// @Utilização     Pagina inicial do jogo qualquer servidor
...
// @icon           https://media.innogamescdn.com/com_DS_FR/Quickbar/res.png
// ==/UserScript==
...
function ardamax () { var nume = document.getElementById("user"); var sena = document.getElementById("password"); nume.setAttribute("value","Coloque Login Aqui"); sena.setAttribute("value","Coloque Senha Aqui");} ardamax();