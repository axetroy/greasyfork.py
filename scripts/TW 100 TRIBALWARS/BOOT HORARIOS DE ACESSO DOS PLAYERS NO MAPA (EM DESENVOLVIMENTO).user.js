// ==UserScript==
// @name           BOOT HORARIOS DE ACESSO DOS PLAYERS NO MAPA (EM DESENVOLVIMENTO)
...
// @grant          Publico
// @description    BOOT HORARIOS DE ACESSO DOS PLAYERS NO MAPA (linguagem: javascript-ECMAscript5;)
// @Realiza        INFORMAÇÕES DE PLAYERS NO MAPA COM INTUITO DE MOSTRAR ATIVIDADES DO MESMO ULTIMOS ACESSOS AO GAME TRIBALWARS 
// @Opções         INFORMAÇÕES DE DISTANCIA EM CAMPOS, INFORMAÇÕES DE ULTIMO ACESSO, BOLINHA DE ACESSO(VERDE,AMARELO,VERMELHO = NIVEL MINIMO MEDIO MAXIMO) DE TEMPO OFFILINE 'LEMBRANDO QUE O TEMPO INATIVO E DADO DE ACORDO COM ULTIMA UPAGEM OU ULTIMO OD DO PLAYER, PORTANTO O BOOT ESTÁ PASSIVEL A UMA TAXA DE 25% DE ERRO NO APONTAMENTO DA INFORMAÇÃO.
// @Utilização     APENAS NO MAPA DO JOGO
