// ==UserScript==
// @name         VIP视频在线解析
// @namespace    http://video.ixiaotian.com/
// @version      1.0
...
(function() {
    ...
    if(reYk.test(videoSite)){
        ...
        if(youkuTitle.length !== 0){
	        ...
	        $('#ifkdySearchBtn').attr('href','http://video.ixiaotian.com/index.php?key=' + curWords + '&p=1');
        }else{
    ...
    $('#ifkdyVipBtn').on('click',function(){
        ...
        window.location.href = 'http://video.ixiaotian.com/index.php?key=' + curPlaySite + '&p=1';
    });
})();