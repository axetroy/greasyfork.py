...
// @exclude        http*://*efectodoppler.pw/reportsv2.php*
	...
	WhutBB.db = {
		sites: {
			...
			efectodoppler: function () {
				return {
					link: 'http://efectodoppler.pw/wiki.php?action=article&id=10',
					emoticonDir: '/static/common/smileys/',
					emoticons: WhutBB.db.emoticons.gazelle.concat(WhutBB.db.emoticons.efectodoppler),
					blueprint: 'gazelle'
				};
			},
		},
		buttons: {
			b: {title: 'Texto Negrita', icon: 'bold'},
			i: {title: 'Texto Cursiva', icon: 'italic'},
			u: {title: 'Texto Subrayado', icon: 'text-width'}, //underline
			s: {title: 'Texto Tachado', icon: 'minus'},
			code: {display: 'c', title: 'Código en Línea', icon: 'leaf'},
			important: {display: '!', title: 'Texto Importante', icon: 'exclamation-sign'},
			color: {type: 1, display: '\u25ee', prompt: 'Ingrese número #hexadecimal o Nombre del color.', title: 'Color', val: '#', icon: 'tint'},
			size: {type: 1, display: '\u00b1', prompt: 'Ingrese un número.', title: 'Tamaño', val: 3, icon: 'text-height'},
			align: {type: 1, display: '-', title: 'Alineacion del texto', icon: 'align-left'},
			left: {display: '<', title: 'Alineación Izquierda', icon: 'align-left'},
			center: {display: '\u2013', title: 'Alineación Centrada', icon: 'align-center'},
			right: {display: '>', title: 'Alineación Derecha', icon: 'align-right'},
			'#': {type: 3, title: 'Lista Ordenada', icon: 'list-alt'},
			'*': {type: 3, title: 'Lista', icon: 'list'},
			url: {type: 1, prompt: 'Ingrese un Enlace', title: 'Enlace Web', val: 'http://', icon: 'globe'},
			img: {title: 'Imagen', icon: 'picture'},
			quote: {type: 1, display: 'q', prompt: 'Ingrese un nombre o author', title: 'Quote', placeholder: 'author', icon: 'comment'},
			pre: {title: 'Texto preformateado/Bloque de codigo', icon: 'asterisk'},
			hide: {display: 'SP', title: 'Contenido oculto/Spoilers', icon: 'warning-sign'},
			spoiler: {display: '_', title: 'Spoilers!', icon: 'exclamation-sign'},
			mature: {display: 'm', title: 'Ocultar contenido para adultos', icon: 'eye-open'},
			artist: {display: 'a', title: 'Enlace a un artista/banda en el sitio', icon: 'music'},
			user: {display: 'Us', title: 'Enlace a un usuario en el sitio', icon: 'user'},
			wiki: {type: 4, tag: ['[[', ']]'], display: 'w', title: 'Enlace a un artículo Wiki', icon: 'share'},
			tex: {display: 't', title: 'LaTeX', icon: 'pencil'},
			plain: {display: 'x', title: 'Deshabilitar BB tags', icon: 'ban-circle'},
			youtube: {type: 2, display: 'yt', title: 'Video YouTube', icon: 'film'},
			font: {type: 1, display: 'f', prompt: 'Ingrese nomnre de fuente', title: 'Font', val: 'Arial', icon: 'font'},
			torrent: {display: 'id', title: 'Enlace a torrent ID', icon: 'download'},
			search: {type: 1, display: '@', prompt: 'Ingrese término de búsqueda', title: 'Enlace a término de búsqueda', val: 'keywords', icon: 'search'},
			table: {display: 'tbl', title: 'Insertar una tabla', icon: 'th-large'},
			tr: {display: 'tr', title: 'Insertar una fila de tabla', icon: 'th-list'},
			th: {display: 'th', title: 'Insertar un título de tabla', icon: 'th'},
			td: {display: 'td', title: 'Insertar una celda de table', icon: 'pencil'},
			heading: {type: 4, tag: '=', display: '=', title: 'Insertar encabezado', icon: 'arrow-right'},
			// Gazelle
			gz_left: {tag: 'align', val: 'left', type: 1, noPrompt: true, display: '<', title: 'Alinear a la izquierda', icon: 'align-left'},
			gz_center: {tag: 'align', val: 'center', type: 1, noPrompt: true, display: '\u2013', title: 'Alinear al centro', icon: 'align-center'},
			gz_right: {tag: 'align', val: 'right', type: 1, noPrompt: true, display: '>', title: 'Alinear a la derecha', icon: 'align-right'},
			gz_src: {macro: ['quote', 'pre'], type: -3, display: '<>', title: 'Código fuente', icon: 'tasks'},
			gz_rule: {tag: 'rule', title: 'Enlace a regla', icon: 'info-sign', display: 'r' },
			// Panels
			emoticon: {display: ':]', toggle: ';]', title: 'Emoticonos', type: -1, icon: 'fire'},
			settings: {display: '%', title: 'Configuración', type: -1, icon: 'wrench'},
			shortcut: {display: '?', title: 'Atajos', type: -1, icon: 'question-sign'},
			erase: {display: '-', title: 'Borrar mensaje', type: -2, icon: 'remove-sign'}
		},
		emoticons: {
