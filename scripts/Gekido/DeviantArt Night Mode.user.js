...
addGlobalStyle('.dev-page-container.bubbleview, body.fullview .dev-page-container.bubbleview, body.gruze .dev-page-container.bubbleview, body.deviant .dev-page-container.bubbleview, .dev-page-view .dev-right-col-bg { background-color : #333 !important; }');

addGlobalStyle('.browse-container.newbrowse .browse-left-bar .browse-left-bar-inner, .browse-container.newbrowse .browse-left-bar, .dev-page-view.view-mode-full .dev-view-deviation, .dev-page-view.view-mode-full_zoomed .dev-view-deviation, div.mczone, h2.mczone-title, f messages-left{ background-color : #333 !important; }');
...
addGlobalStyle('i.gr2, i.gr3, .gr-body, .gr-top, i.gr1 + i.gr2, i.gr2 i, i.gr3 i, .gr-top .gr, i.gr1 {background: #333 !important}');
...
addGlobalStyle('body.gruze .bubbleview, ul.iconset-gruser li.tab, i.gr3 i, .gr-top .gr, #aboutme-interests, #deviantART-v7 footer#depths .depths-inner { background: #333 !important; }');
