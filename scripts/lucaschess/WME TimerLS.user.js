...
sheet.insertRule('#timerLSIconContainer div[type=\'savedInfo\']{background: transparent; height: auto; width: auto; position: absolute; right: 0; top: 40px;}', sheet.cssRules?sheet.cssRules.length:0);
...
sheet.insertRule('#timerLSIconContainer button{background: none; border: none; outline: none; position: absolute; right: 5px; top: 3px;}', sheet.cssRules?sheet.cssRules.length:0);
...
sheet.insertRule('#timerLSIconContainer input[type=\'range\']{left: -4px; margin: 0; outline: none; padding: 0; position: absolute; top: 17px; transform: rotate(-90deg); width: 25px;}', sheet.cssRules?sheet.cssRules.length:0);
	...
	this.initialize = function(){
		try {
			...
			var saveItem = $('[class*="toolbar-button waze-icon-save"]')[0];
