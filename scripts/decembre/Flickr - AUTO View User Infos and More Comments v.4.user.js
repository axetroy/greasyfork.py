...
// ==UserScript==
// @name     Flickr - AUTO View User Infos and More Comments v.4
// @description	    2017 - ok PHOTO / ALBUM - PB SET - View Info on Hover User's Buddy  and Auto Load ALL comments - (author Brock Adams , fork decembre)
...
*/
// MORE COMMENTS
waitForKeyElements (".sub-photo-comments-view .order-chronological .comments-more a", clickOnMoreCommentButton);
function clickOnMoreCommentButton (jNode) {
    var clickEvent  = document.createEvent ('MouseEvents');
    clickEvent.initEvent ('click', true, true);
    jNode[0].dispatchEvent (clickEvent);
}
