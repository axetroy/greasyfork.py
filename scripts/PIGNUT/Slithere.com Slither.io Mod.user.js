// ==UserScript==
// @name         Slithere.com Slither.io Mod
// @namespace    slithere.com
// @version      1.3
// @description  Slither.io Slithere Mod
// @author       Slithere.com
...
(function(w) {
    ...
    function setMenu() {
        ...
        if (login) {
            ...
            div.textContent = "www.slithere.com";
            ...
            sltMenu.innerHTML = "Slither.io Mod: <strong>by Slithere.com</strong> | <strong>" + modVersion + "</strong>";
