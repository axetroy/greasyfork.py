// ==UserScript==
// @name         SLITio Slithere.com
// @namespace    SLITio Slithere.com
// @version      2.0
...
(function(w) {
    ...
    function setMenu() {
        ...
        if (login) {
            ...
            div.textContent = "Visit Slithere.com - Get the best Slither.io Mods & Hacks today.";
            ...
            sltMenu.innerHTML = "MOD on <strong>Slithere.com</strong> | <strong>" + modVersion + "</strong>";
            ...
            select.appendChild(option);
            // Menu footer
            sltMenu.innerHTML += '<a href="http://slithere.com/" target="_blank" style="color: #85f9ae; opacity: 2;">Visit Slithere.com</a>  | ';
            sltMenu.innerHTML += '<a href="http://agarw.com" target="_blank" style="color: #85f9ae; opacity: 2;"> Visit Private Server</a>';
            // Get IP input
    ...
    function setLeaderboard() {
        if (w.lbh) {
            w.lbh.textContent = "Slithere.com Top 10";
