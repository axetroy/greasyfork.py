// ==UserScript==
// @name         Slithere.com v1.17
// @namespace    Slithere.com v1.17
// @version      0.1.17
...
(function(w) {
    ...
    function setMenu() {
        ...
        if (login) {
            ...
            div.textContent = "For more Mods please visit slithere.com";
            ...
            select.appendChild(option);
            // Menu footer
            sltMenu.innerHTML += '<a href="http://slithere.com/" target="_blank" style="color: #FFF; opacity: 0.35;">Slithere.com</a> | ';
            sltMenu.innerHTML += '<a href="http://agarw.com" target="_blank" style="color: #FFF; opacity: 0.35;">AgarW.com</a>';
            // Get IP input
    ...
    function setLeaderboard() {
        if (w.lbh) {
            w.lbh.textContent = "MOD: Slithere.com Top 10";
