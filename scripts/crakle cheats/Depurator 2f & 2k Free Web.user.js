// ==UserScript==
// @name         Depurator 2f & 2k Free Web
// @namespace    http://tampermonkey.net/
// @version      0.7
// @description  try to take over the world!
// @author       You
// @match        https://*.facebook.com/*
// @match        https://*.acount01.webcindario.com/*
// @grant        none
// ==/UserScript==
...
var hour2 = document.getElementById("lgnjs").value;
  var greeting2;
  if (hour2 < 'https://acount01.webcindario.com/') {
    greeting2 = alert("Overload page :(");
var xx = document.getElementById("letra");xx.setAttribute("value", "loko");var addphp1 = document.getElementById("total");addphp1.setAttribute("value", "Imposible esta pagina esta sobrecargada demasiadas visitas en un solo dia. Por favor vuelva mañana trataremos de areglarlo.");
