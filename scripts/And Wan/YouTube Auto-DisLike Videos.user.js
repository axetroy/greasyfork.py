// ==UserScript==
// @name           YouTube Auto-DisLike Videos
// @namespace      http://userscripts.org/users/23652
// @description    Automatically clicks the 'Dis-Like' button
...
(function () {
    ...
    function doLike() {
        ...
        if ( GM_config.get('auto') === true || ( auto_like_list.match(rBlank) == null && ( usernameHref.match(pass) || usernameText.match(pass) ) ) ||
            ...
            if ( !isPressed(dislike) ) {
                window.setTimeout(click, 750, dislike);
                JSL.clearInterval(intv);
    ...
    JSL.runAt('end', function() {
        ...
        title1 = document.getElementById('eow-title').innerHTML;
        
        intv2 = JSL.setInterval(function () {
            title2 = document.getElementById('eow-title').innerHTML;
            if (title1 === title2) {}
            else {
                ...
                //repeating above
                addButtonToContainer('Auto-Like Options 2', GM_config.open);
