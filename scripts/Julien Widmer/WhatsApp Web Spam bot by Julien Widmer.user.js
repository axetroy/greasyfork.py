// ==UserScript==
// @name         WhatsApp Web Spam bot by Julien Widmer
// @namespace    http://tampermonkey.net/
// @version      1.0
// @description  Spam the shit out of people
// @author       Julien
...
function doSpam(element) {
  if(element.innerHTML == 'SPAM'){
    ...
    if(input.innerHTML == '' || input.innerHTML == null){
      window.alert('Text muss vorher eingegeben sein.');
      return;
    }
    element.innerHTML = 'STOP';
    message = input.innerHTML;
    var interval = parseInt (prompt('Wähle den Zeitabstand pro Nachricht => spam-interval:', '500'));
