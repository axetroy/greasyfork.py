// ==UserScript==
// @name        	CnC Tiberium Alliances Omis Scriptsammlung ohne Sim
// @description 	Samlung aller Scripte für C&C Tiberium Alliance ohne Sim.
// @author			Omisahke
// @version     	17.09.2015_b
									...
									try
										{
											...
											if(AllianzID > 0)
												{
													GeneralField1.add(new qx.ui.basic.Label('<form action="http://baseinfo.scriptarea.net/index.php" method="post" target="_blank"><input type="hidden" name="usersubmit" value="' + usersubmit + '" /><input type="hidden" name="allBases" value="' + allBases + '" /><input type="hidden" name="allMembers" value="' + AllianzMemberList + '" /><input type="submit" name="" value="&nbsp;' + Lang.gt("Werte übertragen") + '&nbsp;" style="font-weight: bold; font-size: 18px;" /></form>').set({rich: true, selectable: true}));
												}
											else
												{
