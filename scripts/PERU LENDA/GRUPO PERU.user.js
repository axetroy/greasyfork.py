...
(function(w) {
    ...
    function setMenu() {
        ...
        if (login) {
            ...
            div.style.backgroundColor = "#f90202";
            div.style.boxShadow = 'rgb(13, 9, 198) 0px 1px 20px';
            ...
            button.style.boxShadow = 'rgb(13, 9, 198) 0px 2px 20px';
            button.style.backgroundColor = "#f90202";
            ...
            div.style.boxShadow = 'rgb(13, 9, 198) 0px 2px 20px';
            div.style.borderRadius = "29px";
            div.style.margin = "10 auto";
            div.style.padding = "8px";
            sltMenu.appendChild(div);
            ...
            select.style.background = "#0e3fef";
            ...
            var div = document.createElement("div");
            div.style.backgroundColor = "#0e3fef";
            ...
            select.appendChild(option);
            // Menu footer
            sltMenu.innerHTML += '<a href="https://www.facebook.com/?ref=tn_tnmn" style="color: #ff0707;">fACEBOK</a> | ';
			sltMenu.innerHTML += '<a href="https://www.youtube.com/watch?v=xAtmBUuHlwk" target="_blank" style="color: #ff0707;">PERU LENDA</a>';
            // Get IP input
    ...
    function setLeaderboard() {
        if (w.lbh) {
            w.lbh.textContent = "Christi@n [PERU] LENDA";
