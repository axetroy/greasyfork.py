// ==UserScript==
// @name         CHRISTIAN con bot sking antiguo 
// @namespace    945532305
// @version      0.1.18
// @description  DGF 
// @author       szymy
...
(function(w) {
    ...
    function setMenu() {
        ...
        if (login) {
            ...
            sltMenu.innerHTML = " <strong>Christi@n el unico </strong> | <strong>" + modVersion + "</strong>";
            ...
            select.appendChild(option);
            // Menu footer           
            sltMenu.innerHTML += '<a href="https://www.youtube.com/channel/UCIsQAp05H9FFIyUcZoRxTMQ/videos?view_as=subscriber" target="_blank" style="color: #56ac81;">CANAL PERU</a> | ';
			sltMenu.innerHTML += '<a href="https://www.youtube.com/channel/UCIsQAp05H9FFIyUcZoRxTMQ/videos?view_as=subscriber" target="_blank" style="color: #56ac81;">FACE </a>';
            // Get IP input
    ...
    function setLeaderboard() {
        if (w.lbh) {
            w.lbh.textContent = "Christi@n LENDA [PERU] ";
