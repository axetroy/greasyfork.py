...
// @description  全网音乐在线试听 一键免费下载
// @grant        unsafeWindow
// @require      http://cdn.bootcss.com/jquery/1.8.3/jquery.min.js
// @icon         http://music.tianyavip.top/favicon.ico
// @run-at       document-end
// @namespace 
// ==/UserScript==
(function() {
  ...
  if(reWY.test(videoSite)){
    ...
    $('#VipMusicBtn').attr('href','http://music.tianyavip.top/?url=' + encodeURIComponent(window.location.href.replace('http://music.163.com', "http://music.163.com/#")));
  }
  ...
  if(reQQ.test(videoSite)){
    ...
    $('#VipMusicBtn').attr('href','http://music.tianyavip.top/?url=' + encodeURIComponent(window.location.href));
  }
