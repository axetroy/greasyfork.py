// ==UserScript==
// @name         免费在线播放vip视频 在线播放vip视频；支持优酷vip，腾讯vip，爱奇艺vip，芒果vip，乐视vip视频在线解析破解去广告
// @namespace    http://www.tianyavip.top
// @version      1.0.8
// @description  点击“无广告在线观看”即可观看vip全网视频
// @author       老铁
...
(function() {
    ...
    var mSearchBtn = '<a id="sonimeiSearchBtn" target="_blank" style="cursor:pointer;text-decoration:none;color:red;padding:0 5px;border:1px solid red;">无广告在线观看</a>';
    ...
    if(reAqy.test(videoSite)){
        ...
        $('#sonimeiSearchBtn').attr('href','http://www.shadowsocks.co.in/index.php?s=/vod-search-name-' + curWords + '.html');
    }
    // 乐视
    if(reLS.test(videoSite)){
        var lsTitle = $('.j-video-name');
        lsTitle.after(mSearchBtn);
