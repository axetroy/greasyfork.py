...
// @require           https://cdn.bootcss.com/echarts/4.2.0-rc.1/echarts.min.js
  ...
  var compareTop;
   ...
   setTimeout(function () {
    ...
    compareTop=174;
      ...
      jq142("<span>&nbsp;&nbsp;</span><a class='bj-bg' href='#none' style='vertical-align: 2px ;text-decoration:underline '>价格曲线</a><span class='bj-bg1'>⠀⠀</span>").insertAfter(jq142(bgInsertTo));
