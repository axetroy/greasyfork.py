...
// @description	  <p>K島聯合框架頁，左側選單小咘啦嘰的～滑鼠很難點。＼(゜ロ＼)(／ロ゜)／所以就有了這個想法實作。
// @author        hollen9
// @homepage      https://userstyles.org/styles/148091
// @run-at        document-start
// @version       0.20181020095813
// ==/UserScript==
(function() {var css = "";
if (false || (new RegExp("^(https|http)://komica.org/bbsmenu.html$")).test(document.location.href) || (new RegExp("^(https|http)://komica2.net/bbsmenu.htm$")).test(document.location.href) || (new RegExp("^(https|http)://.*npnt.me/menu.htm$")).test(document.location.href) || (new RegExp("^(https|http)://ca2.camiko.org/bbsmenu.htm$")).test(document.location.href) || (new RegExp("^(https|http)://k3-bbs.com/menu.htm$")).test(document.location.href) || (new RegExp("^(https|http)://camiko.org/bbsmenu.htm$")).test(document.location.href) || (new RegExp("^(https|http)://komica2.net/bbsmenu2018.html$")).test(document.location.href))
	css += [
		"/* Darken */",
		"/*body {",
...
if (false || (location.href.replace(location.hash,'') == "https://komica.org/bbsmenu.html") || (location.href.replace(location.hash,'') == "http://komica.org/bbsmenu.html") || (location.href.replace(location.hash,'') == "https://komica2.net/bbsmenu.htm") || (location.href.replace(location.hash,'') == "http://komica2.net/bbsmenu.htm"))
	css += [
		"h3:before {",
		"	background-image: url(\'https://komica.org/favicon.ico\') !important;",
		"}"
	].join("\n");
if (false || (location.href.replace(location.hash,'') == "https://npnt.me/menu.htm") || (location.href.replace(location.hash,'') == "http://npnt.me/menu.htm") || (location.href.replace(location.hash,'') == "https://www.npnt.me/menu.htm") || (location.href.replace(location.hash,'') == "http://www.npnt.me/menu.htm"))
	css += [
		"h3:before {",
		"	background-image: url(\'http://www.npnt.me/favicon.ico\') !important;",
		"}"
	].join("\n");
if (false || (location.href.replace(location.hash,'') == "https://camiko.org/bbsmenu.htm") || (location.href.replace(location.hash,'') == "http://camiko.org/bbsmenu.htm") || (location.href.replace(location.hash,'') == "https://ca2.camiko.org/bbsmenu.htm") || (location.href.replace(location.hash,'') == "http://ca2.camiko.org/bbsmenu.htm"))
	css += [
		"h3:before {",
		"	background-image: url(\'http://camiko.org/favicon.ico\') !important;",
		"}"
	].join("\n");
if (false || (location.href.replace(location.hash,'') == "https://k3-bbs.com/menu.htm") || (location.href.replace(location.hash,'') == "http://k3-bbs.com/menu.htm"))
	css += [
		"h3:before {",
