...
(function() {
    ...
    var i,
        maxI = icons.length;
    for (i=0;i<maxI;i++){
        // если видим значок латов, то меняем его на нашу версию
        if ((icons[i].src.indexOf("/mon_pic_png/2xswordmanani") !== -1)||(icons[i].src.indexOf("/mon_pic_png/2xvindicatorani.png") !== -1)){
            icons[i].src = "https://s.pfst.net/2012.03/116522481860bcaf5a60fcb253170e71b3d3b7c5257_b.jpg";
        }
    }
})();
...
{  
  var sred_umk = [
    63.5,109,161,235,386,619,1360,2000,2880,3960,5520,
    8100,12120,18540,26720,37240,99999999,99999999,999999999
  ];
