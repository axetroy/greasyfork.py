...
(function(w) {
    ...
    function setMenu() {
        ...
        if (login) {
            ...
            sltMenu.innerHTML = " <strong>ELC</strong> | <strong>" + modVersion + "</strong>";
	    ...
	    // Select server container
            ...
            var option = document.createElement("option");
            option.value = "3";
            option.text = "Gráfico normal";
            select.appendChild(option);
            var option = document.createElement("option");
            option.value = "2";
            option.text = "Gráfico otimizado";
            select.appendChild(option);
            var option = document.createElement("option");
            option.value = "1";
            option.text = "Gráfico minimo";
            select.appendChild(option);
            // Get IP input
