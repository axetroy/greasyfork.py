(function() {
// ==UserScript==
// @name         Super_preloaderPlus_one [English Version]
...
// @include     https://www.google.it/search?q=*
// @include     https://greasyfork.org/en/scripts?q=*
// @include      https://www.apkmirror.com/?post_type=app_release
...
var prefs={
    ...
    pauseA: true,            // 快速停止自动翻页(当前模式为翻页模式的时候生效.);
        ...
        stop_ipage: false,       // 如果在连续翻页过程中暂停.重新启用后.不在继续..连续翻页..
