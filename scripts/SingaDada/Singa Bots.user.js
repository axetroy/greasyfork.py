// ==UserScript==
// @name         Singa Bots
// @namespace    Singa Bots
// @version      5.0
// @description  Singa Clan
// @author       Singa Dada
// @match        http://agar.io/*
...
alert("Don't Forget to Subscribe For Singa Clan (To buy bots visit: http://singaclan.hol.es/Shop/ ");
    ...
    var socket = io.connect('ws://127.0.1:8081');
    var canMove = true;
...
var a = '';
    ...
    iDiv.innerHTML = '<div style="position: absolute; top: 467px; left: 30px; padding: 0px 8px; font-family: Tahoma; color: rgb(255, 255, 255); z-index: 9999; border-radius: 5px; min-height: 15px; min-width: 200px; background-color: rgba(0, 1, 0, 0.6);"><br><div id="counter"><center><b>Singa Bots</b></center></div></b>' + a
