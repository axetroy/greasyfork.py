...
$(function() {
    ...
    (function() {
        ...
        settings_VM = {
            settings_options: [{"id": "settings_option_sl", "name": "Smile list (Hiện tất cả icon smile của Voz)"}, {"id": "settings_option_qq", "name": "Quote nhanh 1 hay nhiều post"}, {"id": "settings_option_fpp", "name": "Nút 'Capture' để chụp nhanh 1 post"}, {"id": "settings_option_rs", "name": "Size ảnh sau khi resize (lazy load) <span id='wrap_resize_choices' data-bind='stopBinding: true'></span>"}, {"id": "settings_option_rb", "name": "Tạo chữ với hiệu ứng Rainbow <span id='wrap_rainbow_choices' data-bind='stopBinding: true'></span>"}, {"id": "settings_option_bb", "name": "Banh bím<span id='settings_option_bb_img' class='inlineimg'></span>"}, {"id": "settings_option_help", "name": "<a href='javascript:;' title='Click to download' id='download_help'>Download file hướng dẫn chức năng</a>"}],
        ...
        $("#download_help").on("click", function(e) {
            e.preventDefault();
            location.href = "http://upnhanh.mobi/f/05Hejo";
        });
        ...
        var all_page = function(f17_flag) {
            ...
            if (st || qn) {
                ...
                $("a[href^='login.php?do=logout']").on('click', function() {
                    ...
                    if (confirm('#Tit: Đồng chí chơi chán chưa?')) $.removeCookie('isLogin');
                    else {
                        A.style.filter = '';
                        return false;
                    }
