...
// @include      https://footcup.fr*
// @exclude      https://footcup.fr/*action=logout*
...
var gameVeriables = {
    ...
    "at":{
        "flag":"AUT",
        "ageDates": [25709988, 25753764, 25797540, 25841316, 25885092, 25928868],
        "zone" : "Europe/Vienna",
        "language" : "German",
        "footballerPositions":{
            "Position1":"TW",
    ...
    "pl":{
        "flag":"POL",
        "ageDates" : [25715172, 25758948, 25802724, 25846500, 25890276, 25934052, 25977828, 26021604, 26065380, 26109156, 26152932, 26196708],
        "zone" : "Europe/Warsaw",
        "language" : "Polish",
        "footballerPositions":{
            "Position1":"BR",
    ...
    "fr":{
        ...
        "ScriptAuthorClubId":"170122",
        "ClubExchange":"Clubs Changer",
        "acceptedBidText" :"accepté",
...
var scriptTexts = {
    "English" : {
        ...
        "ResetNeedNecessaryInformation":" The tool needs the information to run properly.",
        ...
        "EnterClubInformation": "Enter current club information <br> (You can change this data later using the Reset button)",
        "ClubId":"Club Id",
        "ClubName":"Club Name",
        ...
        "ChooseTrainingSchedule":"Choose Training Schedule <br> (Depending on the level of your training courses Plan 3, if everything is full, otherwise 1 or 2)",
        ...
        "ClubExchange":function(date,clubName){return "This player will have gone to "+clubName+" zum "+date+"!";},
        ...
        "UpdateScript":"New version is available. Click it to update the Fcup Script.",
        "FinishedTrainings" : "Finished Trainings",
        "WrongTrainings" : "Wrong Trainings",
    ...
    "German" : {/*Thanks to mot33*/
        ...
        "InformScriptWorking":"Gespeicherte Scriptdaten wurden nicht gefunden, weil du das Script zum ersten mal benutzt.",
        "HelpDataUploading":"Solltest du doch schon mal das Script benutzt haben und die Daten heruntergeladen, dann kannst du sie über die Schaltfläche Hochladen (Wenn nicht, dann überspringe diesen Schritt einfach): ",
        "EnterClubInformation":"Eingabe aktueller Vereinsinformation <br> (Diese Daten kannst du später über die Reset Schaltfläche ändern)",
        "ClubId":"Club Id",
        ...
        "ChooseTrainingSchedule":"Trainingsplan wählen: <br> (Je nach Ausbaustufe deiner Trainingsplätze. Plan 3, wenn alles voll, sonst 1 od. 2)",
        ...
        "ClubExchange":function(date,clubName){return "Dieser Spieler wechselt zu "+clubName+" zum "+date+"!";},
        ...
        "TrainingGroupInformation":function(CountOfPlayer){return CountOfPlayer + " Spieler entwickeln sich in dieser Trainingsgruppe";},
        ...
        "FilterPlayerInformation":function(CountOfPlayers,showPlayerCount){return 'Diese Seite zeigt '+showPlayerCount+' von '+CountOfPlayers+' Spielern.';},
        ...
        "UpdateTheScriptInfo":function(a,b){return 'Eine neue Version des Tools steht zur Installation bereit: '+a+'Bitte klick hier zum aktualisieren'+b+'. Hast du das Update vollzogen, dann klick auf aktualisieren:';},
    ...
    "Polish" : {
        ...
        "EnterClubInformation": "Podaj aktualne informacje o klubie <br> (Możesz zmienić te dane później za pomocą przycisku Resetuj)",
        ...
        "ChooseTrainingSchedule":"Wybierz harmonogram szkoleń <br> (w zależności od poziomu Twoich szkoleń, Plan 3, jeśli wszystko jest pełne, w przeciwnym razie 1 lub 2)",
        ...
        "FaultyTrainingMessage":function(playerName,skillName){return playerName+' musi poprawić umiejętność '+skillName+' gra na przedpolu.';},
        "ImproveSkillTitle":function(skillName){return skillName+" umiejętność musi zostać poprawiona.";},
        "NoInformation":"brak informacji",
        "TrainingGroupInformation":function(CountOfPlayer){return CountOfPlayer + " Zawodnik(ów) rozwija się w tej grupie treningowej";},
    ...
    "French" : {
        ...
        "FeaturesName":{
            "ShowPublicRelations":"Montrer relations publiques, statut des relations publiques",
            "ConstructionCountdown":"Compte à rebours de la construction",
            "ClubExchange":"Echange de club",
            "PlayersHealth":"Santé des Joueurs",
            ...
            "ShowSquadStrength":"Montrer la force de l*'quipe"
        },
        "Skills" : [
        ...
        "ChooseTrainingSchedule":"Choisissez le programme de formation (en fonction du niveau de votre plan de formation, plan 3 si tout est plein, sinon 1 ou 2)",
        ...
        "ClubExchange":function(date,clubName){return "Ce joueur veut être allé à "+clubName+" au "+date+"!";},
        ...
        "FaultyTrainingMessage":function(playerName,skillName){return playerName+ 'doit améliorer son '+skillName+'compétence.';},
        "ImproveSkillTitle":function(skillName){return skillName+" la capacité doit être améliorée.";},
        "NoInformation":"Aucune information",
        "TrainingGroupInformation":function(CountOfPlayer){return CountOfPlayer + " Player(s) se développent dans ce groupe de formation";},
        ...
        "FilterPlayerInformation":function(CountOfPlayers,showPlayerCount){return 'Cette page montre '+showPlayerCount+' of '+CountOfPlayers+' Joueurs.';},
        ...
        "Now":"Maintenant",
        "SuccessfullyTransferred":function(playerName){return "Vous avez transféré avec succès votre joueur de football"+playerName+"à votre club!";},
        "RemainingNextAgeDay":function(day){return 'Le prochain âge restera pour'+day+' journée et la jeunesse se terminera.';},
        ...
        "EndYouth":function(remainingDays,date){return 'Après '+remainingDays+' journée la jeunesse se terminera '+date;},
        "AfterTrainings":function(trainings){return 'Après ' + trainings+ 'formations';},
        ...
        "UpdateTheScriptInfo":function(a,b){return 'Si vous voulez mettre à jour le script, '+a+'cliquez ici'+b+'. Mettez à jour le script à partir de la page qui ouvre. Puis actualisez cette page !! (F5 ou bouton de rafraîchissement)';},
        "NewVersion":"Nouvelle version",
        "CurrentVersion":"Version actuelle",
        "ReleasedVersion":function(newVersion){return 'Version '+newVersion+' du script FCup est sorti!!!';},
                ...
                onload: function(response) {
                    ...
                    if(version>currentVersion){
                        ShowDialog(
                            ...
                            scriptTexts.UpdateTheScriptInfo('<a href="https://greasyfork.org/scripts/40715-fcup-script/code/FCup%20Script.user.js" style="font-size:14px">','</a>')+
                            '</p>'+
...
`);
            ...
            (function() {
                'use strict';
                GM_addStyle("#soundonoffbtn {cursor: pointer; width: 35px; height: auto;}");
                GM_addStyle("#header {position: relative;}");
                GM_addStyle("#soundonoffbtn {position: absolute; right: -60px; bottom: 8px;}");
...
height:40px;
width:40px;
background-image: url(https://cdn.pbrd.co/images/HFWRRt6.png);
z-index:20;
opacity:.5;
cursor:pointer;
}
                ...
                if(IsPage('area=user&module=main')){
                    ...
                    if(scriptData.FeaturesOfScript["ConstructionCountdown"]){
                        $('#clubinfocard').find('ul').first()[0].innerHTML +=
                            '<li><img width="16px" src="'+sources.get('construction','png')+'" alt="construction" style="margin: -3px 3px 0;vertical-align:middle;"><span class="label"><st k="Stadium">'+scriptTexts.Stadium+'</st>:</span><span id="countdown1"><st k="Loading">'+scriptTexts.Loading+'</st>...</span></li>'+
                            '<li><img width="16px" src="'+sources.get('construction','png')+'" alt="construction" style="margin: -3px 3px 0;vertical-align:middle;"><span class="label"><st k="Buildings">'+scriptTexts.Buildings+'</st>:</span><span id="countdown2"><st k="Loading">'+scriptTexts.Loading+'</st>...</span></li>';
                        $('.likebox').css('marginBottom','-40px');
                        var modules = ["stadium","buildings"];
                        for(var i = 0 ; i < 2 ; i++){
                            if(scriptData["finisDate_"+modules[i]]===undefined){
                                getData(i);
                            }
                            else{
                                var seconds = parseInt((scriptData["finisDate_"+modules[i]] - GetServerTime()) /1000);
                        ...
                        function getData(i){
                            ...
                            getPageData(href,'content',function(html){
                                ...
                                if(cd.length){
                                    ...
                                    scriptData["finisDate_"+modules[i]] = finishDate;
                                    start(seconds,$('#countdown'+(i+1)));
                                }
                                else{
                                    var ol = '';
                                    if(i==1){
                                        if($(html).find('.build').length){
                                            ol = '<a href="'+href+'" <span="" style="color: #51ff44;"><st k="GoToBuildings">'+scriptTexts.GoToBuildings+'</st></a>';
                                        }
                                        else{
                                        ...
                                        if($(html)[0].querySelector('#block-building-selected-blocks')){
                                            ol = '<a href="'+href+'" <span="" style="color: #51ff44;"><st k="GoToStadium">'+scriptTexts.GoToStadium+'</st></a>'
                                        }
                                        else{
                                            ol = '<st k="Full" style="color:white;">'+scriptTexts.Full+'</st>';
                                        }
...
$('.table-container:first').children().first().after(
    ...
    '&#10148; <span style="cursor:pointer;" id="ShowAllPlayers">'+scriptTexts.ShowAllPlayers+'</span><br>'+
    '&#10148; <span style="cursor:pointer;" id=OnlyForeignPlayers>'+scriptTexts.OnlyForeignPlayers+'</span><br>'+
    '</div>'
);
...
$('#OnlyForeignPlayers').click(function(){
    var count = 0;
    $('#content > div.container.transfermarket > div.table-container > table > tbody > tr').each(function(i){
        if(!$('td:nth-child(1) > img',this).attr('src').endsWith(scriptData.flag+'.gif')){
            $(this).show();
                    ...
                    if($('#tournaments > div.container.upcoming > div > table > tfoot > tr > td').html()=="" &&
                       !$('#tournaments > div.container.upcoming > div > table > tbody').find('.name-column').length?false:true){
                        ...
                        function showTournaments(){
                            ...
                            thead.before('<tr style="background:none;"><th colspan="8" style="background-color: #075971;border-radius: 7px 7px 0 0;" id="ShowNumberOfTournament">'+scriptData.tournaments.length+' '+scriptTexts.Showtournaments+' </th></tr>');
                            $('th:nth-child(6)',thead).after('<th class="SortTournaments" sort="money" k="-1" style="cursor:pointer;">'+scriptTexts.totalprice+'</th>');
