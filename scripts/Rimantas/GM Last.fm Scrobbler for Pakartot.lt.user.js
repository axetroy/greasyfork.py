...
// @grant       none
// ==/UserScript==
jQuery("#header").append("<div id='scrobblerdiv' style='position:absolute; right:20px; top:20px; z-index:999'><div id='togglescrobbling' style='width:20px; height:20px; border-radius:10px; border: 1px solid black; background-color:rgb(43, 177, 43); line-height:20px; text-align:center;'></div></div>");
...
function updatenowplaying()
{
  ...
  $.ajax(
  {
    ...
    error : function(code, message){
        ...
        if (errorcode==9) {
          $.removeCookie('pakartotscrobblerlastfmkey', {path: '/', domain: '.bandcamp.com'});
          authentication();
        }
    }
  });
