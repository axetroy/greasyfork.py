// ==UserScript==
// @name         WWT - Downloaded Torrents List
// @namespace    superiorSilicon
// @version      1.16
// @description  Keep track of WWT torrent downloads
// @author       superiorSilicon, NotNeo
// @require      https://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js
// @include      *worldwidetorrents.to/account.php
// @include      *worldwidetorrents.to/torrents-details.php*
// @grant        GM_getValue
// @grant        GM_setValue
...
$(document).ready(function(){
    ...
    var torID = window.location.href.split(/.*worldwidetorrents.to\/torrents-details.php\?id=/g)[1];
