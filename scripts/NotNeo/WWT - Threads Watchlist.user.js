// ==UserScript==
// @name         WWT - Threads Watchlist
// @namespace    superiorSilicon
// @version      1.6
// @description  Adds a list of threads that you "watch" on WWT
// @author       superiorSilicon, NotNeo
// @include      *worldwidetorrents.to*
// @require      https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js
// @require      https://greasyfork.org/scripts/35440-jsmodal/code/jsModal.js
// @grant        GM_getValue
// @grant        GM_setValue
// @grant        GM_listValues
...
function Notify(body, title, tag, threadLink) { //Function for firing notifications. Use by calling Notify(params)
    var options = {
        body: body,
        tag: tag,
        icon: "https://i.imgur.com/YRBWYJj.png"
    };
...
$(document).ready(function() {
    ...
    $('#threadsWatched').click(function(e) { //"Watched Threads" click event
        e.preventDefault();
        ...
        Modal.open({ //Modal constructor
            ...
            draggable: true //Modal draggable boolean
        });
        for (var i = 0; i < threadList.length; i++) {
        ...
        $('.threadremove a[id*="remove-"]').click(function(e2) {
            e2.preventDefault();
    ...
    $('#watchlistSettings').click(function(e) {
        e.preventDefault();
        Modal.open({
...
<div id="settingsButtonContainer">
    ...
    <div id="applyButtonContainer">
        ...
        $('#saveSettings').click(function(e2) {
            e2.preventDefault();
        ...
        $('#applySettings').click(function(e2) {
            e2.preventDefault();
            GM_setValue('useAudio_WT', document.getElementById('audioCheck').checked === true ? true : false);
            GM_setValue('audioSrc_WT', $('#audioSource').val());
            GM_setValue('activity_WT', $('#activityInterval').val());
        ...
        $('#resetSettings').click(function(e2) {
            e2.preventDefault();
        ...
        $('#previewNotif').click(function(e2) {
            e2.preventDefault();
            let previewNotif = new Notification('Notification Preview', {
                ...
                icon: "https://i.imgur.com/l3hsdze.png"
            });
    ...
    function checkActivity() {
        ...
        for (var thread of threadList) { //Iterates on the thread list
            let url = 'https://worldwidetorrents.to/forums.php?action=viewtopic&topicid=' + thread.threadListName.split(/thread-/g)[1] + '&page=last';
    ...
    $('#watchlist-notifications').click(function(e) {
        e.preventDefault();
        Modal.open({
