// ==UserScript==
// @name        Maelstrom Tools ADDON Basescanner (TerraInc fork)
// @namespace   http*://prodgame*.alliances.commandandconquer.com/*/index.aspx*
// @description Maelstrom ADDON Basescanner with layout silo calculation
...
(function () {
    var MaelstromTools_Basescanner = function () {
        ...
        function createMaelstromTools_Basescanner() {
                    ...
                    FI : function () {
                        try {
                            ...
                            this.ZL.setColumns([
                                ...
                                "Crystalfields",
                                "Tiberiumfields",
                                this.T.get("Building state"),
                                this.T.get("Defense state"),
                                this.T.get("CP"),
                                "Def.HP/Off.HP",
                                "Sum Tib+Cry+Cre",
                                "(Tib+Cry+Cre)/CP", "CY", "DF",
                                this.T.get("base set up at"),
                                this.T.get("Layout")
                            ]);
                                                ...
                                                if (buildings != null) //defenseUnits !=null können null sein
                                                {
                                                    ...
                                                    if (ncity.GetBuildingsConditionInPercent() != 0) {
                                                        ...
                                                        if (this.ZE[i][5] != 0) {
                                                            ...
                                                            for (k = 0; k < 9; k++) {
                                                                for (l = 0; l < 8; l++) {
                                                                    var resType = ncity.GetResourceType(k, l);
                                                                    var connects = 0;
                                                                    if (resType != 1 && resType != 2) {
                                                                        for (var k1 = (k === 0 ? 0 : -1); k1 <= (k === 8 ? 0 : 1); k1++) {
                                                                            for (var l1 = (l === 0 ? 0 : -1); l1 <= (l === 7 ? 0 : 1); l1++) {
                                                                                if (k1 !== 0 || l1 !== 0) {
                                                                                    if (ncity.GetResourceType(k+k1, l+l1) == 2) {
                                                                                        connects ++;
                                                                                    }
                                                                                }
                                                                            }
                                                            ...
                                                            console.log(szT);
                                                            this.ZE[i][20] = szT.slice(3,8).reverse().join(";");
            ...
            T.addtranslateobj( {main:"Layout", de: "Layout", pt: "Layout", fr: "Layout"} );
