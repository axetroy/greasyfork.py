...
(function() {
    ...
    function SetDefaults() {
        ...
        function parseResponse(response) {
            ...
            var Name = ajaxDoc.querySelectorAll(".gb_Cb.gb_Db");
            var NamePart = Name[0].innerText.split(" ")
            GM_setValue("GB_Url1text", "+" + NamePart[0]);
        }
        ...
        GM_setValue("GB_Url5", "https://www.google.com/maps/");
        ...
        GM_setValue("GB_DropDownUrl5", "https://greasyfork.org/");
        GM_setValue("GB_DropDownUrl5text", "GreasyFork");
        GM_setValue("GB_TotalBarLinks", 11);
