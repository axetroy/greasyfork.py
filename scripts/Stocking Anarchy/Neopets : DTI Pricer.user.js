...
// @description  Displays waka values for NC items on Dress to Impress (values are subjective). Items with ? check ~waka for price. Blank items means no price is listed on ~waka.
...
Bringer of the Night Collectors Throne ~1 \
...
Carved Wooden Vanity Table ~2-3 \
...
Dreary Spring Window Foreground ~2-3 \
...
Flowering Vine String Lights ~38-44 \
...
Hot Air Balloon and Cloud Garland ~8-10 \
...
Ornamental Lake with Goldies ~20 \
...
Premium Collectible: Mountainside Getaway Background ~. \
...
Soaring Heart Balloon Garland ~4-5 \
...
Summer Shine Candle Holders ~1-2 \
