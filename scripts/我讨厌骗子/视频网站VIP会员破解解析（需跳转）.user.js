// ==UserScript==
// @name     视频网站VIP会员破解解析（需跳转）
// @namespace  https://greasyfork.org/zh-CN/users/104201
// @version    4.2.5
// @description  一键破解[优酷|腾讯|乐视|爱奇艺|芒果|AB站|音悦台]等VIP或会员视频，解析接口贵精不贵多，绝对够用。详细方法看说明和图片。包含了[一键VIP视频解析、去广告（全网） [Tampermonkey | Violentmonkey | Greasymonkey 4.0+]
// @author     黄盐
...
(() => {
  ...
  `);
  var defaultapi = {
    title: "综合接口，破解全网VIP视频会员-去广告，默认用解析一，失效请更换接口",
    url: "http://vip.oo.gd/index2.php?url="
  };
