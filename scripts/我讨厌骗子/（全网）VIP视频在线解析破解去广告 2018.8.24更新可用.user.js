// ==UserScript==
// @name         （全网）VIP视频在线解析破解去广告 2018.8.24更新可用
// @namespace    http://vip.oo.gd/
// @version      2.8.0
...
(function() {
    ...
    var vipBtn = '<a id="sonimeiVipBtn" style="cursor:pointer;text-decoration:none;color:red;padding:0 5px;border:1px solid red;">vip无广告视频解析</a>';
    ...
    if(reAqy.test(videoSite)){
        ...
        $('#sonimeiSearchBtn').attr('href','http://itv.oo.gd/search.php?searchword=' + curWords + '&p=1');
    }
    // 乐视
    if(reLS.test(videoSite)){
        ...
        $('#sonimeiSearchBtn').attr('href','http://tv6.oo.gd/search.php?searchword=' + curWords + '&p=2');
    }
    // 腾讯
    if(reTX.test(videoSite)){
        ...
        $('#sonimeiSearchBtn').attr('href','http://tv6.oo.gd/search.php?searchword=' + curWords + '&p=1');
    }
    // 土豆
    ...
    $('#sonimeiVipBtn').on('click',function(){
        ...
        window.location.href = 'http://vip.oo.gd/index2.php?url=' + curPlaySite;
    });
})();