// ==UserScript==
// @name         Splix.io Mods,Hacks,Cheats
// @description  Splix.io extension (no ads,zoom,play with friends,stop player)
// @version      2.0
// @author       Slithere.com
// @match        http://splix.io
...
(function() {
      ...
      window.addEventListener("load", function(){
       ...
       function WheelHandler(event) {
        ...
        myDiv.innerHTML = "BY------>CreeHack.net";
