                ...
                case 130:
                    if (agar_server != packet.data.url) {
                        ...
                        var content = ('You are now at: <strong>' + agar_server
                            + '</strong><ß&ω>Your team members are all at: <strong>' + packet.data.url + ', ' + region_name + ':' + gamemode_name + packet.data.party
                            + '</strong>.<ß&ω>The minimap server has disconnected automatically.');
