// ==UserScript==
// @name           RatingR2 beta - season 45 (darkxuy EDIT)
// @version        4.6
// @description    REREC(+b), Season TI, TrExMa, RatingR2 -https, facebook compatible
...
var weightRb = [[	0.10476131	,	0.05214691	,	0.07928798	,	0.14443775	,	0.13140328	,	0.06543399	,	0.07762453	,	0.06649973	,	0.05174317	,	0.02761713	,	0.12122597	,	0.01365182	,	0.02547069	,	0.03869574	],	// DC
                ...
                [	0.08204632	,	0.08683808	,	0.07230980	,	0.09758248	,	0.08869325	,	0.09137643	,	0.09682993	,	0.09073510	,	0.04583547	,	0.05981366	,	0.05481978	,	0.04837385	,	0.05880749	,	0.02593835	],	// DMC
                ...
                [	0.07462571	,	0.08041546	,	0.08495109	,	0.07147983	,	0.05442725	,	0.08369814	,	0.08525544	,	0.11151195	,	0.03222804	,	0.07676736	,	0.06317729	,	0.07537475	,	0.07826644	,	0.02782127	],	// OMC
                [	0.06643139	,	0.05903785	,	0.10343250	,	0.06915742	,	0.07809769	,	0.08581661	,	0.08102926	,	0.06659015	,	0.11165243	,	0.07460092	,	0.04028340	,	0.06535109	,	0.07370623	,	0.02481304	],	// OML/R
                [	0.07696743	,	0.05076189	,	0.07749067	,	0.01258547	,	0.01146086	,	0.06362563	,	0.07760326	,	0.07599049	,	0.02725659	,	0.07768637	,	0.12793304	,	0.15353079	,	0.12831805	,	0.03878945	],	// F
...
if (location.href.indexOf("/players/") != -1){
	...
	recbth.innerHTML = "<b style=\"color: gold;\">RERECb</b>";
	...
	function seasonTI (playerID, gettr, SI) {
		...
		var s45t = new Date("02 23 2016 00:30:00 GMT");				// first training
		...
		if (wage == 30000 || (playerID > 112870168 && count == 0)) {	// s45 young player ID
			sitd.innerHTML = "---";
		}
		else {
		...
		if (wage > 30000 && playerID > 112468679 && age < ageMax) {	// s45 BOT player ID
			wage_rate = 23.75;
