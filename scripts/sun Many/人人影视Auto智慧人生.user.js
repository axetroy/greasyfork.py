...
(function aimei5544() {
    ...
    var edit_url="http://www.zimuzu.io/release/resource/app?rid="+url_[4];
    //资源页面跳转编辑页面
    ...
    if(url_[3]=="release"){ //跳转编辑页面添加按钮 更新缓存
        ...
        var edit_url_updata="http://www.zimuzu.io/resource/updateCache?rid="+edit_[1];
        ...
        setTimeout(function(){
            ...
            if(num_class.length==1){
                ...
                window.location.href="http://www.zimuzu.io/release/resource/app?rid="+rid_1[2];
