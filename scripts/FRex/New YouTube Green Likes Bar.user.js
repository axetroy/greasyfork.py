...
// @description Turns the like bar green and makes it higher
...
// ==/UserScript==
function recolorBars(likes)
{
  var likesbar = likes[0];
  var dislikesbar = likesbar.parentElement;
...
waitForKeyElements('#like-bar', recolorBars);
