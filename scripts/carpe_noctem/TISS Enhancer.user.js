...
// @require     https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.19.4/locale/de.js
// ==/UserScript==
...
if (page == "education/favorites")
{
  $("tr.ui-widget-content").each(function(index, row) {
    ...
    var img = '<img src="https://vowi.fsinf.at/favicon.png" title="VoWi" width="16" height="16"></img>';
