...
// @grant        GM_addStyle
// @contributor  Emir
// @icon         http://i.imgur.com/4EnGoyg.png
// ==/UserScript==
...
GM_addStyle('* #logo {background-image: url("http://i.imgur.com/3Jp1JR4.png");}'); 
...
var maincontent = document.getElementById("main-content");
  ...
  ffscversion.innerHTML = 'Subscribe to EmirYT<br>http://www.youtube.com/c/EmirYT ';
  ffscversion.id = 'EmirScript';
  maincontent.appendChild(ffscversion);
document.getElementById("EmirScript").style.cssText = "text-align:center;font-size:18px;color:red;";
