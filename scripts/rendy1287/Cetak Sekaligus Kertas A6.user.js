...
{
  $.getJSON('http://vendor.akulaku.com/installment/api/json/vendor/pending/delivery/sales/order/list.do?offset=' + offset + '&count=' + count + '&status=' + status, function()
  {
    console.log( "success" );
  })
  .done(function(data) {
...
function cetakAkulaku3(list)
{
    ...
    var logotoko         = 'http://i66.tinypic.com/2la3t6p.png'; //'https://raw.githubusercontent.com/rendy1287/tokopedia-cetak-sekaligus/master/gambar/logo_akulaku.png';
...
function cetakAkulaku()
{
  ...
  initWatcher = setInterval(function ()
  {
    ...
    if (unsafeWindow.angular)
    {
      ...
      if (/index\/processingOrders/.test(window.location.href) && currentPage != 'http://vendor.akulaku.com/#/index/processingOrders')
      {
        ...
        currentPage = 'http://vendor.akulaku.com/#/index/processingOrders';
        cetakAkulaku2(0, 10, 1);
      }
      else if (/index\/preparingOrders/.test(window.location.href) && currentPage != 'http://vendor.akulaku.com/#/index/preparingOrders')
      {
        $('button.btn.btn-success.btn-sm').first().after('<button type="button" id="cetakAkulaku" class="btn btn-primary btn-sm" style="margin-left: 20px;" data-toggle="button"">Loading...</button>');
        currentPage = 'http://vendor.akulaku.com/#/index/preparingOrders';
        cetakAkulaku2(0, 10, -1);
      }
      else
      {
...
{
  //http://vendor.akulaku.com/installment/api/json/vendor/delivered/sales/order/list.do?offset=0&count=10
  //http://vendor.akulaku.com/installment/api/json/vendor/pending/delivery/sales/order/list.do?offset=10&count=10&status=1
...
function cetakAkulaku3(list)
{
    var text             = '';
    var logokurir        = 'https://ecs7.tokopedia.net/img/kurir/logo_sicepat.png';
    var logotoko         = 'https://raw.githubusercontent.com/rendy1287/tokopedia-cetak-sekaligus/master/gambar/logo_akulaku.png';
