...
function inicio() {
    ...
    redondearControles();
    colorPanelCentral("#1f0303");
    colorPanelDerecho("#fafafa");
    colorTextoPestaña("#fafafa");
    colorPestañaActiva("#10c2ba");
    ...
    colorBotonCreate("#640fb6", "#640fb6");
    bordeBotonCreate("#640fb6", "#640fb6");
 
    colorBotonJoin("#640fb6", "#640fb6");
    bordeBotonJoin("#640fb6", "#640fb6");
    ...
    colorBotonSaveHotkeys("#640fb6", "#640fb6");
    bordeBotonSaveHotkeys("#640fb6", "#640fb6");
 
    colorBotonCloseHotkeys("#C62828", "#C62828");
    bordeBotonCloseHotkeys("#C62828", "#C62828");
 
    colorBotonSaveTheme("#640fb6", "#640fb6");
    bordeBotonSaveTheme("#640fb6", "#640fb6");
 
 
    colorInput("#fafafa");
    colorTextoInput("#110bc5");
 
    colorSelect("#fafafa");
    colorTextoSelect("##110bc5");
 
    colorPicker("red");
 
    nuevoCursor("http://cur.cursors-4u.net/people/peo-8/peo963.cur");
