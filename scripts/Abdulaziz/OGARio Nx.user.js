...
// @namespace    Nx.v1
// @version      1.0.0
// @description  Es una edición de OGARio Nx
// @author       ABO3TB
// @match        http://agar.io/*
...
function inicio() {
    document.title = "Nx extension :)";
    modificarTextoMinimapa("By ABO3TB");
    modificarTextoLeaderboard("ZR extension");
    modificarCanalYoutube("Baysn Channel", "UCuMoX-ZzayiUWRznAdvIZwA");
    modificarFooter("Nx Chat", "http://nxnx.chatovod.com/");
    panelDerecho();
...
function modificarTextoMinimapa(titulo) {
    ...
    CanvasRenderingContext2D.prototype._fillText = function(){
        if(arguments[0] == 'ogario.ovh'){
            arguments[0] = titulo; // arguments[0] = 'ву zr ♔'; // Borra el texto transparente encima del minimapa
        }
