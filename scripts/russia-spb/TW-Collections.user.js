...
// @name            TW-Collections
-RUS
// @description     Russian Translation - TW-Collections
...
// @history 	1.3.8   miscelaneous changes - 

update link to patebin (thanks to Tom Robert )
// @history 	1.3.7   correct bug for double 

item wearing - reactivate update
// @history 	1.3.6   correct translations links
// @history 	

1.3.5   correct bugs save & trader icons
...
// @history 
	...
	1.3.3.6 correcting tips in mobile trader
// @history 	1.3.3.5 add vertical scrollbar 

in set & collection selectboxs
// @history 	1.3.3.4 maj 2.08 & optimisation chargement 

items de collections
// @history 	1.3.3.3 Fix ended bids  
// @history 	1.3.3.2 correct 

End bids on collector list, add setting for deactivate menu mouse hover  
// @history 	1.3.3 

Mod. listcolector: recherche dans le marché   add direct link to market / mobile trader, add 

filters 
// @history     1.3.2.1 Fix inventory bug 
// @history     1.3.2  fix for the the mobile 

trader link, add the new TW items of the achieved collections, add pictures on collections 
...
// @history     1.3.1 correction pour le nouveau marchand 

ambulant + patch TWDB new
// @history     1.3.0 correction trad en + ajout lien forum
// @history 

    1.2.9 correction trad en et logout sans confirmation + ajout trad Slovak
// @history     

1.2.7 correction trad en et logout sans confirmation 
// @history     1.2.7 ajout filtres 

inventaires, correction 
// @history     1.2.7 modification du systeme de langue et de 

l'updater, simplification suppression rapport, etc...
// @history     1.2.6.1 correction 
...
corrections ... or not :)
// @history     1.2.4 Création d'une barre d'outils dans l'inventaire 

(recettes, sets, consommables,doublons)
// @history     1.2.3 ajout d'un bouton doublon dans 

l'inventaire et correction bug lang
...
"/images/icons/achv_points.png",
						logout : 

"data:image/jpg;base64,

uM+mKhNJKwNSbfN+B654f8ACXhm

+sNMjudOleaaxS5llF0wG4hsjb2+5+tQ5tGkadzD8aeFvD1t4Tj1KzsNl05GxXlMmz7pPX/epxm77ilSTWxhWOnWUtlbySa

Lbs7xqzMJggJI67e30rKU1d6sajUt0+45rSfA+r+JpZr61jsTaC

+mV1luo4ZDiQ5BVmH5j/Gul1Yw0b1svyPKr4yMXKEVqr9vluz3u+l

+wWWppNFG263Vy5ZsXSAopx/d525HVcjkgqzYJqVmjtw2IjVjZvX



ZXMifV2sdWuhN/aMDTlJk2sih1KKM5PJ5B6dOlR7NTirWZhVw9Kc

+apH8T0Gy1+2tLLbPq2i3F0YTF5jXJLRqy7SBzjJ6kkEk

+wAB9Vt8LRGDhHDx1u5df6/q5j694l057GOJDppiiLMkUUzHex2j

+Ikk/KMD1pvDSe7R2fWEu5j2mrPbWsMCi/jWJAgRiMrgYwaxlG7b/UtWsQa/8Aduf+uSVdLdhX/QpeG/uxfh/M0q

+xVDY72w/5Cll/vt/6DXn/AGDePxHNa7/rG/65P/Ou6j+hhW2Rz+gf+zH+YrStsRh+p3sfW1/67R/zNef0Z1dUW7z/AI

+5/wDfb+dJbEy3P//Z",
						twdb_iconNew : 

"data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAACMAAAAjCAYAAAAe2bNZAAAAGXRFWHRTb2Z0d2FyZQBBZG9i

ZSBJbWFnZVJlYWR5ccllPAAAC/tJREFUeNp0WAlUFFcWvVXdTTc0NIuogLiAgsYtJm4kGk3UqMkYM3GiUXN0TDJGj6NRo7g

ko+JuTGLiEhN3x2VwGz1x1MQxQeNKiGCjAm4IAooI0ghN02vVvP

+7quk2mTqnqKLr1//vv3vfe/eV8GKfvmgeHY7pk8bC6XRDEABRFMEOj0fiV1EUINNVliR

+L7BBfocke5+x3/XBRpjzC6MijdrquJhm3uc0QJYbT7aISGdQkA6bdh5Cwa27SE1NhTYrKwvduyShT/f2qLPWQ6MRodVqwF

Z3ujzMBPpNQxNKcHs8CNJq+RhmHP8jyHC7ZXru4b

+bYhJ6lRYVr/ktJ/u1d5fMqrPZHXxT7GSGqBthl5BgA1asfgCz2YyKigqIQUFBfDEPLcZ2wE6Ph071XmKLecgQ5TlN6FYmV

99hV5fLBV14tFCVlbs66UxGn7KHjyf9mpMHnU7Hx7B32OmiudR1yDSItLbX



+fPvt+eFVNxr6T57uXlj/iCc8boX7GyAp2Ag9B

+IGkklkI5BB5RxceabLmFR/OnZHaTqK8IRB8DJ46um97PR9RKd1Rn9gKMiU8vghF06Mr12DauiulS

+Hd8zlXbiw5ffm6yU7Gq9ne5xlRsVA9/agb6ElmiCki2FHy



+naLQ8abHZekjQ6qk0xzZpg3DvDeGYU0Fi1eXalSQzRzeOs+fe

+z54w6RVbcTH0pjBYyRCLqEECXQ1lD9B1ynuoahmH/MxsSJWVEC5mo

+Xg/vB06gTb6fNMAkCgBGkk/uQnJmD5I0veuZLy2TpRXNxgdzwcOnQotP6JjS0uKt6QPG5otEEIaR7/XNWps/tyZ8xJdlZX

I5iwryFoyocMRnSXDniycy/qdu/Ho6t5eGHxfGDIK5Cp9p15byYsldWIpIyMmhpoqXZ5SFIciGzi2pR5dXeXdq1XXPjP1sL

ln2/G9z+ceSq0fdFDhrjJkOAwhMUljb6/Y3+GeeKUZHftE

+gJmidkSPHgAejVNgEdb99Bsxd6UxYOhvNuMbJHf4Cyucugr65FyjdfwnLZjMJN20DJBXVJiVgqaR58dyFn2sz3R07+5ejW

wp49usJO5FcPLfxCmMNCXjLGttHBISwzT5895/7edIikO0hrQCJIPB2S8caH76LmTiFOfLMZho4d0Ilgc9RayZNalP9wCvW

2BkTGtwTu36cMHYWCpLZYfrv0V4Ijdf/mFedGDBsEG41x1Nt

+n/Q4RyU3gvQGmFo907HhZsnPmSNGzrm391/QUhbV0SK1lEMamkUj6l4JKmenIS6xNVJ2rUffMSMhmyJQOqg/ZOJeUFgobJ

evoCx9P4zhJmQkt8P0y3n745pHjzp3dOu5P78+AI+ra7j

+eVqS8KTnoFxgiIqBsWnC1HubdlwkQ16yXL0ObXg4tLLMhZT1r6M5H2yWJ7AW3Ebe/JVI6dwBTqMWDym6WuiDEEnweRrs3N

2hFEVH4uI8y8/lrHl7cL

+J/z30bUlC6xZcTQZSw88Yg0Gv7dk75QX3nYqffhszbv21BYvCOWfII7zWEEcK9Xq0KbqHzn8ahOqhA9FAiU7Ov4lLw8chq

X0iolYvREP7jhBLyqkmURogD+1s0tSx4dzlRbMnjZ2357sVdSxCbWSoSgv/zOszJqFNq

+iE5lEbz3w6b2D9+QvQEVSSluoGhS2TifXvjEDn7V+htE1LXNyyF8l/GwPt2BEkH92wF5Xg2tRP0KPbc+hAxlp

+yoChVTy2RzZp

+OeF7PlL5k5e8VnadJfd4SDp6g6AxSPJT0kVQGO3O63HTp0+ni1qPRFdO3Zua9AbBIJCUopBC8K2U9+eSJkwCrr4eOiowLX

u1wt5+behvVcKkRapOHYSTy5dQmiLWOyJbmbfdT77k1WLpn89Z9oE1FLBZBleoo0xgcUMYoHC9IyBoN13+EfcKSoFyzOikx

br06tb2aqF0+ccs9T1/4fdc



+wELZYapHYJh6HN68qiW3b+i

+7TBGHTBTCAhU3J3GpcsN26I6egExV2kBRVkOZdVlB0aUenZJSN3+90Npgd/LeCIGK0gcL106Bzc4fyE5FLjCXOihFs

+7x67SZDmNM0w8uJbW7ZmoSBYGysD3HjCfXqTmjaJPjYvBFje0+jf94z7fL7+tI97J3GQ5q06fKV05apQNhB5uftywBGlj1

IFN6ijDljCfjbJT

+F06bUHvdLU229unlElxuUv86LkUNVH0PmyJcl/JuL9y5YXEm8ybLI4KiuEW16ZPh68vYe0y3qJ5SZW6gMbxQy0pP5GW/Rv

Duhin68W8NuXhSp18f/mxHqk8OBNOObya0xqZM845PZry/642hL6O2rt77/lPwcMEmeY3jHQhr5vwMeaqjVHbCc0Bjjva

+IMBa34B+vbqhaXzcssIOSSVGgsIZH4t1RQ

+uPd8pedmnsya6a0nVqS2wr0NVvONROk4Z/kJfaXGV6HrKM4KiZ1TpqQzkTRt4mR87fJDlioRF4a/2x0GIjpslD5ZsXD2/l

LUeqijjHaOfY9iGJCXT8tZWUGHxNnIaMZDMWrU7MFK1lSmbuogXPJH5tbhu

+i0xuQ1efrHHnoMXsj7eX3Dmxmf/mHqkd//ekAmeCJIQXqi9XFM9zaKTkZp9iWCphvNSUvIMjWEaWqN8heDGuFxOFNy4gwV

L13KtqhjOB6vtCjNQr9fR1eNet/PgBHuD01lRUelZMH

+Vb5xiTSMUsncOxju2oOD7WOCFj5UInU6D3Gs3+HAuKdLS0kgVkixQhM4ffPXw8YBFg5F2w3bNxqtftv7f4Z1LaGSG3Cj

+1TaXzce8N3z4cPxPgAEA6JcjmcJQzpoAAAAASUVORK5CYII=",
						

traderImg : 

"data:image/jpeg;base64,"
...
"position:relative;top:0px;left:0px;width:12px;height:12px;padding:0px;border:0px;margin:0px;",
	

					styleT : 

"position:absolute;top:4px;left:3px;width:15px;height:15px;padding:0px;border:0px;margin:0px;",
	

					styleN : 

"position:absolute;top:120px;left:25px;padding:0px;border:0px;margin:0px;",
			

			styleDB : 

"position:absolute;top:0px;left:0px;padding:0px;border:0px;margin:0px;"
		  ...
		  cs : {link: "https://greasyfork.org/cs/scripts/7260", texte:"Czech - 

čeština", author:"Dr.Keeper" },
						    es : {link: 

"https://greasyfork.org/es/scripts/7313", texte:"Spanish - Español", author:"pepe100" },
	

					    de : {link: 

"https://greasyfork.org/de/scripts/1672", texte:"German - Deutsch", author:"Hanya" },
		

				    it : {link: "https://greasyfork.org/it/scripts/1675", 

texte:"Italian - Italiano", author:"tw81" },
						    hu 

: {link: "https://greasyfork.org/scripts/7261", texte:"Hungarian - Magyar", author:"Zoltan80" 

},
						    sl : {link: 

"https://greasyfork.org/scripts/7259", texte:"Slovak - Slovenčina", author:"Surge" },
		

				    pl : {link: "https://greasyfork.org/pl/scripts/1674", 

texte:"Polish - Polski", author:"Dun from Darius II mod" },
					

	    pt : {link: "https://greasyfork.org/pt-BR/scripts/7312", texte:"Portuguese - 

Português", author:"VSaantiago" },
						    ru : {link: 

"https://greasyfork.org/ru/scripts/7271", texte:"Russian - Pу́сский", author:"Anch665" }
...
description : "<center><BR /><b>TW Collections</b><br>Astuces et signalement des items 

manquants des collections<br>Liste des items manquants des collections<br>Frais bancaires en 

survol avant dépot<br>Divers raccourcis et fonctions<br> Suppressions des rapports<br> Frais 

bancaires<br>Doublons dans l'inventaire<br>etc...</center>",
...
village de Waupee',
	...
	ownSaloon : 'Ouvrir votre saloon',
				...
				openMarket : 'Ouvrir le march&eacute;',
							...
							mobileTrader : 'Ouvrir le marchand 
...
gereNewItems : 'Gérer les nouveaux items des succés déjà obtenus',
							...
							patchsell : 'Signalement des items 

manquants aux collections dans l\'inventaire',
							

				patchtrader : 'Signalement des items n&eacute;cessaires aux 

collections chez les marchands',
								

			patchmarket : 'Signalement des items n&eacute;cessaires aux collections 

dans le march&eacute;',
...
'Boutons supplémentaires dans l\'inventaire',
			...
			doublons : 'Bouton de recherche des doublons',
							...
							useables : 'Bouton de recherche des 
...
recipe : 'Bouton de recherche des recettes',
				...
				sets : 'Liste de recherche des sets',
							...
							sum : "Cumul des prix de vente marchand 
...
du menu du script Collections au survol'
...
'Filtre dans le march&eacute; pour n\'afficher que les items manquants <a target=\'_blanck\' 

href="http://tw-db.info/?strana=userscript">(twdb add)</a>'
...
message : 'Préférences appliquées',
	...
	reloadButton : 'Recharger cette page',
		...
		gameButton : 'Aller sur le jeu',
			...
			indispo : 'Option indisponible (Collections terminées ou script non 
...
page des traductions'
			...
			updok : 'Le script TW Collection est à jour',
					...
					updscript : 'Une nouvelle version du script TW 

Collections est disponible<br/>Mettre à jour ?',
						

			updlangmaj : 'Une mise à jour est disponible pour une ou plusieurs 

langues utilisées avec le script TW Collections.<br/>Cliquez sur les liens ci dessous pour 
...
checknow : 'Verifier les mises à jour ?',
		...
		upderror : 'Impossible de mettre le script  TW Collections à jour, vous devez 

installer le script ou la langue manuellement'
...
'Param&egrave;tres de l&acute;outil'
...
les rapports',
						...
						deleteReports : 'Supprimer les rapports',
							...
							confirmText : 'Etes-vous sur de vouloir 
...
buyFilterTip : 'Montrer seulement les items manquants',
		...
		buyFilterLabel : 'Items manquants'
			...
			thEncours : 'Vous avez une ench&egrave;re en cours pour cet article',
							...
							thFetch : 'Vous pouvez récuperer cet 

article au marché de %1',
								allOpt 

: 'Tous',
								listText : 'Liste des 

items manquants des collections',
...
collectionFilterTip : 'Montrer seulement les items de collection',
		...
		searchMarket : 'Rechercher dans le marché',
			...
			atTraderTitle : 'Affichez les items en vente chez le marchand 

ambulant',
								atBidTitle : 'Affichez 

les items en cours d\'enchère',
...
en : {
							description : "<center><BR /><b>TW-

Collections</b><br><b>Tips and reporting missing items collections <br>list of collection 

needed items<BR> Bank fees on mouseover <br> Various shortcuts"
					

				+ "<br>All reports deletion<br> Fees in bank <br> Additional 

buttons in inventory (duplicates,useables, recipes, sets) <br>etc ...</b>",
...
showmiss : 'Список отсутствующих вещей',
				...
				filterMarket : 'Фильтр рынка : показывать только недостающие 
...
вещи (коллекции)'
					...
					title : 'Кнопки в инвентаре',
						...
						doublons : 'Дополнительные кнопки инвентаря 

(дублирует,можно съесть, рецепт, наборы)',
...
'Комиссия банка',
	...
	popupTWT:'Открыть меню TW Collection'
								...
								filterBuyMarket : 'Фильтр рынка 

: показывать только недостающие вещи (twdb add)',
...
: 'Установка недоступна (Коллекции собраны или скрипт недоступен)',
...
updok : "Скрипт TW Collection's обновлен до последней версии",
				...
				updlangmaj : 'Доступно обновление, перейдите по ссылкам ниже, 
...
updscript : 'Доступно обновление TW Collection. Обновить?',
				...
				upderror : 'Невозможно обновить, вы должны установить скрипт 
...
collection : {
							...
							thEncours : 'У вас есть заявка на этот 

предмет',
								thFetch : 'Вы можете 

получить этот предмет на %1\ рынке',
								

allOpt : 'Все',
								collectionFilterTip : 

'Показать только коллекции предметов',
...
купить у коммивояжёра',
								atBidTitle : 

'Показать только ставки',
...
"Предметы необходимые для коллекции"
...
["179395","179358","179298","178773","180784","182959","179302"];
				

		
						if($.inArray(lang.idscript 
...
("Unmaintained language script for TW Collection",
			 ...
			 "<div><b>You are using an obsolete version of '" + lang.name + "' 
...
href='"+TWT.langPatchs[lang.short_name].link+"'>"
...
function() {
						var selLang = TWT.langs

[TWT.Settings.checked.miscellaneous.lang]
...
(TWT.Settings.isChecked('inventory.doublons')
...
txtArea = '<div style="width:650px;margin-left:15px;margin-top:20px;height:250px;font-

size:16px;text-align:justify;padding-bottom:50px;">'
						

		+ '<h4 style="margin-bottom:20px;"><center>The translation\'s system of the TW 

Collections script has changed</center></h4>'
							

	+ "TW Collections script contains just the french and english languages, if you need a 

different translation you must install one of the script below and reload the TW page<BR><BR>"
	

						+ "<div style='text-align: center;overflow: 

auto; height: 165px;font-size:15px;'>";
								
					
					  var 

langPatchs = TWT.langPatchs;
						$.each(langPatchs, 

function(lang){
							txtArea +=  "<a 

target='_blanck' href='"+langPatchs[lang].link+"'>"+langPatchs[lang].texte+" by " + langPatchs
...
"</div><br>If you want to create your own translation, you can go to <a target=\'_blanck\' 

href=\'https://greasyfork.org/fr/scripts/5379-tw-collections\'> the home page of the script</a> 
...
.appendToContentPane($(
		...
		'<div id="divopts" style="font-weight: bolder;width: 683px;left:10px;" 

class="daily_activity-list"/>')
...
+ "</span>");
	...
	$
			...
			.each(
							...
							TWT.LANG.Options.checkbox_text[key]
...
maj_button = $('<span title="'
									

+ TWT.LANG.Options.update.checknow
								

	+ '" style="background-color: transparent; background-attachment: scroll; background-

clip: border-box;'
									+ 

'background-image: url(./images/interface/character/menuicons.jpg); background-position: 0px -

250px; '
									+ 'cursor: 

pointer;  position: absolute; height: 25px; width: 25px; margin: 4px;" />');
...
['miscellaneous.lang'] = TWT.Options.lang_box
...
UserMessage(TWT.LANG.Options.message.message,
...
.indexOf("locked") > -1),
			...
			if (shoudBuy) {
							...
							if (!isDefined(TWT.MetaCol.group
...
window=achievement&action=get_list&h='
...
TWT.MetaCol.inProgress[$.trim(name)];
							if (!
...
isDefined(item)) {
						...
						} else if (isDefined(TWT.MetaCol.group
				...
				.isChecked('collection.showmiss')) {
					...
					var br = (withbr) ? "<BR>" : " - ";
						...
						var item = TWT.MetaCol.inProgress[$
							...
							var manquants = TWT.MetaCol.group
...
new west.gui.Textfield().maxlength(
...
'game.php?window=shop_trader&mode=index',
...
(data_return);
	...
	traderInv = all["inventory"]["trader"];
					...
					west.window.shop.model._data.inventory.trader = all
...
total = 0;
							...
							var divMain = $("<br /><table 

width='100%' cellpading=10 cellspacing=10  style='font-style: bold; -webkit-user-select: text 

!important; -khtml-user-select: text !important; -moz-user-select: text !important; -ms-user-

select: text !important; user-select: text !important;' />");
...
url(\'/images/window/market/market_icons2.png\') '
			...
			+ 'repeat-x scroll 0 0 transparent;cursor: pointer;'
						...
						+ 'height: 16px; background-position: -16px 

0;display: inline-block;width: 16px;"> </span>');
...
TWT.Injecteur.winTabInjected[e];
...
MarketWindow.DOM).length > 0) {
				...
				$(
							...
							'p.accordion_contentRow:not(:has
...
(.TWDBcollector)):not(:has(.TWDBbuyTip))',
...
('collection.filterMarket');
	...
	.restore('collection.filterMarket');
						...
						// TWT.Injecteur.divsnifferoff('marketplace-
...
src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAACMAAAAjCAYAAAAe2bNZAAAAGXRFWHRTb2Z0d2FyZQBB

ZG9iZSBJbWFnZVJlYWR5ccllPAAAC/tJREFUeNp0WAlUFFcWvVXdTTc0NIuogLiAgsYtJm4kGk3UqMkYM3GiUXN0TDJGj6N

Ro7gko+JuTGLiEhN3x2VwGz1x1MQxQeNKiGCjAm4IAooI0ghN02vVvP
		...
		EventHandler.listen("inventory_ready",
			...
			TWT.Inventaire.addCheckBoxBag, "dblbag");
					...
					EventHandler.unlisten("inventory_ready",
							...
							TWT.Inventaire.addCheckBoxBag, 

"dblbag");
							$('#bagFilterIsCollect', 

Inventory.DOM).remove();
...
iconset tw2gui-icon-dollar' "
									

						+ " src='./images/tw2gui/pixel-vfl3z5WfW.gif' 
...
style="position: relative;background-color: transparent; background-attachment: scroll; 

background-clip: border-box; cursor: pointer; bottom: inherit; " >'
				

							+ '<img  

src="./images/items/recipe/recipe_smith.png" width="20px" height="20px" /></span>');
...
TWT.LANG.Doublons.tipsets
		...
		+ '" id="inventory_sets"'
				...
				+ '" style="cursor: pointer; position: relative; margin-right: 
...
((montant * tauxPourc) / 100);
							var txtFrais = 

TWT.LANG.fees.tipText.replace('%1',
...
".window_AllReportsDelete .window_inside { width:540px; position:absolute; left:5px; top:2px; 
...
".window_AllReportsDelete .cell_what { width:170px; } "
			...
			+ ".window_AllReportsDelete .tbody .cell_what { padding-left:6px; } 

.window_AllReportsDelete .tbody .row { left:0px; }"
						

			+ ".window_AllReportsDelete .cell_progress { text-align:center; 
...
href='javascript:TWT.AllReportsDelete.init();'>"
...
TWT.LANG.AllReportsDelete.button
						...
						TWT.AllReportsDelete.attachedFunction = 
...
var j = 0; j < data_return['reports'].length; j++) {
...
(data_return['reports'][j]['report_id']);
...
'game.php?window=reports&action=delete_reports&h='
...
"<div style='text-align:right;padding-right: 5px; padding-top: 15px;'><a href=

\"javascript:MessagesWindow.open(\'telegram\', {insert_to: \'Dun\'})\">by Dun</a></div>";
	...
	return "<div style='text-align:right;padding-right: 5px; padding-top: 15px;'><a href=

\"javascript:MessagesWindow.open(\'telegram\', {insert_to: \'Duncol\'})\">by Dun</a></div>";
...
TheWestApi.register('TW_Collections',
...
'TW Collections', TWT.info.min_gameversion,
	...
	'https://greasyfork.org/scripts/5379-tw-collections');
	...
	TWApi
								...
								"<div id='twtApiContent' 

style=' font-family: comic sans ms;font-size: 12pt;padding-top: 10px;text-align: right;'>"
...
"https://greasyfork.org/de/scripts/1669/code.user.js",
...
(ScriptUpdater.scriptStorage == null) {
...
ScriptUpdater.scriptStorage = new Storage("local",
			...
			"ScriptUpdater." + scriptId);
						...
						ScriptUpdater.scriptStorage.setItem(key, 
...
ScriptUpdater.scriptStorage.getItem(key,
...
var strLang = "";
							console.log("Check TW 

Collection language update")
							$
...
ScriptUpdater.scrnv[language.script]) {
...
d'affichage des mises a jour<BR><BR>"
...
ScriptUpdater.scrnv['news']
									

		|| '';
									var 

parent = new west.gui.Dialog(
...
[ScriptUpdater.scriptId]
				...
				+ "<div id='boxnews' style='margin-top:20px;font-
...
"https://greasyfork.org/scripts/5379-tw-collections/code/TW-Collections.user.js"
...
ScriptUpdater.getValue("lastCheck", 0);
					},
...
interval = ScriptUpdater.getValue("interval",
...
(ScriptUpdater.getInterval() > 1) {
							if 

((date.getTime() - ScriptUpdater.getLastCheck()) > ScriptUpdater
