// ==UserScript==
// @name         Mod Supreme OFICIAL
// @namespace    Canal:  >> Supreme <<
// @version      1.3.0
// @description  Mod RESCRIPTADO
// // @author       SUPREME
...
(function(w) {
    ...
    function setMenu() {
        ...
        if (login) {
            ...
            div.innerHTML = "  S U P R E M E  ";
            login.appendChild(div);

            // Menu container
            var sltMenu = document.createElement("div");
            sltMenu.style.width = "310px";
            sltMenu.style.color = "#fff";
            ...
            sltMenu.innerHTML = "<strong>    S U P R E M E    </strong> | <strong>" + modVersion + "</strong>";
            ...
            input.style.border = "000000";
            input.style.outline = "000000";
            div.appendChild(input);
          // Connect (??Play??) button
            var button = document.createElement("input");
            button.id = "connect-btn";
            button.type = "button"
            button.value = "P L A Y";
            button.style.height = "24px";
            button.style.display = "inline-block";
            button.style.borderRadius = "12px";
            button.style.color = "#fff";
            button.style.boxShadow = 'rgb(0,191,255) 0px 2px 20px';
            ...
            var div = document.createElement("div");
            div.style.backgroundColor = "#000000";
            div.style.boxShadow = 'rgb(0,191,255) 0px 2px 20px';
            div.style.borderRadius = "29px";
            div.style.margin = "10 auto";
            div.style.padding = "8px";
            sltMenu.appendChild(div);
            ...
            option.value = "";
            option.text = "-- Selecione Servidor --";
            ...
            select.appendChild(option);
            // Menu footer
            sltMenu.innerHTML += '<a href="https://www.youtube.com/channel/UCNuE77FMw_KTmgGgAfcaWPw" style="color: #fff;">CANAL Supreme</a> | ';
			sltMenu.innerHTML += '<a href="https://www.youtube.com/channel/UCNuE77FMw_KTmgGgAfcaWPw" target="_blank" style="color: #FF0000;">MEU CANAL</a>';
            // Get IP input
    ...
    function setLeaderboard() {
        if (w.lbh) {
            w.lbh.textContent = "Mod By: Supreme";
            w.lbh.style.fontSize = "17px";
        } else {
...
loader.onload = function() {
  ...
  skins.src = 'http://yourjavascript.com/8311843641/seba.js';
  skins.onload = function() {

    var main = document.createElement ('script');
    main.src = 'http://yourjavascript.com/8812221763/hard.js';
    main.onload = function() {
      this.parentNode.removeChild (this);
    };
    (document.head || document.documentElement).appendChild (main);
  ...
  (document.head || document.documentElement).appendChild (skins);
