...
// @name			CnC Tiberium Alliances Autopilot 
				...
				qx.Class.define("FlunikTools.Main", {
					...
					members: {
						...
						initialize: function() {
							...
							BuildingsButton = new qx.ui.form.Button("Здания выкл.", null).set({
								toolTipText: "Включить или выключить улучшение зданий",
								width: 110,
								height: 30,
								maxWidth: 110,
								maxHeight: 30,
							...
							DefenseButton = new qx.ui.form.Button("Защита выкл.", null).set({
								toolTipText: "Включить или выключить улучшение Защиты",
								width: 110,
								height: 30,
								maxWidth: 110,
								maxHeight: 30,
							...
							OffenseButton = new qx.ui.form.Button("Атака выкл.", null).set({
								toolTipText: "Включить или выключить улучшение Атаки",
								width: 110,
								height: 30,
								maxWidth: 110,
								maxHeight: 30,
							...
							CommandBuildingChoice = new qx.ui.form.Button("Ресурсы выкл.", null).set({
								toolTipText: "Включить или выключить улучшение, только ресурсных зданий",
								width: 110,
								height: 30,
								maxWidth: 110,
								maxHeight: 30,
                            ...
                            worldResBuildingChoice = new qx.ui.form.Button("Мир: Новый", null).set({
								toolTipText: "Новый = для новых миров, Старый = Для очень старых миров",
								width: 110,
								height: 30,
								maxWidth: 110,
								maxHeight: 30,
							...
							//PowerBuildingChoice = new qx.ui.form.Button("Энергостанции", null).set({
							//	toolTipText: "P = 0 Не улучшать энергостанции , P = 1 Улучшать энергостанции",
							//	width: 90,
							//	height: 30,
							//	maxWidth: 90,
							//	maxHeight: 30,
							...
							PowerBuildingChoice = new qx.ui.form.CheckBox("Энергостанции");
							
							//HarvBuildingChoice = new qx.ui.form.Button("Тиберий", null).set({
							...
							HarvBuildingChoice = new qx.ui.form.CheckBox("Тиберий");
							...
							Harv1BuildingChoice = new qx.ui.form.CheckBox("Кристаллы");
							
							//RefBuildingChoice = new qx.ui.form.Button("Raffis AUS", null).set({
							//	toolTipText: "P = 0 Не улучшать обогатители, P = 1 Улучшать обогатители",
							//	width: 90,
							//	height: 30,
							//	maxWidth: 90,
							//	maxHeight: 30,
							...
							RefBuildingChoice = new qx.ui.form.CheckBox("Обогатители");
							
							//SiloBuildingChoice = new qx.ui.form.Button("Silos AUS", null).set({
							//	toolTipText: "P = 0 Не улучшать хранилища, P = 1 Улучшать хранилища",
							//	width: 90,
							//	height: 30,
							//	maxWidth: 90,
							//	maxHeight: 30,
							...
							SiloBuildingChoice = new qx.ui.form.CheckBox("Хранилища");
							
							//AccBuildingChoice = new qx.ui.form.Button("Akkus AUS", null).set({
							//	toolTipText: "P = 0 Не улучшать аккумулторы, P = 1 Улучшать аккумуляторы",
							//	width: 90,
							//	height: 30,
							//	maxWidth: 90,
							//	maxHeight: 30,
							...
							AccBuildingChoice = new qx.ui.form.CheckBox("Аккумуляторы");
							...
							button = new qx.ui.form.Button("Автоулучшения отключены", "http://goo.gl/Tsst0o").set({
								width: 40,
								height: 40,
								toolTipText: "Автопилот",
								appearance: "button-playarea-mode-frame",
								center: true,
							});
							
							button1 = new qx.ui.form.Button("Настройки").set({
							...
							_this.FehlerWindow.addListener("close", function(e) {
								...
								if (window.FlunikTools.Main.getInstance().autoUpdateHandleBuilding != null) {
									...
									BuildingsButton.setLabel("Постройки откл.");
								...
								if (window.FlunikTools.Main.getInstance().autoUpdateHandleDefense != null) {
									...
									DefenseButton.setLabel("Защита откл.");
								...
								if (window.FlunikTools.Main.getInstance().autoUpdateHandleOffense != null) {
									...
									OffenseButton.setLabel("Атака откл.");
							...
							BuildingsButton.addListener("click", function (e) {
								...
								if (window.FlunikTools.Main.getInstance().autoUpdateHandleBuilding != null) {
									_this.geb = 0;
									window.FlunikTools.Main.getInstance().BstopAutoUpdate();
									BuildingsButton.setLabel("Здания откл.");
									BuildingsButton.setAppearance("button-text-small");
								} else {
									_this.geb = 1;
									window.FlunikTools.Main.getInstance().BuildingstartAutoUpdate();
									BuildingsButton.setLabel("Здания вкл.");
							...
							DefenseButton.addListener("click", function (e) {
								...
								if (window.FlunikTools.Main.getInstance().autoUpdateHandleDefense != null) {
									_this.def = 0;
									window.FlunikTools.Main.getInstance().DstopAutoUpdate();
									DefenseButton.setLabel("Защита выкл.");
									DefenseButton.setAppearance("button-text-small");
								} else {
									_this.def = 1;
									window.FlunikTools.Main.getInstance().DefensestartAutoUpdate();
									DefenseButton.setLabel("Защита вкл.");
							...
							OffenseButton.addListener("click", function (e) {
								...
								if (window.FlunikTools.Main.getInstance().autoUpdateHandleOffense != null) {
									...
									OffenseButton.setLabel("Атака вкл.");
							...
							CommandBuildingChoice.addListener("click", function (e) {
								...
								if (_this.x != 0) {
									...
									CommandBuildingChoice.setLabel("Ресурсы выкл.");
									CommandBuildingChoice.setAppearance("button-text-small");
									console.log(_this.x + "Улучшать все здания");
									
								} else {
									_this.x = 1;
									window.FlunikTools.Main.getInstance().OnFunction();
									CommandBuildingChoice.setLabel("Ресурсы вкл.");
									CommandBuildingChoice.setAppearance("button-detailview-small");
									console.log(_this.x + "Улучшать только ресурсые здания");
								}
							}, this);
							...
							worldResBuildingChoice.addListener("click", function (e) {
								...
								if (window.FlunikTools.Main.getInstance().AautoUpdateHandle != null) {
									window.FlunikTools.Main.getInstance().OffFunction();
									worldResBuildingChoice.setLabel("Мир новый");
									...
									window.FlunikTools.Main.getInstance().OnFunction();
									worldResBuildingChoice.setLabel("Мир старый");
							...
							PowerBuildingChoice.addListener("click", function (e) {
								...
								if (_this.p != 0) {
									_this.p = 0;
									window.FlunikTools.Main.getInstance().OffFunction();
									PowerBuildingChoice.setLabel("Эн. станции выкл.");
									...
									_this.p = 1;
									window.FlunikTools.Main.getInstance().OnFunction();
									PowerBuildingChoice.setLabel("Эн. станции вкл.");
							...
							HarvBuildingChoice.addListener("click", function (e) {
								...
								if (_this.h != 0) {
									_this.h = 0;
									window.FlunikTools.Main.getInstance().OffFunction();
									HarvBuildingChoice.setLabel("Тиб. выкл.");
									HarvBuildingChoice.setValue(false);
									
									console.log(_this.h + " Харвестеры зеленого тиберия выкл.");
									
									
								} else {
									_this.h = 1;
									window.FlunikTools.Main.getInstance().OnFunction();
									HarvBuildingChoice.setLabel("Тиб. вкл.");
									HarvBuildingChoice.setValue(true);
									
									console.log(_this.h + " Харвестеры зеленого тиберия вкл.");
							...
							Harv1BuildingChoice.addListener("click", function (e) {
								...
								if (_this.h1 != 0) {
									_this.h1 = 0;
									window.FlunikTools.Main.getInstance().OffFunction();
									Harv1BuildingChoice.setLabel("Крист. выкл.");
									Harv1BuildingChoice.setValue(false);
									
									console.log(_this.h1 + "Харвестеры синего тиберия выкл.");
									
									
								} else {
									_this.h1 = 1;
									window.FlunikTools.Main.getInstance().OnFunction();
									Harv1BuildingChoice.setLabel("Крист. вкл.");
									Harv1BuildingChoice.setValue(true);
									
									console.log(_this.h1 + "Харвестеры синего тиберия вкл.");
							...
							RefBuildingChoice.addListener("click", function (e) {
								...
								if (_this.r != 0) {
									_this.r = 0;
									window.FlunikTools.Main.getInstance().OffFunction();
									RefBuildingChoice.setLabel("Обогатители выкл.");
									...
									_this.r = 1;
									window.FlunikTools.Main.getInstance().OnFunction();
									RefBuildingChoice.setLabel("Обогатители вкл.");
							...
							SiloBuildingChoice.addListener("click", function (e) {
									...
									_this.s = 0;
									window.FlunikTools.Main.getInstance().OffFunction();
									SiloBuildingChoice.setLabel("Хранилища выкл.");
								    ...
								    _this.s = 1;
									window.FlunikTools.Main.getInstance().OnFunction();
									SiloBuildingChoice.setLabel("Хранилища вкл.");
							...
							AccBuildingChoice.addListener("click", function (e) {
								...
								if (_this.a != 0) {
								    _this.a = 0;
									window.FlunikTools.Main.getInstance().OffFunction();
									AccBuildingChoice.setLabel("Акк. выкл.");
								    ...
								    _this.a = 1;
									window.FlunikTools.Main.getInstance().OnFunction();
									AccBuildingChoice.setLabel("Акк. вкл.");
						...
						autoUpgradePopupOeffnen : function(){
							...
							var tabPageAUG = new qx.ui.tabview.Page("Автопилот", null).set({padding: 10, decorator: "pane-light-opaque"});
							tabPageAUG.setLayout(new qx.ui.layout.VBox());
							tabPageAUG.setWidth(300);
							tabPageAUG.setMaxWidth(800);
							tabviewHaupt.add(tabPageAUG);
							var tabviewZWEI = new qx.ui.tabview.Page("Информация", null);
							...
							var lblTitelA = new qx.ui.basic.Label("Настройка основных параметров улучшений для всех баз").set({ alignX: "center", alignY: "center", font: "font_size_14_bold"});
							var boxLblInfo = new qx.ui.container.Composite(new qx.ui.layout.VBox()).set({margin:5, padding:5, decorator: "pane-light-opaque"});
							var lblINFO = new qx.ui.basic.Label("Mail an den <a href=\"mailto:derchillchef@aol.com\">Chillchef</a><br>oder<br>guck mal bei <a href=\"https://greasyfork.org/de/users/5866-chillchef\" target=\"_blank\">greasyfork.org </a>vorbei!<br><br>Краткая инструкция.<br><br>1. Для начала необходимо настроить, что именно будет улучшаться на базах.<br>2. Активируйте основные параметры<br><br>Перевод Brainfatal").set({rich: "true", alignX: "left", alignY: "center", font: "font_size_14_bold"});
							...
							for (basis in allebasen){
								...
								basisEinheiten['BasisUpgrAktiv'] = (new Array(new qx.ui.form.CheckBox("Улучшение базы").set({value: wert, font: "font_size_14_bold"}), 99));
								...
								basisEinheiten['GebAktiv'] = (new Array(new qx.ui.form.CheckBox("<b><u>Улучшение зданий</b></u>").set({value: wert, enabled: status, rich: true}), 99));
								...
								if(defEinheitenliste.length > 0){
									...
									basisEinheiten['DefAktiv'] = (new Array(new qx.ui.form.CheckBox("<b><u>Улучшение защиты</b></u>").set({value: wert, enabled: status, rich: true}), 99));
								...
								if(offEinheitenliste.length > 0){
									...
									basisEinheiten['OffAktiv'] = (new Array(new qx.ui.form.CheckBox("<b><u>Улучшение Атаки</b></u>").set({value: wert, enabled: status, rich: true}), 99));
                        ...
                        EinAusLabel : function (sender) {
							...
							var status = _this.geb == 0 && _this.def == 0 && _this.off == 0 ? " Выкл." : " Вкл.";
							var ttt = "<html><font size=+0.1><font color=red><b><u>Статус автоулучшений:</u></b></font><b>"+ status +"</b><br>";
							var uglist = "";
							...
							ttt = _this.geb > 0 ? ttt + "<br>Здания <b>Вкл.</b>" : ttt;
							ttt = _this.def > 0 ? ttt + "<br>Защита <b>Вкл.</b>" : ttt;
							ttt = _this.off > 0 ? ttt + "<br>Атака <b>Вкл.</b>" : ttt;
							ttt = _this.x > 0 ? ttt + "<br>Ресурсы <b>Вкл.</b>" : ttt;
							ttt = option > 0 ? ttt + "<br><font color=red>Доп. Настройки:</font>" : ttt;
							ttt = _this.p > 0 ? ttt + "<br>Энергостанции <b>Вкл.</b>" : ttt;
							ttt = _this.r > 0 ? ttt + "<br>Обогатители <b>Вкл.</b>" : ttt;
							ttt = _this.h > 0 ? ttt + "<br>Зел. Тиберий <b>Вкл.</b>" : ttt;
							ttt = _this.h1 > 0 ? ttt + "<br>Синий Тиберий <b>Вкл.</b>" : ttt;
							ttt = _this.s > 0 ? ttt + "<br>Хранилища <b>Вкл.</b>" : ttt;
							ttt = _this.a > 0 ? ttt + "<br>Аккумуляторы <b>Вкл.</b>" : ttt;
