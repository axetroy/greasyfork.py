				...
				qx.Class.define("FlunikTools.Main", {
					...
					members: {
						...
						initialize: function() {
							...
							BuildingsButton = new qx.ui.form.Button("Ð—Ð´Ð°Ð½Ð¸Ñ Ð²Ñ‹ÐºÐ».", null).set({
								toolTipText: "Ð’ÐºÐ»ÑŽÑ‡Ð¸Ñ‚ÑŒ Ð¸Ð»Ð¸ Ð²Ñ‹ÐºÐ»ÑŽÑ‡Ð¸Ñ‚ÑŒ ÑƒÐ»ÑƒÑ‡ÑˆÐµÐ½Ð¸Ðµ Ð·Ð´Ð°Ð½Ð¸Ð¹",
								width: 110,
								height: 30,
								maxWidth: 110,
								maxHeight: 30,
							...
							DefenseButton = new qx.ui.form.Button("Ð—Ð°Ñ‰Ð¸Ñ‚Ð° Ð²Ñ‹ÐºÐ».", null).set({
								toolTipText: "Ð’ÐºÐ»ÑŽÑ‡Ð¸Ñ‚ÑŒ Ð¸Ð»Ð¸ Ð²Ñ‹ÐºÐ»ÑŽÑ‡Ð¸Ñ‚ÑŒ ÑƒÐ»ÑƒÑ‡ÑˆÐµÐ½Ð¸Ðµ Ð—Ð°Ñ‰Ð¸Ñ‚Ñ‹",
								width: 110,
								height: 30,
								maxWidth: 110,
								maxHeight: 30,
							...
							OffenseButton = new qx.ui.form.Button("ÐÑ‚Ð°ÐºÐ° Ð²Ñ‹ÐºÐ».", null).set({
								toolTipText: "Ð’ÐºÐ»ÑŽÑ‡Ð¸Ñ‚ÑŒ Ð¸Ð»Ð¸ Ð²Ñ‹ÐºÐ»ÑŽÑ‡Ð¸Ñ‚ÑŒ ÑƒÐ»ÑƒÑ‡ÑˆÐµÐ½Ð¸Ðµ ÐÑ‚Ð°ÐºÐ¸",
								width: 110,
								height: 30,
								maxWidth: 110,
								maxHeight: 30,
							...
							CommandBuildingChoice = new qx.ui.form.Button("Ð ÐµÑÑƒÑ€ÑÑ‹ Ð²Ñ‹ÐºÐ».", null).set({
								toolTipText: "Ð’ÐºÐ»ÑŽÑ‡Ð¸Ñ‚ÑŒ Ð¸Ð»Ð¸ Ð²Ñ‹ÐºÐ»ÑŽÑ‡Ð¸Ñ‚ÑŒ ÑƒÐ»ÑƒÑ‡ÑˆÐµÐ½Ð¸Ðµ, Ñ‚Ð¾Ð»ÑŒÐºÐ¾ Ñ€ÐµÑÑƒÑ€ÑÐ½Ñ‹Ñ… Ð·Ð´Ð°Ð½Ð¸Ð¹",
								width: 110,
								height: 30,
								maxWidth: 110,
								maxHeight: 30,
                            ...
                            worldResBuildingChoice = new qx.ui.form.Button("ÐœÐ¸Ñ€: ÐÐ¾Ð²Ñ‹Ð¹", null).set({
								toolTipText: "ÐÐ¾Ð²Ñ‹Ð¹ = Ð´Ð»Ñ Ð½Ð¾Ð²Ñ‹Ñ… Ð¼Ð¸Ñ€Ð¾Ð², Ð¡Ñ‚Ð°Ñ€Ñ‹Ð¹ = Ð”Ð»Ñ Ð¾Ñ‡ÐµÐ½ÑŒ ÑÑ‚Ð°Ñ€Ñ‹Ñ… Ð¼Ð¸Ñ€Ð¾Ð²",
								width: 110,
								height: 30,
								maxWidth: 110,
								maxHeight: 30,
							...
							//PowerBuildingChoice = new qx.ui.form.Button("Ð­Ð½ÐµÑ€Ð³Ð¾ÑÑ‚Ð°Ð½Ñ†Ð¸Ð¸", null).set({
							//	toolTipText: "P = 0 ÐÐµ ÑƒÐ»ÑƒÑ‡ÑˆÐ°Ñ‚ÑŒ ÑÐ½ÐµÑ€Ð³Ð¾ÑÑ‚Ð°Ð½Ñ†Ð¸Ð¸ , P = 1 Ð£Ð»ÑƒÑ‡ÑˆÐ°Ñ‚ÑŒ ÑÐ½ÐµÑ€Ð³Ð¾ÑÑ‚Ð°Ð½Ñ†Ð¸Ð¸",
							//	width: 90,
							//	height: 30,
							//	maxWidth: 90,
							//	maxHeight: 30,
							...
							PowerBuildingChoice = new qx.ui.form.CheckBox("Ð­Ð½ÐµÑ€Ð³Ð¾ÑÑ‚Ð°Ð½Ñ†Ð¸Ð¸");
							
							//HarvBuildingChoice = new qx.ui.form.Button("Ð¢Ð¸Ð±ÐµÑ€Ð¸Ð¹", null).set({
							...
							HarvBuildingChoice = new qx.ui.form.CheckBox("Ð¢Ð¸Ð±ÐµÑ€Ð¸Ð¹");
							...
							Harv1BuildingChoice = new qx.ui.form.CheckBox("ÐšÑ€Ð¸ÑÑ‚Ð°Ð»Ð»Ñ‹");
							
							//RefBuildingChoice = new qx.ui.form.Button("Raffis AUS", null).set({
							//	toolTipText: "P = 0 ÐÐµ ÑƒÐ»ÑƒÑ‡ÑˆÐ°Ñ‚ÑŒ Ð¾Ð±Ð¾Ð³Ð°Ñ‚Ð¸Ñ‚ÐµÐ»Ð¸, P = 1 Ð£Ð»ÑƒÑ‡ÑˆÐ°Ñ‚ÑŒ Ð¾Ð±Ð¾Ð³Ð°Ñ‚Ð¸Ñ‚ÐµÐ»Ð¸",
							//	width: 90,
							//	height: 30,
							//	maxWidth: 90,
							//	maxHeight: 30,
							...
							RefBuildingChoice = new qx.ui.form.CheckBox("ÐžÐ±Ð¾Ð³Ð°Ñ‚Ð¸Ñ‚ÐµÐ»Ð¸");
							
							//SiloBuildingChoice = new qx.ui.form.Button("Silos AUS", null).set({
							//	toolTipText: "P = 0 ÐÐµ ÑƒÐ»ÑƒÑ‡ÑˆÐ°Ñ‚ÑŒ Ñ…Ñ€Ð°Ð½Ð¸Ð»Ð¸Ñ‰Ð°, P = 1 Ð£Ð»ÑƒÑ‡ÑˆÐ°Ñ‚ÑŒ Ñ…Ñ€Ð°Ð½Ð¸Ð»Ð¸Ñ‰Ð°",
							//	width: 90,
							//	height: 30,
							//	maxWidth: 90,
							//	maxHeight: 30,
							...
							SiloBuildingChoice = new qx.ui.form.CheckBox("Ð¥Ñ€Ð°Ð½Ð¸Ð»Ð¸Ñ‰Ð°");
							
							//AccBuildingChoice = new qx.ui.form.Button("Akkus AUS", null).set({
							//	toolTipText: "P = 0 ÐÐµ ÑƒÐ»ÑƒÑ‡ÑˆÐ°Ñ‚ÑŒ Ð°ÐºÐºÑƒÐ¼ÑƒÐ»Ñ‚Ð¾Ñ€Ñ‹, P = 1 Ð£Ð»ÑƒÑ‡ÑˆÐ°Ñ‚ÑŒ Ð°ÐºÐºÑƒÐ¼ÑƒÐ»ÑÑ‚Ð¾Ñ€Ñ‹",
							//	width: 90,
							//	height: 30,
							//	maxWidth: 90,
							//	maxHeight: 30,
							...
							AccBuildingChoice = new qx.ui.form.CheckBox("ÐÐºÐºÑƒÐ¼ÑƒÐ»ÑÑ‚Ð¾Ñ€Ñ‹");
							...
							button = new qx.ui.form.Button("ÐÐ²Ñ‚Ð¾ÑƒÐ»ÑƒÑ‡ÑˆÐµÐ½Ð¸Ñ Ð¾Ñ‚ÐºÐ»ÑŽÑ‡ÐµÐ½Ñ‹", "http://goo.gl/Tsst0o").set({
								width: 40,
								height: 40,
								toolTipText: "ÐÐ²Ñ‚Ð¾Ð¿Ð¸Ð»Ð¾Ñ‚",
								appearance: "button-playarea-mode-frame",
								center: true,
							});
							
							button1 = new qx.ui.form.Button("ÐÐ°ÑÑ‚Ñ€Ð¾Ð¹ÐºÐ¸").set({
								toolTipText: "ÐÐ°ÑÑ‚Ñ€Ð¾Ð¹ÐºÐ¸",
								width: 90,
								height: 30,
								maxWidth: 90,
								maxHeight: 30,
							...
							_this.FehlerWindow.addListener("close", function(e) {
								...
								if (window.FlunikTools.Main.getInstance().autoUpdateHandleBuilding != null) {
									...
									BuildingsButton.setLabel("ÐŸÐ¾ÑÑ‚Ñ€Ð¾Ð¹ÐºÐ¸ Ð¾Ñ‚ÐºÐ».");
								...
								if (window.FlunikTools.Main.getInstance().autoUpdateHandleDefense != null) {
									...
									DefenseButton.setLabel("Ð—Ð°Ñ‰Ð¸Ñ‚Ð° Ð¾Ñ‚ÐºÐ».");
								...
								if (window.FlunikTools.Main.getInstance().autoUpdateHandleOffense != null) {
									...
									OffenseButton.setLabel("ÐÑ‚Ð°ÐºÐ° Ð¾Ñ‚ÐºÐ».");
							...
							BuildingsButton.addListener("click", function (e) {
								...
								if (window.FlunikTools.Main.getInstance().autoUpdateHandleBuilding != null) {
									_this.geb = 0;
									window.FlunikTools.Main.getInstance().BstopAutoUpdate();
									BuildingsButton.setLabel("Ð—Ð´Ð°Ð½Ð¸Ñ Ð¾Ñ‚ÐºÐ».");
									BuildingsButton.setAppearance("button-text-small");
								} else {
									_this.geb = 1;
									window.FlunikTools.Main.getInstance().BuildingstartAutoUpdate();
									BuildingsButton.setLabel("Ð—Ð´Ð°Ð½Ð¸Ñ Ð²ÐºÐ».");
							...
							DefenseButton.addListener("click", function (e) {
								...
								if (window.FlunikTools.Main.getInstance().autoUpdateHandleDefense != null) {
									...
									DefenseButton.setLabel("Ð—Ð°Ñ‰Ð¸Ñ‚Ð° Ð²ÐºÐ».");
							...
							OffenseButton.addListener("click", function (e) {
								...
								if (window.FlunikTools.Main.getInstance().autoUpdateHandleOffense != null) {
									...
									OffenseButton.setLabel("ÐÑ‚Ð°ÐºÐ° Ð²ÐºÐ».");
							...
							CommandBuildingChoice.addListener("click", function (e) {
								...
								if (_this.x != 0) {
									...
									CommandBuildingChoice.setLabel("Ð ÐµÑÑƒÑ€ÑÑ‹ Ð²Ñ‹ÐºÐ».");
									CommandBuildingChoice.setAppearance("button-text-small");
									console.log(_this.x + "Ð£Ð»ÑƒÑ‡ÑˆÐ°Ñ‚ÑŒ Ð²ÑÐµ Ð·Ð´Ð°Ð½Ð¸Ñ");
									
								} else {
									_this.x = 1;
									window.FlunikTools.Main.getInstance().OnFunction();
									CommandBuildingChoice.setLabel("Ð ÐµÑÑƒÑ€ÑÑ‹ Ð²ÐºÐ».");
									CommandBuildingChoice.setAppearance("button-detailview-small");
									console.log(_this.x + "Ð£Ð»ÑƒÑ‡ÑˆÐ°Ñ‚ÑŒ Ñ‚Ð¾Ð»ÑŒÐºÐ¾ Ñ€ÐµÑÑƒÑ€ÑÑ‹Ðµ Ð·Ð´Ð°Ð½Ð¸Ñ");
								}
							}, this);
							...
							worldResBuildingChoice.addListener("click", function (e) {
								...
								if (window.FlunikTools.Main.getInstance().AautoUpdateHandle != null) {
									window.FlunikTools.Main.getInstance().OffFunction();
									worldResBuildingChoice.setLabel("ÐœÐ¸Ñ€ Ð½Ð¾Ð²Ñ‹Ð¹");
									...
									window.FlunikTools.Main.getInstance().OnFunction();
									worldResBuildingChoice.setLabel("ÐœÐ¸Ñ€ ÑÑ‚Ð°Ñ€Ñ‹Ð¹");
							...
							PowerBuildingChoice.addListener("click", function (e) {
								...
								if (_this.p != 0) {
									_this.p = 0;
									window.FlunikTools.Main.getInstance().OffFunction();
									PowerBuildingChoice.setLabel("Ð­Ð½. ÑÑ‚Ð°Ð½Ñ†Ð¸Ð¸ Ð²Ñ‹ÐºÐ».");
									...
									_this.p = 1;
									window.FlunikTools.Main.getInstance().OnFunction();
									PowerBuildingChoice.setLabel("Ð­Ð½. ÑÑ‚Ð°Ð½Ñ†Ð¸Ð¸ Ð²ÐºÐ».");
							...
							HarvBuildingChoice.addListener("click", function (e) {
								...
								if (_this.h != 0) {
									_this.h = 0;
									window.FlunikTools.Main.getInstance().OffFunction();
									HarvBuildingChoice.setLabel("Ð¢Ð¸Ð±. Ð²Ñ‹ÐºÐ».");
									HarvBuildingChoice.setValue(false);
									
									console.log(_this.h + " Ð¥Ð°Ñ€Ð²ÐµÑÑ‚ÐµÑ€Ñ‹ Ð·ÐµÐ»ÐµÐ½Ð¾Ð³Ð¾ Ñ‚Ð¸Ð±ÐµÑ€Ð¸Ñ Ð²Ñ‹ÐºÐ».");
									
									
								} else {
									_this.h = 1;
									window.FlunikTools.Main.getInstance().OnFunction();
									HarvBuildingChoice.setLabel("Ð¢Ð¸Ð±. Ð²ÐºÐ».");
									HarvBuildingChoice.setValue(true);
									
									console.log(_this.h + " Ð¥Ð°Ñ€Ð²ÐµÑÑ‚ÐµÑ€Ñ‹ Ð·ÐµÐ»ÐµÐ½Ð¾Ð³Ð¾ Ñ‚Ð¸Ð±ÐµÑ€Ð¸Ñ Ð²ÐºÐ».");
							...
							Harv1BuildingChoice.addListener("click", function (e) {
								...
								if (_this.h1 != 0) {
									_this.h1 = 0;
									window.FlunikTools.Main.getInstance().OffFunction();
									Harv1BuildingChoice.setLabel("ÐšÑ€Ð¸ÑÑ‚. Ð²Ñ‹ÐºÐ».");
									Harv1BuildingChoice.setValue(false);
									
									console.log(_this.h1 + "Ð¥Ð°Ñ€Ð²ÐµÑÑ‚ÐµÑ€Ñ‹ ÑÐ¸Ð½ÐµÐ³Ð¾ Ñ‚Ð¸Ð±ÐµÑ€Ð¸Ñ Ð²Ñ‹ÐºÐ».");
									
									
								} else {
									_this.h1 = 1;
									window.FlunikTools.Main.getInstance().OnFunction();
									Harv1BuildingChoice.setLabel("ÐšÑ€Ð¸ÑÑ‚. Ð²ÐºÐ».");
									Harv1BuildingChoice.setValue(true);
									
									console.log(_this.h1 + "Ð¥Ð°Ñ€Ð²ÐµÑÑ‚ÐµÑ€Ñ‹ ÑÐ¸Ð½ÐµÐ³Ð¾ Ñ‚Ð¸Ð±ÐµÑ€Ð¸Ñ Ð²ÐºÐ».");
							...
							RefBuildingChoice.addListener("click", function (e) {
								...
								if (_this.r != 0) {
									_this.r = 0;
									window.FlunikTools.Main.getInstance().OffFunction();
									RefBuildingChoice.setLabel("ÐžÐ±Ð¾Ð³Ð°Ñ‚Ð¸Ñ‚ÐµÐ»Ð¸ Ð²Ñ‹ÐºÐ».");
									...
									_this.r = 1;
									window.FlunikTools.Main.getInstance().OnFunction();
									RefBuildingChoice.setLabel("ÐžÐ±Ð¾Ð³Ð°Ñ‚Ð¸Ñ‚ÐµÐ»Ð¸ Ð²ÐºÐ».");
							...
							SiloBuildingChoice.addListener("click", function (e) {
									...
									_this.s = 0;
									window.FlunikTools.Main.getInstance().OffFunction();
									SiloBuildingChoice.setLabel("Ð¥Ñ€Ð°Ð½Ð¸Ð»Ð¸Ñ‰Ð° Ð²Ñ‹ÐºÐ».");
								    ...
								    _this.s = 1;
									window.FlunikTools.Main.getInstance().OnFunction();
									SiloBuildingChoice.setLabel("Ð¥Ñ€Ð°Ð½Ð¸Ð»Ð¸Ñ‰Ð° Ð²ÐºÐ».");
							...
							AccBuildingChoice.addListener("click", function (e) {
								...
								if (_this.a != 0) {
								    _this.a = 0;
									window.FlunikTools.Main.getInstance().OffFunction();
									AccBuildingChoice.setLabel("ÐÐºÐº. Ð²Ñ‹ÐºÐ».");
								    ...
								    _this.a = 1;
									window.FlunikTools.Main.getInstance().OnFunction();
									AccBuildingChoice.setLabel("ÐÐºÐº. Ð²ÐºÐ».");
						...
						autoUpgradePopupOeffnen : function(){
							...
							var tabPageAUG = new qx.ui.tabview.Page("ÐÐ²Ñ‚Ð¾Ð¿Ð¸Ð»Ð¾Ñ‚", null).set({padding: 10, decorator: "pane-light-opaque"});
							tabPageAUG.setLayout(new qx.ui.layout.VBox());
							tabPageAUG.setWidth(300);
							tabPageAUG.setMaxWidth(800);
							tabviewHaupt.add(tabPageAUG);
							var tabviewZWEI = new qx.ui.tabview.Page("Ð˜Ð½Ñ„Ð¾Ñ€Ð¼Ð°Ñ†Ð¸Ñ", null);
							...
							var lblTitelA = new qx.ui.basic.Label("ÐÐ°ÑÑ‚Ñ€Ð¾Ð¹ÐºÐ° Ð¾ÑÐ½Ð¾Ð²Ð½Ñ‹Ñ… Ð¿Ð°Ñ€Ð°Ð¼ÐµÑ‚Ñ€Ð¾Ð² ÑƒÐ»ÑƒÑ‡ÑˆÐµÐ½Ð¸Ð¹ Ð´Ð»Ñ Ð²ÑÐµÑ… Ð±Ð°Ð·").set({ alignX: "center", alignY: "center", font: "font_size_14_bold"});
							var boxLblInfo = new qx.ui.container.Composite(new qx.ui.layout.VBox()).set({margin:5, padding:5, decorator: "pane-light-opaque"});
							var lblINFO = new qx.ui.basic.Label("Mail an den <a href=\"mailto:derchillchef@aol.com\">Chillchef</a><br>oder<br>guck mal bei <a href=\"https://greasyfork.org/de/users/5866-chillchef\" target=\"_blank\">greasyfork.org </a>vorbei!<br><br>ÐšÑ€Ð°Ñ‚ÐºÐ°Ñ Ð¸Ð½ÑÑ‚Ñ€ÑƒÐºÑ†Ð¸Ñ.<br><br>1. Ð”Ð»Ñ Ð½Ð°Ñ‡Ð°Ð»Ð° Ð½ÐµÐ¾Ð±Ñ…Ð¾Ð´Ð¸Ð¼Ð¾ Ð½Ð°ÑÑ‚Ñ€Ð¾Ð¸Ñ‚ÑŒ, Ñ‡Ñ‚Ð¾ Ð¸Ð¼ÐµÐ½Ð½Ð¾ Ð±ÑƒÐ´ÐµÑ‚ ÑƒÐ»ÑƒÑ‡ÑˆÐ°Ñ‚ÑŒÑÑ Ð½Ð° Ð±Ð°Ð·Ð°Ñ….<br>2. ÐÐºÑ‚Ð¸Ð²Ð¸Ñ€ÑƒÐ¹Ñ‚Ðµ Ð¾ÑÐ½Ð¾Ð²Ð½Ñ‹Ðµ Ð¿Ð°Ñ€Ð°Ð¼ÐµÑ‚Ñ€Ñ‹<br><br>ÐŸÐµÑ€ÐµÐ²Ð¾Ð´ Brainfatal").set({rich: "true", alignX: "left", alignY: "center", font: "font_size_14_bold"});
							...
							for (basis in allebasen){
								...
								basisEinheiten['BasisUpgrAktiv'] = (new Array(new qx.ui.form.CheckBox("Ð£Ð»ÑƒÑ‡ÑˆÐµÐ½Ð¸Ðµ Ð±Ð°Ð·Ñ‹").set({value: wert, font: "font_size_14_bold"}), 99));
								...
								basisEinheiten['GebAktiv'] = (new Array(new qx.ui.form.CheckBox("<u>Ð£Ð»ÑƒÑ‡ÑˆÐµÐ½Ð¸Ðµ Ð·Ð´Ð°Ð½Ð¸Ð¹</u>").set({value: wert, enabled: status, rich: true}), 99));
								...
								//page.add(new qx.ui.basic.Label('<u>Gebaude:</u>').set({rich: true}),{row: 2, column: 0});
								...
								if(defEinheitenliste.length > 0){
									...
									basisEinheiten['DefAktiv'] = (new Array(new qx.ui.form.CheckBox("<u>Ð£Ð»ÑƒÑ‡ÑˆÐµÐ½Ð¸Ðµ Ð·Ð°Ñ‰Ð¸Ñ‚Ñ‹</u>").set({value: wert, enabled: status, rich: true}), 99));
									...
									//page.add(new qx.ui.basic.Label('<u>Def-Einheiten:</u>').set({rich: true}),{row: reihe, column: 0});
									reihe++;
									spalte = 0;
								...
								if(offEinheitenliste.length > 0){
									...
									basisEinheiten['OffAktiv'] = (new Array(new qx.ui.form.CheckBox("<u>Ð£Ð»ÑƒÑ‡ÑˆÐµÐ½Ð¸Ðµ ÐÑ‚Ð°ÐºÐ¸</u>").set({value: wert, enabled: status, rich: true}), 99));
									...
									//page.add(new qx.ui.basic.Label('<u>Off-Einheiten:</u> ').set({rich: true}),{row: reihe, column: 0});
									reihe++;
									spalte = 0;
							...
							if(_this.timer == true){
								timer.start(function(userData, timerId)
								{
									...
									rangAktuell = rangAktuell == 0 ? "Â±0" : rangAktuell;
									rangdiff = rangdiff > 0 ? "+" + rangdiff : rangdiff;
									rangdiff = rangdiff == 0 ? "Â±0" : rangdiff;
                        ...
                        EinAusLabel : function (sender) {
							...
							var status = _this.geb == 0 && _this.def == 0 && _this.off == 0 ? " Ð’Ñ‹ÐºÐ»." : " Ð’ÐºÐ».";
							var ttt = "<html><font size=+0.1><font color=red><u>Ð¡Ñ‚Ð°Ñ‚ÑƒÑ Ð°Ð²Ñ‚Ð¾ÑƒÐ»ÑƒÑ‡ÑˆÐµÐ½Ð¸Ð¹:</u></font>"+ status +"<br>";
							var uglist = "";
							...
							ttt = _this.geb > 0 ? ttt + "<br>Ð—Ð´Ð°Ð½Ð¸Ñ Ð’ÐºÐ»." : ttt;
							ttt = _this.def > 0 ? ttt + "<br>Ð—Ð°Ñ‰Ð¸Ñ‚Ð° Ð’ÐºÐ»." : ttt;
							ttt = _this.off > 0 ? ttt + "<br>ÐÑ‚Ð°ÐºÐ° Ð’ÐºÐ»." : ttt;
							ttt = _this.x > 0 ? ttt + "<br>Ð ÐµÑÑƒÑ€ÑÑ‹ Ð’ÐºÐ»." : ttt;
							ttt = option > 0 ? ttt + "<br><font color=red>Ð”Ð¾Ð¿. ÐÐ°ÑÑ‚Ñ€Ð¾Ð¹ÐºÐ¸:</font>" : ttt;
							ttt = _this.p > 0 ? ttt + "<br>Ð­Ð½ÐµÑ€Ð³Ð¾ÑÑ‚Ð°Ð½Ñ†Ð¸Ð¸ Ð’ÐºÐ»." : ttt;
							ttt = _this.r > 0 ? ttt + "<br>ÐžÐ±Ð¾Ð³Ð°Ñ‚Ð¸Ñ‚ÐµÐ»Ð¸ Ð’ÐºÐ»." : ttt;
							ttt = _this.h > 0 ? ttt + "<br>Ð—ÐµÐ». Ð¢Ð¸Ð±ÐµÑ€Ð¸Ð¹ Ð’ÐºÐ»." : ttt;
							ttt = _this.h1 > 0 ? ttt + "<br>Ð¡Ð¸Ð½Ð¸Ð¹ Ð¢Ð¸Ð±ÐµÑ€Ð¸Ð¹ Ð’ÐºÐ»." : ttt;
							ttt = _this.s > 0 ? ttt + "<br>Ð¥Ñ€Ð°Ð½Ð¸Ð»Ð¸Ñ‰Ð° Ð’ÐºÐ»." : ttt;
							ttt = _this.a > 0 ? ttt + "<br>ÐÐºÐºÑƒÐ¼ÑƒÐ»ÑÑ‚Ð¾Ñ€Ñ‹ Ð’ÐºÐ»." : ttt;
											...
											katAktiv = _this.upgradeAuswahl[basis]['DefAktiv'][0].getValue();
												...
												if(kat == 'off'){
													katAktiv = _this.upgradeAuswahl[basis]['OffAktiv'][0].getValue();
														...
														console.log('Funktion \'DarfUpgraden\' kat ungultig!');
														katAktiv = false;
													}
											}
									}
                                 ...
                                 //}
								...
								}catch(e)
									{
										...
										if (!_this.FehlerWindow.isVisible()){
											var text = null;
											text = new qx.ui.basic.Label("Ein dummer Fehler ist aufgetreten, frag mich nicht warum :( <br>Beim schlie?en dieses Fensters wird das Upgradetool gestoppt!<br> Warte dann ein paar Sekunden, klick dich mal durch deine Basen <br>und versuche den Autopiloten zu starten. Klappt manchmal ^^<br>ODER mach einfach nen reload ;) <br>MELDUNG:<br>"+ e.toString() +""); 
											text.setRich(true);
