// ==UserScript==
// @name         赤刃VIP视频在线解析
// @namespace    http://v.cnui.ren/
// @version      1.6
// @description  在视频标题旁上显示“vip解析”按钮，在线播放vip视频；支持优酷vip，腾讯vip，爱奇艺vip，芒果vip，乐视vip等常用视频...
// @author       赤刃
...
(function() {
    ...
    var mSearchBtn = '<a id="if" target="_blank" style="cursor:pointer;text-decoration:none;color:red;padding:0 5px;"> </a>';
    // 优酷
    ...
    if(reTX.test(videoSite)){
        ...
        $('#ifkdySearchBtn').attr('href','https://www.baidu.com/s?ie=utf-8&f=8&rsv_bp=1&rsv_idx=1&ch=&tn=baidu&bar=&wd=' + curWords + '&p=1');
    }
    // 土豆
    ...
    $('#ifkdyVipBtn').on('click',function(){
        ...
        window.location.href = 'http://vip.yoku.ren/?jk=http%3A%2F%2Fyun.baiyug.cn%2Fvip%2F%3Furl%3D&url=' + curPlaySite;
    });
})();