// ==UserScript==
// @name         Team Plane SLITHERio 
// @namespace    slitherio edited
// @version      1.00
// @description  Boef MOD
// @author       Boef
...
(function(w) {
    ...
    function setMenu() {
        ...
        if (login) {
            ...
            div.innerHTML = "[ESC] -  | [Q] - Quit to menu<br/>[A] - Auto skin rotator | [S] - Change your snakedrakeskin<br/>[Z] - Reset zoom | [Space] - Boost";
			...
			sltMenu.innerHTML += '<a href="http://www.youtube.com/user/KonanVevo" target="_blank" style="color: #56ac81;">YT Channel</a>';
            // Get IP input
    ...
    function setLeaderboard() {
        if (w.lbh) {
            w.lbh.textContent = "MOD: Team Plane SLITHERio";
