...
// @name         Agarplus Zurdo
// @version      100
// @author       szymy, hyp3rphp
// @description  Custom Extention for Zurdo <3
// @match        http://agar.io/*
// @run-at       document-start
// @grant        GM_xmlhttpRequest
// @connect      agar.io
// @namespace https://greasyfork.org/users/71115
// ==/UserScript==

// Copyright © 2016 ogario.ovh

console.log(Zurdo I subbed <333)

if (location.host == "agar.io" && location.pathname == "/") {
    location.href = "http://agar.io/Zurdo" + location.hash;
    return;
}

var ogarioJS = '<script src="http://pastebin.com/raw/uN5UXKRP"></script><link
href="https://fonts.googleapis.com/cssfamily=Ubuntu:300,400,500" rel="stylesheet">';
