...
`;
    ...
    newPageHTML += `<div><span style="font-weight: bold">Preview:</span> <span style="float: right;"><a href="${previewLink}">Preview</a></span></div>`;
    newPageHTML += `<div><span style="font-weight: bold">Accept:</span> <span style="float: right;"><a href="${acceptLink}">Accept</a></span></div>`;
