// ==UserScript==
// @name        OPENREC.tv Screen Comment Scroller
// @namespace   knoa.jp
...
(function(){
  ...
  /* サイト定義 */
  var site = {
    getScreen:   function(){return document.querySelector('.video-player-wrapper')},
    getBoard:    function(){return document.querySelector('.chat-list-content')},
    getComments: function(node){return node.querySelectorAll('.chat-content')},
    getPlay:     function(){return document.querySelector('[class^="MovieToolbar"] [class^="TextLabel__Wrapper"]')},
