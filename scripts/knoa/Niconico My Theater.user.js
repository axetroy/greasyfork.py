...
(function(){
  ...
  const DEBUG = false;/* 
意図しないショートカットキーの動作を修正しました。動画の差し替え直しや動画ページの遷移に対応しました。
...
# 参考: <a href="https://qa.nicovideo.jp/faq/show/287">ニコニコ標準のショートカットキー</a>
...
# 参考: <a href="https://dic.nicovideo.jp/a/szbh%E6%96%B9%E5%BC%8F">SZBH方式とは (エスゼットビーエイチホウシキとは) [単語記事] - ニコニコ大百科</a>
