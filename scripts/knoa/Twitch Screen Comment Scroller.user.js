...
(function(){
  ...
  var site = {
    ...
    getBoard:    function(){return document.querySelector('.chat-list__lines [role="log"]') || document.querySelector('.video-chat__message-list-wrapper ul')},
  ...
  var core = {
    ...
    initialize: function(){
      ...
      play = site.getPlay();
      video = site.getVideo();
      console.log(screen, board, play, video);
