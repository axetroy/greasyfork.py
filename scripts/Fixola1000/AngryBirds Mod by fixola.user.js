// ==UserScript==
// @name         AngryBirds Mod by fixola
// @namespace    Monstrão.PVP.xD
// @version      1.7.2
// @description  slither.io MOD bots AngryBirds MOD
// @author       Monstrão PVP xD
// @match        http://slither.io/*
// @run-at       document-body
// @grant        none
// ==/UserScript==

// Source: https://greasyfork.org/en/scripts/20221-angrybirds-mod-by-fixola/code

(function(w) {
    var modVersion = "v1.7.2 Extreme Bots",
    ...
    function getConsoleLog(log) {
        ...
        if (log.indexOf("FPS da delicia") != -1) {
            gameFPS = log;
        }
    }
    // Set menu
    function setMenu() {
        ...
        if (login) {
            ...
            div.innerHTML = "[ESC] - faser respawn | [A] - rodador de skin automatico | [S] - selecionar skin | [Z]- Resetar o zoom | [Space] - modo sonic :D |  <strong>DOWNLOAD BOTS FREE DO SITE CHITHER.COM";
            ...
            sltMenu.innerHTML = "MOD: AngryBirds Mod by Monstrão PVP xD</strong> | <strong>" + modVersion + "</strong>";
            ...
            input.id = "server-ip";
            input.type = "text";
            input.placeholder = "ip do server (IP:delicia :o)";
            ...
            option.value = "";
            option.text = "-- Selecionar o server --";
            ...
            var option = document.createElement("option");
            option.value = "3";
            option.text = "Grafico: normal";
            select.appendChild(option);
            var option = document.createElement("option");
            option.value = "2";
            option.text = "Grafico: melhor";
            select.appendChild(option);
            var option = document.createElement("option");
            option.value = "1";
            ...
            select.appendChild(option);
            // Menu footer           
            sltMenu.innerHTML += '<a href="https://www.youtube.com/channel/UCP5o4hr8U_x4xd8zWxhiYZA">Visita O MEU CANAL CILCANDO AQUI</a> | ';
            sltMenu.innerHTML += '<a href="https://www.youtube.com/channel/UCP5o4hr8U_x4xd8zWxhiYZA" target="_blank" style="color: #56ac81;">Canal Youtube</a>';
            // Get IP input
            ...
            getServersList();
            // Set graphic mode
            var selectGraph = document.getElementById("selecionar grafico");
            if (renderMode == 1) {
    ...
    function setLeaderboard() {
        if (w.lbh) {
            w.lbh.textContent = "MOD: BotsHack by Monstrão PVP xD";
	...
	function setHighScore() {
		...
		if (scoreHUD && highScore > 0) {
			scoreHUD.textContent = "Melhor score: " + highScore;
		}
	}
    // Show FPS
    function showFPS() {
