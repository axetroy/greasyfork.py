...
let UID_ARR = new Map();
var COLORS_UID = ["null", "black", "purple", "midnightblue", "darkgoldenrod", "red", "mediumaquamarine", "darkorange", "steelblue", "orange", "lawngreen", "saddlebrown", "forestgreen", "deepskyblue", "blueviolet", "olive", "magenta", "brown", "teal", "darkolivegreen", "lightpink"];
