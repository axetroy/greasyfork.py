...
setTimeout(function() {
    ...
    $( "#canvas" ).after( "<div style='background-color: #0000ff; -moz-opacity: 1; -webkit-border-radius:6px; -moz-border-radius:5px; -khtml-border-radius:10px; -khtml-opacity: 1; opacity: 1; filter: alpha(opacity=40); zoom: 1; width: 205px; top: 10px; left: 10px; display: block; position: absolute; text-align: center; font-size: 15px; color: #FFFF00; padding: 5px; font-family: Ubuntu;'> <div style='color:#FFFF00; display: inline; -moz-opacity:1; -khtml-opacity: 1; opacity:1; filter:alpha(opacity=100); padding: 10px;'><a>EZBOTS.TK</a></div> <div style='color:#ffff00; display: inline; -moz-opacity:1; -khtml-opacity: 1; opacity:1; filter:alpha(opacity=100); padding: 10px;'><br>BOTS: <a id='minionCount' >Offline</a> </div> <div style='color:#ffff00; display: inline; -moz-opacity:1; -khtml-opacity: 1; opacity:1; filter:alpha(opacity=100); padding: 10px;'><br>Controls:<br>On Mouse[A]: <a id='ismoveToMouse' >On</a> </div> <div style='color:#ffff00; display: inline; -moz-opacity:1; -khtml-opacity: 1; opacity:1; filter:alpha(opacity=100); padding: 10px;'><br>Split Bots[E]<br>Eject Bots[R]<br>Stop Move[D]: <a id='isStopMove' >Off</a> </div>");
