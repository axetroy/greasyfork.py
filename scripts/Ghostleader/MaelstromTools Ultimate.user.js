// ==UserScript==
// @name        MaelstromTools Ultimate
// @namespace   MaelstromTools
// @description A compilation of several MaelstromTools. Contained, MaelstromTools Dev (slightly changed), Maelstrom Base Scanner and Maelstrom ADDON City Online Status Colorer.
// @version     0.1.4.4
// @author      Maelstrom, HuffyLuf, KRS_L and Krisan, White X Dragon, Der_Flake, BlinDManX, Tool amalgamation Ghostleader1402
...
(function () {
	var MaelstromTools_Basescanner = function () {
		...
		function createMaelstromTools_Basescanner() {
			...
			T.addtranslateobj( {main:"BaseScanner", de: "Basescanner", pt: "Visão geral do scanner de base", fr: "Aperçu du scanner de base"} );
			...
			var openBaseScannerOverview = MT_Base.createDesktopButton(T.get("BaseScanner") + "", "BaseScanner", false, MT_Base.desktopPosition(2));
			openBaseScannerOverview.addListener("execute", function () {
				Addons.BaseScannerGUI.getInstance().openWindow(T.get("BaseScanner") + "");
			}, this);
