            ...
            if($(element).is("div[class*='fortbattle-']")) {
                ...
                setTimeout(function(){
                    ...
                    switch (datafort[NSfortID]) {
                        case 0: //PICCOLO
						    if(NSlang=='pt') NSurl='http://i63.tinypic.com/54j71l.jpg';
                            ...
                            break;
                        case 2: //GRANDE
						    if(NSlang=='pt') NSurl='http://i63.tinypic.com/2db74mp.png';
                            ...
                            break;
                        default: //MEDIO
						    if(NSlang=='pt') NSurl='http://i64.tinypic.com/2i0c9ed.png';
