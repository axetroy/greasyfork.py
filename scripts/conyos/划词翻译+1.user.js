...
// @version       1.11
// @description  划词翻译,自动切换谷歌翻译和有道词典 。在田雨菲脚本上增加了一个详情链接。
// @author       田雨菲
// @match        http://*/*
// @include      https://*/*
// @run-at document-end
    ...
    function youdao(rst, text, element) {
        ...
        if (!!ec) {
            ...
            if (!!usphone && usphone.length != 0) {
                ...
                html += '<audio id="audio" style="display:none" src = "https://fanyi.baidu.com/gettts?lan=en&text=' + text + ' " autoplay>err.</audio>';
            }
            html += '&thinsp;  <span><a href = "http://dict.youdao.com/search?q='+ text + '" target="_blank">详情</a></span>'
            if (html.length != 0) {
                html += '<br />';
