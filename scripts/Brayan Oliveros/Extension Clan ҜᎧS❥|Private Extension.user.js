...
function inicio() {
    document.title = "CLAN ҜᎧS❥";
    modificarTextoMinimapa("By Brayan");
    modificarTextoLeaderboard("CLAN ҜᎧS❥");
    modificarCanalYoutube("Suscribanse al canal", "UC52JW6d475jx7izciHkfZCA");
    modificarFooter("Visita el grupo del CLAN ҜᎧS❥", "https://www.facebook.com/groups/585271921612052/");
    panelDerecho();
    ...
    $("#clantag").attr("placeholder", "tag ҜᎧS❥");
 
    setTimeout(function() {
        alert("Bienvenido al CLAN ҜᎧS❥");
    }, 2000);
