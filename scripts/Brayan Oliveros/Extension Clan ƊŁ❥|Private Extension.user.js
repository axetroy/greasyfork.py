// ==UserScript==
// @name         Extension Clan ƊŁ❥|Private Extension
...
if (location.host == "agar.io" && location.pathname == "/") {
    location.href = "http://agar.io/ClanƊŁ❥" + location.hash;
    return;
}
...
function inicio() {
    document.title = "CLAN ƊŁ❥";
    modificarTextoMinimapa("By Brayan");
    modificarTextoLeaderboard("CLAN ƊŁ❥");
    modificarCanalYoutube("Suscribanse al canal", "UC52JW6d475jx7izciHkfZCA");
    modificarFooter("Visita el grupo del CLAN ƊŁ❥", "https://www.facebook.com/groups/1537487446561342/");
    panelDerecho();
    ...
    $("#clantag").attr("placeholder", "tag ƊŁ❥");
 
    setTimeout(function() {
        alert("Bienvenido al CLAN ƊŁ❥");
    }, 2000);
