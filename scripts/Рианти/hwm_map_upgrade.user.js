...
// @namespace      Demin
// @description    HWM mod - Avtosdacha zadanij GN, tajmer perehoda, skrytie karty (by Demin). В данной версии исправлено распознавание секторов, за счет ошибки в котором скрипт не мог автоматически сдавать задания гн.
...
place_map[0] = /\*(\d+)/.exec( place_map[0] )[1]; // 12/11/2016 fix
