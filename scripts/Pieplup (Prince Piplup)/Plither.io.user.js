...
(function(w) {
    var modVersion = "v0.1.18",
		...
		scoreHUD = null,
        fpsHUD = null,
        styleHUD = "color: #00b2FFF; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 14px; position: fixed; opacity: 0.35; z-index: 7;",
        inpNick = null,
        currentIP = null,
        retry = 0,
        bgImage = null,
    ...
    function setMenu() {
        ...
        if (login) {
            ...
            select.appendChild(option);
            // Menu footer           
            sltMenu.innerHTML += '<a href="http://ogario.ovh" target="_blank" style="color: #FFFFFF;">Visit ogario.ovh</a> | ';
