...
// @name        MiWiFi
// @namespace   vagyula
// @description MiWiFi Hungarian Firefox (Beta)
// @version     1
// @grant       none
// ==/UserScript==
"use strict";
...
var str = replaceAll("正在测速，请等待。", "Hálózat tesztelése, kérem várjon", str);
...
var str = replaceAll("你访问的页面地址出错了\(404\)", "Hoppá, A keresett oldal nem található!", str);
...
var str = replaceAll("立即进行网络诊断", "Hálózat tesztelése", str);
...
var str = replaceAll("请选择固件:", "Firmware kiválasztása:", str);
var str = replaceAll("开始升级", "Frissítés indítása", str);
...
var str = replaceAll("恢复出厂设置", "Gyári beállítások visszaállítása", str);
...
var str = replaceAll("格式化硬盘", "Merevlemez formázása", str);
...
var str = replaceAll("可以通过", "Ugrás ", str);
var str = replaceAll("路由状态", "Router állapota", str);
var str = replaceAll("存储状态", "Tárhely állapota", str);
var str = replaceAll("常用设置", "Gyakori beállítások", str);
var str = replaceAll("高级设置", "További beállítások", str);
var str = replaceAll("终端设备", "Terminal Equipment", str);
var str = replaceAll("路由器信息", "Router adatok", str);
var str = replaceAll("路由器型号", "Router modell", str);
var str = replaceAll("小米路由器", "MiWiFi router ", str);
var str = replaceAll("系统ROM版本", "Rendszer ROM verzió", str);
var str = replaceAll("开发版", "Fejlesztői kiadás", str);
var str = replaceAll("当前CPU负载", "Current CPU load", str);
var str = replaceAll("当前CPU状态", "A CPU jelenlegi állapota", str);
var str = replaceAll("当前网络状态", "Hálózat jelenlegi állapota", str);
var str = replaceAll("下载速度", "Letöltési sebesség", str);
var str = replaceAll("上传速度", "Feltöltési sebesség", str);
var str = replaceAll("终端流量统计", "Adatforgalmi statisztika", str);
var str = replaceAll("当前终端", "Jelenlegi kliens", str);
var str = replaceAll("平均网速", "Átlagos sebesség", str);
var str = replaceAll("最快下载", "Leggyorsabb sebesség", str);
var str = replaceAll("总下载量", "Összes letöltés", str);
var str = replaceAll("总上传量", "Összes feltöltés", str);
var str = replaceAll("累计终端", "Cumulative terminal", str);
var str = replaceAll("当前内存状态", "Memória jelenlegi állapota", str);
var str = replaceAll("当前内存占用", "Memóriahasználat", str);
var str = replaceAll("核心数", "Magok száma", str);
var str = replaceAll("核心频率", "Mag frekvencia", str);
var str = replaceAll("内存容量", "Memória kapacitása", str);
var str = replaceAll("内存类型", "Memória típusa", str);
var str = replaceAll("内存频率", "Memória frekvenciája", str);
var str = replaceAll("互联网", "Internet", str);
var str = replaceAll("外网状态", "Külső hálózat állapota", str);
var str = replaceAll("外网带宽", " Outside The Network Bandwidth", str);
var str = replaceAll("连接类型", "Csatlakozás típusa", str);
var str = replaceAll("IP地址", "IP címek", str);
var str = replaceAll("下载带宽", "Letöltési sávszélesség", str);
var str = replaceAll("上传带宽", "Feltöltési sávszélesség", str);
var str = replaceAll("网关地址", "Átjáró", str);
var str = replaceAll("重新测速", "Sebességmérés", str);
var str = replaceAll("手工修改", "Kézi módosítás", str);
var str = replaceAll("网线连网设备", "Hálózati eszközök", str);
var str = replaceAll("5G连网设备", "5G networking equipment", str);
var str = replaceAll("MAC地址", " MAC address ", str);
var str = replaceAll("访问外网", "Internet hozzáférés", str);
var str = replaceAll("访问硬盘", "Lemez hozzáférés", str);
var str = replaceAll("修改路由器名称", "Router nevének módosítása", str);
var str = replaceAll("系统升级", "Rendszerfrissítés", str);
var str = replaceAll("下载客户端", "Letöltőkliens", str);
var str = replaceAll("修改路由器名称", "Router nevének módosítása", str);
var str = replaceAll("路由器名称", "Router neve", str);
var str = replaceAll("路由器位置", "Router helye", str);
var str = replaceAll("位置", "Hely", str);
var str = replaceAll("系统版本", "Rendszer verzió", str);
var str = replaceAll("开发版", "Fejlesztői kiadás", str);
var str = replaceAll("MAC地址", " MAC address ", str);

var str = replaceAll("官方网站", "Hivatalos honlap", str);
var str = replaceAll("官方微博", "Hivatalos blog", str);
var str = replaceAll("官方微信", "Hivatalos micro letter ", str);
var str = replaceAll("用户社区", "User Community", str);
var str = replaceAll("服务热线", "Forróvonal", str);
var str = replaceAll("文件系统", "Fájlrendszer", str);
var str = replaceAll("运行时间", "Futás idő", str);
var str = replaceAll("硬盘转速", "Merevlemez forgási sebessége", str);
var str = replaceAll("硬盘接口", "Merevlemez interface", str);
var str = replaceAll("硬盘型号", "Merevlemez gyártója", str);
var str = replaceAll("本地存储", "Helyi tároló", str);
var str = replaceAll("您的硬盘已经", "A merevlemez nem volt tesztelve ", str);
var str = replaceAll("建议每隔15天执行一次硬盘体检", " napja, minden 15.nap után ajánlott a tesztelése", str);
var str = replaceAll("天没有进行过检测，", "", str);
var str = replaceAll("上次体检为", "Utoljára ellenőrizve: ", str);
var str = replaceAll("立即体检", "Ellenőrzés most", str);
var str = replaceAll("文件类型存储统计", "Fájl tárhely statisztika", str);
var str = replaceAll("总容量", "Teljes kapacitás ", str);
var str = replaceAll("硬盘读写状态", "Merevlemez R/W állapota", str);
...
var str = replaceAll("详细体检报告", "Részletes jelentés", str);
var str = replaceAll("硬盘体检总得分", "Hard physical examination total score", str);
var str = replaceAll("优", "Excellent", str);
var str = replaceAll("恭喜，您的硬盘很健康！", "Gratulálunk, a merevlemez teljesen rendben van!", str);
...
var str = replaceAll("设置", " Beállítás ", str);
var str = replaceAll("上网设置", "Internet beállítások", str);
var str = replaceAll("安全中心", "Biztonsági beállítások", str);
var str = replaceAll("局域网设置", "LAN beállítások", str);
var str = replaceAll("系统状态", "Rendszer állapot", str);
var str = replaceAll("隐藏网络不被发现", "Hálózat elerejtése", str);
var str = replaceAll("混合加密(WPA/WPA2个人版)", "WPA / WPA2 titkosítás", str);
var str = replaceAll("强加密(WPA2个人版)", "WPA2 titkosítás", str);
var str = replaceAll("无加密(允许所有人连接)", "Nincs titkosítás", str);
var str = replaceAll("无线信道", "Wi-Fi csatornák", str);
var str = replaceAll("节能", "Energatakarékosság", str);
var str = replaceAll("信号强度", "Jelerősség", str);
var str = replaceAll("上网方式", "Internet hozzáférési pontok", str);
var str = replaceAll("连接类型", "Csatlakozás típusa", str);
var str = replaceAll("子网掩码", "Subnet Mask", str);
var str = replaceAll("默认网关", "Alapértelmezett átjáró", str);
var str = replaceAll("WAN口速率", "WAN port sebesége", str);
var str = replaceAll("自动（推荐）", "Automatikus (ajánlott)", str);
var str = replaceAll("MAC地址克隆", "MAC地址克隆", str);
var str = replaceAll("当前使用的MAC地址是", "Jelenlegi MAC address : ", str);
var str = replaceAll("MAC地址", " MAC address ", str);
