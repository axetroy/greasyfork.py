// ==UserScript==
// @name        freebitco.in BET00000
// @description 01
// @include  https://btcspinner.io/game *
...
function bootStart(){
    if ((b.innerHTML != "Dragging") && parseInt(b.innerHTML) < 1000){
        var xInicial = 0, yInicial = 0;
       
        // "parseInt(b.innerHTML) < 500": 500 is the minimum value in RPMs from which the spinner rotates again.
...
var bootIntervalId = setInterval(bootStart, 20);
