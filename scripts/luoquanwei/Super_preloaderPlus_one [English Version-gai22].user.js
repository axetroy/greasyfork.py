(function() {
// ==UserScript==
// @name         Super_preloaderPlus_one [English Version-gai22]
...
var SITEINFO_D={
    ...
    autopager: {
        ...
        useiframe: false,       // (翻页)是否使用iframe..
            ...
            newIframe: false,
        remain: 0,              // 剩余页面的高度..是显示高度的 remain 倍开始翻页..
        maxpage: 999,            // 最多翻多少页..
        ipages: [true, 3],     // 立即翻页,第一项是控制是否在js加载的时候立即翻第二项(必须小于maxpage)的页数,比如[true,3].就是说JS加载后.立即翻3页.
