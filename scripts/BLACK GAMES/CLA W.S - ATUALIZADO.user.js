// ==UserScript==
// @name         CLA W.S - ATUALIZADO
// @namespace    CANAL:BLACK GAMES
// @version      1.9.5
// @description  MOD : CLA W.S
// @author       CLA W.S MOD
...
(function(w) {
    var modVersion = "v1.9.5",
        renderMode = 2, // 3 - Alto, 2 - Médio, 1 - Baixo (mobile)
        normalMode = false,
        gameFPS = null,
        positionHUD = null,
        ipHUD = null,
    ...
    function setMenu() {
        ...
        if (login) {
            ...
            sltMenu.innerHTML = "🔩CONFIGURAÇÕES🔩</strong>";
            login.appendChild(sltMenu);
            // IP input container
            var div = document.createElement("div");
            div.style.color = "#fff";
            div.style.backgroundColor = "#000000";
            div.style.boxShadow = 'rgb(255, 255, 255) 0px 1px 20px';
            ...
            input.id = "server-ip";
            input.type = "text";
            input.placeholder = "    (IP) Selecionado Aqui    ";
            ...
            button.style.boxShadow = 'rgb(255, 255, 255) 0px 2px 20px';
            ...
            var div = document.createElement("div");
            div.style.backgroundColor = "#000000";
            div.style.boxShadow = 'rgb(255, 255, 255) 0px 2px 20px';
            div.style.borderRadius = "29px";
            div.style.margin = "10 auto";
            div.style.padding = "8px";
            sltMenu.appendChild(div);
            ...
            select.appendChild(option);
            // Menu footer
            sltMenu.innerHTML += '<a href="https://discord.gg/ywf5e2M" target="_blank" style="color: #ffffff;">Discord Clã</a> | ';
			sltMenu.innerHTML += '<a href="https://www.youtube.com/channel/UCLQchRAzjYsTmeDA5rGjn-w?view_as=subscriber" target="_blank" style="color: #ffffff;">Canal Youtube</a>';
            // Get IP input
    ...
    function setLeaderboard() {
        if (w.lbh) {
            w.lbh.textContent = "Tabela De Líderes";
	...
	function setHighScore() {
		...
		if (scoreHUD && highScore > 0) {
			scoreHUD.textContent = "Seu Record: " + highScore;
		}
	}
    // Show FPS
    function showFPS() {
    ...
    function updateLoop() {
        ...
        if (w.playing) {
            ...
            if (inpIP && w.bso && currentIP != w.bso.ip + ":" + w.bso.po) {
                ...
                if (ipHUD) {
                    ipHUD.textContent = "Seu Servidor: " + currentIP;
                }
            }
        } else {
