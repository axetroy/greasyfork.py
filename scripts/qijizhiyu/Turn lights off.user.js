...
function makeswitch() {
	...
	b.setAttribute('style', 'width: 30px; height: 30px; top: 5%; left: 5%; z-index: 60000; position: fixed; color: black; background: white; border: 1px solid black; text-align: center; vertical-align: middle; font-size: 9pt; cursor: pointer;');
	b.innerHTML = 'Turn\nOff';
