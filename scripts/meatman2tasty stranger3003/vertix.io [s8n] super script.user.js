// ==UserScript==
// @name         vertix.io [s8n] super script
// @namespace    http://vertix.io/
// @version      2.1
// @description  Increases Size and view of map,Show's Camos, Right click secondary(buffed), Accurate Aim cursor, +zoom using [tab] and [`], aimbot('shift'=on,'t'=off), 'x' to fill chat, Autojump(press 'z' to start), press '\' to max name space
// @author       Meatman2tasty
// @match        http://vertix.io/
// @grant        none
// ==/UserScript==

//Extended Weapon Length//
...
document.addEventListener("keydown", function(a) { // press '\' to max name
    if (a.keyCode == 220) {
