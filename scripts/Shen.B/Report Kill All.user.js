// ==UserScript==
// @name         Report Kill All
// @namespace    https://greasyfork.org/scripts/38032-report-fb-by-voz-er/code/Report%20fb%20by%20Voz-er.user.js
// @version      1.0.9
// @description  Script report facebook lũ vô văn hoá chửi team bạn
// @author       You
// @include        /.*://.*facebook.com/tin123.vn/?$/
// @include        /.*://.*facebook.com/Baotintucvietnam.vn/?$/
// @include        /.*://.*facebook.com/giang.vu.965928/?$/
// @include        /.*://.*facebook.com/bsdalieuthammy.hp/?$/
// @include        /.*://.*facebook.com/ngoc.quyen.1829/?$/
// @include        /.*://.*facebook.com/ngoc.quyen.1829/?$/
// @include        /.*://.*facebook.com/groups/1389505377815022/?$/
...
if(/ngoc.quyen.1829|bsdalieuthammy.hp|giang.vu.965928/i.test(window.location.href)){
...
//reports groups
if(/1389505377815022|phongthutoibeatvn|kysuduongpho|780485565464752|phongtrutgianbeatvn|tuyettinhcocbeatvn|BEATGAMER/i.test(window.location.href)){
...
//reports pages
if(/tin123.vn|Baotintucvietnam.vn|beatvn\.quotes|BanHoiVozerTraLoi|beatvn\.troll|beatvn.page|beatvn.sport|beatvn\.video/i.test(window.location.href)){
