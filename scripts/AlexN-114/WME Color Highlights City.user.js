...
function _aNchecksCity() {
  ...
  console.log("HiLiCi: Cities in progress *: " + hilici.CityInProgress.length +
  ...
  if (hilici.CityInProgress.length > 0) {
	...
	console.log("HiLiCi: found City: " + cityName + " / Country: " + countryName);
	hStr = '"' + cityName + '"';
	...
	aNstatus = undefined;
	aNurl  = "http://members.aon.at/aneumeister/scripts/waze/"+countryName2[0]+".txt";
