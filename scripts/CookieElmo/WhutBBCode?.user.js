...
// @author         hateradio
// @version        3.2
// @description    This is a cross-browser BBCode helper. It works with both What.CD and Waffles.ch and other sites . . . CDs and waffles, mmm. Updated to support apollo.rip
...
// @exlude         http*://*apollo.rip/*logchecker*
	...
	WhutBB.Panel = (function () {
		...
		Panel.construct = function () {
			Panel.factory('link', dom.dom('div', {className: 'wbblink' + (WhutBB.user.settings.link ? '' : ' wbbhide') },
				dom.dom('a', {href: WhutBB.config.link, title: 'Version 3.2', txt: 'WhutBBCode?'})), true);
