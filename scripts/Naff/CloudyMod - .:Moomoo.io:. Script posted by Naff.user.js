// ==UserScript==
// @name         CloudyMod - .:Moomoo.io:. Script posted by Naff 
// @namespace    -
// @version     15.9987,00
// @description  XXL HACK (Moomoo.io 2) and moomoo.io 
// @author       ＶĻＡĐＺŹＫĻＹＴвлад#2764
// @match        *://moomoo.io/*
...
itemTitle.innerText = "авто хил скорость";
currentSpeed.innerHTML = '<div id="cspeed">сейчас скорость »</div> <div id="numfocus">50</div>';
...
$("#healSlider").change((event, ui) => {
   let coreVal = parseInt($("#healSlider").val());
    ...
    currentSpeed.innerHTML = `<div id="cspeed">сейчас скорость »</div> <div id="numfocus">${coreVal}</div>`;
})
...
<h1 id="settingsTitle">VladMod настройки</h1>
<div class="flexControl">
<h3 class="menuPrompt">чтобы сделать инста килл надо нажать: </h3> <input value="${String.fromCharCode(instaKillKey)}" id="keyPress" maxlength="1" type="text"/>
</div>
<hr/>при атаки одевать:</h3>
<div id="choiceWrap">
...
<div id="mnwrap">
<h3 class="menuPrompt" id="rmvMonkey">удалять Monkey Tail?</h3> <input id="removeMonkey" maxlength="1" ${removeMonkeyTail ? "checked" : ""} type="checkbox"/>
</div>
<hr/>
<h3 class="menuPrompt lowprompt">шип и ловушка1 (можно изменить кнопки на которые ставишь):</h3>
...
<hr id="hrule"/>
<div id="endwrap">
<h3 id="createdEnd">cоздал ＶĻＡĐＺŹＫĻＹＴвлад#2764 | <a href="https://discord.gg/TWrcmvh">заходи в мой дискорд</a></h3>
</div>
`
...
$("#mapDisplay").on("click", (event) => {
    ...
    infoDiv.innerHTML = `<h1 id="autotitle">VladMod авто пилот.</h1>
...
document.title="VladMod: авто хил ON"
...
document.addEventListener('keypress', (e)=>{
   ...
   if (e.keyCode == 116 && document.activeElement.id.toLowerCase() !== 'chatbox'){
       ...
       document.title = document.title=`VladMod: авто хил ${autoheal ? "ON" : "OFF"}` //"хил " + (авто хил ? "ON" : "OFF") + " / Bull Hat " + (autobull ? "ON" : "OFF");
