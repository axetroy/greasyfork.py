// ==UserScript==
// @name           MooMoo.io AutoHotKeysHats 
// @namespace      youtube.com/c/naff
// @version        8.0
// @description    M=Solider ,AltGr=Bull helement ,Ctrl=Tank gear, Its for traning but its fun but its not funny for everyone.
// @author         ?TrickyModz? & ?František:)?
// @match          http://dev.moomoo.io/*
// @match          http://sandbox.moomoo.io/*
// @match          http://moomoo.io/*
// @match          https://45.77.0.81/*
// @require        http://code.jquery.com/jquery-3.3.1.min.js
// @icon           https://pbs.twimg.com/profile_images/843945577008250885/7XV9Qbw4.jpg
// ==/UserScript==
...
document.addEventListener('keydown', function(kfc) {
    if(!$(':focus').length) {
        switch (kfc.keyCode) {
            ...
            case 187: Rt(13); kfc.preventDefault(); break;            // Turrete Gear                        = = [ equal sign / 187 ]
...
document.getElementById('enterGame').innerHTML = 'Letz go';
document.getElementById('loadingText').innerHTML = 'w8'
document.getElementById('nameInput').placeholder = "unknown";
document.getElementById('chatBox').placeholder = "XxTy for dwonloadxX";
document.getElementById('diedText').innerHTML = ';-WellPlay-;!';
document.getElementById('gameName').innerHTML = 'ViceDie';
...
$('#foodDisplay').css({'color': '#F1442A'});

$('#woodDisplay').css({'color': '#00FF00'});

$('#stoneDisplay').css({'color': '#9B9493'});

$('#scoreDisplay').css({'color': '8A21EC'});
...
myElement.style.backgroundColor = "#0404B4";
myElement.style.color = "#80FF00";

var myElement = document.querySelector('#enterGame');
myElement.style.backgroundColor = "#0000FF";
myElement.style.color = "#0489B1";
