...
// @match          https://v.comicbus.com/online/*.html?ch=*
// @match          https://www.cartoonmad.com/comic/*.html
// @match          https://www.comicnad.com/comic/*.html
// @run-at         document-end
...
function manhuagui(){
	...
	let getPicUrl = unsafeWindow.eval(unsafeWindow.eval(document.scripts[4].innerHTML.slice(26)).slice(0,-11)).getPicUrl;
...
var min_v_height = 900;
var max_v_height = 1100;
