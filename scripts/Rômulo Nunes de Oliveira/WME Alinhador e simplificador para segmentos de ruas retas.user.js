...
function SimplifyStreetGeometry() {
  ...
  //  multiaction.setModel(Waze.model);
    ...
    window.W.selectionManager.events.register("selectionchanged", null, insertSimplifyStreetGeometryButtons);
    ...
    function insertSimplifyStreetGeometryButtons()
    {
        ...
        $('.edit-restrictions').after('&nbsp <button id="SimplifyStreetGeometry" class="waze-btn waze-btn-small waze-btn-white">' + FrasesNaLingua.btn +'</button>');
    }
