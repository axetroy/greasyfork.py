...
(function(w) {
    var modVersion = "v0.1.07",
		...
		scoreHUD = null,
        fpsHUD = null,
        styleHUD = "color: #FFFFFF; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 14px; position: fixed; opacity: 0.35; z-index: 7;",
        inpNick = null,
        currentIP = null,
        retry = 0,
        bgImage = null,
    ...
    function setMenu() {
        ...
        if (login) {
            ...
            div.innerHTML = "[ESC] - Salida rapida | [Q] - Salir <br/>[A] - Auto skin rotador | [S] - Cambiar skin <br/>[Z] - Zoom normal | [Space] - Velocidad ";
            ...
            sltMenu.innerHTML = "MOD: <strong>SLITiHER by WUICHO</strong> | <strong>" + modVersion + "</strong>";
    ...
    function setLeaderboard() {
        if (w.lbh) {
            w.lbh.textContent = "MOD: by WUICHO";
