// ==UserScript==
// @name         MOOMOO.IO Insane Mod! AC BYPASS BY SEASAME
// @namespace    MOOMOO.IO Insane Mod! AC BYPASS BY SEASAME
// @version      1.2 w/ AC Bypass
// @description  Better Minimap, Hat & Accessory Toolbar, Auto Heal, R-Click Food, Rainbow Hat, Hotkeys
// @author       TigerYT, Seasame
...
$("#rightCardHolder").append("<div class='menuCard' id='guideCard'><div class='menuHeader'> Description of Mod: <br> <br> Special Thanks to: <br></div><div class='menuText'> TigerYT(Making the Mod) <br> Seasame(Modding the Mod) <br> Tuxxaman (Gave me Auto Heal) <br> lightningking (Made Upgrade Tree Image) <br> Areith/Ella (Edited Upgrade Tree Image)<br> Mudkip (ID's for items) <br> <br> <div class='menuHeader'> Read Below ⬇⬇⬇ </div><br>Please know that I do not advise you to hack because it will be unfair for other moomoo.io players. Also if you want to join a clan, if they find out you use hacks or have used hacks they will not accept you. <br> <br> <div class='menuHeader'> TIPS: </div> <br>If you want to survive as long as possible make sure you spam the weapon you are using! For exampe if I am using bow since it is a Second Weapon I would spam 2 (Or '.' If I am a Arrow Key User) <br></div></div>");
$("#rightCardHolder").append("<div class='menuCard' id='guideCard'><div class='menuHeader'>How to use Mod <br></div><div class='menuText'> <br> <br> F = Spikes <br> <br> SPACEBAR = Pittrap/Booster Pad <br> <br> R = First Weapon <br> <br> Home = Rainbow Hat <br> <br> R-Click = Eat 1 Food <br>  <br> P = Toggle Mod Menu <br> <br> L = Toggle Upgrade Tree <br> <br> Click Auto Heal Checkbox = Toggle Autoheal Off/On </div></div>");
$('body').prepend('<img class="UpgradeTree" src="https://cdn.discordapp.com/attachments/387753857687486464/389103386764509186/image.png" alt="Upgrade Tree" width="300" height="300" style="position:absolute; margin-top:100px; padding:10px; opacity:0.7;"/>' );
...
(function () {
    ...
    document.addEventListener('mousedown', function (e) {
        if (ws && e.button == 2) {
            e.stopPropagation();
            if (player.items[ITEM_TYPE.FOOD]) ws.send("42[\"5\"," + player.items[ITEM_TYPE.FOOD].id + ",null]");
            ws.send("42[\"4\",1,null]");
            player.itemInHand = player.items[ITEM_TYPE.WEAPON];
        }
    }, true);
    ...
    function StartBot() {
        ...
        avN = 203+Math.random()*11-Math.random()*11;

        var makeThisMoreLegit = setInterval(function () {
            avN = 203+Math.random()*11-Math.random()*11;
        },11000);
