// ==UserScript==
// @name         SLITHER.IO by xiongtianqi.cn
...
(function(w) {
    ...
    function setMenu() {
        ...
        if (login) {
            ...
            div.innerHTML = "[ESC] - 立即重生 | [Q] - 重新开始 <br/>[A] - 自动更换皮肤 | [S] - 更换皮肤 <br/>[Z] - 还原视角 | [Space] - 按空格加速 ";
            ...
            sltMenu.innerHTML = "感谢<strong>www.xiongtianqi.cn</strong> | <strong>" + modVersion + "</strong>";
    ...
    function setLeaderboard() {
        if (w.lbh) {
            w.lbh.textContent = "MOD: www.xiongtianqi.cn";
