// ==UserScript==
// @name            TW-Koleksiyon
// @description     TW-Koleksiyon - Oğuzhan Ünal
				...
				TWT = {
					...
					langPatchs : {
						...
						pt : {
							...
							texte : "Portekizce - Português",
							author : "VSaantiago"
						},
						ru : {
							link : "https://greasyfork.org/ru/scripts/7271",
							texte : "Rusça - Pу́сский",
							author : "Anch665"
						},
						ro : {
					...
					langs : {
						...
						en : {
							description : "<center><BR /><b>TW-Koleksiyon</b><br>Koleksiyonunda olmayan ürünleri işaretleme ve gösterme <br>Koleksiyon için gereken ürünleri listeleme<BR> Fare ile üzerine gelince banka ücretini gösterme <br> Çeşitli kısayollar"
									+ "<br>Tüm raporları silme<br> Bankadaki ücretler <br> Envantere eklenen butonlar (Çok sayıda olanlar, kullanılabilenler, reçeteler, setler) <br>Türkçe Çeviri: Oğuzhan Ünal",
							Options : {
								tab : {
									setting : 'Ayarlar'
								},
								checkbox_text : {
									box : {
										title : 'Özellikler / Menüler',
										options : {
											goHome : 'Kasabana git',
											goToDaily1 : 'Hayalet Kasaba',
											goToDaily2 : 'Waupee\'nin Kızılderili Köyüne Git ',
											ownSaloon : 'Salonu Aç',
											openMarket : 'Pazarı Aç',
											mobileTrader : 'Gezici Tüccarı Aç',
											forum : 'Forumu Aç',
											listNeeded : 'Koleksiyonculara gereken ürünler'
									...
									collection : {
										title : 'Koleksiyonlar',
										options : {
											gereNewItems : 'Başarıya ulaşınca başarılara eklenen yeni ürünleri yönet',
											patchsell : 'Envanterinde eksik olan ürünleri işaretle',
											patchtrader : 'Tüccardaki eksik olan ürünleri işaretle',
											patchmarket : 'Pazardaki eksik olan ürünleri işaretle',
											showmiss : 'Listedeki eksik ürünleri göster',
											filterMarket : 'Pazar filtresi : sadece eksik ürünleri göster (koleksiyoncular)'

										}
									},
									inventory : {
										title : 'Envanterdeki Butonlar',
										options : {
											doublons : 'Çok sayıdaki ürünleri aramak için buton eklendi',
											useables : 'Kullanılabilirleri aramak için buton eklendi',
											recipe : 'Reçeteleri aramak için buton eklendi',
											sets : 'Set listesi için buton eklendi',
											sum : 'Arama sonucundaki ürünlerin tüccardaki toplam satış fiyatını göster'
									...
									miscellaneous : {
										...
										options : {
											lang : 'Dil',
											logout : 'Çıkış butonu ekle',
											deleteAllReports : 'Tüm raporları silme özelliği ekle',
											showFees : 'Fare ile üzerine gelince banka ücretini göstermeyi ekle',
											popupTWT : 'Fare ile üzerine gelince TW Koleksiyon menüsünü aç'
										}
									},
									craft : {
										title : 'Ustalık',
										options : {
											filterMarket : 'Pazarda aranan ustalık ürünleri için simge'
									//		filterMiniMap : 'Icon for searching craft item job in the minimap'
										}
									},
									twdbadds : {
										title : 'Clothcalc Eklentisi',
										options : {
											filterBuyMarket : 'Pazar filtresi : sadece işaretli eksik ürünleri göster <a target=\'_blanck\' href="http://tw-db.info/?strana=userscript">(twdb add)</a>'
								...
								message : {
									title : 'Bilgi',
									message : 'Tercihler uygulandı.',
									reloadButton : 'Sayfayı yenile',
									gameButton : 'Oyuna geri dön',
									indispo : 'Ayar kullanılamıyor (Koleksiyonlar tamamlandı veya betik mevcut değil)',
									more : 'Daha ?',
									moreTip : 'Çeviriler sayfasını aç'
								},
								update : {
									title : 'Güncelle',
									upddaily : 'Her gün',
									updweek : 'Her hafta',
									updnever : 'Asla',
									checknow : 'Güncellemeyi şimdi kontrol et ?',
							...
							Craft : {
								titleMarket : 'Bu ürünü pazarda ara',
								titleMinimap : 'Mini haritada ilgili çalışmayı bul'
							},
							ToolBox : {
								title : 'Özellikler',
								list : {
							...
							Doublons : {
								tip : 'Sadece çok sayıda olanları göster',
								current : 'Geçerli arama',
								upgradeable:'Geliştirilebilenler',
								noset : 'Set ürünü olmayanlar',
								sellable : 'Satılabilenler',
								auctionable : 'Açık arttırmaya sokulabilenler',
								tipuse : 'Sadece kullanılabilenleri göster',
								tiprecipe : 'Sadece reçeteleri göster',
								tipsets : 'Sadece set ürünlerini göster',
								sellGain : '$ gezici tüccara toplam satış ücreti'
							},
							Logout : {
								title : 'Çıkış yap'
							},
							AllReportsDelete : {
								button : 'Tümünü sil',
								title : 'Tüm raporları sil',
								work : 'Çalışma',
								progress : 'İlerleme',
								userConfirm : 'Kullanıcı onayı',
								loadPage : 'Sayfayı Yükle',
								deleteReports : 'Raporları sil',
								confirmText : 'Tüm raporlar silinecek - Onaylıyor musun ?',
								deleteYes : 'Evet, sil',
								deleteNo : 'Hayır, silme',
								status : {
									title : 'Durum',
									wait : 'Bekle',
									successful : 'R&eacute;ussi',
							...
							twdbadds : {
								buyFilterTip : 'Sadece envanterinde olmayan ürünleri göster',
								buyFilterLabel : 'Eksik ürünler'
							},
							collection : {
								miss : "Eksik : ",
								colTabTitle : "Koleksiyonlar",
								setTabTitle : "Setler",
								thText : '%1 eksik ürün',
								thEncours : 'Bu ürün için bir teklif var',
								thFetch : 'Bu ürünü pazarda bulabilirsin %1',
								allOpt : 'Hepsi',
								collectionFilterTip : 'Sadece koleksiyon ürünlerini göster',
								collectionFilterLabel : 'Sadece koleksiyon',
								select : 'Seç ...',
								listText : 'Koleksiyonculara gereken ürünler',
								listSetText : 'Setlere gereken ürünler',
								filters : 'Filtreler',
								atTrader : 'Gezici tüccarda satılanlar',
								atBid : 'Geçerli teklifler',
								atCurBid : 'Biten teklifler',
								atTraderTitle : 'Gezici tüccarda satışa sunulan ürünleri göster',
								atBidTitle : 'Geçerli teklifleri göster',
								atCurBidTitle : 'Pazardan alınabilen ürünleri göster',
								searchMarket : 'Pazarda ara',
								patchsell : {
									title : "Koleksiyonu tamamlamak için gereken ürünler"
								}
							}
						}
					},
						...
						translate : {
							open : function() {
								var txtArea = '<div style="width:650px;margin-left:15px;margin-top:20px;height:250px;font-size:16px;text-align:justify;padding-bottom:50px;">'
										+ '<h4 style="margin-bottom:20px;"><center>TW Koleksiyon betiğinin çeviri sistemi değişti</center></h4>'
										+ "TW Koleksiyon betiği yalnızca Fransızca ve İngilizce dilleri içerir, farklı bir çeviri gerekiyorsa aşağıdaki TW sayfalarından istediğiniz betiği yükleyebilirsiniz<BR><BR>"
								...
								txtArea += "</div><br>Kendi çevirinizi oluşturmak isterseniz, daha fazla açıklama için <a target=\'_blanck\' href=\'https://greasyfork.org/fr/scripts/1670-tw-collections\'> betik anasayfasına</a> gidebilirsiniz";
								+'</div>';
								...
								TWT.Options.Windows.activateTab('TabTranslate')
										...
										.empty();
								TWT.Options.Windows
										.setTitle("TW Koleksiyon İçin Çeviriler");
...
//												.isChecked('craft.filterMiniMap')
									...
									.addButton(
											...
											function() {
												...
												$('div.tw2gui_dialog_text')
														.html(
																'<p>Silinme süreci.....<br /></p><span id="sppage" />');
					...
					api : function() {
						...
						var TWApi = TheWestApi
								.register('TW_Collections', 'TW Koleksiyon - Türkçe',
										TWT.info.min_gameversion,
										TWT.info.max_gameversion, 'Dun - v'
												+ TWT.info.version,
										'https://greasyfork.org/scripts/1670-tw-collections');

						var set_button = new west.gui.Button(
								TWT.LANG.Options.tab.setting, function() {
									TWT.Options.open('setting');
								}, this, this, "Ayarlar Sayfasını Aç");
						var more_button = new west.gui.Button(
								TWT.LANG.Options.checkbox_text.miscellaneous.options.lang,
								function() {
									TWT.Options.open('translate');
								}, this, this, "Çeviri İpuçları Sayfasını Aç");
				...
				ScriptUpdater = {
					...
					scriptUpdUrl : "http://pastebin.com/raw.php?i=W4fYvHcM", // "https://greasyfork.org/de/scripts/1669/code.user.js",
									...
									var parent = new west.gui.Dialog(
											...
											.addButton(
													...
													function() {
														...
														window
																.open(
																		"https://greasyfork.org/scripts/1670-tw-collections/code/TW-Collections.user.js",
																		'_self');
