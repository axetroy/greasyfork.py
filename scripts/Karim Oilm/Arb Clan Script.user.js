// ==UserScript==
// @name         Arb Clan Script
// @namespace    http://tampermonkey.net/
// @version      v2.1
// @description  For Arb Clan Members Only
// @author       Kareem
...
// ==/UserScript==
var doZoom = true;
$("h2").replaceWith('<h2>Arb Clan Script</h2>');
window.addEventListener('keydown', keydown);
window.addEventListener('keyup', keyup);
var Feed = false;
var Dingus = false;
var imlost = 25;
document.getElementById("instructions").innerHTML += "<center><span class='text-muted'><span data-itr='instructions_e'> Press <b>E</b> or <b>4</b> to TrickSplit</span></span></center>";
document.getElementById("instructions").innerHTML += "<center><span class='text-muted'><span data-itr='instructions_d'> Press <b>D</b> or <b>2</b> to DoubleSplit</span></span></center>";
document.getElementById("instructions").innerHTML += "<center><span class='text-muted'><span data-itr='instructions_q'> Press <b>A</b> for TribleSplit</span></span></center>";
...
document.getElementById("instructions").innerHTML += "<center><span class='text-muted'><span data-itr='instructions_Clan'> Vist <b>Www.Arb.n.nu</b> for Chat With Us</span></span></center>";
load();
function load() {
