// ==UserScript==
// @name          汉典翻译
// @namespace     http://www.zdic.net/
// @description	  汉典翻译,汉字字典，单字可发音
// @version		  1.0
// @author        Handian
// @include       *
// @include       about:*
// @exclude       *inf.10010.com*
// ==/UserScript==
function _zdicInit(){
  if(_zdic_init==1){
    _zdicUpdateStatus();
  ...
  var h = '<table width="268" height="268" border="0" cellspacing="0" cellpadding="0"><tr><td style="'+b+'padding-right:8px;" align="right" valign="top">';
  h += '<table width="100%" height="23" border="0" cellspacing="0" cellpadding="0" style="margin-right:8px;margin-top:8px;">';
  h += '<tr>';
  h += '<td width="35" height="23">&nbsp;</td>';
  h += '<td align="right" height="23" style="cursor:move;line-height:23px;border:none;padding:0px;margin:0px;" valign="middle" onmouseover="_zdic_onmove=1;" onmouseout="_zdic_onmove=0;">';
  h += '<a href="'+_zdic_help+'" target="_blank" title="&#24110;&#21161;" style="border:none;padding:0px;margin:0px;">';
  h += '<img src="'+_zdic_host+'images/xzsy_b1.gif" border="0" style="border:none;display:inline;border:none;padding:0px;margin:0px;" align="absmiddle"></a> ';
  h += '<a href="'+_zdic_host+'" target="_blank" title="&#35814;&#32454;&#35299;&#37322;" style="border:none;padding:0px;margin:0px;" id="_zdic_detail" name="_zdic_detail">';
  h += '<img src="'+_zdic_host+'images/xzsy_b3.gif" border="0" style="border:none;display:inline;border:none;padding:0px;margin:0px;" align="absmiddle"></a> ';
  h += '<a href="javascript:_zdicClose()" title="&#20851;&#38381;" target="_self" style="border:none;padding:0px;margin:0px;">';
  h += '<img src="'+_zdic_host+'images/xzsy_b4.gif" border="0" style="border:none;display:inline;border:none;padding:0px;margin:0px;" align="absmiddle">';
  h += '</a>';
  h += '</td><td width="40" height="23">&nbsp;</td></tr></table>';
  h += '<table border="0" cellspacing="0" cellpadding="0" width="250" align="center" onmouseover="_zdic_onlayer=1;" onmouseout="_zdic_onlayer=0;" style="'+b+'margin-top:3px;">';
  h += '<tr><td style="'+b+'">';
  h += '<table border="0" cellspacing="0" cellpadding="0" align="center" style="'+b+'">';
  h += '<tr><td width="100%" height="205" style="'+b+'" id="_zdicContent" name="_zdicContent">';
  h += '<iframe id="_zdicFrame" name="_zdicFrame" HEIGHT="205" src="about:blank" FRAMEBORDER="0" width="100%"></iframe>';
  ...
  try{
	...
	el.style.background='url('+_zdic_host+'/images/xzsy_bg.gif) no-repeat';
  ...
  _zdic_onselect = 1;
  var img = new Image();
  img.src = _zdic_host+"images/tj2.gif";
...
function _zdic_geturl(u,word){
    try{
		...
		if(!_zdic_iframe){
			_zdic_frameid ++;
			_zdicSet(_zdic_getObj('_zdicContent'),'<iframe id="_zdicFrame'+_zdic_frameid+'" name="_zdicFrame'+_zdic_frameid+'" HEIGHT="205" src="about:blank" FRAMEBORDER="0" width="100%"></iframe>');
	        ...
	        iframeWin.document.write('<html><body><div><span style="color:font-weight:bold;">&#26597;&#35810;&#20013;&#46;&#46;&#46;<img src="'+_zdic_host+'images/tj2.gif"/></span><br/><br /></div><center><span style="font-weight:bold;">'+word+'</span> </center></body></html>');
...
function _zdicStatus(){
    ...
    h +='] <a href="javascript:dictRemove();" target="_self" style="'+b+'"><img src='+_zdic_host+'images/close.gif border=0 align=absmiddle style="padding:0px;margin:0px;"></a>';
    return h;
}
function _zdic_load(){
   if(! document || ! document.body || !document.body.firstChild){
