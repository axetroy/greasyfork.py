...
var usersTroll = [
    ...
    'naruciakk', 'aperist', 'SouthNH', 'begbie', 'yasiinbey1', 'Pablo84krk', 'Agusia',
    ...
    'gregry', 'kasztelan54', 'macieii', 'aperist', 'ciacho23', '19Dako20', 'PanCerka2',
    'borkosiu', 'Lares', 'Bartek78',  'truhl', 'moionet', 'Monarchi', 'r9999', 'aliveinchains',
    'tentom', 'Shagohad', 'openal', 'vvi', 'TYCZYW', 'victorek', 'Fantomasas', '_No_Name_',
    'Jan Mocny', 'WUNDER-BAUM', 
    'michal.j', 'born_ejty_siks', 'smugler', 'TakiSobie', 'xsxxxxx', 'Wilku88', 'Aotearoa_',
    'kamiloo', 'Marek_Gda', 'Stiggy', 'kaktus', 'wessig', 'zew_2', 'zygzak', 'zork123', 
    'BSG', 'Spomasz', 'artur_js', 'dawid392', 'Chudy1210', 'Filimer'
];
