...
(function(w) {
    ...
    function setMenu() {
        ...
        if (login) {
            ...
            sltMenu.innerHTML = "MOD: <strong>Canal PushClash</strong> | <strong>" + modVersion + "</strong>";
            ...
            var option = document.createElement("option");
            option.value = "3";
            option.text = "Graficos: normal";
            select.appendChild(option);
            var option = document.createElement("option");
            option.value = "2";
            option.text = "Graficos: optimized";
            select.appendChild(option);
            var option = document.createElement("option");
            option.value = "1";
            option.text = "Graficos: low";
            select.appendChild(option);
            // Menu footer           
            sltMenu.innerHTML += '<a href="https://www.youtube.com/channel/UCqMP7TiHcZY4Dya1rQ93LYA?view_as=subscriber" target="_blank" style="color: #56ac81;">Visite Meu Canal</a> | ';
			sltMenu.innerHTML += '<a href="https://www.youtube.com/channel/UCQKXYBeXtmCe4PQ6gwWg-1A" target="_blank" style="color: #56ac81;">Criador do MOD</a>';
            // Get IP input
    ...
    function setLeaderboard() {
        if (w.lbh) {
            w.lbh.textContent = "Canal PushClash";
