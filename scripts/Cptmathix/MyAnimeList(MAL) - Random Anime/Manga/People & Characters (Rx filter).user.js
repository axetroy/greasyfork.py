...
(function() {
    ...
    function getRandomAnime() {
        ...
        var r = Math.floor(Math.random() * 40000);
        $.get('/includes/ajax.inc.php?t=64&id=' + r, function(result) {
            if (result.length > 29 && result.indexOf('Hentai') == -1) {
    ...
    function getRandomManga() {
        ...
        var r = Math.floor(Math.random() * 130000);
        $.get('/includes/ajax.inc.php?t=65&id=' + r, function(result) {
            if (result.length > 0 && !result.match(/(Hentai|Yaoi|Yuri)/)) {
    ...
    function getRandomCharacter() {
        ...
        var r = Math.floor(Math.random() * 200000);
