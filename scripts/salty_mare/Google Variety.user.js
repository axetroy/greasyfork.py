...
// @description	  Google search with daily wallpapers from Yandex & Bing, or random wallpapers from Unsplash.it & Unsplash.com .
// @author        creampie
// @homepage      https://userstyles.org/styles/128178
// @run-at        document-start
// @version       0.20180604133620
// ==/UserScript==
(function() {var css = "";
if (false || (new RegExp("^https://(www|encrypted|images).google.(com|co.[a-z]{2}|com.[a-z]{2}|[a-z]{2})?/(?!(maps)).*$")).test(document.location.href))
	css += [
		"/* front page & general*/",
		"",
		"body.hp {",
		"    background: linear-gradient(to bottom, rgba(255, 255, 255, 0.6), rgba(255, 255, 255, 0.5) 43px, rgba(255, 255, 255, 0.4) 92px, rgba(255, 255, 255, 0.3) 146px, rgba(255, 255, 255, 0.2) 210px, rgba(255, 255, 255, 0.1) 295px, rgba(255, 255, 255, 0) 500px), url(https://unsplash.it/1920/1080/?random)!important;",
		...
		"",
		"#spch {",
		"    background: linear-gradient(to bottom, rgba(255, 255, 255, 0.6), rgba(255, 255, 255, 0.5) 43px, rgba(255, 255, 255, 0.4) 92px, rgba(255, 255, 255, 0.3) 146px, rgba(255, 255, 255, 0.2) 210px, rgba(255, 255, 255, 0.1) 295px, rgba(255, 255, 255, 0) 500px, rgba(255, 255, 255, 0)), url(https://unsplash.it/1920/1080/?random)!important;",
		"    height: 100%!important;",
		"    background-position: center!important;",
		"    background-size: cover;",
		"    background-attachment: fixed;",
		...
		"    background: linear-gradient(to top, rgba(250, 250, 250, 1), rgba(250, 250, 250, 0.2)), url(https://unsplash.it/1920/1080/?random), white!important;",
		...
		"",
		".srp #footcnt {",
		"    background: linear-gradient(to bottom,white, white calc(100% - 83px), rgba(255,255,255,0) calc(100% - 83px),rgba(255,255,255,0) ), url(https://unsplash.it/1920/1080/?random)!important;",
		...
		"/*image viewer*/",
		"#irc_bgl {",
		"    background: url(https://unsplash.it/1920/1080/?random)!important;",
		"    height: 100%!important;",
		"    background-position: top center!important;",
		"    background-attachment: fixed!important;",
		"    background-repeat: no-repeat;",
...
if (false || (document.domain == "www.google.com" || document.domain.substring(document.domain.indexOf(".www.google.com") + 1) == "www.google.com") || (new RegExp("^https://(www|encrypted|images).google.(com|co.[a-z]{2}|com.[a-z]{2}|[a-z]{2})?/.*$")).test(document.location.href))
	css += [
