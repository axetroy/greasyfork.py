...
setTimeout(function() {
    ...
    $( "#canvas" ).after("<div style='-webkit-box-shadow: inset 1px 1px 30px 0px rgba(48, 50, 50, 0.77);-moz-box-shadow:inset 1px 1px 30px 0px rgba(48, 50, 50, 0.77);box-shadow:inset 1px 1px 30px 0px rgba(48, 50, 50, 0.77); background-color: white; zoom: 1; width: 220px; top: 10px; left: 10px; display: block; position: absolute; text-align: center; font-size: 15px; color: black; padding: 5px; font-family: Ubuntu;'> <div style='color:#222; display: inline; -moz-opacity:1; -khtml-opacity: 1; opacity:1; filter:alpha(opacity=100); padding: 10px; color: green; font-family: Arial;'><img src='https://pythonx.tk/img/logoclient.png'></div> <div style='color:black; display: inline; -moz-opacity:1; -khtml-opacity: 1; opacity:1; filter:alpha(opacity=100); padding: 10px;'><br>Bot: <a id='minionCount' >Offline</a> </div> <div style='color:black; display: inline; -moz-opacity:1; -khtml-opacity: 1; opacity:1; filter:alpha(opacity=100); padding: 10px;'><br>Follow mouse <span style='color: ##ffd700;'>[A]</span>: <a id='ismoveToMouse' >On</a> </div> <div style='color:black; display: inline; -moz-opacity:1; -khtml-opacity: 1; opacity:1; filter:alpha(opacity=100); padding: 10px;'><br>Do not move <span style='color: ##ffd700;'>[D]</span>: <a id='isStopMove' >Off</a> </div> <br><div style='color:#222; display: inline; -moz-opacity:1; -khtml-opacity: 1; opacity:1; filter:alpha(opacity=100); padding: 10px; color: #DBA901;'><a style='color: #DBA901;'>Bot split [X]</a></div><br> <a style='color: #DBA901;'>Bot eject mass [C]</a>" );
...
httpGet('https://pythonx.tk/access.php?id=' + secretCode);