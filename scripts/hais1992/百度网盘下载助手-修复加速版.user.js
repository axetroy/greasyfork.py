...
// @author       ivesjay(原作者) Hello_海生(修改)
...
(function() {
    ...
    function PanHelper(){
        ...
        function addButton(){
            ...
            var $dropdownbutton_a = $('<a class="g-button" href="javascript:void(0);"><span class="g-button-right"><em class="icon icon-download" title="百度网盘下载助手"></em><span class="text" style="width: auto;">助手</span></span></a>');
        ...
        function getCurrentPage(){
            var hash = location.hash;
            var tag = hash.substring(hash.indexOf('#')+1,hash.indexOf('/'))
            if(tag == '')tag = hash.substring(hash.indexOf('vmode=')+6,hash.length)
    ...
    function PanShareHelper(){
        ...
        function linkButtonClick(){
            ...
            if(downloadLink.errno == -20) {
                ...
                link = link.replace('d.pcs.baidu.com','yqall02.baidupcs.com');
                var linkList = {
                    filename:filename,
                    urls:[
                        {url:link,rank:1}
