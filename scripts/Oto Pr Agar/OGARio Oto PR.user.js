...
function inicio() {
    document.title = "OGARio Oto PR";
    modificarTextoMinimapa("By Oto PR");
    modificarFooter("Visita mi página web", "http://agarioje.webnode.es/");
    panelDerecho();
    ocultarBotonAdelante();
    ocultarBotonAtras();
    modificarMargenesPanel();
    
    alert("Bienvenidos ami extensión :)");
}
...
}modificarFooter("Visita mi página web", "http://agarperu.pe.hu/");