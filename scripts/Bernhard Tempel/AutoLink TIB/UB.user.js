...
// Für Abfrage im Picaplus-Format (Parsing der Signatur einfacher)
	libraryUrlPatternA = "https://opac.tib.eu/DB=1/LNG=DU/CMD?ACT=SRCHA&PRS=PP%7F&TRM=(not+lcd+eblpda)+and+num+";
// Für Einfügen des Links auf den Katalog
	libraryUrlPatternB = "https://opac.tib.eu/DB=1/LNG=DU/CMD?ACT=SRCHA&IKT=1016&SRT=YOP&TRM=num+";
