...
function inicio() {
    document.title = "OGARio";
    modificarTextoMinimapa("By Wolf");
    modificarTextoLeaderboard("ƲƑ❖");
    modificarCanalYoutube("United Force", "UCC6hurPo_LxL7C0YFYgYnIw");
    modificarFooter("UnitedForce-Wolf");
    ocultarBotonAdelante();
    ocultarBotonAtras();
    modificarMargenesPanel();
    colorPanelCentral();
    
    alert("WELCOME TO EXT ƲƑ❖");
}
