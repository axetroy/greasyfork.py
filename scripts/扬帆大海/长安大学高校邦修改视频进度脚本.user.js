// ==UserScript==
// @name         长安大学高校邦修改视频进度脚本
// @namespace    www.tjsky.net
// @version      0.1.1
// @description  一键看完视频，用于长安大学高校邦 ,谢谢广城高校邦的原作者！
// @author       0扬帆大海0
// @match        http://chdcx.class.gaoxiaobang.com/*
// @run-at       document-end
// @grant        none
// ==/UserScript==
'use strict';
...
function f_help(){
    alert("等视频开始播放后，点击修改，会直接跳到完成，效果不会立即出来，刷新页面或者直接进入下一节即可看到效果，如出现显示已完成但视频还没放完可尝试返回一次“我的课程”界面！’");
}
...
function f_exec(){
    ...
    else
    {
        ...
        var url="http://chdcx.class.gaoxiaobang.com/log/video/"+arg1+"/"+arg2+"/api?"+time;
