...
function accountGo() {
	...
	var accountBlock = elc('div',{style:{border:'1px solid blue',width:'95%'}},[
		elc('div',{style:{backgroundColor:'blue',color:'white',fontWeight:'bold',textAlignment:'center',padding:'1px 0'}},'Auto Choice'),
		prefContent
	]);
	...
	tgt.insertBefore(accountBlock,tgt.lastChild);
}
