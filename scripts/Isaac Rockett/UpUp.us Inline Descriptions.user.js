...
// @exclude        http://*kingdomofloathing.com/charpane.php*
...
var hoverItems = snap(".//img[contains(@onclick,'descitem(') or contains(@onclick,'item(')]|.//a[contains(@href,'descitem(')]");
