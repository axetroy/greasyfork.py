...
(function () {
    ...
    function PanHelper() {
        ...
        function addButton() {
            ...
            $('.g-dropdown-button.last-button').parent().append($dropdownbutton);
        }
        ...
        function getOuterlinkBatchLinkFirst(list) {
            ...
            $.each(list, function (index, element) {
                result.push({
                    filename: element.filename,
                    downloadlink: element.links[0].url
                });
            });
            return result;
        }
        ...
        function getCurrentPage() {
            var hash = location.hash;
            return decodeURIComponent(hash.substring(hash.indexOf('vmode=') + 6));
        }
