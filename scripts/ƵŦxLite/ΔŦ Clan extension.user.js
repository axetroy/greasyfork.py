...
// @namespace https://greasyfork.org/users/17135
// ==/UserScript==
    ...
    function miniMapInit() {
        ...
        if ($('#mini-map-wrapper').length === 0){
            var wrapper = $('<div>').attr('id', 'mini-map-wrapper').css({position: 'fixed',bottom: 10,right: 10,width: 160,height: 160,background: 'rgba(60, 60, 60, 0.58)'});
            ...
            $("#setka table").css({"borderSpacing":"0px","font":"normal 10px Arial"});
            $("#setka table tr>td").css({"textAlign":"center","border":"1px solid black"});
