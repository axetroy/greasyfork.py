...
// @namespace  Wall Manager Sidekick (PT)
// @description    Assists Wall Manager with Pioneer Trail posts
// @require https://greasyfork.org/scripts/765-wm-common-library/code/WM%20Common%20Library.js?version=2185
...
// @include        https://www.facebook.com/lists/*
...
//December 2014 adds
"science tong","tweezer","cow feed","unstable concoction","chicken mix","mesh wiring","boot spikes","danger sign","pig feed","extra long shovel","radioactive leader","hollow leather",
"backup grain","milk crate","large net","hunting supplies","old door","ink pen","bottomless cage","pumpkin guts",
"crazy politician","depressing memory","hard labor","helping hand","good deed","loving parent","baby talk","support frame","silly card","educated teacher","empty bank","festive barrier",
"play shovel","trick knee","spice",
"clear tape","finished gift","nice list","beautiful bow",
"worn mitts","strange feeling","eager stallion",
"claw grabber","squash snack","locker hardware","growin' cone","silk weave","photo documentation","eau de skunk","trippin' cord","ship brass","scared neighbor","used blanket","cross beam",
"unfashionable frame","kiight's valor","squared frame",
"confidence","kerosene fire","feather brush","extended arm","mop handle","old key","holdin' tank","cheese covering","metal bucket","steel spike","thick steel",
"bone bat","incensed candle","skull mold","cleanish sheet",
"hard liquor fuel","velvet pillow",
"old hound","eager cow","carrier pigeon","cooking oil","hat stretcher","chocolate laxative","raw chocolate","oven mitt","boiled leather glove","empty mitt","frontier caviar","hair mousse","romantic writing",
"landing pad","lightweight framing","gildin' wings","gear bit","test barrel","coffee snack","distilled stuff","lockin' buckle","metal vase","motor oil","puffy tire",
"well worn tool","tools of the trade","baby's breath",
"nurturing parent","pink box","oval basin",
"safety bubble","floating tube","jack's outrage","swim trunk","banister","romantic poetry","summer shade","shade maker","waterproof plank","chilly water",
"frontier knowledge","frontier agreement",
"sweet piccolo","varmint grant","sheet stand",
"smoke blanket","herb mix","flint dust","good luck charm","gull feather","canvas cloth","blank soil","dipping chocolate",
"inspector info","vigorous scrubbing","cleaned up area","blue coverall","sturdy plywood","polished frame","hand sized hole","flag fabric",
"combination lock","metal frame","phillips screwdriver","sissy's lasso","chalk outline","hittin' mitts","hungry goat","cleanish bucket","pit shovel","balanced axe","witness report",
"honest work","reinsmanship",
"club handle","well crafted layout",
"solid gold ring","scally wag flag","contrite word",
"sturdy roller","lightning catcher","public support","shady deal","quick-gro","thick wall","perfect cut","case for statehood",
"purple petal","used sock","audience",
"battalion portrait","etched vase","wooden loops","goody design","unbreakable hammer","make shift shelf","mournful memory","family tree","half barrel","used saddle",
"thinking pipe","voucher","suspect sketch","dark soil","special salve","fancy merch",
"tree jack","shiny shovel","welcome pamphlet","carved letter",
"leather mallet","canned good","strap","homemade baseball","porcelain glue","cake batter","frontier softball","practice stand","25 lb sledge hammer","hollow hammer head","fire retardant",
"frying tong","culinary flair","grease thermometer","safety rails","power water","itty bitty buckle","smooth case","itchy trigger finger","sissy's lock","honesty testimony",
"chupacabra club","ancient art book","old compass","groundhog track","snake bite","bear barrel","paper mache",
"kombucha culture","cheese culture","fed scent",
"veterinary cone","down glove","angling basket","ancient tomb","coop key","cook pot","point harness","easter glove","horse tranquilizer","oak armour","pitch",
"rope oil","practice equipment",
"proper math","cartographer kit","compromise","truth serum","tennis racket","handled frame",
"barnyard dog","dirty hoe","roid rabbit","hand fashioned shank","doc’s questionable blend","sprinkler head","homestead direction","thick glasse","tinted monocle","periscope",
"carvin wood","welcoming wreath","glass ornament","fine brush","widdling tool","old desk","bells n' whistle","flat rubber band","positive energy",
"flat crowbar","paint dissolver","lime mix","electrode","metal sealant","walking plank","ted's family photo","kingly bags","annabelle's picture","overstuffed upholstery",
"castle brick","thick chain","long frilly feather","chainmail doublet","square spire","buckler base","kneeling pedestal","hedge shear","crested ring","heavy sword",
"trailer top","chocolate top hat","skeleton marionette","mausoleum candle","skull frame","love one's picture","candle string","recycle fabric","broken phonograph",
"harnesser","offer bowl","incense cone","arch top","wall drape","low table","fancy footstool","set candle","tea setting","burnin' matches",
"mitre saw","steam drill","copper spyglass","stair stringer","tree fort stove","framing hammer","brass pulley","jesse james poster","circular hole",
"blue pacifier","shaky rattle","cloth diaper","country mobile","feathery stuffing","night light","hard plank","soft blanket",
"construction crew","sculpting crew","message chair","paddle wheel","parking meter","painted line","warnin' ticket","ridin' instruction","stay right arrow",
"pairs of matresses","welcome packet","itchy blanket","overpriced textbook","stack of unread books","varmint curriculum","final exam","graduated cylinder","plagarism",
"cleanin' brooms","brass dustpan","old fashioned dress","perfume puffer","frontier know-how","relationship advice","prison experience","steele's warrant","deodorant spray","sturdy stitching","potpourri mask","tin sanitizer",
"loan contract","landscaper","medieval tower","ancient mortar","microscope","small wheel","joseph's passport","golf tee",
"scavanged ship part","skury disguise","gunnwain funnel","treasure tail","treasure hunting attire","swing line","brass money","loose fitting clothing","cannon barrel",
"sturdy thread","blue fabric","gills of vinegar","72 hops","ink bullet","musket barrel","granny's flag","granny snare","cargo net","hard sweet",
"palm branch","luau shovel","tiny umbrella","plush headrest","tropical flower arrangement","whittling implements","wooden plates","jungle juice","carving hatchet","tropical fruit medley",
"missing sign","road map","anonymous tip","duster","reward sign","pulse check","oil trap","scounting lens","bull barrel","resistant stucco",
"transplant tree","tasteful decor","human chain","sharpened stake","sturdy chair","monkey wrench","guard cat","ceramic capsule","responsible direction",
"ax handle","archaeology whip","mortar","scaffold nail","metal pole","catch pole","vicious crocodile","faux fur","bull stampede",
"gallery blueprint","chicken warmer","modern art","high class hat","chiseled model","cocktail","caber-neigh","vinyl cylinder","trainable yokel",
"horse hitch","flashy sign","practice target","fancy pattern","extra rope","broken shovel","bright bridles","riding practice","sturdy stirrup","flashy spark",
"flag pin","jack's flag","slogan spouter","black tint","mediocre mediator","one sided opinion","telegraph dispatch","celebrity endorsement","frontier made drawer","children's art supply",
...
//MASS COLLECTION---------------------------------------------------------------------------------
			...
			menu: {
				section:{type:"section",label:"Pioneer Trail ("+version+")",kids:{
					updateSidekick:{type:"link",label:"Update Sidekick",href:"https://greasyfork.org/scripts/766-wall-manager-sidekick-pt/code/Wall%20Manager%20Sidekick%20(PT).user.js"},
					...
					sephomestead:{type:"separator",label:"Homestead",kids:{
						Missionstab:{type:'tab',label:'Missions',kids:{
						meteorstrike:buildBlock({arr:["science tong","tweezer","cow feed","unstable concoction","chicken mix","mesh wiring","boot spikes","danger sign","pig feed","extra long shovel","radioactive leader","hollow leather",],label:"Meteor Strike",prefix:"send",accText:allAccTexts,newitem:true,}),
						wildturkeys:buildBlock({arr:["backup grain","milk crate","large net","hunting supplies","old door","ink pen","bottomless cage","pumpkin guts",],label:"Wild Turkeys",prefix:"send",accText:allAccTexts,newitem:true,}),
						eddysfreshstart:buildBlock({arr:["play shovel","trick knee","spice",],label:"Eddy's Fresh Start",prefix:"send",accText:allAccTexts,newitem:true,}),
						eddysfreshstart:buildBlock({arr:["play shovel","trick knee","spice",],label:"Eddy's Fresh Start",prefix:"send",accText:allAccTexts,newitem:true,}),
						santashelpers:buildBlock({arr:["clear tape","finished gift","nice list","beautiful bow",],label:"Santa's Helpers",prefix:"send",accText:allAccTexts,newitem:true,}),
						tedsdad:buildBlock({arr:["worn mitts","strange feeling","eager stallion",],label:"Ted's Dad",prefix:"send",accText:allAccTexts,newitem:true,}),
						bigfootsback:buildBlock({arr:["claw grabber","squash snack","locker hardware","growin' cone","silk weave","photo documentation","eau de skunk","trippin' cord","ship brass","scared neighbor","used blanket","cross beam",],label:"Bigfoot's Back",prefix:"send",accText:allAccTexts,newitem:true,}),
						frontierchivalry:buildBlock({arr:["unfashionable frame","kiight's valor","squared frame",],label:"Frontier Chivalry",prefix:"send",accText:allAccTexts,newitem:true,}),
						hauntedmansion:buildBlock({arr:["confidence","kerosene fire","feather brush","extended arm","mop handle","old key","holdin' tank","cheese covering","metal bucket","steel spike","thick steel",],label:"Haunted Mansion",prefix:"send",accText:allAccTexts,newitem:true,}),
						dayofthedead:buildBlock({arr:["bone bat","incensed candle","skull mold","cleanish sheet",],label:"Day of the Dead",prefix:"send",accText:allAccTexts,newitem:true,}),
						genieswish:buildBlock({arr:["hard liquor fuel","velvet pillow",],label:"Genies Wish",prefix:"send",accText:allAccTexts,newitem:true,}),
						bachelorettegranny:buildBlock({arr:["old hound","eager cow","carrier pigeon","cooking oil","hat stretcher","chocolate laxative","raw chocolate","oven mitt","boiled leather glove","empty mitt","frontier caviar","hair mousse","romantic writing",],label:"Bachelorette Granny",prefix:"send",accText:allAccTexts,newitem:true,}),
						docsflyinmachine:buildBlock({arr:["landing pad","lightweight framing","gildin' wings","gear bit","test barrel","coffee snack","distilled stuff","lockin' buckle","metal vase","motor oil","puffy tire",],label:"Doc's Flyin Machine",prefix:"send",accText:allAccTexts,newitem:true,}),
						growinpains:buildBlock({arr:["well worn tool","tools of the trade","baby's breath",],label:"Growin' Pains",prefix:"send",accText:allAccTexts,newitem:true,}),
						bessbaby:buildBlock({arr:["nurturing parent","pink box","oval basin",],label:"Bess'  Baby",prefix:"send",accText:allAccTexts,newitem:true,}),
						summervacation:buildBlock({arr:["safety bubble","floating tube","jack's outrage","swim trunk","banister","romantic poetry","summer shade","shade maker","waterproof plank","chilly water",],label:"Summer Vacation",prefix:"send",accText:allAccTexts,newitem:true,}),
						frontiervillethestate:buildBlock({arr:["frontier knowledge","frontier agreement",],label:"Frontierville The State",prefix:"send",accText:allAccTexts,newitem:true,}),
						piedpiper:buildBlock({arr:["sweet piccolo","varmint grant","sheet stand",],label:"Pied Piper",prefix:"send",accText:allAccTexts,newitem:true,}),
						solareclipse:buildBlock({arr:["smoke blanket","herb mix","flint dust","good luck charm","gull feather","canvas cloth","blank soil","dipping chocolate",],label:"Solar Eclipse",prefix:"send",accText:allAccTexts,newitem:true,}),
						frontierinspection:buildBlock({arr:["inspector info","vigorous scrubbing","cleaned up area","blue coverall","sturdy plywood","polished frame","hand sized hole","flag fabric",],label:"Frontier Inspection",prefix:"send",accText:allAccTexts,newitem:true,}),
						maskedlassoreturns:buildBlock({arr:["combination lock","metal frame","phillips screwdriver","sissy's lasso","chalk outline","hittin' mitts","hungry goat","cleanish bucket","pit shovel","balanced axe","witness report",],label:"Masked Lasso Returns",prefix:"send",accText:allAccTexts,newitem:true,}),
						bessniece:buildBlock({arr:["honest work","reinsmanship",],label:"Bess' Niece",prefix:"send",accText:allAccTexts,newitem:true,}),
						frontiergolf:buildBlock({arr:["club handle","well crafted layout",],label:"Frontier Golf",prefix:"send",accText:allAccTexts,newitem:true,}),
						tedstreasure:buildBlock({arr:["solid gold ring","scally wag flag","contrite word",],label:"Ted's Treasure",prefix:"send",accText:allAccTexts,newitem:true,}),
						fourthofjuly14:buildBlock({arr:["solid gold ring","scally wag flag","contrite word"],label:"4th of July (2014)",prefix:"send",accText:allAccTexts,newitem:true,}),
						representativejack:buildBlock({arr:["sturdy roller","lightning catcher","public support","shady deal","quick-gro","thick wall","perfect cut","case for statehood",],label:"Representative Jack",prefix:"send",accText:allAccTexts,newitem:true,}),
						fouryranniversary:buildBlock({arr:["purple petal","used sock","audience",],label:"4 yr Anniversary",prefix:"send",accText:allAccTexts,newitem:true,}),
						fathersday14:buildBlock({arr:["battalion portrait","etched vase","wooden loops","goody design","unbreakable hammer","make shift shelf","mournful memory","family tree","half barrel","used saddle",],label:"Father's Day (2014)",prefix:"send",accText:allAccTexts,newitem:true,}),
						minsexpress:buildBlock({arr:["thinking pipe","voucher","suspect sketch","dark soil","special salve","fancy merch",],label:"Min's Express",prefix:"send",accText:allAccTexts,newitem:true,}),
						wildlifepreserve:buildBlock({arr:["tree jack","shiny shovel","welcome pamphlet","carved letter",],label:"Wildlife Preserve",prefix:"send",accText:allAccTexts,newitem:true,}),
						countryfairgames:buildBlock({arr:["leather mallet","canned good","strap","homemade baseball","porcelain glue","cake batter","frontier softball","practice stand","25 lb sledge hammer","hollow hammer head","fire retardant",],label:"Country Fair Games",prefix:"send",accText:allAccTexts,newitem:true,}),
						gratchettsatthefair:buildBlock({arr:["frying tong","culinary flair","grease thermometer","safety rails","power water","itty bitty buckle","smooth case","itchy trigger finger","sissy's lock","honesty testimony",],label:"Gratchetts at the Fair",prefix:"send",accText:allAccTexts,newitem:true,}),
						chupacabra:buildBlock({arr:["chupacabra club","ancient art book","old compass","groundhog track","snake bite","bear barrel","paper mache",],label:"Chupacabra",prefix:"send",accText:allAccTexts,newitem:true,}),
						frontierculture:buildBlock({arr:["kombucha culture","cheese culture","fed scent",],label:"Frontier Culture",prefix:"send",accText:allAccTexts,newitem:true,}),
						threeeasters:buildBlock({arr:["veterinary cone","down glove","angling basket","ancient tomb","coop key","cook pot","point harness","easter glove","horse tranquilizer","oak armour","pitch",],label:"13 Easters",prefix:"send",accText:allAccTexts,newitem:true,}),
						sissyswildwestshow:buildBlock({arr:["rope oil","practice equipment",],label:"Sissy's Wild West Show",prefix:"send",accText:allAccTexts,newitem:true,}),
						frontierpolitics:buildBlock({arr:["proper math","cartographer kit","compromise","truth serum","tennis racket","handled frame",],label:"Frontier Politics",prefix:"send",accText:allAccTexts,newitem:true,}),


	sciencefair:buildBlock({arr:["balloon gas","booth application","booth sign","chemistry book","copious notes","copper disc","display board","glass cage","improvised ingenuity","rough sketch","short post","spirit of cooperation","terrified tortoise","testing compound",],label:"Science Fair",prefix:"send",accText:allAccTexts,}),
						maskedlasso:buildBlock({arr:["deers toebuck catalog","five yardof black cloth","ground melatonin","knitting yarn","knot tying manual","kobe beef filet","reading glass","slender crowbar","soothing syrup","sturdy wood","10 pounds of gunpowder","transaction receipt","wire cutter",],label:"Masked Lasso",prefix:"send",accText:allAccTexts,}),
						leprechaunkings:buildBlock({arr:["blarney pebble","drinking jug","green free neighbor","horizontal support","irish spirit","irishman's incense","leprechaun repellent  ","old tent stake","pushin' power","rock shamrock","rune decoder","runic guide","uilleann pipe",],label:"Leprechaun Kings",prefix:"send",accText:allAccTexts,}),
						runtsrunt:buildBlock({arr:["abandoned water wheel","alligatoraid","body by runt","catclaw","chamois cloth","corner piece","deer antler powder","horse sling","rough toboggan","sanitation basin","stealth snare","tortuga wax","wagon spoke","workout leotard",],label:"Runt's Runt",prefix:"send",accText:allAccTexts,}),
						boskitchen:buildBlock({arr:["airtight canister","bird feed","broken ladle","cod fillet","dishwasher","exit sign","kerosene fuel","smothering blanket","spicy batter","stained oven mitt","tying strap","tying string","wide bowl",],label:"Bo's Kitchen",prefix:"send",accText:allAccTexts,}),
						lunarny:buildBlock({arr:["ancient scroll","dog house","dragon platter","elemental scale","eternal flame","iron will","manual sundial","peer review","sheep intellect",],label:"Lunar New Year",prefix:"send",accText:allAccTexts,}),
						...
						thanksandgiving:buildBlock({arr:["thankful memory","tip tap timing","fine leather","lovely loom","patient air","churnin' device","grinding stone","feather fletching","weaved horn","admirable tone",],label:"Thanks and Giving",prefix:"send",accText:allAccTexts,}),
						hibernationpreparation:buildBlock({arr:["warm jammies","wooden piece","animal night cap","packing mud","winter mix","mounted bottle","filled boxe","bear feet","wee bedframe","extra oil",],label:"Hibernation Preparation",prefix:"send",accText:allAccTexts,}),
						hotsprings:buildBlock({arr:["liquid soap","test tube","elastic band","stored toolbelt","mineral sample","steamy sight","spa reservation","stress relief","fine sieve","dripping device","spring location","thermal treatment","connector q’","building gear","wet towel","forge wood",],label:"Hot Springs",prefix:"send",accText:allAccTexts,}),
						harvestfestival:buildBlock({arr:["varmint repellent","long handled brush","fancy table cloth","harvest table","sharp pitch fork","leafy rope","sealing tar","doorknob","table cloth patch","makeshift chair","veggie scrap","scrounged sweetener",],label:"Harvest Festival",prefix:"send",accText:allAccTexts,}),
						ghostlytriplets:buildBlock({arr:["ancient text","black bidding","timeless verse","white collar","dusty overall","dark dinnerware","frozen carbon","dusting mask","roofing frame","lamp oil","ragged clothing","sorted disorder","historical entry",],label:"Ghostly Triplets",prefix:"send",accText:allAccTexts,}),
						trickortreat2013:buildBlock({arr:["animold","bright sprinkle","buffer cloth","heavy chain","mad science book","narrow nozzle","preservation jar","sour fish","spooky costume","sticky granola","sweet powder","tiny beret","witchs’ powder",],label:"Trick Or Treat 2013",prefix:"send",accText:allAccTexts,}),
						froghaven:buildBlock({arr:["amphibious amp","slippery spirit","frog motivator","white pole","clean water","starting shot","misting mover","stick tongue","etching brand","pollywog power","misting motor","boarded frame","inset base","water feeder","tad pole egg","planting shovel","sun stone","tinted glass","volunteer lips","sticky tongue",],label:"Frog Haven",prefix:"send",accText:allAccTexts,}),
						naturefury:buildBlock({arr:["offering bowl","noodle soup","spirit charm","water's woe","vivid dye","energy detector","inert dream catcher","fast horse","natural guidance","magnetized needle","wide barreled musket",],label:"Nature's Fury",prefix:"send",accText:allAccTexts,}),
						bugcollecting:buildBlock({arr:["holey jar","long pin","left-over bugs","decoy stick","eye dropper","glass cup","sturdy handle","thick paper","bee keeping hat","hoop","light net",],label:"Bug Collecting",prefix:"send",accText:allAccTexts,}),
						goldenfiddle:buildBlock({arr:["gold polish","unsavory meat","backwood map","lawful know how","shiny bead","cuttin' grip","silver coin","slotted box",],label:"Golden Fiddle",prefix:"send",accText:allAccTexts,}),
						dreadfuldrought:buildBlock({arr:["irritation pipe","low flow sprinkler","push pump","bug proof tarp","light","big boiler","water filter","pound sledge","trash can","water filter","thermal detonator",],label:"Dreadful Drought",prefix:"send",accText:allAccTexts,}),
						basketball:buildBlock({arr:["burro ball","hoop fastener","jackhole jersey","cleaning kit","team color","accurate trim","shoe stitching","burro blessing","good grip",],label:"Basketball Court",prefix:"send",accText:allAccTexts,}),
						warehouse:buildBlock({arr:["glass repair kit","secret door","sluething cap","camera piece","hound leash","winch","decoy note","wanted flyer","grooved wheel","shiny bait","hidden disguise",],label:"Warehouse",prefix:"send",accText:allAccTexts,}),
						fishingderby:buildBlock({arr:["heavy pebble","fly reel n' line","lifting help","line crank","engraved pole","boat schematic","boat bucket","ornate clasp","wood stiffener","hook n' tie",],label:"Fishing Derby",prefix:"send",accText:allAccTexts,}),
						swimminghole:buildBlock({arr:["fanny pack","building tool","swimsuit","flippy floppies","water ski","dinghies","piercing whistle","deck chair","bright floater","dam outlet pipe","dam hole plugger","dam thick mud","gear shift",],label:"Swimming Hole",prefix:"send",accText:allAccTexts,}),
						summercamp:buildBlock({arr:["camp kit","camp patch","depth gear","joint fastener","packed smore","precise pick","second opinion","threaded bottle","wet patch",],label:"Summer Camp",prefix:"send",accText:allAccTexts,}),
						pilgrimageprer:buildBlock({arr:["travel cloak","sleeping bag","campsite torch","wooden support","luck charm","signal blanket","natural drill","spirit drum","spiritual tea","scalding stone","colorful beads","inert totem",],label:"Pilgrimage Prep",prefix:"send",accText:allAccTexts,}),
						besswedding:buildBlock({arr:["pretty hydrangea","cut doilie","calming tea","white dove","padded leather","lots of ice","hay cushion","tie down rope","breathing bag","family jewel","extra thread",],label:"Bess Wedding",prefix:"send",accText:allAccTexts,}),
						supplydepot:buildBlock({arr:["clothing rack","vaporizer","spit guard","used rucksack","fancy writin'","rustic painting","smooth velvet","shopping cart","critter conveyor","broken cart","snow spade","dynamite stick","spare helmet","spare pick","recycled nail","rock vaporizer","stone chisel","small trowel",],label:"Supply Depot",prefix:"send",accText:allAccTexts,}),
						independence2013:buildBlock({arr:["lighting wick","powder mix","colored chemical","powder mix","wooden tube","sparkler dip","wooden tube","sparkler dip","amour blend","igniting charge","flame fixer",],label:"Indepedence Day 2013",prefix:"send",accText:allAccTexts,}),
						sodashop:buildBlock({arr:["hand lotion","storin' tank","extra bottle","soda capper","reflective glass","soda coloring","brass detailing","fancy glass","place mat","pressure pump","piano base",],label:"Soda Shop",prefix:"send",accText:allAccTexts,}),
						dinobones:buildBlock({arr:["dino know how","head cover","bone screw","di-notebook","hanglin' line","circular stone","precise pick","second opinion","tnt","acidic goo","dust goggle","case base","wide scrunchy","ancient water",],label:"Dinosaur Bones",prefix:"send",accText:allAccTexts,}),
						bullgames:buildBlock({arr:["bleak clamp","antler tape","chicken wire","puffy short","protection rope","wore wall","rear pad","cut off boot tops","coarse cloth","doc box","ring wall","trophy base","strong breathes",],label:"Bull Game",prefix:"send",accText:allAccTexts,}),
						scavengerhunt:buildBlock({arr:["clearin' cutter","spare rope","weaved basket","belt pouch","belt buckle","leather top","air-tight bag","alluring bottle",],label:"Scavenger Hunt",prefix:"send",accText:allAccTexts,}),
						thirdanniversary:buildBlock({arr:["balloon pumper","punch bowl","trash collector","colored hankie","floatin' device","long tarp","thick lumber","park bird bath","barrel base","hay pile","sweet treat",],label:"3rd Anniversary",prefix:"send",accText:allAccTexts,}),
						rabbitranch:buildBlock({arr:["cotton collar","pen post","berry blush","bunny lip balm","comfy seat","hare conditioner","bruised veggies","lavish leafage","flat board","big bottle","veggie stalk",],label:"Rabbit Ranch",prefix:"send",accText:allAccTexts,}),
						grangehalls:buildBlock({arr:["historic item","glass door","town map","fixing glue","wash bin","stretchy hose","bright lantern","drinkin' troughs","stencil","chair frame","frontier gift",],label:"Grange Hall",prefix:"send",accText:allAccTexts,}),
						frontiercircus:buildBlock({arr:["spare tent","taming chair","trampoline","sparkly sequins","oil rub","wooden helmet","clown nose",],label:"Frontier Circus",prefix:"send",accText:allAccTexts,}),
						sunsetcelebrate:buildBlock({arr:["amber spray","special seed","orange rub","green hose","aged bird home","wire support",],label:"Sunset Celebrations",prefix:"send",accText:allAccTexts,}),
						totems:buildBlock({arr:["nature spirit","spirit feed","shaman spirit spell","sharp saw","animal spell","jagged blade","carving stand","fine blade","crop spell","sharp obsidian","lumber spell","wood extracter","wheel stand",],label:"Totems",prefix:"send",accText:allAccTexts,}),
						kiteflying:buildBlock({arr:["rain jacket","kite plan","smithin' hammer","glass jar","wood grip","metal claw","crow feather","sandpaper",],label:"Flying Kites",prefix:"send",accText:allAccTexts,}),
						buildomatic:buildBlock({arr:["sparkling operator","stained plan","precise level","bull treat","gourd knife","quilted curtain","metal cylinder","recycled lumber","surplus wirin'",],label:"Build-O-Matic",prefix:"send",accText:allAccTexts,}),
						mysterywagon:buildBlock({arr:["fearless feed","mud boot","measurin' tape","tough comb","sample chart","waterproof liner","sealed log","phonograph cone","large net","trappin' board",],label:"Mystery Wagon",prefix:"send",accText:allAccTexts,}),
						springfling:buildBlock({arr:["long spring","balance bar","knitting supply","cider vinegar","active yeast","seamstress kit","faded cloth","small spring",],label:"Spring Fling",prefix:"send",accText:allAccTexts,}),
						stormshelter:buildBlock({arr:["chewing nail","coyote kiss","tranquil tidbit","steel ring","stretchy tarp","jacks track","pole portion","cowboy secret","mashin' pin","well-kept canister","fancy water",],label:"Storm Shelter",prefix:"send",accText:allAccTexts,}),
						butterflysanctuary:buildBlock({arr:["rearing cage","raindrop","workout ball","smooth landing strip","sugar crystal","rose extract","wind tube","cocoon feed",],label:"Butterfly Sanctuary",prefix:"send",accText:allAccTexts,}),
						egghatchery:buildBlock({arr:["egg-selent advice","warm stone","foreign fowl book","glass tool","yellow glaze","hot rock","hot candle","seat cushion","warmed-up seat","distilled water",],label:"Egg Hatchery",prefix:"send",accText:allAccTexts,}),
						goldenwaterfall:buildBlock({arr:["soft glove","balance scale","bow saw","river skiff","iron cladding","wide shovel","sifting frame","bear muzzle","iron cladding","big honeycomb","cord cutter","wood shear",],label:"Golden Waterfall",prefix:"send",accText:allAccTexts,}),
						lumberyard:buildBlock({arr:["axe sharpener","supply wgaon wheel","strong cable","hand crank","sign chain","stack stand","tracking paper","office wall","exterior nail","wall support","whoopi cushion","bark remover","frame supports","frog feed","wall boards",],label:"Lumber Yard",prefix:"send",accText:allAccTexts,}),
						springgarden:buildBlock({arr:["pipe bender","garden marker","small handle","building soil","cart box","tin cutter","weed mulch","basic grip","balancing soil",],label:"Spring Garden",prefix:"send",accText:allAccTexts,}),
						surveysituation:buildBlock({arr:["canvas patch","gravel bucket","squared post","stone chisel","mercury cistern","stable table","walnut board","brass sextant",],label:"Survey Office",prefix:"send",accText:allAccTexts,}),
						animalcompanioin:buildBlock({arr:["leftover bag","cut grass","noisy knick knack","expired boost","service medal","concrete base","sack of stuff","intriguing scent","glass tube","energy aura",],label:"Animal Companions",prefix:"send",accText:allAccTexts,}),
						rideablestorage:buildBlock({arr:["musical metal","chap strap","horseshoeing tool","tight knot","horse whistle","stable halter","wool pad","water trough","stable design","brass horse hook","heated blanket",],label:"Rideable Storage",prefix:"send",accText:allAccTexts,}),
						weddinggazebo:buildBlock({arr:["dog treat cutter","bon bon platter","hand cream","cucumber blindfold","rough towels","big ol' pail","long stem tulip","hyacinth bloom","pre-nuptial agreement",],label:"Wedding Gazebo",prefix:"send",accText:allAccTexts,}),
						kittens:buildBlock({arr:["kitty leash","shaggy rug","kite string","kitten ladder","adorable bow","cuddle pillow","flea powder","bamboo pole","catnip oil",],label:"Kitten Conundrum",prefix:"send",accText:allAccTexts,}),
						botanicalgarden:buildBlock({arr:["cleaning supply","steak sauce","flower start","ladybug","garden fencing","exotic butterfly","latch screw","hedge trimmer","busy bees",],label:"Botanical Garden",prefix:"send",accText:allAccTexts,}),
						candyheart:buildBlock({arr:["candy heart mix","oiled wrench","press schematic","candy recipe","clean skillet","conveyor belt","letter block","candy basket","potbellied stove","geared wheel",],label:"Candy Heart Press",prefix:"send",accText:allAccTexts,}),
						expansion53:buildBlock({arr:["water can","good deals","shelter roofing","map cakes","quick silver boots",],label:"53 x 53 Expansion",prefix:"send",accText:allAccTexts,}),
						expansion51:buildBlock({arr:["warm clothes","hiking boots","murky swamp water","rock pillow","sticky wamp water",],label:"51 x 51 Expansion",prefix:"send",accText:allAccTexts,}),
						avalanche:buildBlock({arr:["tracking guide","thick thread","hawk food","heavy needle","goat manual","filter cloth","strap ring","hot soup","letter stencil","mini spring","rescue skills",],label:"Avalanche",prefix:"send",accText:allAccTexts,}),
						candyshop:buildBlock({arr:["gold paper box","lollipop stick","brown sugar cube","candy tray","gummy mould","sugar lump","fine sugar","chocolate dipper","vanilla syrup","colorful confetti",],label:"Candy Shop",prefix:"send",accText:allAccTexts,}),
						fallharvest:buildBlock({arr:["cutting reel","tough trowel","long tined rake","strong axle","iron u-bar","heavy bolt","revolving reel","helical rotor","round cushion","forked tines","seat platform","metal sprocket","pine air freshener",],label:"Fall Harvest and Combine",prefix:"send",accText:allAccTexts,}),
						quilting:buildBlock({arr:["patch backing","sewin' pin","cuttin' guide","long needle","nimble thread","rotary cutter","polished bracket","fabric scrap","cushion casing","foot pedal",],label:"Quilting",prefix:"send",accText:allAccTexts,}),
						thanksgiving2012:buildBlock({arr:["flimsy moccasin","wheel rim","cinnamon shaker","mushroom soup","tar sealant","pit rock","cushiony rod",],label:"Saving Thanksgiving",prefix:"send",accText:allAccTexts,}),
						turkeystampede:buildBlock({arr:["gobbler grow","mega grow","mower bottom","ice bath","skid","number bibs","old wood crate","spoke lever","race clock","hitching harness","golden leaf",],label:"Turkey Stampede",prefix:"send",accText:allAccTexts,}),
						inferno:buildBlock({arr:["hard water","critter salve","strong pulley","warning whistle","thick goggle","long range nozzle","hefty hinge","tall ladder","thick screw",],label:"Inferno and Extinguisher Building",prefix:"send",accText:allAccTexts,}),
						smokehouse:buildBlock({arr:["gun powder","smoked woodchip","cherry wood chip","strap hinge","foundation brick","slow burnin' wood","meat hanger","stove body","smokin' tong",],label:"Smoke House",prefix:"send",accText:allAccTexts,}),
						pigskinpark:buildBlock({arr:["pom pom","jersey knit kit","yard hose","dummy stand","stuffed dummy","team face paint","fan banner","pro uniform","puffy glove","climactic kick","passing practice","spikey sole","plank support",],label:"Pig Skin Party and Park",prefix:"send",accText:allAccTexts,}),
						launchpad:buildBlock({arr:["balloon gas","long screw","rake head","catch net","spring doohickey","snap buckle","trigger lever","brass arrow","winch cable",],label:"Launch Pad and Balloon Adventure",prefix:"send",accText:allAccTexts,}),
						holidaydecor:buildBlock({arr:["jolly decor","royal icing","gingerbread mix","ornament hook","red ornament","light string","gold buckle","jingly bell","wrapping tape",],label:"Holiday Decorations and Holiday Glade",prefix:"send",accText:allAccTexts,}),
						snowballfort:buildBlock({arr:["warm water","ground salt","thick yarn","digger scoop","roasted chestnut","sage honey","improved sled","fortress flag","y-shaped stick",],label:"Snowball Fort and First Snow",prefix:"send",accText:allAccTexts,}),
						merryville:buildBlock({arr:["carving tool","unpaired sock","glass bulb","secret formula","engraving tool","cider cloth",],label:"Merryville",prefix:"send",accText:allAccTexts,}),
						stainedglass:buildBlock({arr:["scoring pencil","mahogany frame","glass polish","silver glass","oak handle","iron frame","plier part","iron stand","perfect glass","teal glass",],label:"Stained Glass",prefix:"send",accText:allAccTexts,}),
						toyshop:buildBlock({arr:["crafting tool","secure bolt","small hat","wrangle controller","mini boot","steerin column","cart rim","workshop magic",],label:"Toy Shop and Being Santa",prefix:"send",accText:allAccTexts,}),
						climbingwall:buildBlock({arr:["climbing permit","knot diagram","cloth comforter","weight belts","hefty stone","carabiner","climbing pack","hand axe","hand crank","printed flyer","metal box",],label:"Climbing Wall and Healthy Hank",prefix:"send",accText:allAccTexts,}),
						pigeonloft:buildBlock({arr:["parcel label","jacket lining","garment bag","golden thread","bundling paper","official header","goggle strap","escargot fork","onion powder","chopped tomato","morsel",],label:"Pigeon Loft and Jack's Adventure",prefix:"send",accText:allAccTexts,}),
						icepond:buildBlock({arr:["gold lettering","red bobber","wooly worm","ice patch kit","stocking cap","suspender","pillow case","hockey puck","goal frame","boiling water",],label:"Ice Pond",prefix:"send",accText:allAccTexts,}),
						makebelieve:buildBlock({arr:["skinny branch","lookout tower","mop handle","active puppy","silk sail","rusty bucket","plain clothes",],label:"Make Believe",prefix:"send",accText:allAccTexts,}),
						snowslide:buildBlock({arr:["long john","cocoa flavor","recycled nail","handle bar","wagon ski","snow decoration","old len","cake decoration","farrier rasp",],label:"Snow Slide and Winterfest",prefix:"send",accText:allAccTexts,}),
						icehotel:buildBlock({arr:["room candle","quilting thread","heated water","display leg","engraving tool","stage door","podium paneling","heavy rope","frigid water","heating torch",],label:"Ice Hotel and Sculptures",prefix:"send",accText:allAccTexts,}),
						auctionblock:buildBlock({arr:["brass mallet","burn plate","molasses base","long pole","waxed string","brush base","sun glasses","bathing suit","gold certificate","mane conditioner","tail ribbon",],label:"Auction Block",prefix:"send",accText:allAccTexts,}),
						expansion8:buildBlock({arr:["flexible straps","pink flag","beautiful basket","long blade","meat hook","snack mix","viewin' scope",],label:"Homestead Expansion 8",prefix:"send",accText:allAccTexts,}),
						pumpkincarving:buildBlock({arr:["strong oak board","caliper","wagon axle","pulp bowl","pumpkin scooper","small trowel","gardening hose","drawin' charcoal","weavin' needle","clean water",],label:"Pumpkin Carving",prefix:"send",accText:allAccTexts,}),
						curseofmummy:buildBlock({arr:["mummy wrap","uncurse charm","Khol Mascara","colorful gem","mob torch","spooky beaker","linen skirt","spray bottle","lapiz lazuli","garlic amulet","limb strap","essence jar",],label:"Curse of the Mummy",prefix:"send",accText:allAccTexts,}),
						helpasoldier:buildBlock({arr:["soothing serum","printed fabric","bed legs","round rungs","party glass","get well card","house plans","well wishes",],label:"Help a Soldier",prefix:"send",accText:allAccTexts,}),
						burninup:buildBlock({arr:["hard water","spring water","brass tubing","forged bolt","water barrel","brass trim","brass bits","smotherin' tarp","tender bandage","shoulder strap","pick tip",],label:"Burnin' Up",prefix:"send",accText:allAccTexts,}),
						countdowntoween12:buildBlock({arr:["chain breaker","leather fraying","simple thread","sugar mixture","wax candle","metal spike","cupcake mix","broccoli floret","lapis lazuli",],label:"Countdown to Halloween",prefix:"send",accText:allAccTexts,}),
						lostmemory:buildBlock({arr:["precise lens","sugar water","iron banding","slice of cake","brass handle","chore list","friend portrait","old clothes","spouse story","scrap book",],label:"Lost Memory",prefix:"send",accText:allAccTexts,}),
						leatherworks:buildBlock({arr:["cord thread","leather punch","braided popper","boot silver","tanning lime","glove pattern","broken bridle","cracked collar","sole sealant","flint knife","leather guide",],label:"Leather Works",prefix:"send",accText:allAccTexts,}),
						dogshow:buildBlock({arr:["doodoo claw","beefy bits","stage pin","puppy pillar","big bar","lickin' cream","ruff turf","identity tag","scratchin cone",],label:"Dog Show",prefix:"send",accText:allAccTexts,}),
						animalhabitat:buildBlock({arr:["habitat blueprint","magnified lens","goat flank","wooden platform","panko bread crumbs","squeaker","leather thread","bouncy ball","cleaning supplies","water dish",],label:"Animal Habitat",prefix:"send",accText:allAccTexts,}),
						caveconundrum:buildBlock({arr:["heavy screw","heavy head","lilting chimes","calcium carbide","rubble movin' glove","tight corset","hull reinforcement","bat trap",],label:"Cave Conundrum",prefix:"send",accText:allAccTexts,}),
						penpalpack:buildBlock({arr:["drawing chalk","thumb screw","dolly eyes","military patches","bird seed","bird canteen","soldier's journal","child's paint","tin cup","cherry woodstain","hollowed tube","lantern candles",],label:"Pen Pal Package",prefix:"send",accText:allAccTexts,}),
						gratredemption:buildBlock({arr:["old shoe","chipping knife","sparklin' hat","practice post","bed post","encyclopedia","dictionary","activated yeast","ground cinnamon","lock pick",],label:"Gratchett's Redemption",prefix:"send",accText:allAccTexts,}),
						greatcattledrive:buildBlock({arr:["birthing kit","solid post","unpainted dummy","sewin' thread","pile of alfalfa","rake dowel",],label:"Great Cattle Drive",prefix:"send",accText:allAccTexts,}),
						applefest:buildBlock({arr:["sittin' plank","granny's old fashioned cider","cross bow","unstamped ticket","sweet apple butter","apple fritter","apple festival invitation","apple festival flag","cider glass","apple stamp",],label:"Apple Festival",prefix:"send",accText:allAccTexts,}),
						fireonthefrontier:buildBlock({arr:["station siding","critter salve","crystal water","pump handle","steel case","oak puller","cross beams","elastic loops","brass pole","fire station sign","bag of sand",],label:"Fire on the Frontier",prefix:"send",accText:allAccTexts,}),
						prettyponies:buildBlock({arr:["horsey punch","oat crop","parade shoes","horse course","sweet oils","balance spring","sturdy base","side saddle","practice prancer",],label:"Pretty Ponies",prefix:"send",accText:allAccTexts,}),
						bonfire12:buildBlock({arr:["chili bib","wooden utensil","bug spray","hook clasp","cheese cloth","melted butter","torn ticket stub","fryin' oil","ruined sheets","canning lid","wood staple","mattress patch",],label:"Family Bonfire",prefix:"send",accText:allAccTexts,}),
						whitegrizzlytamin:buildBlock({arr:["trap blueprint","tamin' whip","bear net","long leash","catfish fillet","large pulley","hefty rope","large salmon","deer jerky","fluffy pillow","calming leaves","wooden pole",],label:"White Grizzly Tamin'",prefix:"send",accText:allAccTexts,}),
						jacksmineshaft:buildBlock({arr:["unsprung spring","double axe head","solid spikes","sturdy wheels","root breaker","liquid courage","sun mirror","diggin' pick","missin' jack poster","miner hat",],label:"Jack's Mineshaft",prefix:"send",accText:allAccTexts,}),
						asoldierspenpal:buildBlock({arr:["red wax","draggin slayor","small zipper","open envelope","graphite mold","fanny's writing guide",],label:"A Soldier's Pen Pal",prefix:"send",accText:allAccTexts,}),
						themysteriouslostcrate:buildBlock({arr:["amaranth herb","cutting razor","claw head","love letter","metal saw","chain cutters","metal wedge",],label:"The Mysterious Lost Crate",prefix:"send",accText:allAccTexts,}),
						thefrontiergames:buildBlock({arr:["heavy weight","frontier megaphone","construction certificate","simple pulley","durable saw","fancy red ribbon","rock hammer","gold medal mold","large pitcher","green wreath","runnin' shoes",],label:"The Frontier Games",prefix:"send",accText:allAccTexts,}),
						civiccenter:buildBlock({arr:["morse keys","well diggin' kit","posse poster","empty flower box","party placemat","wooden skeleton","dewey card","librarian glasses","head measurement","bounty board","writing surface","voting booth","shiny badge"],label:"Civic Center",prefix:"send",accText:allAccTexts,}),
						burlybullsblock:buildBlock({arr:["claw stepper","clown barrel","barbell","wood wheel","log weight","soothin' salt","peg hook","beef cake"],label:"Burly Bulls",prefix:"send",accText:allAccTexts,}),
						countyfairsummer:buildBlock({arr:["carnival flyer","thirsty pioneer","wooden duck","water pump","marconi bulb","a carnival stamp"],label:"Carnival Games",prefix:"send",accText:allAccTexts,}),
						bromance3:buildBlock({arr:["animal decoy","owl decoy","owl call","small collar","strong leash","rabbit jerky","wooden rabbit"],label:"Wild Animal Tamin'",prefix:"send",accText:allAccTexts,}),
						summergames:buildBlock({arr:["bow limb","bow grip"],label:"Summer Games",prefix:"send",accText:allAccTexts,}),
						bromance2:buildBlock({arr:["tent pole","hearty trailmix","chicken chunk","soft fabric","strong bandage","sugary syrup"],label:"Meet Ted",prefix:"send",accText:allAccTexts,}),
						showpen:buildBlock({arr:["animal nametag","massage oil","stylin' shades","squeaky slippers","sensitive trigger","loft blueprints","facial mud","inspired pattern","sheep scissors","salad dressing","drink sword","velvet fabric"],label:"Show Pen",prefix:"send",accText:allAccTexts,}),
						fourth2012:buildBlock({arr:["stage plank","firework fuse","firework launcher","frontier firecracker","firework tubing","red rocket","multicolor rocket","bag of flour","super-sweet icing","safety bucket","firework stand"],label:"2012 July 4th Celebration",prefix:"send",accText:allAccTexts,}),
						sheepspa:buildBlock({arr:["styling mirror","hair sweeper","sheep smock","master plaster","sprung springs","loose lace","carvin' blade","softness soap",],label:"Shearin' Salon",prefix:"send",accText:allAccTexts,}),
						dinerblock:buildBlock({arr:["leather seating","parasol ribbing","mystery meat","frozen yogurt","mood candle","flyswatter"],label:"Country Diner",prefix:"send",accText:allAccTexts,}),
						libraryblock:buildBlock({arr:["catalog drawer","wood lathe kit","basement beam","dewey decimal label","end table","frontier anecdote","local legend","rough sandpaper","second-hand book","sunny window"],label:"Library",prefix:"send",accText:allAccTexts,}),
						museumblock:buildBlock({arr:["expedition chronicle","pioneer portrait","fancy hat","tiny antlers","toolbox"],label:"Museum",prefix:"send",accText:allAccTexts,}),
						countyfair4:buildBlock({arr:["soft material","fine sand paper","ferris wheel flyer","metal rim","safety net","candy dispenser","safety belt","display rack","funny munny"],label:"County Fair 4",prefix:"send",accText:allAccTexts,}),
						holidayhall:buildBlock({arr:["kissin' memories","hidden attic schematic","rustic candelabra","bottomless basket","romantic vanity","decorations","aroma therapy","xtra wide chimney","glittery ball","resolution list","jack-o-lantern pattern","old candy corn","creepy crawly costume","sparkling water","cubed caramel"],label:"Holiday Hall",prefix:"send",accText:allAccTexts,}),
						wishingwell:buildBlock({arr:["hole auger","grip wrench","work towels","coin press","hedge trimmers","mail slot","pipe form","frosted glass","wish list"],label:"Wishing Well",prefix:"send",accText:allAccTexts,}),
						countyfair3:buildBlock({arr:["female bear decoy","large trout","monkey proof lid","red ribbon","essence of bunyan","strong stitching","pouch of glitter","iron shavings","massage iou"],label:"County Fair 3",prefix:"send",accText:allAccTexts,}),
						bestforbess:buildBlock({arr:["large haybale","horse chow","leather patch","grilled steak","silver clasp","grilled chicken"],label:"Best for Bess",prefix:"send",accText:allAccTexts,}),
						cadetacademy:buildBlock({arr:["speaking trumpet","drill whistle","range target","skid marks","shiny stars","cadet hat","red wool","thief","wagon tracks","cadet exam","cadets"],label:"Cadet Academy",prefix:"send",accText:allAccTexts,}),
						twoyear:buildBlock({arr:["vibrant flowers","small fuse","rockin' horse","party balloon","large ridin' saddle","huge flowerbed","pink handcuffs","confetti tree"],label:"2nd Aniversary",prefix:"send",accText:allAccTexts,}),
						courthouse:buildBlock({arr:["judge's gavel","scales of justice","the book","lock pin kit","armed escort","bandit stash"],label:"Court House",prefix:"send",accText:allAccTexts,}),
						clocktower:buildBlock({arr:["marble pedestal","chisel kit","glass plate","large clock spring","metal frame beam","chime tuner","clock winder","mechanism blueprint"],label:"Clocktower",prefix:"send",accText:allAccTexts,}),
						countryfair2:buildBlock({arr:["horseshoe nail","organizer","spoonful of sugar","doc's secret stuff","long board","pig massage","duster handle","sugary shortening"],label:"County Fair 2",prefix:"send",accText:allAccTexts,}),
						babysittingtime:buildBlock({arr:["muffin","picnic sheet","smellbetter soap","mounting bolt","fingerboard","warm milk"],label:"Babysitting Time",prefix:"send",accText:allAccTexts,}),
						jailhouse:buildBlock({arr:["prisoner calendar","mouth organ","spotlight","food tray","iron u bar","cryptography book","iron ball","encrypted message"],label:"Jailhouse",prefix:"send",accText:allAccTexts,}),
						gofishing:buildBlock({arr:["creek map","beaver distraction","hard hat","lemonade","rod rings","mixed nuts","reinforced wheel","beaver bed","fish hook","rubber padding","fishing score card"],label:"Time To Go Fishing",prefix:"send",accText:allAccTexts,}),
						hbcountyfair:buildBlock({arr:["bowl of water","chunk o' chicken","gate schematic","fence sign","warm oven mitt","pie tin","indigestion pill"],label:"Humble Bob's County Fair",prefix:"send",accText:allAccTexts,}),
						hmstdmystery:buildBlock({arr:["guilty confessions","secret recipes","spyglass lens","warm water","maplewood handle","footprints","horse tracks","torn fabric"],label:"Mystery on the Homestead",prefix:"send",accText:allAccTexts,}),
						buildbakery:buildBlock({arr:["cooling rack","bread pantries","pie plate","sifted flour","refined sugar","shredded coconut","chocolate sprinkles"],label:"Dream Bakery",prefix:"send",accText:allAccTexts,}),
						townhall:buildBlock({arr:["frame boards","chandelier candle","town emblem","iron bell","paint brush","support bar","boost permit","thin chain","construction sign","trash picker","iron plumbing","wood column","stone steps","potluck dish"],label:"Town Hall",prefix:"send",accText:allAccTexts,}),
						familyouting:buildBlock({arr:["baby bird food","machete handle","hiking boot","wooden mallet","iron stake","clean cloth","spray nozzle","cool spring water","monstrous match","spooky story"],label:"Family Outing",prefix:"send",accText:allAccTexts,}),
						sheriffoffice:buildBlock({arr:["steel handcuffs","creaky floorboard","wanted board","porch chair","sheriff's seal","sugar crystal","office blueprint","book pages","wicker basket"],label:"Sheriff's Office",prefix:"send",accText:allAccTexts,}),
						statelyestate:buildBlock({arr:["clipped bush","pristine gutter","overpriced wood","door stain","spotless pane","kingly curtain","stable cobble"],label:"Stately Estate",prefix:"send",accText:allAccTexts,}),
						hankstwins:buildBlock({arr:["crib mobile","woolen sheep","frontier wallpaper","number blocks","sand box frame","shovel and pail","paper dolls","kids books","safety ties","swan ornament","leather straps","silk doll parts","sanded wood","step ladder","polished slide"],label:"The Twin's Nursery",prefix:"send",accText:allAccTexts,}),
						cowgirltraining:buildBlock({arr:["coat conditioner","ranch gloves","tossed salad","cowgirl spice","saddle plans","guitar glue","cowgirl terrets"],label:"Cowgirl Training",prefix:"send",accText:allAccTexts,}),
						bertsimports:buildBlock({arr:["ornate vase","floral fabric","sweet honey","sharp scissors","imported goods","starch solution","price tag","exotic fabric","appraisal certificate"],label:"Bert's Imports",prefix:"send",accText:allAccTexts,}),
						fannybaby3:buildBlock({arr:["knitting needle","blue pacifier","cool water","mitt leather","bonnet cap","teddy dress","stroller wheel"],label:"Fanny's Baby is Coming",prefix:"send",accText:allAccTexts,}),
						springflood:buildBlock({arr:["coarse wool","wax coating","blackberry root","panther butter","large floodbag","panther chow"],label:"Spring Flood / Panicking Panthers",prefix:"send",accText:allAccTexts,}),
						familyreunion:buildBlock({arr:["side dish","serving spoon","sauteed veggie","name tag","black bean","ground cumin","colored chalk","bbq bib","chopped chives","family harmony","exercise strap","opals"],label:"Family Reunion",prefix:"send",accText:allAccTexts,}),
						telegraphstation:buildBlock({arr:["telegraph key","rubber","electric circuit","cable tape","timesheet","frontier batteries","telegram"],label:"Telegraph Station",prefix:"send",accText:allAccTexts,}),
						frontierworks:buildBlock({arr:["foundation rod","stacked chimney","iron camshaft","knotty board","rigid pole","unstuffed glove"],label:"Frontier Works",prefix:"send",accText:allAccTexts,}),
						barterdepot:buildBlock({arr:["auction podium","tomato seedling","pressure plate","tense spring","snake skin","silver star","sharpened plow","gun oil","heavy duty beam","barter tariff"],label:"Barter Depot",prefix:"send",accText:allAccTexts,}),
						familytreeev:buildBlock({arr:["coarse rock", "compass needle","orange dye","hair bristle","sweet lemon","raw leather","willow branch","cappy glue","rhubarb stalk","roasting rod","secret spice","ripe walnut","raw pith","brass plate","bright candle","liquid smoke","steak seasoning","iced pitcher","small yoke","crude lathe","thin oil","heavy press","pie crust","walnut cracker","pith helmet","mining helmet","portrait frame","granny's lemonade"],label:"Family Tree",prefix:"send",accText:allAccTexts,}),
						
						}},
						buildtab:{type:'tab',label:'Buildings',kids:{
						
						eddysfarmhouse:buildBlock({arr:["barnyard dog","dirty hoe","roid rabbit","hand fashioned shank","doc’s questionable blend","sprinkler head","homestead direction","thick glasse","tinted monocle","periscope",],label:"Eddy's Farmhouse",prefix:"send",accText:allAccTexts,newitem:true,}),
						christmasworkshop:buildBlock({arr:["carvin wood","welcoming wreath","glass ornament","fine brush","widdling tool","old desk","bells n' whistle","flat rubber band","positive energy",],label:"Christmas Workshop",prefix:"send",accText:allAccTexts,newitem:true,}),
						guesthouse:buildBlock({arr:["flat crowbar","paint dissolver","lime mix","electrode","metal sealant","walking plank","ted's family photo","kingly bags","annabelle's picture","overstuffed upholstery",],label:"Guest House",prefix:"send",accText:allAccTexts,newitem:true,}),
						frontiercastle:buildBlock({arr:["castle brick","thick chain","long frilly feather","chainmail doublet","square spire","buckler base","kneeling pedestal","hedge shear","crested ring","heavy sword",],label:"Frontier Castle",prefix:"send",accText:allAccTexts,newitem:true,}),
						dayofthedeadfloat:buildBlock({arr:["trailer top","chocolate top hat","skeleton marionette","mausoleum candle","skull frame","love one's picture","candle string","recycle fabric","broken phonograph",],label:"Day of the Dead Float",prefix:"send",accText:allAccTexts,newitem:true,}),
						genieslamp:buildBlock({arr:["harnesser","offer bowl","incense cone","arch top","wall drape","low table","fancy footstool","set candle","tea setting","burnin' matches",],label:"Genies Lamp",prefix:"send",accText:allAccTexts,newitem:true,}),
						treefort:buildBlock({arr:["mitre saw","steam drill","copper spyglass","stair stringer","tree fort stove","framing hammer","brass pulley","jesse james poster","circular hole",],label:"Tree Fort",prefix:"send",accText:allAccTexts,newitem:true,}),
						nursery:buildBlock({arr:["blue pacifier","shaky rattle","cloth diaper","country mobile","feathery stuffing","night light","hard plank","soft blanket",],label:"Nursery",prefix:"send",accText:allAccTexts,newitem:true,}),
						capitolbuilding:buildBlock({arr:["construction crew","sculpting crew","message chair","paddle wheel","parking meter","painted line","warnin' ticket","ridin' instruction","stay right arrow",],label:"Capitol Building",prefix:"send",accText:allAccTexts,newitem:true,}),
						varminttechincalacademy:buildBlock({arr:["pairs of matresses","welcome packet","itchy blanket","overpriced textbook","stack of unread books","varmint curriculum","final exam","graduated cylinder","plagarism",],label:"Varmint Techincal Academy",prefix:"send",accText:allAccTexts,newitem:true,}),
						etiquettedesk:buildBlock({arr:["cleanin' brooms","brass dustpan","old fashioned dress","perfume puffer","frontier know-how","relationship advice","prison experience","steele's warrant","deodorant spray","sturdy stitching","potpourri mask","tin sanitizer",],label:"Etiquette Desk",prefix:"send",accText:allAccTexts,newitem:true,}),
						clubouse:buildBlock({arr:["loan contract","landscaper","medieval tower","ancient mortar","microscope","small wheel","joseph's passport","golf tee",],label:"Clubouse",prefix:"send",accText:allAccTexts,newitem:true,}),
						seasidecottage:buildBlock({arr:["scavanged ship part","skury disguise","gunnwain funnel","treasure tail","treasure hunting attire","swing line","brass money","loose fitting clothing","cannon barrel",],label:"Seaside Cottage",prefix:"send",accText:allAccTexts,newitem:true,}),
						reenactmentcamp:buildBlock({arr:["sturdy thread","blue fabric","gills of vinegar","72 hops","ink bullet","musket barrel","granny's flag","granny snare","cargo net","hard sweet",],label:"Reenactment Camp",prefix:"send",accText:allAccTexts,newitem:true,}),
						luau:buildBlock({arr:["palm branch","luau shovel","tiny umbrella","plush headrest","tropical flower arrangement","whittling implements","wooden plates","jungle juice","carving hatchet","tropical fruit medley",],label:"Luau",prefix:"send",accText:allAccTexts,newitem:true,}),
						stagecoachtracker:buildBlock({arr:["missing sign","road map","anonymous tip","duster","reward sign","pulse check","oil trap","scounting lens","bull barrel","resistant stucco",],label:"Stage Coach Tracker",prefix:"send",accText:allAccTexts,newitem:true,}),
						wildlifepreservebldg:buildBlock({arr:["transplant tree","tasteful decor","human chain","sharpened stake","sturdy chair","monkey wrench","guard cat","ceramic capsule","responsible direction",],label:"Wildlife Preserve Bldg",prefix:"send",accText:allAccTexts,newitem:true,}),
						goatsanctuary:buildBlock({arr:["ax handle","archaeology whip","mortar","scaffold nail","metal pole","catch pole","vicious crocodile","faux fur","bull stampede",],label:"Goat Sanctuary",prefix:"send",accText:allAccTexts,newitem:true,}),
						gallery:buildBlock({arr:["gallery blueprint","chicken warmer","modern art","high class hat","chiseled model","cocktail","caber-neigh","vinyl cylinder","trainable yokel",],label:"Gallery",prefix:"send",accText:allAccTexts,newitem:true,}),
						wildwestbooth:buildBlock({arr:["horse hitch","flashy sign","practice target","fancy pattern","extra rope","broken shovel","bright bridles","riding practice","sturdy stirrup","flashy spark",],label:"Wild West Booth",prefix:"send",accText:allAccTexts,newitem:true,}),
						soapbox:buildBlock({arr:["flag pin","jack's flag","slogan spouter","black tint","mediocre mediator","one sided opinion","telegraph dispatch","celebrity endorsement","frontier made drawer","children's art supply",],label:"Soap Box",prefix:"send",accText:allAccTexts,newitem:true,}),
