...
function addPlyrClnExpStats(playerStats, pageContent) {
    ...
    var rgxClnAtk = /<b>([\d,]+)<\/b>\s*attack XP/;
    var rgxClnAch = /<b>([\d,]+)<\/b>\s*archery XP/;
    var rgxClnAcn = /<b>([\d,]+)<\/b>\s*arcane XP/;
    var rgxClnDef = /<b>([\d,]+)<\/b>\s*defense XP/;
    var rgxClnHlt = /<b>([\d,]+)<\/b>\s*health XP/;
    var rgxClnStr = /<b>([\d,]+)<\/b>\s*strength XP/;
