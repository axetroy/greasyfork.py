// ==UserScript==
// @name         JD Source Repo Beautifier
// @namespace    source.jd.com/app
// @version      0.4
// @description  Less painful to read the docs.
// @author       Chuyik
// @match        http://source.jd.com/app/*
// @match        http://source.jd.com/fork/*/*
// @grant        none
// ==/UserScript==
/* jshint -W097 */
'use strict';
...
ljs
    .load('//cdnjs.cloudflare.com/ajax/libs/highlight.js/9.2.0/styles/github.min.css')
    .load('http://edwardchu.org/misc/source_jd_com_markdown_highlight.css')
    .load('//cdnjs.cloudflare.com/ajax/libs/highlight.js/9.2.0/highlight.min.js',function(){
       var readmePanel = document.querySelector('.widget-main')
       if (readmePanel) {
           readmePanel.className += " markdown-body";
           var codeBlocks = readmePanel.querySelectorAll('pre code');
           if (codeBlocks.length)
               Array.prototype.slice.call(codeBlocks).forEach(function (el) {
