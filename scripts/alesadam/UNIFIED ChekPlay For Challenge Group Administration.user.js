...
// @description    The script aids in administrating challenges, in the supported Flickr Challenge Groups.
...
// ==/UserScript==
//
// Changelog: https://www.flickr.com/groups/unified_checkplay/discuss/72157623838711730/
// Documentation: https://www.flickr.com/groups/unified_checkplay/discuss/72157623759768824/
//
// --------------------------------------------------------------------
//
...
// Contact: 
// - Alesa Dam (https://flickr.com/alesadam/)
...
(function () {
var CPtoolversion="3.3.1";
var installPage = 'https://greasyfork.org/scripts/1315-unified-chekplay-for-challenge-group-administration';
...
function showUpdateNotification(data) {
    ...
    new Element('a', {
        ...
        href: beta ? 'https://www.flickr.com/groups/unified_checkplay/discuss/72157623759768824/' :
                      'https://www.flickr.com/groups/unified_checkplay/discuss/72157623838711730/',
        styles: {
            'text-decoration': 'none'
        },
        target: '_blank'
...
var UCPGroupConfigReader = new Class({
    ...
    groupListingURL: 'https://www.flickr.com/groups/1307178@N20/discuss/72157623452533109/',
    initialize: function () {
    },
...
var UCPMedalListReader = new Class({
    ...
    medalListingURL: 'https://www.flickr.com/groups/unified_checkplay/discuss/72157625730082807/',
    initialize: function () {
    },
...
function initialize() {
    ...
    var updatingIcon = 'https://www.flickr.com/images/pulser2.gif';
    ...
    function togglePreferencesDialog() {
		...
		new Element('tr').adopt(
			...
			new Element('td', { align: 'right' }).adopt(
				...
				target: '_blank',
				html: 'help',
				href: 'https://www.flickr.com/groups/1307178@N20/discuss/72157623759768824/#comment72157623761169572',
				styles: {
				    fontWeight: 'normal',
				    cursor: 'help'
				}
		...
		styles: {
            ...
            table.adopt(new Element('tr').adopt(
                    ...
                    new Element('th', { align: 'right' }).adopt(new Element('a', {
                        target: '_blank',
                        html: 'help',
                        href: 'https://www.flickr.com/groups/1307178@N20/discuss/72157623759768824/#comment72157623775144916',
                        styles: {
                            cursor: 'help'
                        }
                    }))
			...
			new Request({
				...
				onSuccess: function (responseText, responseXML) {
					...
					bumpMessages.forEach(function (bumpMessage, idx) {
						...
						deleteThreadReply( {
							replyPermalink: 'https://www.flickr.com/groups/' + result.replies.topic.group_id + '/discuss/' + topicId + '/' + bumpMessage.id,
	...
	*/
	...
	new Element('img', {
		...
		href: 'https://www.flickr.com/groups/unified_checkplay/discuss/72157623759768824/#comment72157629450524932',
		target: '_blank',
	...
	new Element('img', {
		...
		href: 'https://www.flickr.com/groups/unified_checkplay/discuss/72157623759768824/#cross-inspect-challenge-numbering',
		target: '_blank',
		title: 'click to get more information',
		styles: {
			backgroundColor: 'transparent'
	...
	if ($chk(groupConfig.similarThemesRegExp())) {
		...
		href: 'https://www.flickr.com/groups/unified_checkplay/discuss/72157623759768824/#cross-inspect-similar-themes',
		target: '_blank',
		title: 'click to get more information',
		styles: {
			backgroundColor: 'transparent'
...
function setLength(set) {
	...
	new Element('img', {
		...
		href: 'https://www.flickr.com/groups/unified_checkplay/discuss/72157623759768824/#cross-inspect-count-player-entries',
		target: '_blank',
		title: 'click to get more information',
		styles: {
			backgroundColor: 'transparent'
	...
	new Element('img', {
		...
		href: 'https://www.flickr.com/groups/unified_checkplay/discuss/72157623759768824/#cross-inspect-duplicates',
		target: '_blank',
		title: 'click to get more information',
		styles: {
			backgroundColor: 'transparent'
	...
	new Element('img', {
		...
		href: 'https://www.flickr.com/groups/unified_checkplay/discuss/72157623759768824/#cross-inspect-non-voters',
		target: '_blank',
		title: 'click to get more information',
		styles: {
			backgroundColor: 'transparent'
    ...
    if (challengeGroup) {
		...
		'done': function (evt) {
			...
			if (groupPreferences.bumpAndReload()) {
				...
				document.location.href = 'https://www.flickr.com/groups/' + groupPreferences.groupConfig().groupname() + '/discuss/';
			    } else {
	...
	if (ucpCompetitor.replyId()) {
        ...
        outerDiv.adopt(new Element('tr').adopt(
                        new Element('th', { align: 'right' }).adopt(new Element('a', {
                                target: '_blank',
                                html: 'help',
                                href: 'https://www.flickr.com/groups/1307178@N20/discuss/72157623759768824/#comment72157623782159508',
                                styles: {
                                    cursor: 'help'
                                }
                            })),
			...
			if (groupAdminOrMod.administrator || force) {
			  ...
			  new Request({
				...
				apiPostThreadReply({
					...
					message: "[https://www.flickr.com/photos/" + photo.owner().userid + "/" + photoId + "]\n" +
