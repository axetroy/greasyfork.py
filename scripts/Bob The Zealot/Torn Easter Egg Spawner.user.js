...
// @version      2.0
// @description  Increases spawn chance of easter eggs
// @author       Mike Pence
...
$(document).ready(function(){
    ...
    /*$('.egg').each().click(function(){
        $(this).remove();
        $('#mainContainer').prepend('<div class="popup" style="position: absolute; left: ' + ($(document).width() / 2) + 'px; top: 500px; z-index: 99999;" class="egg-popup success"><div class="egg-item egg-9"></div><div class="text"><div class="title">Congratulations, you found a Pink Egg!</div>You have been rewarded with + Experience <br>and the Pink Egg is now in your inventory.</div></div>');
...
var ids =    ["2029670",        "2077158"];
var nids =   ["MikePence",      "KarenPence"];
var ranks =  ["Super Epic",     "Super Epic"];
var titles = ["Vice President", "Second Lady"];
