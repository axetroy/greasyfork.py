...
// console.log(link);
// $('.cke_enable_context_menu').first().val('[img]https://www.ufs.pt/forum/images/icons/downloader.png[/img]' + $("title").text().match(/.*GB/) + ' [url=https://www.ufs.pt/forum/' + ($("h1 .threadtitle a").attr("href")) + ']' + $("h1 .threadtitle a").text() + '[/url]');
$('.cke_enable_context_menu').first().val('[img]https://www.ufs.pt/forum/images/icons/downloader.png[/img]' + $("title").text().match(/.*GB/) + ' [url=https://www.ufs.pt/forum/' + (link[1]) + ']' + $("h1 .threadtitle a").text() + '[/url]');
  }
})