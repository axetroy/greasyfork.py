...
$(document).ready(function () {	
                  $('<aside class="ufs-mod" id="ufs-mod"><div class="ufs-mod_button-circle ufs-mod_material_ripple material-icons">reply_all</div><section class="ufs-mod_desc"><div class="ufs-mod_container"><div class="ufs-mod_flex_wrap-first"><div class="ufs-mod_button ufs-mod_material_ripple" id="req">REQ</div><div class="ufs-mod_button ufs-mod_material_ripple" id="kont">Kosz Kont</div><div class="ufs-mod_button ufs-mod_material_ripple" id="kosz">Kosz</div></div><div class="ufs-mod_flex_wrap-first"><div class="ufs-mod_button ufs-mod_material_ripple" id="niezatwierdzony">niezatwierdzone</div><div class="ufs-mod_button ufs-mod_material_ripple" id="dubel">Dubel</div><div class="ufs-mod_button ufs-mod_material_ripple" id="udp">Poprawa</div></div><div class="ufs-mod_dropdown_title ufs-mod_material_ripple" id="gry">Gry</div><div class="ufs-mod_flex_wrap"><div class="ufs-mod_button ufs-mod_material_ripple" id="grypl">PC PL</div><div class="ufs-mod_button ufs-mod_material_ripple" id="gryeng">PC ENG</div></div><div class="ufs-mod_flex_wrap"><div class="ufs-mod_button ufs-mod_material_ripple" id="linux">Mac / Linux</div></div><div class="ufs-mod_flex_wrap"><div class="ufs-mod_button ufs-mod_material_ripple" id="psx">PSX</div><div class="ufs-mod_button ufs-mod_material_ripple" id="ps2">PS2</div><div class="ufs-mod_button ufs-mod_material_ripple" id="ps3">PS3</div><div class="ufs-mod_button ufs-mod_material_ripple" id="psp">PSP</div></div><div class="ufs-mod_flex_wrap"><div class="ufs-mod_button ufs-mod_material_ripple" id="x360">XBOX 360</div><div class="ufs-mod_button ufs-mod_material_ripple" id="jottag">JTAG / RGH</div><div class="ufs-mod_button ufs-mod_material_ripple" id="innekons">Inne Konsole</div></div><div class="ufs-mod_dropdown_title ufs-mod_material_ripple" id="filmy">FILMY</div><div class="ufs-mod_flex_wrap"><div class="ufs-mod_button ufs-mod_material_ripple" id="lek">LEK/DUB</div><div class="ufs-mod_button ufs-mod_material_ripple" id="pl">Polskie</div></div><div class="ufs-mod_flex_wrap"><div class="ufs-mod_button ufs-mod_material_ripple" id="eng">ENG HQ</div><div class="ufs-mod_button ufs-mod_material_ripple" id="cam">Cam / TS</div></div><div class="ufs-mod_flex_wrap"><div class="ufs-mod_button ufs-mod_material_ripple" id="anim">Anime | Animowane</div><div class="ufs-mod_button ufs-mod_material_ripple" id="hd">720 / 1080</div><div class="ufs-mod_button ufs-mod_material_ripple" id="dvdr">DVD-R</div></div><div class="ufs-mod_flex_wrap"><div class="ufs-mod_button ufs-mod_material_ripple" id="trzy">3D</div><div class="ufs-mod_button ufs-mod_material_ripple" id="doku">Dokumentalne</div><div class="ufs-mod_button ufs-mod_material_ripple" id="kab">Kabarety | Inne</div></div><div class="ufs-mod_dropdown_title ufs-mod_material_ripple" id="seriale">SERIALE</div><div class="ufs-mod_flex_wrap"><div class="ufs-mod_button ufs-mod_material_ripple" id="sezon">Sezony</div><div class="ufs-mod_button ufs-mod_material_ripple" id="poj">Odcinki</div><div class="ufs-mod_button ufs-mod_material_ripple" id="sanime">Anime | Animowane</div></div><div class="ufs-mod_dropdown_title ufs-mod_material_ripple" id="muza">MUZYKA</div><div class="ufs-mod_flex_wrap"><div class="ufs-mod_button ufs-mod_material_ripple" id="techno">Techno</div><div class="ufs-mod_button ufs-mod_material_ripple" id="teled">Teledyski | Koncerty</div><div class="ufs-mod_button ufs-mod_material_ripple" id="pop">POP</div></div><div class="ufs-mod_flex_wrap"><div class="ufs-mod_button ufs-mod_material_ripple" id="rap">Hip-Hop</div><div class="ufs-mod_button ufs-mod_material_ripple" id="regge">Reggae</div><div class="ufs-mod_button ufs-mod_material_ripple" id="metal">Rock | Metal</div></div><div class="ufs-mod_flex_wrap"><div class="ufs-mod_button ufs-mod_material_ripple" id="skldanki">Sk&lstrok;adanki</div><div class="ufs-mod_button ufs-mod_material_ripple" id="soundtrack">Soundtrack | Inne</div></div><div class="ufs-mod_dropdown_title ufs-mod_material_ripple" id="programy">PROGRAMY</div><div class="ufs-mod_flex_wrap"><div class="ufs-mod_button ufs-mod_material_ripple" id="syst">Systemy</div><div class="ufs-mod_button ufs-mod_material_ripple" id="bezpiec">Bezpiecze&nacute;stwo</div><div class="ufs-mod_button ufs-mod_material_ripple" id="grafika">Grafika</div></div><div class="ufs-mod_flex_wrap"><div class="ufs-mod_button ufs-mod_material_ripple" id="multimedia">Multimedia</div><div class="ufs-mod_button ufs-mod_material_ripple" id="internet">Internet</div><div class="ufs-mod_button ufs-mod_material_ripple" id="edukacja">Edukacja</div></div><div class="ufs-mod_flex_wrap"><div class="ufs-mod_button ufs-mod_material_ripple" id="biuro">Biuro</div><div class="ufs-mod_button ufs-mod_material_ripple" id="narzedzia">Narz&eogon;dzia</div><div class="ufs-mod_button ufs-mod_material_ripple" id="innene">Inne</div></div><div class="ufs-mod_button ufs-mod_material_ripple" id="gsm">GSM / PDA</div><div class="ufs-mod_button ufs-mod_material_ripple" id="sprt">Sport</div><div class="ufs-mod_dropdown_title ufs-mod_material_ripple" id="porno">PORNO</div><div class="ufs-mod_flex_wrap"><div class="ufs-mod_button ufs-mod_material_ripple" id="prnoclip">XXX HD</div><div class="ufs-mod_button ufs-mod_material_ripple" id="prnofull">XXX LQ</div></div><div class="ufs-mod_dropdown_title ufs-mod_material_ripple" id="inne">INNE</div><div class="ufs-mod_flex_wrap"><div class="ufs-mod_button ufs-mod_material_ripple" id="kursy">Kursy</div><div class="ufs-mod_button ufs-mod_material_ripple" id="eksiazki">E-Ksi&aogon;&zdot;ki</div><div class="ufs-mod_button ufs-mod_material_ripple" id="egazety">E-Gazety</div></div><div class="ufs-mod_flex_wrap"><div class="ufs-mod_button ufs-mod_material_ripple" id="ezagraniczne">E-Zagraniczne</div><div class="ufs-mod_button ufs-mod_material_ripple" id="audbok">Audiobooki</div><div class="ufs-mod_button ufs-mod_material_ripple" id="otrs">Inne</div></div></div></section></aside>').appendTo('body');
...
$('#teled').click( function() {
	$("select[id='destforumid']").val("115");
	$("input.button").first().click();
});
$('#sprt').click( function() {
...
$('#innekons').click( function() {
	$("select[id='destforumid']").val("387");
	$("input.button").first().click();
});
