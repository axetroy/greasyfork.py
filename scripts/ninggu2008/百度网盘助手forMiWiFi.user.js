// ==UserScript==
// @name        百度网盘助手forMiWiFi
// @author      有一份田&ninggu2008
// @description 显示百度网盘文件的直接链接,突破大文件需要使用电脑管家的限制,使用小米路由下载百度网盘文件
// @namespace   https://greasyfork.org/zh-CN/scripts/7904-百度网盘助手formiwifi
 ...
 * === 说明 ===
 *@作者:有一份田&ninggu2008
 *@官网:http://www.duoluohua.com/download/&null
 *@Email:youyifentian@gmail.com&liulonghui@gmail.com
 *@Git:http://git.oschina.net/youyifentian&null
 *@转载重用请保留此信息
 *
 *
 * */
