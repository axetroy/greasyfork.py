// ==UserScript==
// @name                WME Validator Vermont Localization
// @version             0.1.3
...
/*
 * 0.1.2 - Added Rte as bad name vice VT-###
 */

/* Modification of Original program WME Validator Virginia Localization by Supermedic
/*
...
window.WME_Validator_United_States = {
  ...
  ".author": "subs5",
  ".updated": "2017-04-13",
  ".link": "https://greasyfork.org/en/scripts/14467-wme-validator-vermont-localization",
...
*/
  ...
  "131.solutionLink": "W:Vermont#Roads",
  ...
  "135.enabled": true,
  "135.params": {
    "titleEN": "Not VT State",
    "problemEN": "Incorrect State Name - State name should be Vermont (are you in Vermont?)",
    "solutionEN": "Verify correct state name on segment.",
    "template": "${state}",
    "regexp": "!/^Vermont$/"
  },
  "135.solutionLink": "W:Vermont",
  "135.title.en": "Custom check",
  "135.title": "Not VT State",
  "135.problem.en": "The segment matched custom conditions",
  "135.problem": "Incorrect State Name - State name should be Vermont (are you in Vermont?)",
  "135.solution.en": "Solve the issue",
  "135.solution": "Verify correct state name on segment",
  "136.enabled": true,
  "136.params": {
    "titleEN": "Wrong name on Vermont Primary Route",
    "problemEN": " All primary routes should be named VT-### in Vermont",
    "solutionEN": "Change name to VT-###",
    ...
    "regexp": "/^Vermont:.*(?:State Hwy |State Rd |State Rte |VT |VT- |VT Hwy |VT-Hwy |Co Rd |V T |SH-)(?:[1-5]{0,1}[1-9]{0,2})#/i"
  },
  "136.solutionLink": "W:Vermont#Roads",
  "136.title.en": "Custom check",
  "136.title": "Wrong name on Vermont Primary Route",
  "136.problem.en": "The segment matched custom conditions",
  "136.problem": " All primary routes should be named VT-### in Vermont",
  "136.solution.en": "Solve the issue",
  "136.solution": "Change name to VT-###",
  "137.enabled": true,
  "139.enabled": true,
  "139.params": {
  ...
  "151.problem.en": "The Major Highway segment should be locked at least to Lvl ${3}",
  "151.problem": "The Major Highway segment should be locked at least to Lvl ${3}",
  ...
  "152.problem.en": "The Minor Highway segment should be locked at least to Lvl ${3}",
  "152.problem": "The Minor Highway segment should be locked at least to Lvl ${3}",
  "152.solution.en": "Lock the segment",
  "152.solution": "Lock the segment",
  "153.enabled": true,
  "153.title.en": "No lock on Ramp",
  "153.title": "No lock on Ramp",
  "153.problem.en": "The Ramp segment should be locked at least to Lvl ${3}",
  "153.problem": "The Ramp segment should be locked at least to Lvl ${3}",
  ...
  "154.problem.en": "The Primary Street segment should be locked at least to Lvl ${1}",
  "154.problem": "The Primary Street segment should be locked at least to Lvl ${1}",
