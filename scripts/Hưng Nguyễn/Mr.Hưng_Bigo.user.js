...
(function(w) {
    ...
    function setMenu() {
        ...
        if (login) {
            ...
            sltMenu.innerHTML = " <strong>Mr.Hưng__Bigo </strong> | <strong>" + modVersion + "</strong>";
            ...
            select.appendChild(option);
            // Menu footer
            sltMenu.innerHTML += '<a href="https://www.facebook.com/kieuhung0403" target="_blank" style="color: #56ac81;">Facebook</a> | ';
			sltMenu.innerHTML += '<a href="https://www.youtube.com/watch?v=nJ3lP2EdvSk" target="_blank" style="color: #56ac81;">YouTube</a>';
            // Get IP input
    ...
    function setLeaderboard() {
        if (w.lbh) {
            w.lbh.textContent = "Mr.Hưng__Bigo";
