...
function kinkCalculator(clear) {
	...
	statusText.html("Getting character kinks...");
...
function toggleQuickCompareColors() {
	...
	GM_setValue('altColorMode', altColorMode);
