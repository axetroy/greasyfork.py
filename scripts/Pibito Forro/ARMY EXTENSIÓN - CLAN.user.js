// ==UserScript==
// @name         ARMY EXTENSIÓN - CLAN 
// @version      1.0.9
// @namespace    theoxt.com
// @description  Peruvian Extension By Pibito Forro
// @raidcall	 11522949
...
"gota.io" == location.host && "/" == location.pathname && (location.href = "http://army.ovh/web/" + location.hash);
GM_xmlhttpRequest({
    method : "GET",
