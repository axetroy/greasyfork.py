...
// @namespace      North
// @description    This script renders a AP progress bar for the DGNT stats
...
// @include        http*://*animecubedgaming.com/billy/bvs/missions/mission1.html
// @include        http*://*animecubedgaming.com/billy/bvs/quest*
// @include        http*://*animecubedgaming.com/billy/bvs/arena.html
// @include        http*://*animecubedgaming.com/billy/bvs/villagespy*
// @include        http*://*animecubedgaming.com/billy/bvs/villageattack*
// @include        http*://*animecubedgaming.com/billy/bvs/bingo*
// @version	   1.7.4
// @history        1.7.4 New domain - animecubedgaming.com - Channel28
// @history        1.7.3 Now https compatible (Updated by Channel28)
// @history        1.7.2 Fixes for comma inside numbers
// @history        1.7.1 Small fix regarding Level Cap
...
addStyle([
    ".apBar { background: #B5B5B5 url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAAKCAIAAAD6sKMdAAAACXBIWXMAAAsTAAALEwEAmpwYAAAAJklEQVR42gXBsQ0AMAzDsEL/36vYyJCS7+7YXdqSBBWVmUElCW0/SkgdMub8sZ8AAAAASUVORK5CYII=) repeat-x left top; width: 90%; border: 1px solid black; text-align: left;}",
    ".apBarDou { background: #4a4a07 url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAAKCAIAAAD6sKMdAAAACXBIWXMAAAsTAAALEwEAmpwYAAAALklEQVR42gXBQQoAIAhFQX3Q/U8ZhvDFTbuiZuy9wd5ON1SB5ETAnM5aRuZFOh+K0BSu6v8ibAAAAABJRU5ErkJggg==) repeat-x left top;}",
    ".apBarTai { background: #071e4a url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAAKCAIAAAD6sKMdAAAACXBIWXMAAAsTAAALEwEAmpwYAAAAMElEQVR42gXBiQoAEBBAQfvKj/tXkXKkHFvEjLHuIWNAbVAL0jPMgKjHaOSuxNn5A21aFILfIZVwAAAAAElFTkSuQmCC) repeat-x left top;}",
    ".apBarNin { background: #4a0707 url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAAKCAIAAAD6sKMdAAAACXBIWXMAAAsTAAALEwEAmpwYAAAALUlEQVR42gXBQQoAIAhFQf8D73/KKAKjTTslZ+y78yQucICQmMCQWGbsKiKzAdgHDWs7Xvp7AAAAAElFTkSuQmCC) repeat-x left top;}",
    ".apBarGen { background: #124a07 url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAAKCAIAAAD6sKMdAAAACXBIWXMAAAsTAAALEwEAmpwYAAAAMUlEQVR42gXBQQ4AEAwAwXYT7/H/BwmREBcH0qoZyZGIrcSCN+ENxSt4UawJtztn2Ad2ABR2S9mVngAAAABJRU5ErkJggg==) repeat-x left top;}"
    ].join("\n"));
...
function ProgressBar(){
    ...
    var addApBars = function(){
        ...
        for (var i = 0; i < snap.snapshotLength; i++) {
            ...
            var lvl = node.parentNode.childNodes[1].childNodes[0].innerHTML.match(/\b\d{1,2}\b/);
            var levelCapped = ((lvl == ((double_page && i<(opponentHasDou ? 4 : 3)) ? opponentLevelCap : levelCap)) || (lvl == 75));
            ...
            apHave = apHave.replace(/,/g,"");
            apNeed = apNeed.replace(/,/g,"");
            ...
            newitem.innerHTML = '<DIV class="'+getBarClass(apColor)+'" style="width:'+(levelCapped ? '100' : apWidth)+'%; height: '+newitem.style.height+'; text-align: center; color: white">'+(levelCapped ? '<b>MAXED</b>' : '')+'</DIV>';
