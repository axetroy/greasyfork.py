// ==UserScript==
// @id             lsj8924@126.com
// @name           verycd补全下载链接【修改版】
// @version        1.5.3.2
// @author         lsj8924
// @description    在 verycd 页面直接显示下载链接，原脚本作者ywzhaiqi很久没有更新这个脚本，年久失修显示慢，修改后优化速度。
...
VERYCD.sites = [
    ...
    },
    {
        name:'ed2k',
        id:'site_ed2k',
        BASE_URL:'http://www.ed2000.com/',
        url:"http://zhannei.baidu.com/cse/search?q=" + VERYCD.title.replace(/'/g, " ") + "&click=1&s=5102198518115871963&nsid=",
        search_selector:".CommonListArea a:contains('" + VERYCD.title.replace(/&/g, "&amp;") + "')"

    },
/*
    {
        name: "SimpleCD（默认）", //网站挂了
        id: 'site_simplecd',
