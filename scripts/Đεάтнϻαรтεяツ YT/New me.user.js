...
GM_addStyle('* #logo {background-image: url("https://i.imgur.com/tWH6pRF.png");}');
GM_addStyle('* #minimap-canvas {background-image: url("https://i.imgur.com/Q3EIUNT.png");}');
...
document.getElementById("leaderboard-panel").style.borderRadius = "4px";
...
GM_addStyle('* #chat-panel {width: 675px}');
GM_addStyle('* #chat-panel {height: 350px}');
...
var maincontent = document.getElementById("main-content");
  ...
  ffscversion.innerHTML = 'NoNameClan';
  ffscversion.id = 'Mist';
  maincontent.appendChild(ffscversion);
document.getElementById("Mist").style.cssText = "text-align:center;font-size:18px;color:red;";
...
//auto doublesplit
document.addEventListener('doublesplit', function(e) {
var key = auto.keyCod || auto.which;
switch (key) {case 45: document.getElementById("").click();}});
