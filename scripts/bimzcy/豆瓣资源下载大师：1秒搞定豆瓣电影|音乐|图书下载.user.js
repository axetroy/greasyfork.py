...
<div class="rating_more" style="display:none"></div>`); // 修复部分情况$("div.rating_betterthan")不存在情况
            ...
            if (!(is_mandarine) || (is_mandarine && is_otherlan)) {
                site_map.push({
                    ...
                    label: [
                        ...
                        { name: '字幕组', link: 'http://www.zimuzu.io/search/index?type=subtitle&keyword=' + unititle, selector: ".search-result li" },
            ...
            site_map.push({
                ...
                label: [
                    ...
                    { name: '片源网', link: 'http://pianyuan.net/search?q=' + dbzw, selector: 'div.row ul.detail' },
                    ...
                    { name: '中国高清网', link: 'http://www.zg1080.com/?s=' + dbzw, selector: 'div.mainleft div.thumbnail' },
                ]
            });
            if (has_imdb || is_ywm) {
                site_map.push({
                    name: "国外网盘精准",
                    label: [
                        { name: 'BaDshaH✇', link: 'http://spt-112.com/?s=' + jingzhun, selector: 'div.content h2.post-box-title', selector_need_login: "h1 span:contains('Checking your browser')" },
                        ...
                        { name: 'EZDDL✇', link: 'http://ezddl.com/?s=' + jingzhun, selector: '#main header.entry-header', selector_need_login: "h1 span:contains('Checking your browser')" },
                        ...
                        { name: 'Freshwap✇', link: 'http://www.freshwap.us/?do=search&subaction=search&story=' + jingzhun, selector: '#dle-content div.maincont', selector_need_login: "h1 span:contains('Checking your browser')" },
                        { name: 'GoMovie✇', link: 'https://go-movie.org/?do=search&subaction=search&story=' + jingzhun, selector: '#dle-content div.dtitle', selector_need_login: "h1 span:contains('Checking your browser')" },
                        { name: 'HugeWare✇', link: 'http://hugewarez.net/?do=search&subaction=search&story=' + jingzhun, selector: '#dle-content div.title', selector_need_login: "h1 span:contains('Checking your browser')" },
                        { name: 'MFTWBB✇', link: 'https://mftwbb.com/?do=search&subaction=search&story=' + jingzhun, selector: '#dle-content div.shd', selector_need_login: "h1 span:contains('Checking your browser')" },
                        ...
                        { name: 'RLS4U✇', link: 'https://rls4u.net/?do=search&subaction=search&story=' + jingzhun, selector: '#dle-content div.textg', selector_need_login: "h1 span:contains('Checking your browser')" },
                        { name: 'SoftDDL✇', link: 'http://bper-sicura.com/index.php?do=search&subaction=search&story=' + jingzhun, selector: '#dle-content div.news', selector_need_login: "h1 span:contains('Checking your browser')" },
                        { name: 'ULMovie✇', link: 'http://ulmovies.com/?do=search&subaction=search&story=' + jingzhun, selector: '#dle-content div.main-news', selector_need_login: "h1 span:contains('Checking your browser')" },
                        ...
                        { name: 'WrzCraft✇', link: 'http://wrzcraft.life/?s=' + jingzhun, selector: '#side-content div.post', selector_need_login: "h1 span:contains('Checking your browser')" },
                    ]
                });
            }
            site_map.push({
            ...
            site_map.push({
                name: "2010年前影视",
                label: [
                    { name: 'Ed2kers', link: 'http://www.ed2kers.net/index.php/Index/search?keyword=' + unititle, selector: 'div.ucontent div.addlist + div.addlist' },
            ...
            site_map.push({
                ...
                label: [
                    ...
                    { name: '66影视网', method: "post", link: 'http://www.66e.cc/e/search/index.php', data: `show=title%2Csmalltext&tempid=1&tbname=Article&keyboard=${gunititle}&Submit22=%E6%90%9C%E7%B4%A2`, headers: { "Content-Type": "application/x-www-form-urlencoded" }, rewrite_href: true, selector: "div.listBox li" },
            ...
            site_map.push({
                ...
                label: [
                    ...
                    { name: '磁力大全', link: 'http://cilidaquan.cc/cldq/' + unititle + '/1-1-0.html', selector: 'div.list-area dl.item' },
            ...
            if (_version === "完整版") {
                ...
                site_map.push({
                    ...
                    label: [
                        ...
                        { name: "我要Kindle", link: 'http://51kindle.me/search/' + title, selector: "#cardslist div.card-item" },
            ...
            site_map.push({
                ...
                label: [
                    ...
                    { name: 'Freshwap❏', link: 'http://www.freshwap.us/?do=search&subaction=search&story=' + isbn10, selector: '#dle-content div.maincont', selector_need_login: "h1 span:contains('Checking your browser')" },
                    { name: 'GoMovie❏', link: 'https://go-movie.org/?do=search&subaction=search&story=' + isbn10, selector: '#dle-content div.dtitle', selector_need_login: "h1 span:contains('Checking your browser')" },
                    { name: 'HugeWare❏', link: 'http://hugewarez.net/?do=search&subaction=search&story=' + isbn10, selector: '#dle-content div.title', selector_need_login: "h1 span:contains('Checking your browser')" },
                    { name: 'MFTWBB❏', link: 'https://mftwbb.com/?do=search&subaction=search&story=' + isbn10, selector: '#dle-content div.shd', selector_need_login: "h1 span:contains('Checking your browser')" },
                    ...
                    { name: 'RLS4U❏', link: 'https://rls4u.net/?do=search&subaction=search&story=' + isbn10, selector: '#dle-content div.textg', selector_need_login: "h1 span:contains('Checking your browser')" },
                    ...
                    { name: 'SoftDDL❏', link: 'http://bper-sicura.com/index.php?do=search&subaction=search&story=' + isbn10, selector: '#dle-content div.news', selector_need_login: "h1 span:contains('Checking your browser')" },
                    { name: 'WareLove❏', link: 'https://warezlover.in/index.php?do=search&subaction=search&story=' + isbn10, selector: '#dle-content h2.btl', selector_need_login: "h1 span:contains('Checking your browser')" },
            ...
            site_map.push({
                ...
                label: [
                    ...
                    { name: '书单', link: 'http://www.booklist.mobi/?q=' + title, selector: 'div.row div.caption' },
            ...
            if (has_ywm) {
                site_map.push({
                    ...
                    label: [
                        ...
                        { name: 'EPDF', link: 'https://epdf.tips/search/' + ywm, selector: `h3.note-title:contains(${title})` },
