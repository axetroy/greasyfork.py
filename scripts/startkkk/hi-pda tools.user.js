...
sybwV4ABAEMXBDR9AlSHAAAAAElFTkSuQmCC) no-repeat 10px 5px");
  if(_simple_style){ // 启用了精简风格
    ...
    GM_addStyle("\
      ...
      #moderate .colplural,.icon,#forumheader {display:none}\
      ...
      td,.subject{font:13px/1.4em Verdana,Helvetica,Arial,sans-serif;}\
    ");
  }
  changeFontSize();
...
function addConfigDiv(){      // 添加Alt+O的界面
    ...
    hp_cfg.innerHTML = '<center><font face="Impact" size=3 title="来自D版带着爱">hi-pda &hearts; tool</font> <sub>version 5.0</sub></center><hr />\
        字体大小：\
