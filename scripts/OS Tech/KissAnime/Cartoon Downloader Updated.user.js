// ==UserScript==
// @name         KissAnime/Cartoon Downloader Updated
// @namespace    https://greasyfork.org/en/users/88955-os-tech
// @version      1.0
// @description  Download videos from the sites KissAnime.ru, KissAnime.com, KissAsian.com and KissCartoon.com
// @author       OSTech
...
function GetHost(){
	...
	if (window.location.href.split(".to").length > 1){
		...
		split = ".me";
	} else if(window.location.href.split(".ru").length > 1){
		split = ".ru";
	}
