                    ...
                    $.get(url, function (data) {
                        ...
                        GM_xmlhttpRequest({
                            ...
                            onload: function (json) {
								var rtcolour = '#FF5555';
								var rtimglink = 'https://staticv2-4.rottentomatoes.com/static/images/icons/fresh-16.png';
                                ...
                                var rtimglong = '<img src="https://staticv2-4.rottentomatoes.com/static/images/icons/fresh-16.png" alt="rt" height="16" width="16">';
								...
								if (parseFloat(res.tomatoRating) < 60 ) {
                                    rtcolour = '#00CA5F';
									rtimglink = 'https://staticv2-4.rottentomatoes.com/static/images/icons/splat-16.png';
                                    rtimglong = '<img src="https://staticv2-4.rottentomatoes.com/static/images/icons/splat-16.png" alt="rt" height="16" width="16">';
                                }    
