...
function lol(){
    ...
    var robux = document.getElementById("nav-robux-amount").innerHTML = "2000k+";
    var robux2 = document.getElementById("nav-robux-balance").innerHTML = "2000ROBUX";
}
function sleep(){
    GM_setValue('hi', true);
...
function start() {
    ...
    footer.innerHTML = `Your balance after this transaction will be <span class="icon-robux-gray-16x16"></span>2000</div>`;
