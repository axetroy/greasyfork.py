...
setTimeout(function() {
    ...
    $( "#canvas" ).after( "<div class='all'><div style='background-color:#89bdd3;-moz-opacity:.4;-khtml-opacity:.4;opacity:.4;border-radius:10px 10px 10px 10px;filter:alpha(opacity=40);zoom:1;width:225px;top:10px;left:10px;display:block;position:absolute;text-align:center;font-size:15px;color:#06000a;padding:5px;font-family:Ubuntu'> <div style='color:#0b173b;display:inline;-moz-opacity:1;-khtml-opacity:1;opacity:1;filter:alpha(opacity=100);padding:5px'><h2><a class='title'>?❰Ќϻ❱? <-------------> ?BOTS?</a></h2></div> <div style='color:#312c32;display:inline;-moz-opacity:1;-khtml-opacity:1;opacity:1;filter:alpha(opacity=100);padding:5px'><br><h2 class='count'><a class='off'id='minionCount'>Bots Offline</a></h2> </div><div style='color:#06000a;display:inline;-moz-opacity:1;-khtml-opacity:1;opacity:1;filter:alpha(opacity=100);padding:5px'><br> <div style='color:#06000a;display:inline;-moz-opacity:1;-khtml-opacity:1;opacity:1;filter:alpha(opacity=100);padding:5px'><br><div class='cons'><a>A</a> - Bots To Mouse: <a id='ismoveToMouse'>On</a><br><a>D</a> - Stop User: <a id='isStopMove'>Off</a> <a><br>E</a> - Split bots <a><br>R</a> - Bots Eject <a><br>Q</a> - User Fast Eject</div></div></div></div></div><link href='https://fonts.googleapis.com/css?family=Ubuntu' rel='stylesheet' type='text/css'><style>.all{opacity:1;transition:opacity .25s ease-in-out;-moz-transition:opacity .25s ease-in-out;-webkit-transition:opacity .25s ease-in-out}.all:hover{opacity:.3}.count{padding-bottom:10px}h2{margin-top:-10}h1{margin-top:-10}h4{margin-top:-10px}.Con{padding-top:10px;padding-bottom:-10px}h3{margin-top:-10px}.cons{position:relative;top:-25px}.off{border:solid;padding:10px}.title{text-shadow:0 1px 0 #ccc,0 2px 0 #c9c9c9,0 3px 0 #bbb,0 4px 0 #b9b9b9,0 5px 0 #aaa,0 6px 1px rgba(0,0,0,.1),0 0 5px rgba(0,0,0,.1),0 1px 3px rgba(0,0,0,.3),0 3px 5px rgba(0,0,0,.2),0 5px 10px rgba(0,0,0,.25),0 10px 10px rgba(0,0,0,.2),0 20px 20px rgba(0,0,0,.15);color:#fff}</style>" );
