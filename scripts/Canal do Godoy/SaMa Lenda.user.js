...
(function(w) {
    ...
    function setMenu() {
        ...
        if (login) {
            ...
            div.innerHTML = "[ESC] - Saida Rapida | [Q] - Sair do Menu<br/>[A] - Mudar de Skin | [S] - Mudar de Pele<br/>[Z] - Voltar zoom | [Space] - Boost";
            ...
            sltMenu.style.color = "#58d066";

            sltMenu.style.backgroundColor = "#a80b1e";
            ...
            sltMenu.innerHTML = "<strond>Christi@n el unico </strong> | <strong>" + modVersion + "</strong>";
            ...
            div.style.color = "#d61111";

            div.style.backgroundColor = "#447c5f";
            ...
            input.placeholder = "IP do Servidor (IP:porta)";
            ...
            button.style.backgroundColor = "#08d820";
            ...
            option.text = "-- Lista de Servidores --";
            ...
            sltMenu.innerHTML += '<a href="https://www.facebook.com/christianelunico" target="_blank" style="color: #56C0EB  ;">FACEBOK</a> | ';

                                               sltMenu.innerHTML += '<a href="https://www.youtube.com/watch?v=F_rtp-vYwOo" target="_blank" style="color: #56C0EB  ;">PERU LENDA </a>';
    ...
    function setLeaderboard() {
        ...
        if (w.lbh) {
            ...
            w.lbh.textContent = "[PERU] Christi@n LENDA";
            ...
            w.dead_mtm = 0;
                ...
                function setHighScore() {
                               ...
                               if (scoreHUD && highScore > 0) {
                                               ...
                                               scoreHUD.textContent = "Sua Melhor Pontuação: " + highScore;
