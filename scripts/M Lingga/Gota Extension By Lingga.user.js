// ==UserScript==
// @name         Gota Extension By Lingga
// @namespace    Pretty Good Gota Script
// @description  E - 16 Split -|- Q - Triple Split -|- D - Double Split
// @version      10.5
// @author       Edited By Lingga~
// @match        http://gota.io/web/*
// @grant        GM_addStyle
// @icon         https://images.cooltext.com/4901577.png
// ==/UserScript==
...
GM_addStyle('* #logo {background-image: url("https://images.cooltext.com/4901580.png");}'); // Put link between brackets
GM_addStyle('* #minimap-canvas {background-image: url("https://images.cooltext.com/4901580.png");}'); //Put link between brackets
...
version.innerHTML = 'E - Tricksplit -|- Q - Triplesplit -|- D - Double split \Created By Lingga';
...
function keydown(event) {
	...
	} else if (event.keyCode == 81) { //key Q
		split();                  //Triple Split
		setTimeout(split, timeBetweenSplits*1);
