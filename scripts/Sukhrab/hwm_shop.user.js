...
// @author         Demin
// @namespace      Demin
// @description    Отображает стоимость боя и ОА в магазине и инфе арта, переплаты за покупку и аренду, добавляет быстрые ссылки на рынок (by Demin) (обновления by Sukhrab)
...
if ( location.pathname=='/shop.php' ) {
	...
	var arts_id_array = document.querySelectorAll("img[src*='/artifacts/'][src$='.png']");
}
