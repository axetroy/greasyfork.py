// ==UserScript==
// @name         SR Clan Private
// @namespace    http://tampermonkey.net/
// @version      x
// @description  Private SR Clan X
// @author       Mist
// @match        http://gota.io/web/*
// @grant        GM_addStyle
// @contributor  Mist
// @icon         https://i.imgur.com/CxQk74U.png
// @downloadURL
// ==/UserScript==
...
GM_addStyle('* #logo {background-image: url("https://i.imgur.com/x8yorH2.png");}');
GM_addStyle('* #minimap-canvas {background-image: url("https://i.imgur.com/OYmEA01.png");}');
...
//Custom Borders
GM_addStyle('* .main-panel {border: solid 1px rgba(105 105 105)}');
GM_addStyle('* .main-panel {border-radius: 3px}');
...
document.getElementById("leaderboard-panel").style.borderRadius = "0px";
...
document.getElementById("score-panel").style.borderRadius = "0px";
...
document.getElementById("minimap-panel").style.borderRadius = "0px";
...
document.getElementById("party-panel").style.borderRadius = "0px";
...
GM_addStyle('* #chat-panel {height: 275px}');
...
GM_addStyle('* #main-content {width: 300px; height: 400px; margin-top: 80px;}');
...
var maincontent = document.getElementById("main-content");
  ...
  ffscversion.innerHTML = 'Serene Rain Clan';
  ffscversion.id = 'Mist';
  maincontent.appendChild(ffscversion);
document.getElementById("Mist").style.cssText = "text-align:center;font-size:30px;color:white;";
