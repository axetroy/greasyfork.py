// ==UserScript==
// @name         Agario Automatic Mass - W
// @namespace    http://vk.com/dyzain_oleg
// @version      4.3
// @description  Hold W to eject mass until you release.
// @author       Voss
// @match        http://agargold.net/
// @match        http://agarboy.com/
// @match        http://agar.io/
// @match        http://agariotime.com/
// @match        http://agariow.net/
// @match        http://slither.io/
// @match        http://agar.gold/
// @match        http://agar.ws/
// @match        http://agarport.net/
// @grant        none
// ==/UserScript==
