// ==UserScript==
// @name         L_0R3X0 Vaporwave text bot (nitrotype bot)
// @version      2.1.0
// @description  made the menu more "fancy" if you want a custom design for the menu reply to me in the feedback section~
// @author       UltraType
