...
// @namespace    L_0R3X0
// @version      0.1
// @description  Hack For Devast.io (The First One) Still Woriking On It But Enjoy!
// @author       L_0R3X0
...
$(document).ready(function() {
    ...
    var html = "<div id='gbots-box' style='display: table; position: absolute;top: 15%;left: 10px;font-family: Ubuntu;color: rgb(255, 255, 255);z-index: 9999;border-radius: 15px;min-width: 200px;background-color: rgba(0,255,0,0.3);'> <div style='display:table-cell;padding: 0px 12px 0px 12px;'> <div id='gbots-header' style='font-size: 16px;margin: 8px 0px 8px 0px;'> <span style='font-size: 20px;'></span>L_0R3X0 K00L K1DZ HACK ALPHA<span id='bot_'><span style='color:#ff0000;'></span></span><br> <span class='hide' id='position'> </span> </div> <div id='gbots-dl' style='display: block; padding: 12px 0px; border-top: 1px solid rgba(255, 255, 255, 0.85098); width: auto; margin-left: auto; margin-right: 10px; text-align: left; font-size: 20px;'><i class='glyphicon glyphicon-time' style='font-size: 14px;margin-right: 2px;color:#bbb;'></i>Time: Unlimted Time <span id='bot_t' style='color:#bbb;'><hr><span style='font-size: 20px;'></span>R - <span><span style='color:#49ff00;'>Max Inv/All Guns</span></span><br> E - <span><span style='color:#49ff00;'>AimBot</span></span> </span><br>LEVEL 99: <span id='bot_a' style='color:#49ff00;'>Loading...</span></span> </div> </div> </div>";
    $("body").append(html);
