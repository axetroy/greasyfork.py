// ==UserScript==
// @name        SteamKeysGame.gifts[CAPTCHA SKIP]
// @version      0.24
// @description  Plays the next video without CAPTCHA
// @author       Velibor Simonovic
// @license      You dont need it XD
// @match        https://steamkeysgames.gifts.gg
// @grant        GM_xmlhttpRequest
// @grant        GM_getValue
// @grant        GM_setValue
// @grant        GM_listValues
// @grant        GM_deleteValue
// @namespace https://greasyfork.org/users/155252
// ==/UserScript==
...
(function() {
    ...
    $( document ).ready(function() {
        ...
        if($("#btnPrevious").height() === null && $("#btnNext").height() !== null){
            $("#btnNext").parent().before('<a href="#!"><img id="btnPrevious" src="https://steamkeysgames.giftsborder="0"></a>&nbsp;&nbsp;');
            $("#btnPrevious").parent().css("display","none");
        }

        if($("#btnNext").height() === null && $("#btnPrevious").height() !== null){
            $("#btnPrevious").parent().after('&nbsp;&nbsp;<a href="#!"><img id="btnNext" src="https://steamkeysgames.gifts/Content/images/next.png" title="Next episode" border="0"></a>');
            $("#btnNext").parent().css("display","none");
        }
        ...
        function postdata(answer){
            ...
            var msg = $.ajax({type: "POST", url: "https://steamkeysgames.gifts/Special/AreYouHuman2",data: data ,async: false}).responseText;
            //console.log(msg);
            //alert();
        ...
        function loadImage(items, i, onComplete) {
            ...
            img.src = "https://steamkeysgames.gifts/Special/"+items[i];
        }
