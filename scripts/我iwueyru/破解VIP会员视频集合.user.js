...
// @version      3.0.2
// @description  破解[优酷|腾讯|乐视|爱奇艺|芒果|AB站|音悦台]等VIP或会员视频，解析接口贵精不贵多，绝对够用。有直接跳转＋备用接口列表。详细方法看说明还有图片。包含了[【稳定】全网VIP视频在线解析▶ttmsjx][VIP会员视频解析▶龙轩]以及[VIP视频破解▶hoothin]的部分接口。
// @author       黄盐
...
(function() {
    ...
    var apis=[
        ...
        {"name":"噗噗电影","url":"http://pupudy.com/play?make=url&id=","title":"综合接口，ttmsjx脚本的接口"},
