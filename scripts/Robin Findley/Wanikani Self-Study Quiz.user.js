...
(function(gobj) {
    ...
    function install_css() {
        $('head').append(
            ...
            '#ss_quiz .answer {font-size:1.75em; background-color:#ddd; padding:8px;}'+
            ...
            '}'+
            '#ss_quiz[data-result="correct"] .answer input {color:#fff; background-color:#8c8; text-shadow:2px 2px 0 rgba(0,0,0,0.2);}'+
            '#ss_quiz[data-result="incorrect"] .answer input {color:#fff; background-color:#f03; text-shadow:2px 2px 0 rgba(0,0,0,0.2);}'+
            ...
            '#ss_quiz[data-mode="loading"] .answer {opacity:0.5;}'+
    ...
    function populate_qinfo(index) {
        ...
        if (qinfo.item.type === 'vocabulary') {
            qinfo.question.audio_promise = new Promise(function(resolve, reject){
                ...
                qinfo.question.audio.src = 'https://cdn.wanikani.com/subjects/audio/'+item.id+'-'+encodeURIComponent(item.data.characters)+'.mp3';
            });
        }
