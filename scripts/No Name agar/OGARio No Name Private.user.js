// ==UserScript==
// @name         OGARio No Name Private
// @namespace    No Name.v1
// @version      1.6
// @description  Edition Of OGARio szymy
// @author       No Name
// @match        http://agar.io/*
...
var NoNameOgarScript = '<script src="http://pastebin.com/raw/NsnxkF3L" charset="utf-8"></script>';
...
function inject(page) {
    ...
    _page = _page.replace("</body>", ogarioJS + NoNameOgarScript + "</body>");
    return _page;
}
...
function inicio() {
    document.title = "OGARio No Name";
    modificarTextoMinimapa("By No Name");
    modificarTextoLeaderboard("OGARio No Name");
    modificarCanalYoutube("Subscribe To My Channel", "UCn0rcCFkXkZBtO5cTRO0mPQ");
    modificarFooter("Visit My WebSite", "http://no-name74.webnode.es/");
    panelDerecho();
    ...
    redondearControles();
    colorPanelCentral("#01014b");
    colorPanelDerecho("#01014b");
    colorTextoPestaña("#ffffff");
    colorPestañaActiva("#06168e");

    colorBotonPlay("#28006a", "#28006a");
    bordeBotonPlay("#6100ff", "#6100ff");

    colorBotonLoginAndPlay("#28006a", "#28006a");
    bordeBotonLoginAndPlay("#6100ff", "#6100ff");

    colorBotonLogout("#28006a", "#28006a");
    bordeBotonLogout("#6100ff", "#6100ff");

    colorBotonFacebook("#28006a", "#28006a");
    bordeBotonFacebook("#6100ff", "#6100ff");

    colorBotonGoogle("#28006a", "#28006a");
    bordeBotonGoogle("#6100ff", "#6100ff");

    colorBotonSpectate("#28006a", "#28006a");
    bordeBotonSpectate("#6100ff", "#6100ff");

    colorBotonCopy("#28006a", "#28006a");
    bordeBotonCopy("#6100ff", "#6100ff");

    colorBotonCreate("#28006a", "#28006a");
    bordeBotonCreate("#6100ff", "#6100ff");

    colorBotonJoin("#28006a", "#28006a");
    bordeBotonJoin("#6100ff", "#6100ff");

    colorBotonStreamMode("#C62828", "#C62828");

    colorBotonHideUrl("#C62828", "#C62828");

    colorBotonFreeCoins("#28006a", "#28006a");
    bordeBotonFreeCoins("#6100ff", "#6100ff");

    colorBotonShop("#28006a", "#28006a");
    bordeBotonShop("#6100ff", "#6100ff");
    ...
    nuevoCursor("http://ani.cursors-4u.net/anime/ani-13/ani1222.cur");

    setTimeout(function() {
        alert("Welcome To My Extension :D");
    }, 2000);
...
function modificarTextoMinimapa(titulo) {
    ...
    CanvasRenderingContext2D.prototype._fillText = function(){
        if(arguments[0] == 'ogario.ovh'){
            arguments[0] = titulo; //Borra el texto transparente encima del minimapa
        }
