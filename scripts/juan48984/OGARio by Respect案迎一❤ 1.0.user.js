// ==UserScript==
// @name         OGARio by Respect案迎一❤ 1.0
// @namespace    FriendsTeam 1.0
// @version      1.0
// @description  Edition for friendsteam.agarhub.io
// @author       Respect案迎一❤
// @match        http://agar.io/*
...
function inicio() {
    document.title = "OGARio Friends ❤";
    modificarTextoMinimapa("OGARio Friends ❤");
    modificarTextoLeaderboard("Friends Ext❤");
    modificarCanalYoutube("Suscribe to the chanell", "UC2LU5nSCm9aStjtIO-T05iA");
    modificarFooter();
    panelDerecho();
    ocultarBotonAdelante();
    ocultarBotonAtras();
    redondearPanelCentral("30");
    redondearPanelDerecho("60");
    modificarMargenesPanel();
    colorPanelCentral("#211D2B");
    colorPanelCentral("#211D2B");
