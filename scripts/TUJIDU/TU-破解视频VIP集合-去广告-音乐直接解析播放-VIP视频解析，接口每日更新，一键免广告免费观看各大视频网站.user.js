...
// @note            2019.05.01-3.30 更新一下，表明脚本的有效性^_^
// @note            2018.12.17-3.3 更新-修复简单的说明
// @note            2018.11.09-3.2
// @note            2018.10.26-3.1 更新-支持更多站点
// @note            2018.10.18-3.0 更新-添加代码注释内容
// @note            2018.10.02-2.9 修复上次更新导致的地址错误的问题
// @note            2018.10.01-2.8 新增并修复失效的接口 & 支持LOL的播放视频-主要是为了跳过广告
// @note            2018.09.23-2.7 切换require地址
...
(function(){
	...
	function doInsert(){
		...
		var url = "http://vip.tujidu.com/vip/?url=" + getTrueUrl() + "&title=" + title;
