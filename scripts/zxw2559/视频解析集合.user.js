...
(() => {
  ...
  `);
  var defaultapi = {
    title: "默认用寒曦朦解析，失效请更换接口",
    url: "http://jx.hanximeng.com/api.php?url="
  };
  //apis name:显示的文字  url:接口  title:提示文字  intab:是否适合内嵌(嵌入判断:GMgetValue("replaceRaw",false)值||intab值)
  var apis =[
    {name:"云播",url:"http://jiexi.ppjys.cn/?url=",title:"转圈圈就换线路",intab:1},
    {name:"盈余",url:"http://api.xyingyu.com/?url=",title:"转圈圈就换线路",intab:1},
    {name:"618G",url:"http://jx.618g.com/?url=",title:"转圈圈就换线路",intab:1},
    {name:"穷二代",url:"https://ejiafarm.com/jx.php?url=",title:"转圈圈就换线路",intab:1},
    {name:"思念视频",url:"https://api.7kki.cn/api/?url=",title:"转圈圈就换线路",intab:1},
    {name:"乐乐云",url:"https://660e.com/?url=",title:"转圈圈就换线路",intab:1},
  ];
  //嵌入页面播放
