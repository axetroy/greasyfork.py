...
// @namespace      Demin
// @author         Demin
// @description    Отображает стоимость боя и ОА в магазине и инфе арта, переплаты за покупку и аренду, добавляет быстрые ссылки на рынок
// @homepage       https://greasyfork.org/en/scripts/374659-hwm-shop
// @icon           https://i.imgur.com/LZJFLgt.png
// @version        7.2.5
// @encoding       utf-8
// @include        https://www.heroeswm.ru/shop.php*
// @include        https://www.heroeswm.ru/art_info.php?id=*
// @include        https://www.lordswm.com/shop.php*
...
// (c) 2010-2014, demin  ( https://www.heroeswm.ru/pl_info.php?id=15091 )
// 7.2.4+ CheckT: small refactoring
...
(function() {
  ...
  if ( document.querySelector("body") ) {
    ...
    if ( url_cur.match('lordswm') ) {
      ...
      sum = /\u0434\u043B\u044F \u043F\u0440\u043E\u0434\u0430\u0436\u0438:<\/b> (\d+)/;
      sear = "\u0422\u0440\u0435\u0431\u0443\u0435\u043C\u044B\u0439 \u0443\u0440\u043E\u0432\u0435\u043D\u044C:";
      searc = /\u0426\u0435\u043D\u0430 \u0430\u0440\u0435\u043D\u0434\u044B \u043D\u0430 1 \u0431\u043E\u0439.+<td>(\d+)<\/td>/;
      seard = "\u0421\u0442\u043E\u0438\u043C\u043E\u0441\u0442\u044C:";
      shop = "поиск на рынке";
      text0_title = 'Переплата за покупку арта в магазине (если числа отнять получим цену завода), т.е. сколько можно сэкономить если прогуляться по карте.';
      text1 = '<b>\u0421\u0442\u043E\u0438\u043C\u043E\u0441\u0442\u044C 1 \u0431\u043E\u044F:</b> ';
      text1_title = 'Цена за 1 бой (минимальная, при покупке арта с завода).\nЦена ОА (от минимальной цены за бой).\n\nВ скобках (если есть) - переплата за 1 бой при покупке в магазине (если числа сложить получим стоимость боя при покупке в магазине), т.е. сколько вы переплатите за 1 бой, купив арт в магазине.';
      text2 = '&nbsp;&nbsp;\u041F\u0435\u0440\u0435\u043F\u043B\u0430\u0442\u0430: \u0437\u0430 \u0431\u043E\u0439 ';
      text2_title = 'Переплата за аренду на 1 бой и переплата за всю прочку. В скобках - процент удорожания цены за бой, превышающий стоимость боя собственных артефактов.';
      text3 = ' \u0437\u0430 \u0432\u0441\u044E \u043F\u0440\u043E\u0447\u043A\u0443 ';

      s_text1 = '\u0421\u043A\u0440\u044B\u0432\u0430\u0442\u044C \u0430\u0440\u0442\u0435\u0444\u0430\u043A\u0442\u044B';
      s_text1_title = 'Сворачивает арты в магазине, которых нет ("Доступно для продажи: 0").\nКликом по полю с названием арта скрытая информация разворачивается.';
      s_text2 = '\u0418\u0437\u043C\u0435\u043D\u044F\u0442\u044C \u0440\u0430\u0437\u0434\u0435\u043B\u044B';
      s_text2_title = 'Добавляет быстрые ссылки в меню:\n- на аренду категории артов (переход за один клик),\n- на аренду модифицированных артов (переход за один клик).';
      s_author = '\u0410\u0432\u0442\u043E\u0440 \u0441\u043A\u0440\u0438\u043F\u0442\u0430';
      s_text_menu1 = '\u0430\u0440\u0435\u043d\u0434\u0430';
      s_text_menu2 = '\u043c\u043e\u0434';
    ...
    if ( location.pathname=='/shop.php' ) {
      arts_id_array = document.querySelectorAll("a[href^='art_info.php?id=']");
    } else {
      arts_id_array = document.querySelectorAll("img[src*='/artifacts/'][src$='.jpg']");
    }
    ...
    for ( var i=0; i<arts_id_array.length; i++ ) {
      ...
      if ( ai.innerHTML.indexOf(sear)!=-1 ) {
        ...
        if ( ai_pn.className == 'wbwhite' ) {
          ...
          var arts_id;
          if ( location.pathname=='/shop.php' ) {
            arts_id = /id=(\w+)/.exec(arts_id_array[i])[1];
          } else {
            arts_id = /id=(\w+)/.exec(url_cur)[1];
          }
  ...
  function shop_hide_arts_f() {
    if ( $('shop_hide_arts_id').checked==true )
      shop_hide_arts='1';
    else
      shop_hide_arts='0';
  ...
  function shop_change_sections_f() {
    if ( $('shop_change_sections_id').checked==true )
      shop_change_sections='1';
    else
      shop_change_sections='0';
  ...
  function add_array_arts() {
    ...
    // Object.keys(array_arts).length => 176
  }
