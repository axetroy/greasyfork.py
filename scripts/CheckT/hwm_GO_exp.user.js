...
var str_url = "https://greasyfork.org/en/scripts/375163-hwm-go-exp";
...
function settings_go()
{
  ...
  '<label><input type=checkbox '+html_if_checked(enable_5_procent)+' id=set_enable_5_procent title=""> '+str_show_2+'</label><br>'+
  ...
  '<label>'+str_beep_if_free+'<input type=checkbox '+html_if_checked(beep_if_free)+' id=set_beep_if_free title=""></label><br>'+
        //Рекорд из архива.
  '<label><input type=checkbox '+html_if_checked(show_archive)+' id=set_show_archive title=""> '+str_show_archive+'</label><br>'+
        //Суммарное HP.
  ...
  str_skip_select_1+
  '<label><input type=checkbox '+html_if_checked(skip_mode)+' id=set_skip_mode1 title="">'+str_skip_select_2+'</label>'+
  '<label><input type=checkbox '+html_if_checked(!skip_mode)+' id=set_skip_mode2 title="">'+str_skip_select_3+'</label>'+
  '<label>'+str_skip_no_half+'<img width="16" height="16" border="0" title="Бриллианты" src="https://hwm.cdnvideo.ru/i/diamond.gif">'+
  '<input type=checkbox '+html_if_checked(skip_no_half)+' id=set_skip_no_half title=""><b>)</b></label></td></tr>'+
  //пропуск охот по опыту
  ...
  '<label><input type=checkbox '+html_if_checked(short_button)+' id=set_short_button title=""> <font size="1" color="blue">'+str_short_button+'</font></label><hr/></td></tr>'+
...
//****************************************************
var mob_rus_exp = {//251 существ. Cтруктура: Опыт,HP,код,птица
