...
// @namespace      Demin
// @author         Demin
// @description    Быстрые ссылки на итоги, начало, конец, чат боя
// @homepage       https://greasyfork.org/en/scripts/374618-hwm-battlelinks
...
* @link https://userscripts.org/users/362572
* @license GPL
*/
        function uchar(s) {
            switch (s[0]) {
        ...
        var warid = /warid=(\d+)/;
        var show_for_all = /show_for_all=([a-z|\d]+)/;
