...
function insertIcon(a, f, title) {
	...
	if(!insertIcon.styled) {
		...
		GM_registerMenuCommand('Switch debrid service', nextServ);
...
function setRealDebridToken() {
	var t = window.prompt('Enter your private API token. You can find it here: https://real-debrid.com/apitoken', GM_getValue('realdebrid_token'));
	if(typeof t == 'string') {
