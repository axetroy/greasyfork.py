...
// @grant        GM_addStyle
// @contributor  Emir
// @icon         https://i.imgur.com/e35ExzN.png// @downloadURL
// ==/UserScript==
...
GM_addStyle('* #logo {background-image: url("https://i.imgur.com/VOnpcEY.png");}');
...
var maincontent = document.getElementById("main-content");
  ...
  ffscversion.innerHTML = 'Subscribe to Beast_YT<br> You Know What My Channel is LOL';
  ffscversion.id = 'BeastScript';
  maincontent.appendChild(ffscversion);
document.getElementById("BeastScript").style.cssText = "text-align:center;font-size:18px;color:red;";
