/* global WebSocket, io */
// ==UserScript==
// @name NCTPRO - chan022 server 2
// @namespace NCTPRO - chan022 server 2
// @version V.2.0
// @description Free
// @author NatkungTH,chan022
...
sendai: function(socket) {

socket.emit('action', "ai");
},
sendaiclear: function(socket) {

socket.emit('action', "aiclear");
},
sendchatclear: function(socket) {

socket.emit('action', "chatclear");
},
sendchat: function(socket) {

socket.emit('action', "chat");
}
};
...
fe.sendchatclear(socket);
}
});

var info = {
bot_c: document.getElementById("bot_c"),
bot_a: document.getElementById("bot_a"),
bot_t: document.getElementById("bot_t"),
bot_b: document.getElementById("bot_b"),
};

socket.on('info', function(data) {
info.bot_c.innerHTML = data.bot_c;
info.bot_b.innerHTML = data.bot_b;
