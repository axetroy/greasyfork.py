...
// @namespace   https://greasyfork.org/en/users/169660-irobacsi
// @author      adipiciu (based on TTQ by Risi and further edited by Nevam and then Pimp Trizkit and Serj_LV, add extra feature by irobacsi)
// @license     GPL version 3 or any later version; http://www.gnu.org/copyleft/gpl.html
// @description Schedule delayed constructions, upgrades and attacks. irobacsi version: random number generator for sending attacks.
// @contributionURL https://PayPal.Me/irobacsi 
// @include     *://*.travian.*
// @include     *://*/*.travian.*
...
var minNumber = 250; //the min number in seconds
var addNumber = 230; //the number which will add
											//the rng will generate a number between 250-480 in default.
...
function displayTimerForm(iTask, target, options, timestamp, taskindex, villagedid) {
  ...
  var randomNumber = (Math.floor(Math.random() * minNumber)) + addNumber;
	var prev = localStorage.getItem("time");
  var totalNewTime=parseInt(randomNumber)+parseInt(prev);
  localStorage.setItem("time",totalNewTime);
  console.log(totalNewTime);
	...
	/* 3 */ ' <input name="at" type="text" id="at" onmousedown="dragObject = null;" onfocus="document.getElementById(\'after\').value = \'\'; this.value=\'' +sTime+ '\'" title="' +sTimeType+ '" /><span>' + aLangStrings[26] + '</span>' +
	/* 4 */ ' <input name="after" type="text" value="' +totalNewTime+ '" id="after" onmousedown="dragObject = null;" onmousemove="dragObject = null;" onmouseup="dragObject = null;" onfocus="document.getElementById(\'at\').value = \'\';" />' +
	/* 5 */	'<select name="timeUnit"><option value="1" selected="selected">' + aLangStrings[27]
	+ '</option><option value="60">' + aLangStrings[28]
