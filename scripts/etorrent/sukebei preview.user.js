...
var urlOpt = {
	//이미지 링크 추가
	img: ["pixsense.net", "imgwallet.com", "img.yt", "imgstudio.org", "hentai-jav.top", "hentai-sun.top", "star-hentai.com", "hentai-baka.com", "imageteam.org"],
	//html 링크 추가
	html: ["ecoimages.xyz","imagespublic.tk","imagede.top","imgblaze.net","imgfrost.net","picshub.co","hentai-covers.site","imgbaron.com","iceimg.net","chaosimg.site","vestimage.site","picbaron.com","hotimg.site","imagexport.com","imgchili.net","iceimg.net","imgflare.com","imghost.top","xxx.pornscreen.xyz","imagetwist.com","imgazel.info","55888.eu","imgadult.com","dimtus.com","damimage.com","imagedecode.com","pixsense.net","imgtaxi.com","imgseed.com","h-hentai.com","imgdrive.net"],
	imgfile: ["imgblaze.net","imgfrost.net","pixsense.net","iceimg.net","chaosimg.site","vestimage.site"],
	ogimage: ["picshub.co","hentai-covers.site","imgadult.com","imgdrive.net","imgtaxi.com"],
	...
	converthtml: function(getPreviewBox, target, data, time) {
		getPreviewBox.find("a").each(function() {
			...
			if(getText.indexOf("[/img") > -1 || getText.indexOf("<img") > -1) {
				...
				$(this).attr("href",getText).empty().append("<img src='" + getText + "' alt='' style='max-width:500px'>");
			}
			else {
				var getImgs = getText.match(/(http)?s?:?(\/\/[^"']*\.(?:png|jpg|jpeg|gif|png|svg))/gi);
				if(getImgs !== null && getImgs.length > 0 && getImgs[0] !== "") {
					$(this).attr("href",getText).empty().append("<img src='" + getImgs[0] + "' alt='' style='max-width:500px'>");
				}
			}
		});
