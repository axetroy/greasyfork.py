...
// @homepage       https://greasyfork.org/ru/scripts/12761-hwm-ecostat-adv
// @version        4.12
// @include        https://*heroeswm.ru/map.php*
// @include        https://*heroeswm.ru/ecostat*
// @include        https://*heroeswm.ru/object-info.php*
...
// @include        http://*heroeswm.ru/ecostat*
// @include        http://*heroeswm.ru/object-info.php*
...
for (var i=tables.length; i--;)	{
    var gold_img = tables[i].querySelectorAll("img[src*='gold.gif']");
    if (gold_img.length==2) {
