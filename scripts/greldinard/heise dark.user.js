...
$('.a-article-teaser__synopsis').css({'background-color' : bgcolor, 'color' : txtcolor});
...
//$('.ob-unit').attr('style', 'color: ' + txtcolor + '; background-color: '+ bgcolor);
...
//$('.AR_1.ob-strip-layout').attr('style', 'color: ' + txtcolor + ' !important');
