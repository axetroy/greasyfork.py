...
function inicio() {
    document.title = "OGARio - iLay :)";
    modificarTextoMinimapa("By iLay");
    modificarTextoLeaderboard("iLay-XD");
    modificarCanalYoutube("Suscríbete a mi canal", "UCM4IT2JJTzbycMTrqzhxV-w");
    modificarFooter("Visita mi canal de youtube", "https://www.youtube.com/channel/UCM4IT2JJTzbycMTrqzhxV-w");
    panelDerecho();
    ...
    colorBotonPlay("#222123", "#BE0000");
    bordeBotonPlay("#FFFFFF", "#FFFFFF");

    colorBotonLoginAndPlay("#222123", "#6A05A7");
    bordeBotonLoginAndPlay("#FFFFFF", "#FFFFFF");

    colorBotonLogout("", "#DF4700");
    bordeBotonLogout("#FFFFFF", "#FFFFFF");

    colorBotonFacebook("", "");
    bordeBotonFacebook("#FFFFFF", "#FFFFFF");

    colorBotonGoogle("", "");
    bordeBotonGoogle("#FFFFFF", "#FFFFFF");

    colorBotonSpectate("", "#0CC759");
    bordeBotonSpectate("#FFFFFF", "#FFFFFF");

    colorBotonCopy("", "");
    bordeBotonCopy("#FFFFFF", "#FFFFFF");

    colorBotonCreate("", "");
    bordeBotonCreate("#FFFFFF", "#FFFFFF");

    colorBotonJoin("", "");
    bordeBotonJoin("#FFFFFF", "#FFFFFF");

    colorBotonStreamMode("", "");
    ...
    colorBotonResetHotkeys("", "");
    bordeBotonResetHotkeys("", "");

    colorBotonSaveHotkeys("", "");
    bordeBotonSaveHotkeys("", "");

    colorBotonCloseHotkeys("", "");
    bordeBotonCloseHotkeys("", "");
    ...
    setTimeout(function() {
        alert("Hola soy iLay disfrutala");
    }, 2000);
}
