...
// @homepage       https://greasyfork.org/zh-CN/scripts/32746-searchenginejumpmodbytw
// downloadURL    https://greasyfork.org/scripts/32746-searchenginejumpmodbytw/code/searchEngineJumpModByTW.user.js
// updateURL      https://greasyfork.org/scripts/32746-searchenginejumpmodbytw/code/searchEngineJumpModByTW.user.js
// include        *
// match          *://*/*
...
// @include			http://*
// @include			https://*
// @include			http://myweb-page0.appspot.com/gooduck.html
...
var rules = [
	...
	{name: "google网页搜索",// 你要加载的网站的名字(方便自己查找)
		...
		insertIntoDoc: {
			...
			//where: 'beforeBegin',
			//where: 'beforeEnd',
            //where: 'afterEnd',   // version: 2018.01.31
			where: 'beforeEnd',
		},
		// 自定义样式，我新增的
		css: '',
	...
	{name: "baidu网页搜索",
		...
		insertIntoDoc: {
			...
			//target: 'id("container") | html/body/table[2]',   // version:20180131
			//where: 'beforeBegin',                             // version:20180131
   ...
   {name: '鸭子',
		...
		insertIntoDoc: {
			keyword: '//input[@name="q"]',
			//target: 'css;#spacing_hidden_wrapper', // version:20180131
			//where: 'afterEnd',                     // version:20180131
            target: 'css;#header_wrapper',
			where: 'afterBegin',
		},
	},
	{name: 'startpage',
		url: /^https?:\/\/[^.]*\.startpage\.com\/*/i,
		enabled: true,
		engineList: "web",
		style: '\
			//border-top: 1px solid #E6E6E6;\
		...
		insertIntoDoc: {
			...
			//target: 'css;#head_left',    // version:20180131
			//where: 'afterEnd',           // version:20180131
            target: 'css;header.header.header--content',
			where: 'afterEnd',
		},
	},
	{name: "必应网页搜索",
	...
	//GoogleDuck
	{name: "GoogleDuck",
		// url: /^http?:\/\/myweb-page0\.appspot\.com\/*,
		url:  "http://myweb-page0.appspot.com/gooduck.html",
		engineList: "web",
		enabled: true,
		style: "\
			border-top: 0;\
	...
	//Wikidu
	{name: "Wikidu",
		url:  "http://myweb-page0.appspot.com/wikidu.html",
		engineList: "knowledge",
		enabled: true,
		style: "\
			border-top: 0;\
	...
	//Wikiwand
	{name: "Wikiwand",
		url:  "http://www.wikiwand.com/en/i",
		engineList: "knowledge",
		enabled: true,
		style: "\
			border-top: 0;\
	...
	// MerriamDao
	{name: "MerriamDao",
		url:  "http://myweb-page0.appspot.com/merriamdao.html",
		engineList: "translate",
		enabled: true,
		style: "\
			border-top: 0;\
...
engineList.web[5] = {
	name: 'GoogleDuck',
	url: 'http://myweb-page0.appspot.com/gooduck.html?search=%s',
	favicon: 'http://myweb-page0.appspot.com/GoogleDuck.png',
};
engineList.web[-3] = {
	name: '有道',
...
engineList.music = [
	{name: '网易云音乐',
		...
		favicon: 'http://music.163.com//favicon.ico',
	},
	{name: '百度音乐',
...
engineList.image = [
	...
	{name: 'tumblr',
		url: 'http://www.tumblr.com/search/%s',
...
engineList.shopping = [
	...
	{name: '一号店',
		...
		favicon: 'http://search.yhd.com/favicon.ico',
	},
	{name: 'Amazon',
		url: 'https://www.amazon.com/s/ref=nb_sb_noss?field-keywords=%s',
...
engineList.translate = [
	{name: 'MerriamDao',
		url: 'http://myweb-page0.appspot.com/merriamdao.html?search=%s',
		favicon: 'http://myweb-page0.appspot.com/MerriamDao.png',
	},
	{name: 'google翻译',
	...
	{name: 'bing 翻译',
		...
		favicon: 'https://msrmtlivecdn.azureedge.net/images/home/translator-large-icon.png'
	},
	{name: 'bing 词典',
	...
	{name: 'Merriam-Webster',
		...
		favicon: 'https://assets2.merriam-webster.com/mw/static/app-standalone-images/MW_logo.png',
	},
...
engineList.knowledge = [
	...
	{name: 'Wikidu',
		url: 'http://myweb-page0.appspot.com/wikidu.html?search=%s',
		favicon: 'http://myweb-page0.appspot.com/Wikidu_favicon.ico',
	},
	{name: 'Wikiwand',
		url: 'http://www.wikiwand.com/en/%s',
		favicon: 'http://d3isfnyiuldmfu.cloudfront.net/img/logo_new.svg?h=1e5c92df6d73fff6c28e1983e177de13',
	},
	{name: '百度百科',
	...
	{name: 'Google 学术搜索',
		url: 'https://scholar.google.com/scholar?hl=zh-CN&q=%s&btnG=&lr=%s',
...
engineList.details[3] = ['视频', 'video'];
engineList.details[4] = ['音乐', 'music'];
engineList.details[5] = ['图片', 'image'];
engineList.details[1] = ['知识', 'knowledge'];
engineList.details[7] = ['社交', 'sociality'];
engineList.details[6] = ['购物', 'shopping'];
engineList.details[8] = ['下载', 'download'];
engineList.details[2] = ['翻译', 'translate'];
engineList.details[9] = ['BT', 'bittorrent'];
