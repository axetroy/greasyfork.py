                ...
                if (old_content !== "hidden_msg")
                {
                    ...
                    if (x.indexOf(user) >= 0)
                    {
                        ...
                        if (check === "chatList")
                        {
                            ...
                            content.innerHTML = "<span class='hidden_msg' id='" + hidden_id + "' style=\"display: inline;\"><span class=\"dateTime\">" + date + "</span> <span><b>" + user + "</b></span>:<b> Message masqué</b><br /><i>Passez la souris pour voir le message</i></span>";
                        }
                        else
                        {
                            content.innerHTML = "<span class='hidden_msg' id='" + hidden_id + "' style=\"display: inline;\"><span class=\"dateTime\">" + date + "</span> <span><b>" + user + "</b></span>:<b> Message masqué</b><i> &nbsp;&nbsp;&nbsp;&nbsp;Passez la souris pour voir le message</i></span>";
                        }
