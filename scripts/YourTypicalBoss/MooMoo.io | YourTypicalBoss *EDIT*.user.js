// ==UserScript==
// @name           MooMoo.io | YourTypicalBoss *EDIT*
// @namespace      https://greasyfork.org/users/139500
// @version        ╳Y╳O╳U╳R╳ version=235231
// @description   【 E͟͢͢͟N͟͢͢͟G͟͢͢͟L͟͢͢͟I͟͢͢͟S͟͢H 】 ➜〖 AUTO HEAL 〗〖 DOUBLE ATTACK 〗〖 CHANGE HATS / ACCESSORIES IN TOOLBAR 〗〖 CHANGE ITEMS 〗〖 CHANGE HAT + BUYING 2× 〗〖 CHANGER HATS 2× 〗〖 BETTER MINIMAP 〗〖 REMOVING NEEDLESSNESS 〗〖 OTHER IMPROVEMENTS 〗
// @author         ?YourTypicalBoss?
// @match          https://45.77.0.81/*
// @match          https://45.77.0.81/*
// @require        http://code.jquery.com/jquery-3.2.1.min.js
// @icon           http://scontent.cdninstagram.com/t51.2885-15/e35/10691892_1100930263273883_713698675_n.jpg?ig_cache_key=MTE1NTA2OTc2NTg4MjQ1NzQ5Mg%3D%3D.2
// ==/UserScript==
...
document.getElementById('promoImgHolder').innerHTML = '</iframe><iframe width="420px" height="236.25px" src="https://www.youtube-nocookie.com/embed/D3_2AIOEnZQ" frameborder="0" allowfullscreen></iframe>';
document.getElementById('adCard').innerHTML = '<iframe width="420px" height="236.25px" src="https://www.youtube-nocookie.com/embed/gLeFOGp14_Y" frameborder="0" allowfullscreen></iframe>';
...
document.getElementById('loadingText').innerHTML = 'Gucci Gang...';
...
$('#foodDisplay').css({'color': '#ff0400'});

$('#woodDisplay').css({'color': '#ff6a00'});

$('#stoneDisplay').css({'color': '#fffa00'});
