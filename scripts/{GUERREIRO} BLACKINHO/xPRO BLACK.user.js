...
// @description  SLIPKNOT LENDA MOD
...
(function(w) {
    ...
    function setMenu() {
        ...
        if (login) {
            ...
            sltMenu.innerHTML = "MOD: <strong>NANDE20 by LENDA</strong> | <strong>" + modVersion + "</strong>";
            ...
            sltMenu.innerHTML += '<a href="http://black.com" target="_blank" style="color: #56ac81;">Visite meu canal</a> | ';

                                               sltMenu.innerHTML += '<a href="https://www.youtube.com/channel/UCSZYXbKM7CqtyJWuEuLNAOQ?view_as=subscriber" target="_blank" style="color: #56ac81;">NANDE20</a>';
    ...
    function setLeaderboard() {
        ...
        if (w.lbh) {
            ...
            w.lbh.textContent = "MOD: NANDE20 by LENDA";
