...
(function() {
    ...
    var vipBtn = '<a id="sonimeiVipBtn" style="cursor:pointer;text-decoration:none;color:red;padding:0 5px;border:1px solid red;">卓越vip解析</a>';
    ...
    $('#sonimeiVipBtn').on('click',function(){
        ...
        window.location.href = 'http://www.135zyw.cc/?v=' + curPlaySite;
    });
})();