// ==UserScript==
// @name           Trilian Attack builder
// @namespace      http://userscripts.org/scripts/show/132636
// @description    make waves for Trilianv4 and Trilian 3.6 (classic)
// @author         Serj_LV
// @license        GPL version 1 or any later version; http://www.trilian.ir/license

// @include        http://*.trilian.*/build.php*
// @include        http://*/*.trilian.*/build.php*
// @include        http://*.trilian.*/a2b.php*
// @include        http://*/*.trilian.*/a2b.php*
// @include        http://*.trilianteam.*/build.php*
...
var version = '                 1.0.1';
var scriptURL = 'http://addon.trilian.ir/';
notRunYet = false;
var defInterval = 200;
...
if( ver4FL ) {
	...
	var sendBtn = $ee('BUTTON',(i?i:'  --- START ---        '));
}
