...
//	¦																										¦
//	¦	October 2017 Barbarossa69 (www.facebook.com/barbarossa69)											¦
//	+-------------------------------------------------------------------------------------------------------+

var Version = '20180828a';
...
function btStartup (){
	...
	if (!Seed.cities[Options.CurrentCity]) {
		Options.CurrentCity = -1;
		saveOptions();
	}
	...
	m += '<TR><TD class=xtab>&nbsp;</td><td class=xtab><INPUT disabled=true id=AutoUpdateChk type=checkbox /></td><td class=xtab>Automatically check for script updates&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a id=btUpdateCheck class="inlineButton btButton brown11"><span>Check Now</span></a></td></tr>';
...
//		Champion += '<a id="btRefreshChampion" class="inlineButton btButton brown8" onclick="btRefreshChampion()"><span>Refresh</span></a>&nbsp;';
    ...
    var d = getCityBuilding(cityId, 31);
	...
	Walls += '<tr><td class=xtab>Defensive Tower</td><td class=xtab><b>'+(c.maxLevel?'Level '+c.maxLevel:'<span class=xtab style="color:#f00">No Tower</span>')+'</b></td></tr>';
	Walls += '<tr><td class=xtab>Redoubt Tower</td><td class=xtab><b>'+(d.maxLevel?'Level '+d.maxLevel:'<span class=xtab style="color:#f00">No Tower</span>')+'</b></td></tr></table><br>';
