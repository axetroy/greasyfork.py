...
//	┌───────────────────────────────────────────────────────────────────────────────────────────────────────┐
//	│	This script can be found at greasyfork.org/en/scripts/889-koc-additional-throne-monitor/			│
//	│	It is licensed under a Creative Commons Attribution-NonCommercial-NoDerivs 3.0 Unported License:	│
//	│	http://creativecommons.org/licenses/by-nc-nd/3.0													│
//	│																										│
//	│	August 2016 Barbarossa69 (www.facebook.com/barbarossa69)											│
//	└───────────────────────────────────────────────────────────────────────────────────────────────────────┘
...
var Options = {
	...
	Volume              : 100,
	MonitorFontSize		: 11,
	UpdateLocation      : 2, // 1 - SourceForge, 2 - Greasyfork
	USPort              : 8080,
...
var SourceForgeURL = 'svn.code.sf.net/p/koc-battle-console/code/trunk/KoCBattleMonitorAdditional.user.js'
...
function btStartup (){
	...
	m += '<TR><TD class=xtab>&nbsp;</td><td class=xtab><INPUT disabled=true id=AutoUpdateChk_'+NameSpace+' type=checkbox /></td><td class=xtab>Automatically check for script updates&nbsp;&nbsp;<a id=btUpdateCheck_'+NameSpace+' class="inlineButton btButton brown11"><span>Check Now</span></a></td></tr>';
