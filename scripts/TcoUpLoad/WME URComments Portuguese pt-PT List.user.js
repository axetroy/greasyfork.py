...
/* Changelog
 * 0.6.20 - Correcção de erros de gramática e adição de comentário genérico.
 */
...
window.UrcommentsPortugalPortugueseArray2 = [
		...
		"Open",
                ...
                "A recepção do sinal de GPS no seu dispositivo não foi suficiente para ajudar na identificação do erro encontrado, pois a indicações guardadas no waze não passam pelo ponto do seu report, por favor ajude-nos a melhor identificar o erro do seu pedido de actualização!",
                "Open",
