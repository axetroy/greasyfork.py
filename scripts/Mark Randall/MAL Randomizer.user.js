...
(function() {
  ...
  randButton.innerHTML = "<i class='fa fa-random'></i> Random 1";
  randButton5.innerHTML = "<i class='fa fa-random'></i> Random 5";
  randButton10.innerHTML = "<i class='fa fa-random'></i> Random 10";
