// ==UserScript==
// @name         Slither.io - SLITHIO By Pekaiem
// @namespace    SLITHIO.pekaiem
// @version      1.2
// @description  SLITHIO by Pekaiem
// @author       Pekaiem
// @match        http://slither.io/*
// @YT Channel   youtube.com/user/pekaiem
...
// ohh... check my yt channel: youtube.com/user/pekaiem

// Source: http://bangbangtoo.wix.com/slithio
...
(function(w) {
    ...
    function setMenu() {
        ...
        if (login) {
            ...
            div.style.margin = "0 auto";
            div.style.padding = "10px 0";
            div.textContent = "Secret skin: setSkin(snake, 25)";
            login.appendChild(div);
            // Menu container
            ...
            sltMenu.innerHTML = "<strong>SLITHIO - Pekaiem</strong>   <strong>" + modVersion + "</strong>";
            ...
            select.appendChild(option);
            // Menu footer
            sltMenu.innerHTML += '<a href="https://www.youtube.com/user/pekaiem" target="_blank" style="color: #FFF; opacity: 0.35;">CREATOR YT CHANNEL</a>  ';
            // Get IP input
    ...
    function setLeaderboard() {
        if (w.lbh) {
            w.lbh.textContent = "SLITHIO - Pekaiem";
