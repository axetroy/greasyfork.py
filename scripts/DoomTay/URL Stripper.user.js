...
function URLToObject(url)
{
	...
	for(var i = 0; i < params.length; i++)
	{
		...
		while(URLBits[splitParameter[0].toLowerCase()].includes("%2F") || URLBits[splitParameter[0].toLowerCase()].includes("%3A")) URLBits[splitParameter[0].toLowerCase()] = decodeURIComponent(URLBits[splitParameter[0].toLowerCase()]);
	}
