// ==UserScript==
// @name pereka4mod
// @author dw4rf & Casperovskii & mod by Komdosh
// @namespace Pereka4
// @version 2.8
...
function main(e){
    ...
    function makeProgressBar(exp_attuale, min_umka, max_umka){
        ...
        var max_umka = max_umka - min_umka;
    ...
    function showExpBar(){
        ...
        var lvl_attuale = parseInt(expElem.innerHTML.split(': ')[1].split(' (')[0]); //БУ
        var exp_attuale = 0;
        ...
        var remain_umk = Math.round((umk_max - sum_umk)*100)/100; 
        if (remain_umk>0) {var remain_umk_html = "<br>&nbsp;&nbsp;<b>Осталось до перекача:</b> &nbsp" + remain_umk ; }
        else {remain_umk_html = "";}

        if (lvl_attuale>2){progress_bar_html = makeProgressBar(sum_umk, umk_min, umk_max);}
        skill_info.innerHTML = skill_info.innerHTML.replace("<br>&nbsp;&nbsp;\u0413\u0438\u043B\u044C\u0434\u0438\u044F \u041E\u0445\u043E\u0442\u043D\u0438\u043A\u043E\u0432","<br>&nbsp;&nbsp;<span style='font-weight: bold;'>\u0421\u0443\u043C\u043C\u0430 \u0443\u043C\u0435\u043D\u0438\u0439:</span> " + sum_umk +  remain_umk_html + progress_bar_html  +  "<br>&nbsp;&nbsp;\u0413\u0438\u043B\u044C\u0434\u0438\u044F \u041E\u0445\u043E\u0442\u043D\u0438\u043A\u043E\u0432");
