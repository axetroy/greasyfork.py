...
(function(w) {
    var modVersion = " (◕ω◕) ",
        renderMode = 2, // 3 - NORMAL, 2 - OPTIMIZED, 1 - SHIT (mobile)
        normalMode = false,
        gameFPS = null,
        positionHUD = null,
        ipHUD = null,
    ...
    function setMenu() {
        ...
        if (login) {
            ...
            sltMenu.innerHTML = " <strong>AGARPLAYERS</strong> | <strong>" + modVersion + "</strong>";
            ...
            option.style.color = "lightblue";
            // Menu footer
            sltMenu.innerHTML += '<a href="https://www.youtube.com/channel/UC_NBjiDrBt-fbW7auLa2Ujg" target="_blank" style="color: #FFF; opacity: 0.35;">YT Channel</a>';sltMenu.style.color = "red";
            // Get IP input
    ...
    function setLeaderboard() {
        if (w.lbh) {
            w.lbh.textContent = "AgarPlayers";
            w.lbh.style.fontSize = "22px";
            w.lbh.style.color = "lightblue";
        } else {
            setTimeout(setLeaderboard, 101);
        }
    }
    // Set normal mode
