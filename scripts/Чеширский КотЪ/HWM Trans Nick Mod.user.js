...
.btn-trans-nick:focus, .btn-trans-nick:active {
    outline: 0px none;
    text-decoration: none !important;
    outline-offset: -2px;
}
.btn-trans-nick:hover {
...
.btn-trans-nick a:hover, .btn-trans-nick a:focus, .btn-trans-nick a:active {color: #fafafa;}
.transfer { width: 200px;}
span.btn-trans-nick { margin-left: 9px;}
.blue-grey {background-color: #37474f;color: #FFFFFF;}
.blue-grey:hover {background-color: #607d8b;}
span.amber{background-color: #ff8f00;}
span.amber:hover{background-color: #ffc107;}
span.light-green {background-color: #558b2f;}
span.light-green:hover {background-color: #8bc34a;}
span.light-green a:hover, span.amber a:hover{color: #fafafa;}
...
if ( url.match('lordswm') ) {
    ...
    el.className = "btn-trans-nick transfer blue-grey";
	if ( item_name ) {
		span = document.createElement('div');
		span.innerHTML = '<span class="btn-trans-nick transfer amber"><a href=transfer.php?nick=' + item_name[1] + ' style="text-decoration: none;">' + string + '</a></span> ';
		span.innerHTML += '<br><span class="btn-trans-nick transfer light-green"><a href=el_transfer.php?nick=' + item_name[1] + ' style="text-decoration: none;">' + string2 + '</a></span>';
