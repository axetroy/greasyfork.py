...
// @namespace       Esperiano
// @author	    Esperiano (Br por LoMexicano)
            ...
            if($(element).is("div[class*='fortbattle-']")) {
                ...
                setTimeout(function(){
                    ...
                    switch (datafort[NSfortID]) {
                        case 0: //PEQUENO
						    if(NSlang=='pt') NSurl='https://i.imgur.com/0qjUP8u.png';
                            ...
                            break;
                        case 2: //GRANDE
						    if(NSlang=='pt') NSurl='https://i.imgur.com/GMjuZQk.png';
                            ...
                            break;
                        default: //MEDIO
						    if(NSlang=='pt') NSurl='https://i.imgur.com/WLzJzhD.png';
