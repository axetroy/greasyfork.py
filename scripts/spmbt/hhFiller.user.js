...
// @update 5 save selection throw "tests page"; clean banners;
// @grant          none
// ==/UserScript==
...
if(/^hh$|itmozg/.test(site)){ //сохранять выделенное
	$e({el: /itmozg/.test(site)?'.margin-bottom-50':'.vacancy-section .g-user-content', on:{mouseup: selS = function(ev){
