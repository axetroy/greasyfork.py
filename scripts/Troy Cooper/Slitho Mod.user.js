// ==UserScript==
// @name         Slitho Mod
// @namespace    https://www.youtube.com/channel/UCFCAEMfCOO4FfkUT2pBJvbg
// @version      1.0
// @description  Mod for Slither.io created by Troy Cooper
// @author       Troy Cooper
...
(function(w) {
    ...
    function setMenu() {
        ...
        if (login) {
            ...
            div.style.fontFamily = "'Verdana', 'Tahoma', sans-serif";
            ...
            sltMenu.style.fontFamily = "'Verdana', 'Tahoma', sans-serif";
            ...
            sltMenu.innerHTML = "Slitho Mod - version 1";
            ...
            input.id = "server-ip";
            input.type = "text";
            input.placeholder = "Enter a Server IP";
            ...
            button.style.backgroundColor = "#14191E";
            ...
            var div = document.createElement("div");
            div.style.backgroundColor = "#56ac81";
            div.style.borderRadius = "29px";
            div.style.margin = "10 auto";
            div.style.padding = "8px";
            sltMenu.appendChild(div);
            ...
            var option = document.createElement("option");
            option.value = "3";
            option.text = "Normal graphics";
            select.appendChild(option);
            var option = document.createElement("option");
            option.value = "2";
            option.text = "Optimized graphics";
            select.appendChild(option);
            var option = document.createElement("option");
            option.value = "1";
            option.text = "Low graphics";
            select.appendChild(option);
            // Menu footer
            sltMenu.style.color = "#56ac81";
            sltMenu.innerHTML += '<strong><a href="https://www.youtube.com/channel/UCFCAEMfCOO4FfkUT2pBJvbg" target="_blank" style="color: #56ac81;">Created by Troy Cooper</a><br/></strong><br/><b>ESC</b> Respawn - <b>Q</b> Quit to menu<br/><b>A</b> Rotate skins - <b>S</b> Change skin<br/><b>Z</b> Reset zoom - <b>Space</b> Boost snake';
            // Get IP input
