// ==UserScript==
// @namespace Sabanova skripta        -
// @name Sabanova skripta za rw i automatcko pucanje
// @version 1.1
// @description  Automated rw openner and automatic fighting.
// @include      http://*.erevollution.com/*
...
////////////////////////     
            ...
            if ($("img").hasClass("isEpicBattle")) {
                ...
                epic_url = https://www.erevollution.com" + $(".isEpicBattle").siblings().eq(7).attr("href");
...
/////////////
                ...
                url = "https://www.erevollution.com" + $(".fight_button").eq(0).attr("href");
                console.log(url);
                if (url == "http://www.erevollution.comundefined")
                {
                    location.href = "http://www.erevollution.com/en/military/campaigns";
                    console.log("something is wrong");
                }
                else if (url != "http://www.erevollution.comundefined")
                {
                    location.href = url;
                }
			}
        ...
        if ($("#pvp").hasClass("epicBattle")) {
            ...
            t = setInterval(function() {
                if (globalNS.userInfo.wellness < 50) {
                    ...
                    //energy bars, ignore
                        location.href = "http://www.erevollution.com/en";
                    } else {
                    //let's eat food
...
/////////////            
    ...
    else if (main_type == "wars") 
    {
        ...
        if (erevollution.citizen.country == 64 && (jQuery(".reversed:contains(Chile)").length > 0)) //To set your country, change "64" to your country's ID, and the "contains(Chile)" to "contains(COUNTRYNAME)
        {
...
//TO WASTE REFILL                            //
//EDIT THE "erevollution bla bla/campaigns" LINE//
///////////////////////////////////////////////
        
                location.href = "http://www.erevollution.com/en/military/campaigns"; //beshe CAMPAIGNS
////////////////////////
//EPIC TOURNAMENT CODE//
////////////////////////
//OLD CODE///////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if (military_type == "campaigns") {
			//battles list, check for epic battle
				...
				if (reset_health_to_recover - globalNS.userInfo.wellness >= 10) {
					//let's burn some well to not waste refills
					url = "http://www.erevollution.com" + $(".fight_button[href*=military]").eq(0).attr("href");
					location.href = "http://www.erevollution.com/en/wars/show/40092";
				} else {
