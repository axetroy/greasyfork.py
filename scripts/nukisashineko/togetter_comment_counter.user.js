...
(function() {
    ...
    window.addEventListener ("load", function(){
        ...
        var comment_users = Array.prototype.map.call(comment_box.querySelectorAll('li .status_name'), function(x){ return x.innerHTML; });
        ...
        comment_box.querySelectorAll('li[id^=comment_id_] .status_name').forEach(function(twitterid_node, i) {
            // 現コメ数を更新
