...
$(document).ready(function(){
    ...
    $(document).keydown(function(e) {
        switch(e.which) {
            case 37: // left
                window.location.href = $('.pagenav .alt2').prev('.alt1').find('a').attr('href');
                break;
    ...
    $('.neo_column.container').prev().prev().append('<tbody><tr align="center" style="height: 50px;"><td class="alt1Active" colspan="2" align="left" id="f35"><table cellpadding="0" cellspacing="0" border="0"><tbody><tr><td><img src="images/statusicon/forum_new.gif" alt="" border="0" id="forum_statusicon_35" title="Double-click this icon to mark this forum and its contents as read" style="cursor: pointer;"></td><td><img src="clear.gif" alt="" width="9" height="1" border="0"></td><td><div><a href="forumdisplay.php?f=33"><strong>Điểm báo</strong></a></div></td></tr></tbody></table></td><td class="alt2">-</td><td class="alt1">-</td><td class="alt2">-</td></tr></tbody>');
});
function ngamgai() {
