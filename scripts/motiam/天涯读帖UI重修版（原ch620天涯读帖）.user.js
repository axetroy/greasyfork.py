...
.panel-close { color: white; float: right; cursor: pointer }\
.panel-close:hover {\
	color: #ffffaa;\
}\
img { border: none }\
...
if (pref.manual_start) {
	$('@body').a($('+div', '脱水',
		{style: 'position: fixed; right: 4ex; top: 8ex; font-size:200%; color: white; padding: 15px 8px; border: none; border-radius:4px; background-color:#607D8B; cursor:pointer;font-family:微软雅黑;font-size:10px;-webkit-writing-mode:vertical-lr', title: '启动脚本'})
		.e('click', start_all));
} else {
	start_all();
}