...
// @version     SabreTooths-fix-for-Awesome 1.4.3 
// @author      dbendure
	...
	*/                             
						...
						//	/*	 
							 ...
							 //      /*
                                 ...
                                 if (	(tech == ClientLib.Base.ETechName.Construction_Yard ) && ((building.get_CurrentLevel() < baselvl) && (_this.totalRepairTime(airRT, vehRT, infRT) < 15000)&& (_this.x == 0))	){
                                 ...
                                 if (	(tech ==ClientLib.Base.ETechName.Command_Center ) && ((building.get_CurrentLevel() <= offLvl) && (_this.totalRepairTime(airRT, vehRT, infRT) < 15000)&& (_this.x == 0))	){
										  var cbuilding = building;
										  //console.log(name);
										  var building_obj = {
											cityid: city.get_Id(),
							...
							//	*/ 
							//	/*
                                 if (((tech ==ClientLib.Base.ETechName.Support_Air)||(tech == ClientLib.Base.ETechName.Support_Ion)||(tech == ClientLib.Base.ETechName.Support_Art)) && (( _this.totalRepairTime(airRT, vehRT, infRT) < 15400) &&  (building.get_CurrentLevel() <= defLvl + 3)&& (_this.x == 0))	){
	...
	*/						  // console.log(baseName,refnum,pownum);
						...
						//	  */
                             ...
                             break;
							  ...
							  if( (Acc_obj != undefined)&& (accarr.toString() != "") && (maxarr[0] == accarr[0]) && (((_this.totalRepairTime(airRT, vehRT, infRT) < 15400) && (_this.x == 0))||(_this.x == 1))){/*(_this.totalRepairTime(airRT, vehRT, infRT) < 14400)||*/
                            ...
                            break;
							  ...
							  if((Sil_obj != undefined)&& (silarr.toString() != "") && (maxarr[0] == silarr[0]) && (((_this.totalRepairTime(airRT, vehRT, infRT) < 15400) && (_this.x == 0))||(_this.x == 1))){/*(_this.totalRepairTime(airRT, vehRT, infRT) < 14400)||*/
