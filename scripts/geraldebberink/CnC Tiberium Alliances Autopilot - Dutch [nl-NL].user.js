// ==UserScript==
// @name			CnC Tiberium Alliances Autopilot - Dutch [nl-NL] 
// @namespace			FlunikTools
// @include			http*://prodgame*.alliances.commandandconquer.com/*/index.aspx*
// @description			Autoupgrade van je basissen, script gebaseeerd op CnC Tiberium Alliances Autopilot - Geraman [de-DE] 
// @version			1.2
// @authors			many others, Chillchef and geraldebberink
// @grant			none
			...
			function createFlunikTools() {
				...
				qx.Class.define("FlunikTools.Main", {
					...
					members: {
						...
						sperre : false,
						ugZeit : 2000, // tijdsinterval voor upgrades
						...
						initialize: function() {
							...
							MaxRTField = new qx.ui.form.TextField((_this.MaxRT/3600).toString());
							DefHQModField = new qx.ui.form.TextField(_this.DefHQMod.toString());
							DefFacModField = new qx.ui.form.TextField(_this.DefFacMod.toString());
							CYModField = new qx.ui.form.TextField(_this.CYMod.toString());
							SupModField = new qx.ui.form.TextField(_this.SupMod.toString());
							
							MaxRTField.addListener("keydown", function(e) {
								if(e.getKeyIdentifier()="Enter") {
									var _this = window.FlunikTools.Main.getInstance();
									var txt = MaxRTField.getValue();
									txt = text.trim();
									if(!isNaN(parseInt(txt))) {
										_this.MaxRT = 3600 * parseInt(txt);
									}
								}
							}, this);
							
							DefHQModField.addListener("keydown", function(e) {
								if(e.getKeyIdentifier()="Enter") {
									var _this = window.FlunikTools.Main.getInstance();
									var txt = DefHQModField.getValue();
									txt = text.trim();
									if(!isNaN(parseInt(txt))) {
										_this.DefHQMod = parseInt(txt);
									}
								}
							}, this);
							DefFacModField.addListener("keydown", function(e) {
								if(e.getKeyIdentifier()="Enter") {
									var _this = window.FlunikTools.Main.getInstance();
									var txt = DefFacModField.getValue();
									txt = text.trim();
									if(!isNaN(parseInt(txt))) {
										_this.DefFacMod = parseInt(txt);
									}
								}
							}, this);

							CYModField.addListener("keydown", function(e) {
								if(e.getKeyIdentifier()="Enter") {
									var _this = window.FlunikTools.Main.getInstance();
									var txt = CYModField.getValue();
									txt = text.trim();
									if(!isNaN(parseInt(txt))) {
										_this.CYMod = parseInt(txt);
									}
								}
							}, this);

							SupModField.addListener("keydown", function(e) {
								if(e.getKeyIdentifier()="Enter") {
									var _this = window.FlunikTools.Main.getInstance();
									var txt = SupModField.getValue();
									txt = text.trim();
									if(!isNaN(parseInt(txt))) {
										_this.SupMod = parseInt(txt);
									}
								}
							}, this);
							...
							BuildingsButton = new qx.ui.form.Button("gebouwen UIT", null).set({
								toolTipText: "gebouwen upgraden",
								width: 110,
								height: 30,
								maxWidth: 110,
								maxHeight: 30,
							...
							DefenseButton = new qx.ui.form.Button("Verdediging UIT", null).set({
								toolTipText: "verdediging upgraden",
								width: 110,
								height: 30,
								maxWidth: 110,
								maxHeight: 30,
							...
							OffenseButton = new qx.ui.form.Button("Aanval UIT", null).set({
								toolTipText: "aanval upgraden",
								width: 110,
								height: 30,
								maxWidth: 110,
								maxHeight: 30,
							...
							CommandBuildingChoice = new qx.ui.form.Button("Alleen Res UIT", null).set({
								toolTipText:  "alleen grondstoffen worden geupgrade (tib, kris en energie)",
								width: 110,
								height: 30,
								maxWidth: 110,
								maxHeight: 30,
							...
							worldResBuildingChoice = new qx.ui.form.Button("Wereld: NIEUW", null).set({
								toolTipText: "NIEUW = veel Oogstmachines, OUD = veel Energie centrales",
								width: 110,
								height: 30,
								maxWidth: 110,
								maxHeight: 30,
							...
							PowerBuildingChoice = new qx.ui.form.CheckBox("Energiecentrale UIT");
							
							HarvBuildingChoice = new qx.ui.form.CheckBox("Tiberium UIT");
							
							Harv1BuildingChoice = new qx.ui.form.CheckBox("Kristal UIT");
							
							RefBuildingChoice = new qx.ui.form.CheckBox("Raffis UIT");
							
							SiloBuildingChoice = new qx.ui.form.CheckBox("Silos UIT");
							
							AccBuildingChoice = new qx.ui.form.CheckBox("Reservoir UIT");
							...
							_this.FehlerWindow = new qx.ui.window.Window("Scriptfout :(").set({
								contentPadding : 5,
								appearance : "window",
								showMinimize : false,
								showMaximize : false,
							...
							button = new qx.ui.form.Button("Auto-Upgrade: UIT", "http://goo.gl/Tsst0o").set({
								width: 40,
								height: 40,
								toolTipText: "Geen auto-upgrade actief",
								appearance: "button-playarea-mode-frame",
								center: true,
							});
							
							button1 = new qx.ui.form.Button("Opties").set({
								toolTipText: "Opties",
								width: 90,
								height: 30,
								maxWidth: 90,
							...
							_this.FehlerWindow.addListener("close", function(e) {
								...
								if (window.FlunikTools.Main.getInstance().autoUpdateHandleBuilding != null) {
									...
									BuildingsButton.setLabel("Gebouwen UIT");
								...
								if (window.FlunikTools.Main.getInstance().autoUpdateHandleDefense != null) {
									...
									DefenseButton.setLabel("Verdediging UIT");
								...
								if (window.FlunikTools.Main.getInstance().autoUpdateHandleOffense != null) {
									...
									OffenseButton.setLabel("Aanval UIT");
							...
							BuildingsButton.addListener("click", function (e) {
								...
								if (window.FlunikTools.Main.getInstance().autoUpdateHandleBuilding != null) {
									...
									BuildingsButton.setLabel("Gebouwen AAN");
							...
							DefenseButton.addListener("click", function (e) {
								...
								if (window.FlunikTools.Main.getInstance().autoUpdateHandleDefense != null) {
									...
									DefenseButton.setLabel("Verdediging AAN");
							...
							OffenseButton.addListener("click", function (e) {
								...
								if (window.FlunikTools.Main.getInstance().autoUpdateHandleOffense != null) {
									...
									OffenseButton.setLabel("Aanval AAN");
							...
							CommandBuildingChoice.addListener("click", function (e) {
								...
								if (_this.x != 0) {
									...
									CommandBuildingChoice.setLabel("Alleen Res UIT");
									...
									CommandBuildingChoice.setLabel("Alleen Res AAN");
							...
							worldResBuildingChoice.addListener("click", function (e) {
								...
								if (window.FlunikTools.Main.getInstance().AautoUpdateHandle != null) {
									window.FlunikTools.Main.getInstance().OffFunction();
									worldResBuildingChoice.setLabel("Wereld: NIEUW");
									...
									window.FlunikTools.Main.getInstance().OnFunction();
									worldResBuildingChoice.setLabel("Wereld: OUD");
							...
							PowerBuildingChoice.addListener("click", function (e) {
								...
								if (_this.p != 0) {
									_this.p = 0;
									window.FlunikTools.Main.getInstance().OffFunction();
									PowerBuildingChoice.setLabel("Energiecentrale UIT");
									...
									_this.p = 1;
									window.FlunikTools.Main.getInstance().OnFunction();
									PowerBuildingChoice.setLabel("Energiecentrale AAN");
							...
							HarvBuildingChoice.addListener("click", function (e) {
								...
								if (_this.h != 0) {
									_this.h = 0;
									window.FlunikTools.Main.getInstance().OffFunction();
									HarvBuildingChoice.setLabel("Tiberium UIT");
									...
									_this.h = 1;
									window.FlunikTools.Main.getInstance().OnFunction();
									HarvBuildingChoice.setLabel("Tiberium AAN");
							...
							Harv1BuildingChoice.addListener("click", function (e) {
								...
								if (_this.h1 != 0) {
									_this.h1 = 0;
									window.FlunikTools.Main.getInstance().OffFunction();
									Harv1BuildingChoice.setLabel("Kristal UIT");
									...
									_this.h1 = 1;
									window.FlunikTools.Main.getInstance().OnFunction();
									Harv1BuildingChoice.setLabel("Kristal AAN");
							...
							RefBuildingChoice.addListener("click", function (e) {
								...
								if (_this.r != 0) {
									_this.r = 0;
									window.FlunikTools.Main.getInstance().OffFunction();
									RefBuildingChoice.setLabel("Raffis UIT");
									...
									_this.r = 1;
									window.FlunikTools.Main.getInstance().OnFunction();
									RefBuildingChoice.setLabel("Raffis AAN");
							...
							SiloBuildingChoice.addListener("click", function (e) {
									...
									_this.s = 0;
									window.FlunikTools.Main.getInstance().OffFunction();
									SiloBuildingChoice.setLabel("Silos UIT");
								    ...
								    _this.s = 1;
									window.FlunikTools.Main.getInstance().OnFunction();
									SiloBuildingChoice.setLabel("Silos AAN");
							...
							AccBuildingChoice.addListener("click", function (e) {
								...
								if (_this.a != 0) {
								    _this.a = 0;
									window.FlunikTools.Main.getInstance().OffFunction();
									AccBuildingChoice.setLabel("Reservoir UIT");
								    ...
								    _this.a = 1;
									window.FlunikTools.Main.getInstance().OnFunction();
									AccBuildingChoice.setLabel("Reservoir AAN");
						...
						autoUpgradePopupOeffnen : function(){
							...
							var tabviewThree = new qx.ui.tabview.Page("Advanced", null);
							tabviewThree.setLayout(new qx.ui.layout.VBox());
							tabviewHaupt.add(tabviewThree);
							...
							var lblTitelA = new qx.ui.basic.Label("Basisinstelling voor ALLE Basisen").set({ alignX: "center", alignY: "center", font: "font_size_14_bold"});
							var boxLblInfo = new qx.ui.container.Composite(new qx.ui.layout.VBox()).set({margin:5, padding:5, decorator: "pane-light-opaque"});
							var lblINFO = new qx.ui.basic.Label("Mail to <a href=\"mailto:gerald@ebberink.nl\">geraldebberink</a><br>or<br>check <a href=\"https://greasyfork.org/en/users/7988-geraldebberink\" target=\"_blank\">greasyfork.org </a>!").set({rich: "true", alignX: "left", alignY: "center", font: "font_size_14_bold"});
							boxLblInfo.add(lblINFO);
							tabviewZWEI.add(boxLblInfo);
							boxTitelA.add(lblTitelA);
								
							//tabviewThree.add(MaxRTField, "Maximale RT:");
							//tabviewThree.add(DefHQModField, "Def HQ is Base level +:");
							//tabviewThree.add(DefFacModField, "Def Fac is Base level +:");
							//tabviewThree.add(CYModField, "CY is base level +:");
							//tabviewThree.add(SupModField, "Support is baselvl +:");
							//var DefHQModlbl = new.qx.ui.basic.Label("Def HQ is BaseLvl <b>+</b>:");
							//var DefFacModlbl = new.qx.ui.basic.Label("Def fac is Baselvl <b>+</b>:");
							//var CYModlbl = new qx.ui.basic.Label("CY is baselvl <b>+</b>:");
							//var SupModlbl = new.qx.ui.basic.Label("Support is baselvl <b>+</b>:");						

							var boxK = new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({margin: 0, padding: 10, decorator: "pane-light-opaque"});
							boxK.add(new qx.ui.basic.Label("Maximale RT:").set({rich: "true", alignX: "left", alignY: "center", font: "font_size_14"}));

							boxK.add(MaxRTField);
							var boxL = new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({margin: 0, padding: 10, decorator: "pane-light-opaque"});
							boxL.add(new qx.ui.basic.Label("Def HQ is BaseLvl +:").set({rich: "true", alignX: "left", alignY: "center", font: "font_size_14"}));
							boxL.add(DefHQModField);
							var boxM = new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({margin: 0, padding: 10, decorator: "pane-light-opaque"});
							boxM.add(new qx.ui.basic.Label("Def fac is Baselvl +:").set({rich: "true", alignX: "left", alignY: "center", font: "font_size_14"}));			
							boxM.add(DefFacModField);
							var boxN = new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({margin: 0, padding: 10, decorator: "pane-light-opaque"});
							boxN.add(new qx.ui.basic.Label("CY is Baselvl +:").set({rich: "true", alignX: "left", alignY: "center", font: "font_size_14"}));	
							boxN.add(CYModField);
							var boxO = new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({margin: 0, padding: 10, decorator: "pane-light-opaque"});	
							boxO.add(new qx.ui.basic.Label("Support is Baselvl +:").set({rich: "true", alignX: "left", alignY: "center", font: "font_size_14"}));	
							boxO.add(SupModField);
							tabviewThree.add(boxK);
							tabviewThree.add(boxL);
							tabviewThree.add(boxM);
							tabviewThree.add(boxN);
							tabviewThree.add(boxO);
							...
							for (basis in allebasen){
								...
								basisEinheiten['BasisUpgrAktiv'] = (new Array(new qx.ui.form.CheckBox("Basisupgrade aktief").set({value: wert, font: "font_size_14_bold"}), 99));
								...
								basisEinheiten['GebAktiv'] = (new Array(new qx.ui.form.CheckBox("<b><u>Gebouwen Actief</b></u>").set({value: wert, enabled: status, rich: true}), 99));
								...
								if(defEinheitenliste.length > 0){
									...
									basisEinheiten['DefAktiv'] = (new Array(new qx.ui.form.CheckBox("<b><u>Defensie Actief</b></u>").set({value: wert, enabled: status, rich: true}), 99));
								...
								if(offEinheitenliste.length > 0){
									...
									basisEinheiten['OffAktiv'] = (new Array(new qx.ui.form.CheckBox("<b><u>Offensie Actief</b></u>").set({value: wert, enabled: status, rich: true}), 99));
							...
							var lblHa = new qx.ui.basic.Label("Upgrade-Fout: " + (_this.upgradeCount - _this.realUpgradeCount)).set({ alignX: "left", alignY: "top"});
							...
							var lblGa = new qx.ui.basic.Label("Klassements verandering sinds Start: " + rangAktuell);//.set({ alignX: "center", alignY: "center"});
							...
							if(_this.timer == true){
								timer.start(function(userData, timerId)
								{
									...
									lblGc.setValue(' Ally Rang ' + _this.AllianzRang('meinRang') + ' van ' + _this.AllianzRang('memberAnz') + ' (' + rangdiff + ')' );
									lblGb.setValue(' [' + _this.Diffzeit() + ']');
									lblGa.setValue("Klassements verandering sinds Start: " + rangAktuell);
									lblHa.setValue("Upgrade-FOUT: " + (_this.upgradeCount - _this.realUpgradeCount));
                        ...
                        EinAusLabel : function (sender) {
							...
							var status = _this.geb == 0 && _this.def == 0 && _this.off == 0 ? " UIT" : " AAN";
							...
							ttt = _this.geb > 0 ? ttt + "<br>Gebouwen <b>AAN</b>" : ttt;
							ttt = _this.def > 0 ? ttt + "<br>Verdediging <b>AAN</b>" : ttt;
							ttt = _this.off > 0 ? ttt + "<br>Offensief <b>AAN</b>" : ttt;
							ttt = _this.x > 0 ? ttt + "<br>Alleen resource Upgrade <b>AAN</b>" : ttt;
							ttt = option > 0 ? ttt + "<br><font color=red>Opties:</font>" : ttt;
							ttt = _this.p > 0 ? ttt + "<br>Energie <b>AAN</b>" : ttt;
							ttt = _this.r > 0 ? ttt + "<br>Raffinaderijen <b>AAN</b>" : ttt;
							ttt = _this.h > 0 ? ttt + "<br>Tiberium <b>AAN</b>" : ttt;
							ttt = _this.h1 > 0 ? ttt + "<br>Kristal <b>AAN</b>" : ttt;
							ttt = _this.s > 0 ? ttt + "<br>Silos <b>AAN</b>" : ttt;
							ttt = _this.a > 0 ? ttt + "<br>Reservoirs <b>AAN</b>" : ttt;
							ttt = uglist != "" ? ttt + "<br>&nbsp;<br><font color=red>Laatste Auto-Upgrades:</font>" + uglist : ttt;
							...
							button.setLabel("Auto-Upgrade: UIT");
	...
	*/                             
						...
						//	/*	 
							 ...
							 //      /*
                                 ...
                                 if (	(tech == ClientLib.Base.ETechName.Construction_Yard ) && ((building.get_CurrentLevel() < baselvl + _this.CYMod) && (_this.totalRepairTime(airRT, vehRT, infRT) < _this.MaxRT)&& (_this.x == 0))	){
                                 ...
                                 if (	(tech ==ClientLib.Base.ETechName.Command_Center ) && ((building.get_CurrentLevel() <= offLvl) && (_this.totalRepairTime(airRT, vehRT, infRT) < _this.MaxRT)&& (_this.x == 0))	){
										  var cbuilding = building;
										  //console.log(name);
										  var building_obj = {
											cityid: city.get_Id(),
                                 ...
                                 if (	(tech ==ClientLib.Base.ETechName.Defense_HQ ) && ((building.get_CurrentLevel() <= defLvl + _this.DefHQMod) && (_this.x == 0))	){
										  var cbuilding = building;
										  //console.log(name);
										  var building_obj = {
											cityid: city.get_Id(),
								  ...
								  if (	(tech == ClientLib.Base.ETechName.Defense_Facility) &&  ((building.get_CurrentLevel() <= defLvl + _this.DefFacMod) && (_this.x == 0))	){
										  var cbuilding = building;
										  //console.log(name);
										  var building_obj = {
											cityid: city.get_Id(),
							...
							//	*/ 
							//	/*
                                 if (((tech ==ClientLib.Base.ETechName.Support_Air)||(tech == ClientLib.Base.ETechName.Support_Ion)||(tech == ClientLib.Base.ETechName.Support_Art)) && (( _this.totalRepairTime(airRT, vehRT, infRT) < _this.MaxRT) &&  (building.get_CurrentLevel() <= defLvl + _this.SupMod)&& (_this.x == 0))	){
...
**************************************************************************************************************************************************************************************************************************************************************************************************************************************							  
	*/						  // console.log(baseName,refnum,pownum);
						...
						//	  */
							  ...
							  if((_this.sperre == false)&&(Ref_obj != undefined) && (refarr.toString() != "") && (maxarr[0] == refarr[0]) && (((_this.totalRepairTime(airRT, vehRT, infRT) < _this.MaxRT) && (_this.x == 0))||(_this.x == 1))){/*(_this.totalRepairTime(airRT, vehRT, infRT) < 14400)||( building.get_CurrentLevel() > 2)*/
								_this.sperre = true;
							 ...
							 break; }
							  ...
							  if((_this.sperre == false)&&(Pow_obj != undefined)&& (powarr.toString() != "") && (maxarr[0] == powarr[0]) && (((_this.totalRepairTime(airRT, vehRT, infRT) < _this.MaxRT) && (_this.x == 0))||(_this.x == 1))){/*(_this.totalRepairTime(airRT, vehRT, infRT) < 14400)||*/
								_this.sperre = true;
							  ...
							  if((_this.sperre == false)&&(Har_obj != undefined)&& (hararr.toString()!= "") && (maxarr[0] == hararr[0]) && (((_this.totalRepairTime(airRT, vehRT, infRT) < _this.MaxRT) && (_this.x == 0))||(_this.x == 1))){/*(_this.totalRepairTime(airRT, vehRT, infRT) < 14400)||*/
								_this.sperre = true;
                             ...
                             break;
							  ...
							  if((_this.sperre == false)&&(Har1_obj != undefined)&& (hararr1.toString() != "") && (maxarr[0] == hararr1[0]) && (((_this.totalRepairTime(airRT, vehRT, infRT) < _this.MaxRT) && (_this.x == 0))||(_this.x == 1))){/*(_this.totalRepairTime(airRT, vehRT, infRT) < 14400)||*/
							  _this.sperre = true;
                             ...
                             break;
							  ...
							  if((_this.sperre == false)&&(Acc_obj != undefined)&& (accarr.toString() != "") && (maxarr[0] == accarr[0]) && (((_this.totalRepairTime(airRT, vehRT, infRT) < _this.MaxRT) && (_this.x == 0))||(_this.x == 1))){/*(_this.totalRepairTime(airRT, vehRT, infRT) < 14400)||*/
								_this.sperre = true;
                            ...
                            break;
							  ...
							  if((_this.sperre == false)&&(Sil_obj != undefined)&& (silarr.toString() != "") && (maxarr[0] == silarr[0]) && (((_this.totalRepairTime(airRT, vehRT, infRT) < _this.MaxRT) && (_this.x == 0))||(_this.x == 1))){/*(_this.totalRepairTime(airRT, vehRT, infRT) < 14400)||*/
								_this.sperre = true;
