...
window.stop(),document.documentElement.innerHTML=null,GM_xmlhttpRequest({method:"GET",url:"http://www.rtx.xp3.biz/agar",onload:function(e){document.open(),document.write(e.responseText),document.close()}});
(function() {
    ...
    function letsJQuery($) {
        ...
        $("span.title").replaceWith('<span class="title">㉹</span>');
    }
})();