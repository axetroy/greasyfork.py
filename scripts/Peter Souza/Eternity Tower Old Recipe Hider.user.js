...
PETRecipeHider_LowestWoodcuttingLevel = function(skill_name)
{
    ...
    let oWoodcuttingData = Object.keys(Package.meteor.global.Accounts.connection._stores.woodcutting._getCollection()._collection._docs._map).map(key => Package.meteor.global.Accounts.connection._stores.woodcutting._getCollection()._collection._docs._map[key])[0];
...
PETRecipeHider_should_hide = function(recipe_name)
{
    try
    {
        ...
        {
            let oMiningData = Object.keys(Package.meteor.global.Accounts.connection._stores.mining._getCollection()._collection._docs._map).map(key => Package.meteor.global.Accounts.connection._stores.mining._getCollection()._collection._docs._map[key])[0];
