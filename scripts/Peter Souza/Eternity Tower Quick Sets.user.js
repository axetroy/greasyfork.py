...
PETQS_LoadSet = function(iSlot, bEquip = false)
{
    ...
    if (bEquip)
    {
        ET.MCMF.CallGameCmd("abilities.unequip", "mainHand");
        ...
        try
        {
            ...
            if (sSettingVals[0] == "skin")
            {
                ...
                if (bEquip)
                {
                    ...
                    if (sSettingVals[1] == "mageT1HD.png")   ET.MCMF.CallGameCmd("combat.updateCharacterIcon", "mage_t1");
                    if (sSettingVals[1] == "mageT2HD.png")   ET.MCMF.CallGameCmd("combat.updateCharacterIcon", "mage_t2");
                    if (sSettingVals[1] == "damageT1HD.png") ET.MCMF.CallGameCmd("combat.updateCharacterIcon", "damage_t1");
                    if (sSettingVals[1] == "damageT2HD.png") ET.MCMF.CallGameCmd("combat.updateCharacterIcon", "damage_t2");
                    if (sSettingVals[1] == "tankT1HD.png")   ET.MCMF.CallGameCmd("combat.updateCharacterIcon", "tank_t1");
                    if (sSettingVals[1] == "tankT2HD.png")   ET.MCMF.CallGameCmd("combat.updateCharacterIcon", "tank_t2");
