            ...
            try
            {
                ...
                if (oJQ_Options === undefined)
                {
                    jQ("div.flex-grow h2:first-of-type").after("<div id=\"PETSOptionsEl\"><small class=\"mx-2\">" +
                        ...
                        "<select id=\"PETSFilterList\"><option default selected value=\"0\">All Items<option value=\"1\">Equipment<option value=\"3\">Special Stuff<option value=\"4\">Non-Special Stuff<option value=\"2\">Axes &amp; Mining<option value=\"999\">Other</select>" + 
                        "</small><br /><br /></div>");
                ...
                try
                {
                    ...
                    {                
                        ...
                        if (jQ("#PETSItemColor").is(":checked"))
                        {
                            ...
                            else if (sMetaWord === "aab_itembox")       oThisItemEl.css("background-color", "#dfd");
                            else if (sMetaWord === "aac_useful")        oThisItemEl.css("background-color", "#9fd");
                        }
                        else
