...
var ChangeLog = scriptVersion+" Change Log: *Fixed issue with tax rate on sell pages.";
...
function page_war() {
          ...
          if($("warwrap")){
              ...
              if($('def_losses')){
                  ...
                  for (var i = 0; i < children.length; i++) {
                      ...
                      if(tc.innerHTML.includes("Jets")){
                          kjets = tc.innerHTML.replace(/\D/g,'');
                          continue;
                      }
                      if(tc.innerHTML.includes("Tanks")){
              ...
              var t = oil+cash+tech+acres+troops+jets+tanks+civs+ktroops+kjets+ktanks;
              if(t == lastpost){
              ...
              lastpost = t;
              var AttackLog = getSetting( 'AttackLog', '' );
              var log = country+"::"+time+"::"+result+"::"+type+"::"+oil+"::"+cash+"::"+tech+"::"+acres+"::"+troops+"::"+jets+"::"+tanks+"::"+civs+"::"+ktroops+"::"+kjets+"::"+ktanks;
    ...
    for (var i = 0; table.rows[i]; i++) {
        ...
        x.innerHTML = "1/3";
        x.style='cursor: pointer;';
        row.cells[2].firstChild.onkeyup = function(){Update();};
...
function page_advisor() {
    ...
    var newRow = newRow.parentNode.insertRow(-1);
    var cell1 = newRow.insertCell(0);
    var cell2 = newRow.insertCell(1);
