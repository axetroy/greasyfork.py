// ==UserScript==
// @name         ✅Moomoo.io Mods
// @namespace    http://moomoo.io/*
// @version      0.2
// @description  Macro hats
// @author       DQ Sini
...
$('title').html('Moo Moo');
$('#gameName').remove();
$('#leaderboard').append('Cosmin Nation');
$('#menuCardHolder').prepend('<a href="https://www.youtube.com/channel/UC0-fTKzf_mDmDK6Bm7VDGNA" target="_blank"><div id=gameName3>DQ Sini</div></a>');
$('#adCard').html('<div align="left"><center><b><a class="menuText" href="https://www.youtube.com/channel/UCpLebMINCQlfVSJmggN4OqA" target="_blank">DQ Sini  FEATURES</a></b></center><table style="border-collapse: collapse;" border="1"><tbody><tr><td style="width: 100px;"><b>Features</b></td><td style="width: 250px;"><b>How to use</b></td></tr><tr><td>NO ADS</td><td>Automatically Removed</td></tr><tr><td>AUTO-HAT</td><td>Press F8 or Del to toggle!</td></tr><tr><td>AUTO ATTACK</td><td>Make in progress</td></tr><tr><td>CHANGE HATS</td><td>Numpad 0-9 Keys to change hat</td></tr><tr><td>POLICE MOD</td><td>Updated to Auto-Hat </br>...</td></tr><tr><td>AUTO FOOD</td><td>Make in progress</td></tr><tr><td>MINIMAP SIZE</td><td>Edit from within the script as shown in the video.</td></tr><tr><td>+=+=AD POPUPS!!!!=+=+</td><td>Ad popups in different tabs may appear on click!</td></tr><tr><td>AUTO HEAL<a style="font-size:11px; color:green;"></a></td><td>Make in progress</td></tr><tr><td>Enemy Radar<a style="font-size:9.5px; color:red;"></a></td><td>Make in progress</td></tr></tbody></table><hr><b>Subscribe To My Channel!</b><br><a href="https://www.youtube.com/channel/https://www.youtube.com/channel/UC0-fTKzf_mDmDK6Bm7VDGNA" target="_blank">HERE</a>');
$('#linksContainer1').remove();
$('#linksContainer2').html('<a href="./docs/versions.txt" target="_blank" class="menuLink">Changelog</a> |<a href="https://discordapp.com/invite/moomoo" target="_blank" class="menuLink">Discord</a> |<a href="https://www.youtube.com/channel/UCpLebMINCQlfVSJmggN4OqA" target="_blank" class="menuLink">DQ Sini</a>');
