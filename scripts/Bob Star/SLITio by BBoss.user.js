...
(function(w) {
    ...
    function setMenu() {
        ...
        if (login) {
            ...
            div.textContent = "☯ BBoss Is luv☯";
			div.textContent = "☯https://www.youtube.com/channel/UCEYoYGeo_PLT72krpT0Cevg☯";
            ...
            sltMenu.innerHTML = "MOD: <strong>☯☯☯☯  by BBoss</strong> | <strong>" + modVersion + "</strong>";
            ...
            select.appendChild(option);
            // Menu footer
            sltMenu.innerHTML += '<a href="https://www.youtube.com/channel/UCEYoYGeo_PLT72krpT0Cevg" target="_blank" style="color: #FFF; opacity: 0.35;">YT Channel</a> | ';
            sltMenu.innerHTML += '<a href="BBoss Is luv" target="_blank" style="color: #FFF; opacity: 0.35;">ogario.ovh</a>';
            // Get IP input
    ...
    function setLeaderboard() {
        if (w.lbh) {
            w.lbh.textContent = "☯ BBOSS☯ ";
            w.lbh.style.fontSize = "30px";
        } else {
