...
// @supportURL   *https://vk.com/zane_kun*
// ==/UserScript==
...
$("#rightCardHolder").append("<div class='menuCard' id='guideCard'><div class='menuHeader'> members of the clan: <br> <br> Leaders: <br></div><div class='menuText'> Red Fox <br> TheEvilZane <br> <br> <div class='menuHeader'> Players: </div>JloX<br> CTPAXO3ABP<br> SerclinE<br> GoodBanana<br> SovaOneloveBith<br> muWander <br> MyTimers <br> Neatly <br> <div class='menuHeader'> Description: </div> <br> I created this mod, yes it is a full-fledged mod based on javascript, for my friends from the clan Rainbow Dragon, With this mod I will protect them from dangers and do more. <br></div></div>");
$("#rightCardHolder").append("<div class='menuCard' id='guideCard'><div class='menuHeader'>How to use <br></div><div class='menuText'> T = Heal / bull <br> <br> F = Pittrap <br> <br>  <br> <br> <b> </div></div>");
...
$('title').html('Moo Moo');
$('#gameName').remove();
$('#menuCardHolder').prepend('<a href="https://vk.com/club165693955" target="_blank"><div id=gameName3>Rainbow Dragon</div></a>');
