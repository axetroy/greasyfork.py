...
// @description    Check multiple checkboxes with ease by drawing a box around them to automatically select them all. [Converted from CheckBoxMate (https://addons.mozilla.org/en-US/firefox/addon/9740)]
// @author         nrlz
// @date           2010-04-07
// @include        http://*
// @include        https://*
// @version        0.0.1.20160518000000
// @namespace      http://dragtotab.mozdev.org/
// @run-at         document-end
// ==/UserScript==
...
const CheckBoxMate = {
    ...
    onDown: function(e) {
        ...
        if(d.active) {
           ...
           (t.type.toLowerCase() == "checkbox" || t.type.toLowerCase() == "radio")) {
    ...
    calc: function() {
        ...
        for(var i=0, n; (n = elms[i]); i++) {
            if(n.type.toLowerCase() == "checkbox" || n.type.toLowerCase() == "radio") {
                if(gbof) {
