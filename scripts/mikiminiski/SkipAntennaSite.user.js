...
var siteDefs = {
  ...
  // とろたまヘッドライン
  'headline.mtfj.net': ['tr.bold td a', 'td.bold a', 'div.rss_article_bold a'],
  ...
  'rss.harikonotora.net': [textContent(null, 'div.headline a.kizi'),
                           ...
                           descendantClass('.rss_article a.kizi', 'span[style="color:#ff0000;"]')],
  ...
  // 将棋アンテナ 棒銀くん
  'shogis.com': ['tr.bold td.article a',
                 'div.rss_article_bold a'],
