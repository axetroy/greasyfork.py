// ==UserScript==
// @name Orc Clan Script
// @namespace Your Exposed
// @version v6.2
// @description Join our chat@http://xat.com/ORCCLan or our teamspeak:711305.ts3.mpgs.co
// @author Your Exposed
// @match http://agar.io/*
// @license      MIT
// @match        http://agar.io/*
    ...
    function miniMapInit() {
        ...
        if ($('#mini-map-options').length === 0) {
            ...
            var help_btn = $('<button>')
                ...
                .text('?')
                .on('click', function(e) {
                    window.open('http://xat.com/ORCCLan');
                    help_btn.blur();
                    return false;
                })
                .appendTo(form_group);
