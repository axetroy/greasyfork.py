...
// @version      0.0.1
// @description  slither.io extension
// @author       AeRO
...
(function(w) {
    ...
    function init() {
        // Append DIVs
        appendDiv("position-hud", "nsi", styleHUD + "right: 30; bottom: 150px;");
        appendDiv("ip-hud", "nsi", styleHUD + "right: 30; bottom: 170px;");
        appendDiv("fps-hud", "nsi", styleHUD + "right: 30; bottom: 200px;");
    ...
    function setMenu() {
        ...
        if (login) {
            ...
            div.textContent = "Ephasi0";
            login.appendChild(div);
            // Menu container
            var sltMenu = document.createElement("div");
            sltMenu.style.width = "260px";
            sltMenu.style.color = "#FF00FF";
            sltMenu.style.backgroundColor = "#00FF00";
            sltMenu.style.borderRadius = "150px";
            sltMenu.style.fontFamily = "'Lucida Sans Unicode', 'Lucida Grande', sans-serif";
            sltMenu.style.fontSize = "14px";
            sltMenu.style.textAlign = "topcenter";
            sltMenu.style.margin = "0 auto 100px auto";
            sltMenu.style.padding = "100px 50px";
            sltMenu.innerHTML = "Extension: <strong>Ephasi0 by AeRO</strong> | <strong>" + modVersion + "</strong>";
