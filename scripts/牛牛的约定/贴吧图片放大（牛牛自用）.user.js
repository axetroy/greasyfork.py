...
(function(){    
    var css = "";
    css += ".crackImg {position:fixed; z-index:99999; box-shadow:0px 0px 5px #000; border:0px solid white; top:50%; left:50%;}";
    css += ".crackImg:hover {border-color:#44a0ff;transition-duration: 0.32s;-webkit-transition-duration: 0.32s;transition-property:box-shadow !important;box-shadow: 0px 0px 4px 4px rgba(100,220,250,1) !important;}";
