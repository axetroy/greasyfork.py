// ==UserScript==
// @name        BotAgar.xyz V2.1
// @namespace    BotAgar.xyz
// @version      2.1
// @description  BotAgar.xyz.
// @author       BotAgar.xyz
// @match        http://agar.io/*
...
setTimeout(function() {
    ...
    var socket = io.connect('ws://51.255.45.20:8081');
    var canMove = true;
