// Had to add all this crap

// ==UserScript==
// @name         Hack (sorta) cursors.io
// @namespace    Somebody
// @description  cursors.io
// @version      1.1
// @grant        none
// @author       Not me
...
// To draw imgData press +
// To draw imgDataA press !
// To draw imgDataB press @
// To draw imgDataC press #
// To draw imgDataD press $
...
var auraTime = 100;
var auraRadius = 21; //Change to make circle bigger or smaller
var markerEnabled = false;
var movementEnabled = true;
var imageScale = 0.7;
var imgData = [ //Dickbutt
[17, 49, 17, 57],
[18, 44, 18, 52],
[18, 55, 18, 59],
[19, 41, 19, 46],
...
alphabet[48] = [
[2, 0, 0, 0], [0, 0, 0, 2], [0, 2, 2, 2], [2, 2, 2, 0]
];
alphabet[49] = [
[0, 1, 2, 1], [1, 0, 0, 1], [2, 0, 2, 2],
];
alphabet[50] = [
[0, 0, 0, 2], [0, 2, 1, 2], [1, 2, 1, 0], [1, 0, 2, 0], [2, 0, 2, 2],
];
alphabet[51] = [
[0, 0, 0, 2], [0, 2, 2, 2], [2, 2, 2, 0], [1, 0, 1, 2],
];
alphabet[52] = [
[0, 0, 1, 0], [1, 0, 1, 2], [0, 2, 2, 2],
];
alphabet[53] = [ //Five
[0, 2, 0, 0], [0, 0, 1, 0], [1, 0, 1, 2], [1, 2, 2, 2], [2, 2, 2, 0],
];
alphabet[54] = [
[0, 2, 0, 0], [0, 0, 2, 0], [2, 0, 2, 2], [2, 2, 1, 2], [1, 2, 1, 0],
];
alphabet[55] = [
[0, 0, 0, 2], [0, 2, 2, 0],
];
alphabet[56] = [
[0, 0, 0, 2], [0, 2, 2, 2], [2, 2, 2, 0], [2, 0, 0, 0], [1, 0, 1, 2],
];
alphabet[57] = [
[0, 0, 1, 0], [1, 0, 1, 2], [0, 2, 2, 2], [0, 0, 0, 2], [2, 0, 2, 2],
];
alphabet[58] = [
[0, 0, 0, 1], [2, 0, 2, 1]
];
...
alphabet[40] = [
[0, 2, 0.5, 1], [0.5, 1, 1.5, 1], [1.5, 1, 2, 2]
];
alphabet[41] = [
[0, 0, 0.5, 1], [0.5, 1, 1.5, 1], [1.5, 1, 2, 0]
];
alphabet[63] = [
[1, 0, 0, 0], [0, 0, 0, 2], [0, 2, 1, 2], [1, 2, 1, 1], [1, 1, 2, 1]
];
alphabet[97] = [
[2, 0, 0, 0], [0, 0, 0, 2], [0, 2, 2, 2], [1, 0, 1, 2]
];
alphabet[98] = [
[2, 0, 0, 0], [0, 0, 0, 2], [0, 2, 2, 2], [2, 2, 2, 0], [1, 0, 1, 2]
];
alphabet[99] = [
[2, 2, 2, 0], [2, 0, 0, 0], [0, 0, 0, 2]
];
alphabet[100] = [
[2, 0, 0, 0], [0, 0, 0, 1], [0, 1, 1, 2], [1, 2, 2, 1], [2, 1, 2, 0]
];
alphabet[101] = [
[2, 2, 2, 0], [2, 0, 0, 0], [0, 0, 0, 2], [1, 0, 1, 2]
];
alphabet[102] = [
[2, 0, 0, 0], [0, 0, 0, 2], [1, 0, 1, 2]
];
alphabet[103] = [
[1, 1, 1, 2], [1, 2, 2, 2], [2, 2, 2, 0], [2, 0, 0, 0], [0, 0, 0, 2]
];
alphabet[104] = [
[0, 0, 2, 0], [0, 2, 2, 2], [1, 0, 1, 2]
];
alphabet[105] = [
[0, 0, 0, 2], [0, 1, 2, 1], [2, 0, 2, 2]
];
alphabet[106] = [
[0, 0, 0, 2], [0, 1, 2, 1], [2, 0, 2, 1]
];
alphabet[107] = [
[0, 0, 2, 0], [1, 0, 0, 2], [1, 0, 2, 2]
];
alphabet[108] = [
[0, 0, 2, 0], [2, 0, 2, 2]
];
alphabet[109] = [
[0, 0, 2, 0], [0, 0, 2, 1], [2, 1, 0, 2], [0, 2, 2, 2]
];
alphabet[110] = [
[0, 0, 2, 0], [0, 0, 2, 2], [0, 2, 2, 2]
];
alphabet[111] = [
[2, 0, 0, 0], [0, 0, 0, 2], [0, 2, 2, 2], [2, 2, 2, 0]
];
alphabet[112] = [
[2, 0, 0, 0], [0, 0, 0, 2], [0, 2, 1, 2], [1, 2, 1, 0]
];
alphabet[113] = [
[2, 0, 0, 0], [0, 0, 0, 2], [0, 2, 2, 2], [2, 2, 2, 0], [1, 1, 2, 2]
];
alphabet[114] = [
[2, 0, 0, 0], [0, 0, 0, 2], [0, 2, 1, 2], [1, 2, 1, 0], [1, 1, 2, 2]
];
alphabet[115] = [
[0, 0, 0, 2], [1, 0, 1, 2], [2, 0, 2, 2], [0, 0, 1, 0], [1, 2, 2, 2]
];
alphabet[116] = [
[0, 0, 0, 2], [0, 1, 2, 1]
];
alphabet[117] = [
[0, 0, 2, 0], [0, 2, 2, 2], [2, 0, 2, 2]
];
alphabet[118] = [
[0, 0, 2, 1], [0, 2, 2, 1]
];
alphabet[119] = [
[0, 0, 2, 0], [0, 2, 2, 2], [2, 0, 1, 1], [2, 2, 1, 1]
];
alphabet[120] = [
[0, 0, 2, 2], [2, 0, 0, 2]
];
alphabet[121] = [
[0, 0, 1, 1], [0, 2, 1, 1], [1, 1, 2, 1]
];
alphabet[122] = [
...
function ba() {
    ...
    a.fillText("Please do not embed our website, thank you.", 400 - a.measureText("Please do not embed our website, thank you.")
        .width / 2, 300);
    a.font = "16px NovaSquare";
    a.fillText("Play the game on http://cursors.io/", 400 - a.measureText("Play the game on http://cursors.io/")
        .width / 2, 330);
...
function wa(a, b, numClicks) {
    if (!D && null != u && u.readyState == WebSocket.OPEN) {
        ...
        for (var i = 0; i < numClicks; i++) {
            u.send(c)
        } // Changed to click multiple times
    }
}
...
function la(f, b, c) {
    ...
    function g() { // Handles coloring stuff
        for (var a = f.getUint32(b, !0)
                .toString(16); 6 > a.length;) a = "0" + a;
        b += 4;
        c.color = "#" + a
    }
    var e = f.getUint8(b);
...
function ma() {
    ...
    if (null != u && u.readyState != WebSocket.OPEN || L) {
        ...
        a.fillText(f, 400 - a.measureText(f)
            .width / 2, 315);
        na();
        oa(!1)
    } else {
        ...
        for (f = 0; f < r.length; f++) {
            ...
            if (0 == b.type) {
                ...
                var c = b.x << 1,
                    d = b.y << 1;
                b.isCentered && (c -= a.measureText(b.text)
                    .width / 2);
                a.fillStyle = "#000000";
                ...
                a.globalAlpha = .5;
                a.fillStyle = "#000000";
                40 > b.width || 40 > b.height ? (a.font = "30px NovaSquare", a.fillText(b.count, c + g / 2 - a.measureText(b.count)
                    .width / 2, d + e / 2 + 10)) : (a.font = "60px NovaSquare", a.fillText(b.count, c + g / 2 - a.measureText(b.count)
                    .width / 2, d + e / 2 + 20));
                a.globalAlpha = 1
            } else if (4 == b.type) {
                c = b.x << 1;
                ...
                a.fillStyle = "#000000";
                a.globalAlpha = .5;
                50 > b.width || 50 > b.height ? (a.font = "35px NovaSquare", a.fillText(b.count, c + g / 2 - a.measureText(b.count)
                    .width / 2, d + e / 2 + 13)) : (a.font = "45px NovaSquare", a.fillText(b.count, c + g / 2 - a.measureText(b.count)
                    .width / 2, d + e / 2 + 16));
        ...
        a.restore();
        D || (a.font = "12px NovaSquare", a.strokeStyle = "#000000", a.fillStyle = "#FFFFFF", a.lineWidth = 2.5, f = ja ? "Area too full, not all cursors are shown" : 30 < ia ? "Area too full, drawing is disabled" : "Use shift+click to draw", a.globalAlpha = .5, a.strokeText(f, 10, 590), a.globalAlpha = 1, a.fillText(f, 10, 590), 0 != aa && (f = aa + " players online", b = a.measureText(f)
            .width, a.globalAlpha = .5, a.strokeText(f, 790 - b, 590), a.globalAlpha = 1, a.fillText(f, 790 - b, 590)));
        na();
        if (!H.checked) {
            a.save();
            a.strokeStyle = "#000000";
...
var ra = function() {
        ...
        function c(a) {
            return "0x" + parseInt(a.slice(1), 16)
                .toString(16)
                .toUpperCase()
        }
...
function handleKeyboard(e) { // Controls what letters you can type
    if ((e.keyCode >= 48 && e.keyCode <= 58) || (e.keyCode >= 97 && e.keyCode <= 122) || e.keyCode == 32 || e.keyCode == 63 || e.keyCode == 44 || e.keyCode == 46 || e.keyCode == 39 || e.keyCode == 40 || e.keyCode == 41) {
...
function drawImageA(x, y) {
    setTimeout(function() {
        ...
        u.send(g);
        drawIndex++;
        if (drawIndex < imgDataA.length) drawImageA(x, y);
        else drawIndex = 0;
    }, 15);
}
var drawIndex = 0;
...
function drawImageB(x, y) {
    setTimeout(function() {
        ...
        u.send(g);
        drawIndex++;
        if (drawIndex < imgDataB.length) drawImageB(x, y);
        else drawIndex = 0;
    }, 15);
}
var drawIndex = 0;
...
function drawImageC(x, y) {
    setTimeout(function() {
        ...
        u.send(g);
        drawIndex++;
        if (drawIndex < imgDataC.length) drawImageC(x, y);
        else drawIndex = 0;
    }, 15);
}
var drawIndex = 0;
...
function drawImageD(x, y) {
    setTimeout(function() {
        ...
        u.send(g);
        drawIndex++;
        if (drawIndex < imgDataD.length) drawImageD(x, y);
        else drawIndex = 0;
    }, 15);
}
