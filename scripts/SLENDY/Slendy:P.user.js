...
// @version        ╳F╳Δ╳Z╳Σ╳
// @description    Works with The new Version ! Will Try to add Auto heal !
// @author         SLendy
// @match          *.moomoo.io/*
// @match          *://45.77.0.81/*
...
document.addEventListener('keydown', function(kfc) {
    if(!$(':focus').length) {
        switch (kfc.keyCode) {
            ...
            case 96: storeEquip(45); kfc.preventDefault(); break;     // FΔZΣ / FΔZΣ                         = 0 [ 27 / 96 ]
            ...
            case 186: Rt(34); kfc.preventDefault(); break;            // Bull Mask                           = Ů [ semi-colon / ñ / 186 ]
...
$('#mapDisplay').css({'background': 'urlhttps://images.search.yahoo.com/images/view;_ylt=AwrEwSy7DRVbuhwAcv.JzbkF;_ylu=X3oDMTIzMW05cXZwBHNlYwNzcgRzbGsDaW1nBG9pZANjYmVkNTc0NDA0OGViNTBiYmRhZjU3YThiYTljYTBkMgRncG9zAzIwBGl0A2Jpbmc-?.origin=&back=https%3A%2F%2Fimages.search.yahoo.com%2Fsearch%2Fimages%3Fp%3DSLENDER%2BMAN%26fr%3Dmcafee%26fr2%3Dpiv-web%26tab%3Dorganic%26ri%3D20&w=1600&h=1143&imgurl=fc07.deviantart.net%2Ffs70%2Fi%2F2014%2F009%2F9%2F2%2Fslender_man_wallpaper_by_garnetbarren-d71j1uf.jpg&rurl=http%3A%2F%2Fliupis.com%2Fslender%2Fslender-man-wallpaper-hd.html&size=331.9KB&name=%3Cb%3ESlender+Man%3C%2Fb%3E+Wallpaper+Hd+%7C+Auto+Design+Tech&p=SLENDER+MAN&oid=cbed5744048eb50bbdaf57a8ba9ca0d2&fr2=piv-web&fr=mcafee&tt=%3Cb%3ESlender+Man%3C%2Fb%3E+Wallpaper+Hd+%7C+Auto+Design+Tech&b=0&ni=21&no=20&ts=&tab=organic&sigr=11niv87n8&sigb=133ev0vbe&sigi=12pevs44r&sigt=11ivbrsvt&sign=11ivbrsvt&.crumb=75UEThdPt2d&fr=mcafee&fr2=piv-web")'});
...
document.getElementById('promoImgHolder').innerHTML = '</iframe><iframe width="400px" height="300px" src="https://www.youtube.com/watch?v=ERMRWk1bwqo" frameborder="0" allowfullscreen></iframe>';
document.getElementById('adCard').innerHTML = '<iframe width="400" height="300px" src="https://www.youtube.com/watch?v=_OC9LjTeipI" frameborder="0" allowfullscreen></iframe>';
// document.getElementById('downloadButtonContainer').innerHTML = '</iframe><iframe width="420px" height="236.25px" src=""></iframe>';

// document.getElementById("gameUI").style.backgroundImage = "url('')";
// document.getElementById("mainMenu").style.backgroundImage = "url('')";
document.getElementById('enterGame').innerHTML = 'Join ~_~';
document.getElementById('loadingText').innerHTML = 'Hey Bro welcom!';
document.getElementById('nameInput').placeholder = "Ur name Sir";
document.getElementById('chatBox').placeholder = "Talk ;-;";
document.getElementById('diedText').innerHTML = 'u died ?Moahhah xd ';
document.getElementById('gameName').innerHTML = 'Slendy';
...
$('#diedText').css({'background-color': '#FF0000'});
