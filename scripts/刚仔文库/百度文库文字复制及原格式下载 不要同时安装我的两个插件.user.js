// ==UserScript==
// @name         百度文库文字复制及原格式下载 不要同时安装我的两个插件
// @namespace    gangzai
// @version     2.6
// @description  为百度文库页面添加两个按钮，一键复制百度文库文字,一键获取原格式文档
// @author       gangzai
...
let dialogA = '<div id="dialogTpl" style="display:none;background: #fff;box-shadow: 0 1px 10px 0 rgba(0, 0, 0, 0.3);overflow: hidden;width: 500px;height: 200px;border: 1px solid #dcdcdc;position: fixed;z-index: 10000;top: 0;right: 0;bottom: 0;left: 0;margin: auto;"><span id="closeBtn" style="position: absolute;right: 5px;top: 5px;width: 16px;height: 16px;line-height: 16px;text-align: center;font-size: 18px;cursor: pointer;">×</span><div style="padding: 23px 13px;display: table;width: 100%;height: 100%;"><div style="vertical-align: middle;width: 100%;height: 100%;font-size: 14px;">1、可以点击下方的加QQ群下载把链接发到群里即可；<br/>2、您也可以手动将此网页网址发送至邮箱467897369@qq.com获取原格式文档；<br/></div></div><div style="display: table;table-layout: fixed;width: 100%;position: absolute;bottom: 0;left: 0;border-top: 1px solid #dcdcdc;"><span id="getYuan" style="display: table-cell;width: 50%;height: 50px;line-height: 50px;text-align: center;cursor: pointer;">加QQ群下载</span><span id="getEmail" class="btn" style="display: table-cell;width: 50%;height: 50px;line-height: 50px;text-align: center;cursor: pointer;border-left: 1px solid #dcdcdc;">复制下载邮箱</span></div></div>';
function Copy(str){
let result = false;
let save = function(e){
...
window.location.href = "https://jq.qq.com/?_wv=1027&k=5ZIAoDW";
$('#dialogTpl').hide();
});
...
$('body').find('#reader-copy-toemail').click(function() {
$('#dialogTpl').show();
});
