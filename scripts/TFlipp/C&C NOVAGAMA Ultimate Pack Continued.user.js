...
// ==UserScript==
// @name           KRS Zoom Out
// @description    allows you to zoom out further / not on forgotten Servers anymore
// @version        1.0.1c
// ==/UserScript==
			...
			qx.Class.define("ccta_map.container",
			{
				...
				construct: function()
				{
					try
					{
						...
						grid.set({ minWidth: 1500, backgroundColor: '#0b2833', minHeight: 1048, margin: 3, paddingTop: 10 });
						...
						mask.style.background = 'url("webfrontend/ui/common/frame_basewin/frame_basewindow_tl1.png") center center no-repeat';
			...
			qx.Class.define('ccta_pa',
			{
				...
				construct: function()
				{
					try
					{
						...
						newFont.setSize(32);
						abr.setFont(newFont);
						var deco = new qx.ui.decoration.Decorator().set({backgroundImage: "http://eistee82.github.io/ta_simv2/icon.png"});
						var imgCont = new qx.ui.container.Composite(new qx.ui.layout.VBox());
						imgCont.set({minWidth: 106, minHeight: 109, maxWidth: 110, maxHeight: 110, decorator: deco, alignX: 'center'});
