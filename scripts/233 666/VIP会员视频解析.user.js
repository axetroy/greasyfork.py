...
// @version    1.4
// @description  一键解析[优酷|腾讯|乐视|爱奇艺|芒果|AB站|音悦台]等VIP或会员视频，解析接口贵精不贵多，绝对够用。
// @author     对黄盐脚本解析源进行一点更新
...
(() => {
  ...
  `);
  var defaultapi = {
    title: "龙轩脚本的接口，默认用思古解析接口，失效请更换接口",
    url: "https://api.bbbbbb.me/?url="
  };
  //apis name:显示的文字  url:接口  title:提示文字  intab:是否适合内嵌(嵌入判断:GMgetValue("replaceRaw",false)值||intab值)
  var apis =[
    {name:"思古解析",url:"https://api.bbbbbb.me/?url=",title:"综合，多线路",intab:0},
    {name:"爱跟解析",url:"http://2gty.com/apiurl/yun.php?url=",title:"B站解析",intab:0},
    {name:"无名小站",url:"http://www.82190555.com/video.php?url=",title:"综合，多线路",intab:0},
    {name:"乐看会员",url:"http://jx.anlehe.com/?url=",title:"综合，多线路",intab:0},
    {name:"金桥解析",url:"http://jqaaa.com/jx.php?url=",title:"综合，多线路",intab:0},
    {name:"UU解析",url:"http://api.uuyingshi.com/?url=",title:"综合，多线路",intab:0},
    {name:"高端解析",url:"http://api.hlglwl.com/jx.php?url=",title:"综合，多线路",intab:1},
    {name:"花园解析",url:"https://jx.618g.com/?url=",title:"综合，多线路",intab:0},
    {name:"全网解析",url:"http://tv.larmb.com/",title:"综合，多线路",intab:0},
    {name:"音乐解析",url:"http://www.guqiankun.com/tools/music/?source=music163",title:"无",intab:0},
    {name:"音悦台解析",url:"http://www.guqiankun.com/tools/yinyuetai?source=vipvideo",title:"音悦台MV解析下载",intab:0},
  ];
  //嵌入页面播放
...
/** 2018-11-25  自定义解析接口 END */

})();

// 资源参考http://www.5ifxw.com/vip/
// 资源参考http://live.gopartook.com/
// 资源参考http://www.guqiankun.com/tools/vipvideo
// 资源参考http://51.ruyo.net/p/3127.html
// 资源参考https://cdn.yangju.vip/k/?url=
// 资源参考https://jx.lache.me/cc/?url=
// 资源参考https://api.653520.top/vip/?url=
// 资源参考https://jx.ab33.top/vip/?url=
// 资源参考https://vip.mpos.ren/v/?url=
// 资源参考https://jx.000180.top/jx/?url=
// 资源参考https://jx.km58.top/jx/?url=
