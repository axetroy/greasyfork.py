...
(function() {
    'use strict';
    var cracks=[
        {name:"够低调",url:"http://goudidiao.com/?url=",title:"首选"},
        {name:"百域阁",url:"http://api.baiyug.cn/vip/index.php?url=",title:"次选"},
        {name:"47影视云(s)",url:"https://api.47ks.com/webcloud/?v=%s"},
        {name:"无名小站",url:"http://www.wmxz.wang/video.php?url=%s",title:"c"},
