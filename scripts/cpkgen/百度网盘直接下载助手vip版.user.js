    ...
    function PanHelper(){
        ...
        function linkClick(event){
            ...
            if(id.indexOf('direct') != -1){
                ...
                var httplink1 = httplink.replace('d.pcs.baidu.com','bjbgp01.baidupcs.com');
                var httpslink1 = httpslink.replace('d.pcs.baidu.com','bjbgp01.baidupcs.com');
				var httplink2 = httplink.replace('d.pcs.baidu.com','yqall02.baidupcs.com');
                var httpslink2 = httpslink.replace('d.pcs.baidu.com','yqall02.baidupcs.com');
                var filename = '';
                ...
                linkList = {
                    ...
                    urls:[
                        ...
                        {url:httpslink1,rank:3},
                         {url:httpslink2,rank:4}
        ...
        function confirmClick(){
            ...
            if(result.errno == -20){
                ...
                if(buttonTarget == 'download'){
					...
					var link1 = link.replace('https://d.pcs.baidu.com','http://bjbgp01.baidupcs.com');
			     	var slink1 = link.replace('d.pcs.baidu.com','bjbgp01.baidupcs.com');
			        var link2 = link.replace('https://d.pcs.baidu.com','http://yqall02.baidupcs.com');
				    var slink2 = link.replace('d.pcs.baidu.com','yqall02.baidupcs.com');
                    var linkList = {
                        filename:filename,
                        urls:[
                            {url:link1,rank:1},
