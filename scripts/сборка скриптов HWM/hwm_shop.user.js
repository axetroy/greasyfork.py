...
// @include        https://*heroeswm.ru/shop.php*
// @include        https://178.248.235.15/shop.php*
// @include        https://209.200.152.144/shop.php*
// @include        https://*lordswm.com/shop.php*
// @include        https://*heroeswm.ru/art_info.php?id=*
// @include        https://178.248.235.15/art_info.php?id=*
// @include        https://209.200.152.144/art_info.php?id=*
// @include        https://*lordswm.com/art_info.php?id=*
// ==/UserScript==
...
if ( location.pathname=='/shop.php' ) {
	...
	var arts_id_array = document.querySelectorAll("img[src*='/artifacts/'][src$='.jpg'], img[src*='/artifacts/'][src$='.png']");
}
