...
if ( url=='https://www.heroeswm.ru/' || url=='https://qrator.heroeswm.ru/' || url=='https://178.248.235.15/' || url=='https://www.lordswm.com/' ) { update_n(version,script_num,script_name); }
	else { url = 'https://www.heroeswm.ru/'; }
