...
// @description    Помощник ГО. (2019.03.27)
...
//****************************************************
var mob_rus_exp = {//252 существ. Cтруктура: [Опыт,HP,link on picture,flying] 
...
function showExperience() {
	...
	for (var k = 0; k < all_tables.length; k++)
	{
		if (all_tables[k].className == "wbwhite")
		{
			...
			if (mob_rus_exp[$ustring(mob_name)] === undefined) continue;
			if (show_HP) 
			{
