...
function inicio() {
    document.title = "OGARio 團隊親 ❥";
    modificarTextoMinimapa("By 團隊親 ❥");
    modificarTextoLeaderboard("團隊親 ❥");
    modificarCanalYoutube("Suscríbete a mi canal", "UCO1PiH75h1RqP6D8Uv0Y_IQ");
    modificarFooter("Visita mi página web", "https://www.youtube.com/channel/UCO1PiH75h1RqP6D8Uv0Y_IQ");
    panelDerecho();
    ...
    alert("Bienvenido a mi extensión");
}
...
function modificarTextoMinimapa(titulo) {
    ...
    CanvasRenderingContext2D.prototype._fillText = function(){
        if(arguments[0] == 'ogario.ovh'){
            arguments[0] = titulo; // arguments[0] = 'By 團隊親 ❥'; // Borra el texto transparente encima del minimapa
        }
