// ==UserScript==
// @name        哔哩哔哩旧版（bilibili.com）播放器调整
// @namespace   micky7q7
// @author      mickey7q7
// @license     MIT License
...
// @description 针对B站旧版播放器设置,添加了一些实用的选项,原作者为mickey7q7。
// @version     1.53.3
// @grant       GM.setValue
// @grant       GM_setValue
// @grant       GM.getValue
...
(function() {
	...
	var adjustPlayer = {
        ...
        //从"上次观看"处跳转播放
        jumpLastPlay: function (set, type) {
			if (typeof set !== 'undefined') {
				var jumpBtn = isBangumi('.bilibili-player-video-toast-item-jump');
				if (jumpBtn !== null){
					doClick(jumpBtn);
				}
			}
						...
						if (video !== null && readyState !== null) {
							if (readyState.search("display: none;") !== -1) {
								try {
                                    ...
                                    //跳转播放
                                    adjustPlayer.jumpLastPlay(setting.jumpLastPlay, video);
         ...
         <form>
            ...
            <div class="right">
            	...
            	<fieldset class="playbackGroup">
            		...
            		<div class="block">
                        <label class="h5"><input name="jumpLastPlay" type="checkbox"><span class="checkbox"></span>从"上次观看"位置开始播放</label>
